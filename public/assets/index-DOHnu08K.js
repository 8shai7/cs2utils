...
`)}var le=.5;function ue(e){return{base:e,lo:e*(1-le),hi:e*1.5,round:1,choices:[]}}function de(e){return{lower:e.lo,higher:e.hi,mid:(e.lo+e.hi)/2}}function fe(e){return e.round>7}function pe(e){return(e.lo+e.hi)/2}function me(e){let t=pe(e);return t<=0?0:(e.hi-e.lo)/t}function he(e,t){if(fe(e))return e;let n=(e.lo+e.hi)/2,r={round:e.round,side:t,lo:e.lo,hi:e.hi,lower:e.lo,higher:e.hi},i={...e,choices:[...e.choices,r],round:e.round+1};return t===`lower`?i.hi=n:i.lo=n,i}function ge(e){if(e.choices.length===0)return e;let t=e.choices.slice(0,-1),n=e.choices[e.choices.length-1];return{...e,lo:n.lo,hi:n.hi,round:n.round,choices:t}}function _e(e){return pe(e)}var ve=`/api`,ye=`cs2utils.token`,be=/^https?:\/\//.test(ve)?new URL(ve).origin:``;function xe(){try{return localStorage.getItem(ye)}catch{return null}}function Se(e){try{e?localStorage.setItem(ye,e):localStorage.removeItem(ye)}catch{}}async function m(e,t,n,{auth:r=!1}={}){let i={};if(n!==void 0&&!(n instanceof FormData)&&(i[`Content-Type`]=`application/json`),r){let e=xe();e&&(i.Authorization=`Bearer ${e}`)}let a;try{a=await fetch(`${ve}${t}`,{method:e,headers:i,body:n instanceof FormData?n:n===void 0?void 0:JSON.stringify(n)})}catch{throw Error(`Cannot reach the server. Is the API running?`)}let o=null,s=await a.text();if(s)try{o=JSON.parse(s)}catch{o=null}if(!a.ok){let e=Error(o&&o.error||`Request failed (${a.status}).`);throw e.status=a.status,e.data=o,e}return o}var Ce=`${ve}/auth/steam`;function we(e){Se(e)}function h(e){return!!e&&(e.role===`admin`||e.role===`owner`)}function Te(e){return!!e&&e.role===`owner`}function Ee(e){return e?/^https?:\/\//.test(e)||e.startsWith(`data:`)?e:be+e:``}var g={auth:{async register(e){let t=await m(`POST`,`/auth/register`,e);return Se(t.token),t.user},async login(e){let t=await m(`POST`,`/auth/login`,e);return Se(t.token),t.user},logout(){Se(null)},async captcha(){return m(`GET`,`/auth/captcha`)},async changePassword(e){return m(`POST`,`/auth/password`,e,{auth:!0})},async forgot(e){return m(`POST`,`/auth/forgot`,{email:e})},async reset(e,t){return m(`POST`,`/auth/reset`,{token:e,password:t})},async me(){if(!xe())return null;try{return(await m(`GET`,`/auth/me`,void 0,{auth:!0})).user}catch{return Se(null),null}},async profile(){return m(`GET`,`/auth/profile`,void 0,{auth:!0})},async setAvatar(e){return(await m(`POST`,`/auth/avatar`,{url:e},{auth:!0})).user},async uploadAvatar(e){let t=new FormData;return t.append(`file`,e),(await m(`POST`,`/auth/avatar/upload`,t,{auth:!0})).user},async changePassword(e){return m(`POST`,`/auth/password`,e,{auth:!0})},async changeUsername(e){let t=await m(`POST`,`/auth/username`,{username:e},{auth:!0});return t.token&&Se(t.token),t.user},async setCredentials(e){let t=await m(`POST`,`/auth/credentials`,e,{auth:!0});return t.token&&Se(t.token),t.user},async forgot(e){return m(`POST`,`/auth/forgot`,{email:e})},async reset(e,t){return m(`POST`,`/auth/reset`,{token:e,password:t})},steamLoginUrl(){return`${ve}/auth/steam`},async steamLinkUrl(){return(await m(`GET`,`/auth/steam/link-url`,void 0,{auth:!0})).url},async steamUnlink(){return(await m(`POST`,`/auth/steam/unlink`,{},{auth:!0})).user}},settings:{async get(){return m(`GET`,`/settings`)}},contact:{async send(e){return m(`POST`,`/contact`,e)}},pros:{async list({q:e=``,sort:t=`name`}={}){let n=new URLSearchParams;e&&n.set(`q`,e),t&&n.set(`sort`,t);let r=n.toString();return m(`GET`,`/pros${r?`?${r}`:``}`)}},configs:{async list({sort:e=`top`,q:t=``}={}){let n=new URLSearchParams;e&&n.set(`sort`,e),t&&n.set(`q`,t);let r=n.toString();return(await m(`GET`,`/configs${r?`?${r}`:``}`,void 0,{auth:!0})).configs},async create(e){return(await m(`POST`,`/configs`,e,{auth:!0})).config},async rate(e,t){return m(`POST`,`/configs/${e}/rate`,{rating:t},{auth:!0})},async remove(e){return m(`DELETE`,`/configs/${e}`,void 0,{auth:!0})}},highlights:{async list({q:e=``}={}){return(await m(`GET`,`/highlights${e?`?q=${encodeURIComponent(e)}`:``}`,void 0,{auth:!0})).highlights},async create(e){return(await m(`POST`,`/highlights`,e,{auth:!0})).highlight},async report(e,t){return m(`POST`,`/highlights/${e}/report`,{reason:t},{auth:!0})},async remove(e){return m(`DELETE`,`/highlights/${e}`,void 0,{auth:!0})}},nades:{async list({map:e=``,type:t=``}={}){let n=new URLSearchParams;e&&n.set(`map`,e),t&&n.set(`type`,t);let r=n.toString();return(await m(`GET`,`/nades${r?`?${r}`:``}`)).nades},async mine(){return(await m(`GET`,`/nades/mine`,void 0,{auth:!0})).nades},async favorites({map:e=``,type:t=``}={}){let n=new URLSearchParams;e&&n.set(`map`,e),t&&n.set(`type`,t);let r=n.toString();return(await m(`GET`,`/nades/favorites${r?`?${r}`:``}`,void 0,{auth:!0})).nades},async social(){return m(`GET`,`/nades/social`,void 0,{auth:!!xe()})},async favorite(e){return m(`POST`,`/nades/${e}/favorite`,{},{auth:!0})},async create(e){return(await m(`POST`,`/nades`,e,{auth:!0})).nade},async addMedia(e,t){return(await m(`POST`,`/nades/${e}/media`,t,{auth:!0})).media},async remove(e){return m(`DELETE`,`/nades/${e}`,void 0,{auth:!0})},async parseMapGuide(e){return m(`POST`,`/nades/map-guide/parse`,{text:e},{auth:!0})},async importMapGuide({text:e,nades:t,side:n,guideText:r,fileName:i}={}){return m(`POST`,`/nades/map-guide/import`,{text:e,nades:t,side:n,guideText:r,fileName:i},{auth:!0})},async practicePackFromText({text:e,map:t,importId:n}={}){return m(`POST`,`/nades/map-guide/practice-pack`,{text:e,map:t,importId:n},{auth:!0})},async practicePackFromImport(e){return m(`GET`,`/nades/map-guide/imports/${e}/practice-pack`,void 0,{auth:!!xe()})},async practicePackFromNades(e){return m(`POST`,`/nades/map-guide/practice-pack-from-nades`,{nadeIds:e},{auth:!!xe()})}},commands:{async catalog(){return m(`GET`,`/commands/catalog`)},async social(){return m(`GET`,`/commands/social`,void 0,{auth:!0})},async recommend(e){return m(`POST`,`/commands/${e}/recommend`,{},{auth:!0})},async addComment(e,t){return m(`POST`,`/commands/${e}/comments`,{body:t},{auth:!0})}},admin:{async pending(){return(await m(`GET`,`/admin/nades/pending`,void 0,{auth:!0})).nades},async pendingComments(){return(await m(`GET`,`/admin/comments/pending`,void 0,{auth:!0})).comments},async pendingCommentsCount(){return(await m(`GET`,`/admin/comments/pending/count`,void 0,{auth:!0})).count},async reviewComment(e,t){return m(`POST`,`/admin/comments/${e}/review`,{decision:t},{auth:!0})},async removeComment(e){return m(`DELETE`,`/admin/comments/${e}`,void 0,{auth:!0})},async syncCommands(){return m(`POST`,`/admin/commands/sync`,{},{auth:!0})},async checkCommandsCs2(){return m(`POST`,`/admin/commands/check-cs2`,{},{auth:!0})},async saveSettings(e){return m(`POST`,`/admin/settings`,e,{auth:!0})},async highlightReports(){return(await m(`GET`,`/admin/highlights/reports`,void 0,{auth:!0})).highlights},async highlightReportsCount(){return(await m(`GET`,`/admin/highlights/reports/count`,void 0,{auth:!0})).count},async reviewHighlight(e,t){return m(`POST`,`/admin/highlights/${e}/review`,{decision:t},{auth:!0})},async syncPros(){return m(`POST`,`/admin/pros/sync`,{},{auth:!0})},async importCommands(e){return m(`POST`,`/admin/commands/import`,{content:e},{auth:!0})},async importPros(e){return m(`POST`,`/admin/pros/import`,{content:e},{auth:!0})},async banUser(e,{hours:t,permanent:n}){return(await m(`POST`,`/admin/users/${e}/ban`,{hours:t,permanent:n},{auth:!0})).user},async unbanUser(e){return(await m(`POST`,`/admin/users/${e}/unban`,{},{auth:!0})).user},async pendingCount(){return(await m(`GET`,`/admin/nades/pending/count`,void 0,{auth:!0})).count},async reviewNade(e,t,n=``){return m(`POST`,`/admin/nades/${e}/review`,{decision:t,note:n},{auth:!0})},async reviewNadesBulk(e,t,n=``){return m(`POST`,`/admin/nades/review-bulk`,{ids:e,decision:t,note:n},{auth:!0})},async reviewMedia(e,t){return m(`POST`,`/admin/media/${e}/review`,{decision:t},{auth:!0})},async reviewMediaBulk(e,t){return m(`POST`,`/admin/media/review-bulk`,{ids:e,decision:t},{auth:!0})},async removeMedia(e){return m(`DELETE`,`/admin/media/${e}`,void 0,{auth:!0})},async users(){return(await m(`GET`,`/admin/users`,void 0,{auth:!0})).users},async setRole(e,t){return(await m(`POST`,`/admin/users/${e}/role`,{role:t},{auth:!0})).user},async contactMessages(){return(await m(`GET`,`/admin/contact`,void 0,{auth:!0})).messages},async removeContact(e){return m(`DELETE`,`/admin/contact/${e}`,void 0,{auth:!0})},async ownerLogs({limit:e=100,offset:t=0,action:n=``}={}){let r=new URLSearchParams;e&&r.set(`limit`,String(e)),t&&r.set(`offset`,String(t)),n&&r.set(`action`,n);let i=r.toString();return m(`GET`,`/admin/owner-logs${i?`?${i}`:``}`,void 0,{auth:!0})}},uploads:{async image(e){let t=new FormData;return t.append(`file`,e),await m(`POST`,`/uploads`,t,{auth:!0})}}},De=null,Oe=new Set;function ke(){for(let e of Oe)e(De)}function Ae(){return De}function je(e){return Oe.add(e),()=>Oe.delete(e)}async function Me(){return De=await g.auth.me(),ke(),De}async function Ne(e){return De=await g.auth.login(e),ke(),De}async function Pe(e){return De=await g.auth.register(e),ke(),De}function Fe(){g.auth.logout(),De=null,ke()}var Ie,_,Le=`login`,Re={required:!1,token:null,svg:``};function ze(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Be(){let e=Ae();e?(Ie.innerHTML=`
    ...
    </div>`}function bt(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}var xt={error:`Something went wrong`,warn:`Heads up`,ok:`Done`},St=null,Ct=null,wt=null;function Tt(){return St?.isConnected?St:(St=document.createElement(`div`),St.className=`app-toast-host`,St.setAttribute(`aria-live`,`assertive`),St.setAttribute(`aria-relevant`,`additions`),document.body.appendChild(St),St)}function Et(){Ct&&clearTimeout(Ct),wt&&clearTimeout(wt),Ct=null,wt=null}function Dt(e,t={}){let n=t.kind===`ok`||t.kind===`warn`?t.kind:`error`,r=t.title||xt[n],i=Number.isFinite(t.duration)?t.duration:n===`ok`?2800:4500,a=String(e||``).trim();if(!a)return;let o=Tt();Et(),o.replaceChildren();let s=document.createElement(`div`);s.className=`app-toast app-toast--${n}`,s.setAttribute(`role`,`alert`),s.innerHTML=`
    <span class="app-toast-icon" aria-hidden="true"></span>
    <div class="app-toast-body">
      <strong class="app-toast-title">${bt(r)}</strong>
      <p class="app-toast-msg">${bt(a)}</p>
    </div>
    <button type="button" class="app-toast-close" aria-label="Dismiss">&times;</button>`;let c=()=>{Et(),s.classList.remove(`app-toast-in`),s.classList.add(`app-toast-out`),wt=setTimeout(()=>{s.parentNode===o&&s.remove()},220)};s.querySelector(`.app-toast-close`)?.addEventListener(`click`,c),o.appendChild(s),requestAnimationFrame(()=>{requestAnimationFrame(()=>s.classList.add(`app-toast-in`))}),Ct=setTimeout(c,i)}var Ot=360,kt=100,v,y=null,b=`browse`,At={text:``,kind:``},jt=0,Mt=!1,Nt={map:``,type:``},Pt=[],x=new Map,Ft={counts:{},mine:[]},It=[],Lt=[],Rt=[],zt=[],S=Vt(),C=Ht(),w=null,Bt=1;function Vt(){return{map:`mirage`,type:`smoke`,side:`t`,technique:`stand`,title:``,description:``,start:null,end:null}}function Ht(){return{text:``,fileName:``,side:`t`,parsed:null,selected:null}}function T(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Ut(e){let t=Ee(e);return/^https?:\/\//.test(t)||t.startsWith(`data:image/`)?t:``}function Wt(e){let t=/(?:youtube\.com\/(?:watch\?v=|embed\/|shorts\/)|youtu\.be\/)([\w-]{6,})/.exec(e||``);return t?t[1]:null}function Gt(e,t){return e.map(e=>`<option value="${e.id}"${e.id===t?` selected`:``}>${T(e.name)}</option>`).join(``)}function E(e,t=``,n={}){At={text:e,kind:t};let r=v?.querySelector(`#nades-status`);r&&(r.textContent=e,r.className=`status${t?` ${t}`:``}`),(t===`error`||t===`warn`)&&e&&Dt(e,{kind:t,title:n.title})}function Kt(e){return`<span class="nade-badge ${e}">${e}</span>`}function qt(e){try{return new Date(e).toLocaleDateString()}catch{return``}}async function Jt(){if(h(y))try{jt=await g.admin.pendingCount()}catch{jt=0}else jt=0}async function Yt(){try{Ft=await g.nades.social()}catch{Ft={counts:{},mine:[]}}}async function D(e){b=e,Mt=![`add`,`import`].includes(e),Mt&&O();try{b===`browse`&&(Pt=await g.nades.list(Nt),await Yt()),b===`favorites`&&(y?(It=await g.nades.favorites(Nt),await Yt()):It=[]),b===`mine`&&y&&(Lt=await g.nades.mine()),b===`review`&&h(y)&&(Rt=await g.admin.pending(),jt=await g.admin.pendingCount()),b===`users`&&h(y)&&(zt=await g.admin.users())}catch(e){E(e.message,`error`)}Mt=!1,O()}function Xt(e){let t=Ut(e.url);if(!t)return``;if(e.kind===`video`){let n=Wt(e.url);return n?`<iframe class="nade-media-embed" src="https://www.youtube.com/embed/${T(n)}" title="nade video" allowfullscreen loading="lazy"></iframe>`:/\.(mp4|webm|mov)(\?|$)/i.test(e.url)?`<video class="nade-media-embed" src="${T(t)}" controls preload="none"></video>`:`<a class="btn ghost" href="${T(t)}" target="_blank" rel="noopener noreferrer">Open video ↗</a>`}return`<a href="${T(t)}" target="_blank" rel="noopener noreferrer"><img class="nade-media-img" src="${T(t)}" alt="${T(e.addedByName||`nade media`)}" loading="lazy" /></a>`}function Zt(e,{showStatus:t=!1,showTryInGame:n=!1,adminRemove:r=!1,showFavorite:i=!1}={}){let a=tt(e.type),o=(e.media||[]).filter(e=>t?!0:e.status===`approved`),s=o.length?`<div class="nade-media">${o.map(e=>`<div class="nade-media-item">${Xt(e)}${t?`<div class="nade-media-meta">${Kt(e.status)} <span>by ${T(e.addedByName||``)}</span></div>`:``}</div>`).join(``)}</div>`:`<p class="hint">No approved media yet — a 2D throw preview is shown above.</p>`,c=n&&x.has(e.id),l=Ft.mine.includes(e.id),u=Ft.counts[e.id]||0,d=i?`<button class="btn btn-sm favorite ${l?`active`:``}" type="button" data-favorite-nade="${e.id}" title="${l?`Remove from favorites`:`Add to favorites`}">${l?`★ Favorited`:`☆ Favorite`}${u?` <span class="fav-count">${u}</span>`:``}</button>`:``,f=n?`<div class="nade-card-actions">
         <label class="browse-nade-check">
           <input type="checkbox" class="browse-select" value="${e.id}" data-map="${T(e.map)}" ${c?`checked`:``} />
           <span>Select</span>
         </label>
         ${d}
         <button class="btn" type="button" data-try-nades="${e.id}">Try in game</button>
         ${r&&h(y)?`<button class="btn ghost danger" type="button" data-delete-nade="${e.id}">Remove</button>`:``}
       </div>`:d||r&&h(y)?`<div class="nade-card-actions">
           ${d}
           ${r&&h(y)?`<button class="btn ghost danger" type="button" data-delete-nade="${e.id}">Remove</button>`:``}
         </div>`:``;return`
    <article class="nade-card${n?` browse-nade-card`:``}${c?` selected`:``}${l&&i?` favorited`:``}"${n?` data-browse-nade="${e.id}" data-map="${T(e.map)}" tabindex="0" role="checkbox" aria-checked="${c?`true`:`false`}"`:``}>
      <div class="nade-card-head">
        <div>
          <h3>${T(e.title)}</h3>
          <p class="nade-sub">
            <span class="nade-chip" style="--chip:${a.color}">${T(a.name)}</span>
      ...
      ${s}
      <p class="nade-foot">by ${T(e.authorName)} · ${qt(e.createdAt)}</p>
      ${f}
    </article>`}function Qt(){return[...x.keys()]}function $t(){let e=Pt.length?Pt.map(e=>Zt(e,{showTryInGame:!0,adminRemove:!0,showFavorite:!0})).join(``):`<p class="hint">No approved nades yet${y?` — be the first to add one!`:` — log in and add the nades you found.`}</p>`,t=x.size;return`
    <div class="nades-filters">
      <label class="field">
        <span>Map</span>
        <select id="filter-map"><option value="">All maps</option>${Gt(Xe,Nt.map)}</select>
      </label>
      <label class="field">
        <span>Type</span>
        <select id="filter-type"><option value="">All types</option>${Gt(Ze,Nt.type)}</select>
      </label>
    </div>
    ...
    <div class="nade-grid">${e}</div>`}function en(){if(!y)return tn(`save favorite nades`);let e=It.length?It.map(e=>Zt(e,{showTryInGame:!0,adminRemove:!0,showFavorite:!0})).join(``):`<p class="hint">No favorites yet — star lineups in Browse to save them here.</p>`,t=x.size;return`
    <div class="nades-filters">
      <label class="field">
        <span>Map</span>
        <select id="filter-map"><option value="">All maps</option>${Gt(Xe,Nt.map)}</select>
    ...
    <div class="nade-add">
      ...
      <form class="nade-add-form" id="nade-add-form">
        ...
        <div class="sens-grid">
          <label class="field"><span>Map</span><select id="add-map">${Gt(Xe,S.map)}</select></label>
          <label class="field"><span>Type</span><select id="add-type">${Gt(Ze,S.type)}</select></label>
        </div>
        <div class="sens-grid">
          <label class="field"><span>Side</span><select id="add-side">${Gt($e,S.side)}</select></label>
          <label class="field"><span>Technique</span><select id="add-technique">${Gt(Qe,S.technique)}</select></label>
        </div>
    ...
    </div>`:tn(`add nades`)}function rn(){if(!y)return tn(`import a CS2 map guide`);let e=C.parsed,t=e&&C.selected!=null?e.nades[C.selected]:e?.nades?.[0]||null,n=e?`<div class="guide-preview-list">
    ...
    <div class="nade-import">
      ...
      <div class="nade-add-form">
        ...
        <label class="field">
          ...
          <select id="guide-side">${Gt($e,C.side)}</select>
        </label>
        <div class="actions">
    ...
    </div>`}function an(){return y?Lt.length?`<div class="nade-grid">${Lt.map(e=>`
      <div class="nade-mine">
        ${Zt(e,{showStatus:!0})}
      ...
      </div>`).join(``)}</div>`:`<p class="hint">You haven't added any nades yet.</p>`:tn(`see and manage your nades`)}function on(){return h(y)?Rt.length?`
    ...
    <div class="nade-grid">${Rt.map(e=>{let t=e.media||[],n=t.length?`<div class="review-media">${t.map(e=>`<div class="review-media-item">${Xt(e)}
                  <div class="nade-media-meta">${Kt(e.status)} <span>by ${T(e.addedByName||``)}</span></div>
                  <div class="actions">
                 ...
                 <p class="hint">Nade already ${T(e.status)} — you can still unpublish, re-approve, or delete it.</p>
                 <div class="review-actions-btns">
                 ...
                 <input type="text" class="review-note" data-nade="${e.id}" placeholder="Optional note to the author" />
               </div>`;return`<div class="nade-mine">${Zt(e,{showStatus:!0})}${n}${r}</div>`}).join(``)}</div>`:`<p class="hint">Nothing pending review. Nice and clean.</p>`:`<p class="hint">Admins only.</p>`}function sn(e){if(!e.bannedUntil)return null;let t=new Date(e.bannedUntil);return t.getTime()<=Date.now()?null:t.getFullYear()>=9999?`permanently`:`until ${t.toLocaleString()}`}function cn(){if(!h(y))return`<p class="hint">Admins only.</p>`;let e=Te(y);return`<div class="users-table">
    ...
    ${zt.map(t=>{let n=sn(t),r=t.role===`owner`?`<span class="hint">owner</span>`:e?t.role===`admin`?`<button class="btn btn-sm ghost" data-role-user="${t.id}" data-role="user">Remove admin</button>`:`<button class="btn btn-sm primary" data-role-user="${t.id}" data-role="admin">Promote to admin</button>`:`<span class="hint">${T(t.role)}</span>`,i=t.role===`owner`?``:n?`<span class="nade-badge rejected">banned ${T(n)}</span> <button class="btn btn-sm ghost" data-unban="${t.id}">Unban</button>`:`<select class="ban-duration" data-ban-dur="${t.id}">
          ...
          <div><strong>${T(t.username)}</strong><br /><span class="hint">${T(t.email)}</span></div>
          <div>${Kt(t.role)}</div>
          <div class="user-actions">${r}</div>
          <div class="user-actions">${i}</div>
        </div>`}).join(``)}
  </div>`}function ln(){let e=Ft.mine?.length||0,t=[[`browse`,`Browse`]];return y&&(t.push([`favorites`,`Favorites${e?` (${e})`:``}`]),t.push([`add`,`Add nade`],[`import`,`Import guide`],[`mine`,`My nades`])),h(y)&&t.push([`review`,`Review${jt?` (${jt})`:``}`],[`users`,`Users`]),`<nav class="nades-subnav">${t.map(([e,t])=>`<button class="tool-tab ${b===e?`active`:``}" data-view="${e}">${T(t)}</button>`).join(``)}</nav>`}function un(){if(Mt)return`<div class="nades-loading"><span class="spinner"></span> Loading…</div>`;switch(b){case`add`:return nn();case`import`:return rn();case`favorites`:return en();case`mine`:return an();case`review`:return on();case`users`:return cn();default:return $t()}}function O(){v.innerHTML=`
    <div class="nades-shell">
      ${ln()}
      <div class="nades-body">${un()}</div>
      <div id="nades-status" class="status ${At.kind}">${T(At.text)}</div>
      ${w?yt(w,{esc:T,lineupCount:Bt}):``}
    </div>`,mn(),dn()}function dn(){v.querySelectorAll(`canvas.nade-canvas:not(.interactive):not(#guide-preview-canvas)`).forEach(e=>{ut(e,{mapId:e.dataset.map,type:e.dataset.type,start:{x:Number(e.dataset.sx),y:Number(e.dataset.sy)},end:{x:Number(e.dataset.ex),y:Number(e.dataset.ey)}})}),fn(),pn()}function fn(){let e=v.querySelector(`#nade-add-canvas`);e&&ut(e,{mapId:S.map,type:S.type,start:S.start,end:S.end})}function pn(){let e=v.querySelector(`#guide-preview-canvas`);if(!e)return;let t=C.parsed?.nades?.[C.selected??0];if(!t){ut(e,{mapId:`mirage`,type:`smoke`,start:null,end:null});return}ut(e,{mapId:t.map,type:t.type,start:t.start,end:t.end})}function mn(){v.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>Je(e.dataset.openAuth))),v.querySelectorAll(`[data-view]`).forEach(e=>e.addEventListener(`click`,()=>D(e.dataset.view))),v.querySelector(`#filter-map`)?.addEventListener(`change`,e=>{Nt.map=e.target.value,x=new Map,D(b===`favorites`?`favorites`:`browse`)}),v.querySelector(`#filter-type`)?.addEventListener(`change`,e=>{Nt.type=e.target.value,D(b===`favorites`?`favorites`:`browse`)}),v.querySelectorAll(`.browse-select`).forEach(e=>e.addEventListener(`change`,()=>{xn(Number(e.value),e.dataset.map,e.checked),Sn(e.closest(`.browse-nade-card`))})),v.querySelectorAll(`.browse-nade-card`).forEach(e=>{e.addEventListener(`click`,t=>{t.target.closest(`a, button, input, label`)||Cn(e)}),e.addEventListener(`keydown`,t=>{t.key!==` `&&t.key!==`Enter`||t.target.closest(`a, button, input, label`)||(t.preventDefault(),Cn(e))})}),v.querySelector(`#browse-select-clear`)?.addEventListener(`click`,()=>{x=new Map,O()}),v.querySelector(`#browse-try-selected`)?.addEventListener(`click`,()=>{Tn(Qt())}),v.querySelectorAll(`[data-try-nades]`).forEach(e=>e.addEventListener(`click`,t=>{t.stopPropagation(),Tn([Number(e.dataset.tryNades)])})),v.querySelectorAll(`[data-favorite-nade]`).forEach(e=>e.addEventListener(`click`,t=>{t.stopPropagation(),En(Number(e.dataset.favoriteNade))}));let e=v.querySelector(`#nade-add-canvas`);e&&e.addEventListener(`click`,t=>{let n=pt(e,t);!S.start||S.start&&S.end?(S.start=n,S.end=null):S.end=n;let r=v.querySelector(`#nade-add-coords`);r&&(r.textContent=S.end?`Throw + landing set. Adjust by clicking again to start over.`:`Now click the landing spot for the grenade.`),fn()}),v.querySelector(`#add-map`)?.addEventListener(`change`,e=>{S.map=e.target.value,fn()}),v.querySelector(`#add-type`)?.addEventListener(`change`,e=>{S.type=e.target.value,fn()}),v.querySelector(`#add-clear`)?.addEventListener(`click`,()=>{S.start=null,S.end=null,fn();let e=v.querySelector(`#nade-add-coords`);e&&(e.textContent=`Click the map to set the throw position, then click again for the landing spot.`)}),v.querySelector(`#nade-add-form`)?.addEventListener(`submit`,hn),v.querySelector(`#guide-file`)?.addEventListener(`change`,gn),v.querySelector(`#guide-text`)?.addEventListener(`input`,e=>{C.text=e.target.value}),v.querySelector(`#guide-side`)?.addEventListener(`change`,e=>{C.side=e.target.value}),v.querySelector(`#guide-parse`)?.addEventListener(`click`,_n),v.querySelector(`#guide-import`)?.addEventListener(`click`,vn),v.querySelector(`#guide-try-game`)?.addEventListener(`click`,yn),v.querySelector(`#guide-clear`)?.addEventListener(`click`,()=>{C=Ht(),w=null,O(),E(`Cleared map guide.`,``)}),v.querySelectorAll(`[data-guide-idx]`).forEach(e=>e.addEventListener(`click`,()=>{C.selected=Number(e.dataset.guideIdx),O()})),v.querySelector(`[data-try-game-close]`)?.addEventListener(`click`,()=>{w=null,Bt=1,O()}),v.querySelector(`[data-try-game-download]`)?.addEventListener(`click`,()=>{if(!w)return;let e=vt(v);if(!e.guide&&!e.cfg){let e=v.querySelector(`[data-try-game-status]`);e&&(e.textContent=`Choose at least one file to download, or just Open CS2 if you already have them.`);return}let t=ht(w,e),n=v.querySelector(`[data-try-game-status]`);n&&(n.textContent=t.length?`Downloaded ${t.join(` + `)}. Copy into your CS2 folders, then Open CS2.`:`Nothing selected to download.`)}),v.querySelector(`[data-try-game-open]`)?.addEventListener(`click`,Dn),v.querySelector(`[data-try-game-copy-cmd]`)?.addEventListener(`click`,On),v.querySelectorAll(`[data-add-media]`).forEach(e=>e.addEventListener(`click`,()=>kn(e.dataset.addMedia))),v.querySelectorAll(`[data-try-import]`).forEach(e=>e.addEventListener(`click`,()=>bn(e.dataset.tryImport))),v.querySelectorAll(`[data-delete-nade]`).forEach(e=>e.addEventListener(`click`,()=>An(e.dataset.deleteNade))),v.querySelectorAll(`[data-delete-media]`).forEach(e=>e.addEventListener(`click`,()=>jn(e.dataset.deleteMedia))),v.querySelectorAll(`[data-approve-nade]`).forEach(e=>e.addEventListener(`click`,()=>Mn(e.dataset.approveNade,`approved`))),v.querySelectorAll(`[data-reject-nade]`).forEach(e=>e.addEventListener(`click`,()=>Mn(e.dataset.rejectNade,`rejected`))),v.querySelectorAll(`[data-approve-media]`).forEach(e=>e.addEventListener(`click`,()=>Pn(e.dataset.approveMedia,`approved`))),v.querySelectorAll(`[data-reject-media]`).forEach(e=>e.addEventListener(`click`,()=>Pn(e.dataset.rejectMedia,`rejected`)));let t=v.querySelector(`#review-select-all`),n=v.querySelector(`#review-bulk-approve`),r=v.querySelector(`#review-bulk-reject`),i=()=>{let e=v.querySelectorAll(`.review-nade-check:checked`).length;n&&(n.disabled=e===0),r&&(r.disabled=e===0)};t?.addEventListener(`change`,()=>{v.querySelectorAll(`.review-nade-check`).forEach(e=>{e.checked=t.checked}),i()}),v.querySelectorAll(`.review-nade-check`).forEach(e=>e.addEventListener(`change`,i)),n?.addEventListener(`click`,()=>Nn(`approved`)),r?.addEventListener(`click`,()=>Nn(`rejected`)),v.querySelectorAll(`[data-role-user]`).forEach(e=>e.addEventListener(`click`,()=>Fn(e.dataset.roleUser,e.dataset.role))),v.querySelectorAll(`[data-ban]`).forEach(e=>e.addEventListener(`click`,()=>{let t=v.querySelector(`[data-ban-dur="${e.dataset.ban}"]`);In(e.dataset.ban,t?t.value:`24`)})),v.querySelectorAll(`[data-unban]`).forEach(e=>e.addEventListener(`click`,()=>Ln(e.dataset.unban)))}async function hn(e){if(e.preventDefault(),S.title=v.querySelector(`#add-title`)?.value||``,S.map=v.querySelector(`#add-map`)?.value||S.map,S.type=v.querySelector(`#add-type`)?.value||S.type,S.side=v.querySelector(`#add-side`)?.value||S.side,S.technique=v.querySelector(`#add-technique`)?.value||S.technique,S.description=v.querySelector(`#add-description`)?.value||``,!S.start||!S.end){E(`Click the map to set both the throw position and the landing spot.`,`error`);return}let t=[],n=(v.querySelector(`#add-video`)?.value||``).trim(),r=(v.querySelector(`#add-image`)?.value||``).trim();n&&t.push({url:n,kind:`video`}),r&&t.push({url:r,kind:it(r)});let i=v.querySelector(`#add-upload`);try{if(i?.files?.[0]){E(`Uploading image…`,``);let e=await g.uploads.image(i.files[0]);t.push({url:e.url,kind:`image`})}await g.nades.create({...S,media:t}),S=Vt(),await D(`mine`),E(`Nade submitted! It will appear publicly once an admin approves it.`,`ok`)}catch(e){E(e.message,`error`)}}async function gn(e){let t=e.target.files?.[0];if(t)try{C.fileName=t.name,C.text=await t.text(),C.parsed=null,C.selected=null,O(),E(`Loaded ${t.name}. Click Preview lineups.`,`ok`)}catch{E(`Could not read that file.`,`error`)}}async function _n(){let e=(v.querySelector(`#guide-text`)?.value||C.text||``).trim();if(C.text=e,C.side=v.querySelector(`#guide-side`)?.value||C.side,!e){E(`Upload or paste a CS2 map guide .txt first.`,`error`);return}try{E(`Parsing map guide…`,``);let t=await g.nades.parseMapGuide(e);C.parsed=t,C.selected=0,O(),E(`Found ${t.nades.length} lineup${t.nades.length===1?``:`s`} on ${et(t.map)}.`,`ok`)}catch(e){C.parsed=null,O(),E(e.message,`error`)}}async function vn(){if(!C.parsed?.nades?.length){E(`Preview the guide first so you can confirm the lineups.`,`error`);return}C.side=v.querySelector(`#guide-side`)?.value||C.side;let e=(v.querySelector(`#guide-text`)?.value||C.text||``).trim();try{E(`Importing lineups…`,``);let t=await g.nades.importMapGuide({nades:C.parsed.nades,side:C.side,guideText:e,fileName:C.fileName});C=Ht(),await D(`mine`),E(`Imported ${t.count} nade${t.count===1?``:`s`} — pending admin review.`,`ok`)}catch(e){E(e.message,`error`)}}async function yn(){let e=(v.querySelector(`#guide-text`)?.value||C.text||``).trim(),t=C.parsed?.map;if(!e||!t){E(`Preview the map guide first.`,`error`);return}try{E(`Preparing CS2 practice pack…`,``),w=(await g.nades.practicePackFromText({text:e,map:t})).pack,Bt=C.parsed?.nades?.length||1,O(),E(`Choose what to download (or skip if you already have the files), then Open CS2.`,`ok`)}catch(e){E(e.message,`error`)}}async function bn(e){try{E(`Preparing CS2 practice pack…`,``),w=(await g.nades.practicePackFromImport(e)).pack,Bt=1,O(),E(`Choose what to download (or skip if you already have the files), then Open CS2.`,`ok`)}catch(e){E(e.message,`error`)}}function xn(e,t,n){if(!Number.isFinite(e)||e<=0)return!1;if(!n)return x.delete(e),wn(),!0;if(x.size>=kt&&!x.has(e))return E(`You can select at most ${kt} lineups at once.`,`error`,{title:`Too many lineups`}),!1;for(let[,e]of x)if(e!==t)return E(`You can only select lineups from one map. Clear your selection or pick more from ${et(e)}.`,`error`,{title:`One map only`}),!1;return x.set(e,t),wn(),!0}function Sn(e){if(!e)return;let t=Number(e.dataset.browseNade),n=x.has(t);e.classList.toggle(`selected`,n),e.setAttribute(`aria-checked`,n?`true`:`false`);let r=e.querySelector(`.browse-select`);r&&(r.checked=n)}function Cn(e){let t=Number(e.dataset.browseNade),n=e.dataset.map;xn(t,n,!x.has(t)),Sn(e)}function wn(){let e=v.querySelector(`#browse-try-selected`),t=v.querySelector(`#browse-select-clear`),n=x.size;e&&(e.disabled=n===0,e.textContent=`Try selected in game (${n}/${kt})`),t&&(t.disabled=n===0)}async function Tn(e){let t=[...new Set((e||[]).map(Number).filter(e=>Number.isFinite(e)&&e>0))];if(!t.length){E(`Select at least one lineup (max ${kt}, same map).`,`error`,{title:`Nothing selected`});return}if(t.length>kt){E(`You can open at most ${kt} lineups at once.`,`error`,{title:`Too many lineups`});return}try{E(`Preparing CS2 practice pack…`,``),w=(await g.nades.practicePackFromNades(t)).pack,Bt=t.length,O(),E(t.length>1?`Merged ${t.length} lineups into one annotation file. Download what you need, then Open CS2.`:`Choose what to download (or skip if you already have the files), then Open CS2.`,`ok`)}catch(e){E(e.message,`error`)}}async function En(e){if(!y){Je(`login`);return}if(!(!Number.isFinite(e)||e<=0))try{let t=await g.nades.favorite(e);Ft.counts[e]=t.count,Ft.mine=t.favorited?[...Ft.mine.filter(t=>t!==e),e]:Ft.mine.filter(t=>t!==e),b===`favorites`&&!t.favorited&&(It=It.filter(t=>t.id!==e)),O(),E(t.favorited?`Added to favorites.`:`Removed from favorites.`,`ok`)}catch(e){E(e.message,`error`)}}function Dn(){if(!w)return;let e=v.querySelector(`[data-try-game-status]`);try{gt(w);let t=`Opening CS2 private ${w.deMap}… Quit CS2 first if it was already running, otherwise paste in console: ${w.consoleCommand||`map ${w.deMap}; exec ${w.cfgBaseName}`}`;e&&(e.textContent=t),E(t,`ok`)}catch(t){e&&(e.textContent=t.message),E(t.message,`error`)}}async function On(){if(!w)return;let e=v.querySelector(`[data-try-game-status]`);try{let t=`Copied: ${await _t(w)}`;e&&(e.textContent=t),E(t,`ok`)}catch(t){e&&(e.textContent=t.message),E(t.message,`error`)}}async function kn(e){let t=(v.querySelector(`.add-media-url[data-nade="${e}"]`)?.value||``).trim();if(!t){E(`Enter a media URL first.`,`error`);return}try{await g.nades.addMedia(e,{url:t,kind:it(t)}),await D(`mine`),E(`Media added — pending admin review.`,`ok`)}catch(e){E(e.message,`error`)}}async function An(e){if(confirm(`Permanently delete this nade and its media?`))try{await g.nades.remove(e),x.delete(Number(e)),await D(b),E(`Nade deleted.`,`ok`)}catch(e){E(e.message,`error`)}}async function jn(e){if(confirm(`Permanently remove this media?`))try{await g.admin.removeMedia(e),await D(b),E(`Media removed.`,`ok`)}catch(e){E(e.message,`error`)}}async function Mn(e,t){let n=v.querySelector(`.review-note[data-nade="${e}"]`)?.value||``;try{await g.admin.reviewNade(e,t,n),await D(`review`),E(`Nade ${t}.`,`ok`)}catch(e){E(e.message,`error`)}}async function Nn(e){let t=[...v.querySelectorAll(`.review-nade-check:checked`)].map(e=>Number(e.value));if(!t.length){E(`Select at least one pending nade.`,`error`);return}let n=v.querySelector(`#review-bulk-note`)?.value||``;try{let r=await g.admin.reviewNadesBulk(t,e,n);await D(`review`),E(`${e===`approved`?`Approved`:`Rejected`} ${r.updated} nade${r.updated===1?``:`s`}.`,`ok`)}catch(e){E(e.message,`error`)}}async function Pn(e,t){try{await g.admin.reviewMedia(e,t),await D(`review`),E(`Media ${t}.`,`ok`)}catch(e){E(e.message,`error`)}}async function Fn(e,t){try{await g.admin.setRole(e,t),await D(`users`),E(`Role updated.`,`ok`)}catch(e){E(e.message,`error`)}}async function In(e,t){try{t===`perma`?await g.admin.banUser(e,{permanent:!0}):await g.admin.banUser(e,{hours:Number(t)}),await D(`users`),E(`User banned.`,`ok`)}catch(e){E(e.message,`error`)}}async function Ln(e){try{await g.admin.unbanUser(e),await D(`users`),E(`User unbanned.`,`ok`)}catch(e){E(e.message,`error`)}}async function Rn(){v=document.querySelector(`#nades-tool`),v&&(y=Ae(),je(async e=>{y=e,await Jt(),!y&&[`add`,`import`,`mine`,`favorites`,`review`,`users`].includes(b)&&(b=`browse`),y&&!h(y)&&[`review`,`users`].includes(b)&&(b=`browse`),await D(b)}),await Jt(),O(),await D(`browse`))}function zn(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Bn(e){let t=document.createElement(`div`);t.className=`modal`,t.innerHTML=`
    <div class="modal-backdrop" data-close></div>
    ...
    </div>`,document.body.appendChild(t);let n=()=>t.remove();t.querySelectorAll(`[data-close]`).forEach(e=>e.addEventListener(`click`,n));let r=e=>{e.key===`Escape`&&(n(),document.removeEventListener(`keydown`,r))};document.addEventListener(`keydown`,r);let i=t.querySelector(`#import-status`),a=t.querySelector(`#import-run`);a.addEventListener(`click`,async()=>{let r=t.querySelector(`#import-content`).value;if(!r.trim()){i.textContent=`Paste the page content first.`,i.className=`status error`;return}a.disabled=!0,i.textContent=`Importing…`,i.className=`status`;try{let t=await e.onImport(r);i.textContent=t||`Imported.`,i.className=`status ok`,setTimeout(n,900)}catch(e){i.textContent=e.message,i.className=`status error`,a.disabled=!1}}),t.querySelector(`#import-content`)?.focus()}var k,Vn=null,A={commands:[],categories:[],recommendedLaunchOptions:``,source:`seed`,lastSync:0,cs2Build:``,cs2Version:``,remoteConfigured:!1},Hn={counts:{},mine:[],comments:{}},Un=[],Wn={text:``,kind:``},Gn=new Set;function j(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function M(e,t=``){Wn={text:e,kind:t};let n=k?.querySelector(`#commands-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function Kn(e){if(!e)return`—`;try{return new Date(e).toLocaleString()}catch{return`—`}}async function qn(){try{A=await g.commands.catalog()}catch(e){M(`Could not load command catalog: ${e.message}`,`error`)}try{Hn=await g.commands.social()}catch{}if(h(Vn))try{Un=await g.admin.pendingComments()}catch{Un=[]}else Un=[]}function Jn(e){let t=Hn.comments[e.key]||[];return`<div class="cmd-comments">${t.length?t.map(e=>`<div class="cmd-comment">
            <div class="cmd-comment-body"><strong>${j(e.username)}</strong><span>${j(e.body)}</span></div>
            ${h(Vn)?`<button class="btn btn-sm ghost danger" type="button" data-remove-comment="${e.id}">Remove</button>`:``}
          </div>`).join(``):`<p class="hint">No comments yet.</p>`}${Vn?`<form class="cmd-comment-form" data-comment-key="${j(e.key)}">
    ...
    <article class="cmd-card" data-search="${j(`${e.command} ${e.title} ${e.description}`.toLowerCase())}">
      ...
      ${i?Jn(e):``}
    </article>`}function Xn(e){let t=A.commands.filter(t=>t.category===e.id);return t.length?`
    ...
    </section>`:``}function Zn(){let e=A.commands.filter(e=>e.isNew).length,t=h(Vn)?`<div class="actions">
    ...
    <section class="cmd-status-bar">
      <div>
        ...
        <strong>Last synced:</strong> ${Kn(A.lastSync)}
        ${e?` · <span class="nade-badge new">${e} new</span>`:``}
      </div>
      ${t}
    </section>`}function Qn(){return!h(Vn)||!Un.length?``:`
    ...
    </section>`}function $n(){k.innerHTML=`
    <div class="commands-shell">
      ...
      ${A.categories.map(Xn).join(``)}
      <div id="commands-status" class="status ${Wn.kind}">${j(Wn.text)}</div>
    </div>`,tr()}function er(e){let t=e.trim().toLowerCase();k.querySelectorAll(`.cmd-category`).forEach(e=>{let n=0;e.querySelectorAll(`.cmd-card`).forEach(e=>{let r=!t||e.dataset.search.includes(t);e.classList.toggle(`hidden`,!r),r&&(n+=1)}),e.classList.toggle(`hidden`,n===0)})}function tr(){k.querySelectorAll(`[data-copy]`).forEach(e=>e.addEventListener(`click`,async()=>{try{await navigator.clipboard.writeText(e.dataset.copy),M(`Copied to clipboard.`,`ok`)}catch{M(`Clipboard blocked — select and copy manually.`,`error`)}})),k.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>Je(e.dataset.openAuth))),k.querySelectorAll(`[data-recommend]`).forEach(e=>e.addEventListener(`click`,()=>nr(e.dataset.recommend))),k.querySelectorAll(`[data-toggle-comments]`).forEach(e=>e.addEventListener(`click`,()=>{let t=e.dataset.toggleComments;Gn.has(t)?Gn.delete(t):Gn.add(t),$n()})),k.querySelectorAll(`.cmd-comment-form`).forEach(e=>e.addEventListener(`submit`,t=>{t.preventDefault(),rr(e.dataset.commentKey,e.querySelector(`input`))})),k.querySelectorAll(`[data-approve-comment]`).forEach(e=>e.addEventListener(`click`,()=>ir(e.dataset.approveComment,`approved`))),k.querySelectorAll(`[data-reject-comment]`).forEach(e=>e.addEventListener(`click`,()=>ir(e.dataset.rejectComment,`rejected`))),k.querySelectorAll(`[data-remove-comment]`).forEach(e=>e.addEventListener(`click`,()=>ar(e.dataset.removeComment))),k.querySelector(`#cmd-search`)?.addEventListener(`input`,e=>er(e.target.value)),k.querySelector(`#cmd-sync`)?.addEventListener(`click`,or),k.querySelector(`#cmd-check-cs2`)?.addEventListener(`click`,sr)}async function nr(e){if(!Vn){Je(`login`);return}try{let t=await g.commands.recommend(e);Hn.counts[e]=t.count,Hn.mine=t.recommended?[...Hn.mine.filter(t=>t!==e),e]:Hn.mine.filter(t=>t!==e),$n()}catch(e){M(e.message,`error`)}}async function rr(e,t){let n=(t?.value||``).trim();if(!n){M(`Write something first.`,`error`);return}try{await g.commands.addComment(e,n),M(`Comment submitted — an admin will review it before it appears.`,`ok`),t&&(t.value=``)}catch(e){M(e.message,`error`)}}async function ir(e,t){try{await g.admin.reviewComment(e,t),await qn(),$n(),M(`Comment ${t}.`,`ok`)}catch(e){M(e.message,`error`)}}async function ar(e){if(confirm(`Permanently delete this comment?`))try{await g.admin.removeComment(e),await qn(),$n(),M(`Comment deleted.`,`ok`)}catch(e){M(e.message,`error`)}}function or(){Bn({title:`Sync commands from the CS2 wiki`,description:`The Valve wiki has a bot check that blocks servers. Open it in your browser, complete the verification, then copy the page source (wikitext) and paste it here — the server will parse it.`,sourceUrl:`https://developer.valvesoftware.com/w/index.php?title=List_of_Counter-Strike_2_console_command_variables&action=raw`,sourceLabel:`Open CS2 wiki source`,placeholder:`Paste the wiki page source (wikitext), or a JSON list of commands…`,onImport:async e=>{let t=await g.admin.importCommands(e);return await qn(),$n(),`Imported ${t.count} commands.`}})}async function sr(){M(`Checking the current CS2 build…`,``);try{let e=await g.admin.checkCommandsCs2();await qn(),$n(),M(e.ok?`CS2 build ${e.build}${e.changed?` — changed, catalog re-synced`:` — no change`}.`:`Check failed: ${e.reason}`,e.ok?`ok`:`error`)}catch(e){M(e.message,`error`)}}async function cr(){k=document.querySelector(`#commands-tool`),k&&(Vn=Ae(),je(async e=>{Vn=e,await qn(),$n()}),$n(),await qn(),$n())}var N,P=null,lr=null,ur={paypalUrl:``,steamTradeUrl:``},dr={text:``,kind:``};function F(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function I(e,t=``){dr={text:e,kind:t};let n=N?.querySelector(`#profile-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function fr(e){try{return new Date(e).toLocaleDateString()}catch{return`—`}}async function pr(){if(P){try{lr=(await g.auth.profile()).stats}catch(e){I(e.message,`error`)}if(Te(P))try{ur=await g.settings.get()}catch{}}}function mr(e,t){return`<div class="profile-stat"><dt>${F(e)}</dt><dd>${F(t)}</dd></div>`}function hr(){return Te(P)?`
    <section class="panel profile-settings">
      ...
      <div class="profile-settings-body">
        ...
        <label class="field">
          ...
          <input id="set-paypal" type="url" placeholder="https://www.paypal.com/paypalme/yourname" value="${F(ur.paypalUrl)}" />
        </label>
        <label class="field">
          <span>Steam trade link</span>
          <input id="set-steam" type="url" placeholder="https://steamcommunity.com/tradeoffer/new/?partner=...&token=..." value="${F(ur.steamTradeUrl)}" />
        </label>
        <div class="actions">
          <button class="btn primary" id="set-save">Save donate links</button>
        </div>
      </div>
    </section>`:``}function gr(){if(!P){N.innerHTML=`<div class="profile-shell"><div class="login-prompt">
    ...
    </div></div>`,N.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>Je(e.dataset.openAuth)));return}let e=(P.username||`?`).charAt(0).toUpperCase(),t=lr||{nadesTotal:0,nadesApproved:0,nadesPending:0,recommendations:0,comments:0,nadeFavorites:0};N.innerHTML=`
    <div class="profile-shell">
      <section class="panel profile-card">
        <div class="profile-head">
          ...
          <div>
            ...
            <p class="hint">${P.email?F(P.email):`No email set`} · member since ${fr(P.createdAt)}</p>
      ...
      ${hr()}
      <div id="profile-status" class="status ${dr.kind}">${F(dr.text)}</div>
    </div>`,N.querySelector(`#set-save`)?.addEventListener(`click`,wr),N.querySelector(`#pw-save`)?.addEventListener(`click`,vr),N.querySelector(`#username-save`)?.addEventListener(`click`,br),N.querySelector(`#cred-save`)?.addEventListener(`click`,xr),N.querySelector(`#steam-link`)?.addEventListener(`click`,Sr),N.querySelector(`#steam-unlink`)?.addEventListener(`click`,Cr);let n=N.querySelector(`#avatar-file`);N.querySelector(`#avatar-upload`)?.addEventListener(`click`,()=>n?.click()),n?.addEventListener(`change`,e=>_r(e.target.files?.[0])),N.querySelector(`#avatar-remove`)?.addEventListener(`click`,yr)}async function _r(e){if(e){I(`Uploading image…`,``);try{await g.auth.uploadAvatar(e),await Me(),I(`Profile image updated.`,`ok`)}catch(e){I(e.message,`error`)}}}async function vr(){let e=N.querySelector(`#pw-current`)?.value||``,t=N.querySelector(`#pw-new`)?.value||``;try{await g.auth.changePassword({currentPassword:e,newPassword:t}),N.querySelector(`#pw-current`).value=``,N.querySelector(`#pw-new`).value=``,I(`Password updated.`,`ok`)}catch(e){I(e.message,`error`)}}async function yr(){try{await g.auth.setAvatar(``),await Me(),I(`Profile image removed.`,`ok`)}catch(e){I(e.message,`error`)}}async function br(){let e=N.querySelector(`#acc-username`)?.value||``;try{await g.auth.changeUsername(e),await Me(),I(`Username updated.`,`ok`)}catch(e){I(e.message,`error`)}}async function xr(){let e=N.querySelector(`#cred-email`)?.value||``,t=N.querySelector(`#cred-password`)?.value||``;try{await g.auth.setCredentials({email:e,password:t}),await Me(),I(`Email & password saved — you can now log in without Steam.`,`ok`)}catch(e){I(e.message,`error`)}}async function Sr(){try{let e=await g.auth.steamLinkUrl();window.location.href=e}catch(e){I(e.message,`error`)}}async function Cr(){try{await g.auth.steamUnlink(),await Me(),I(`Steam unlinked.`,`ok`)}catch(e){I(e.message,`error`)}}async function wr(){let e=N.querySelector(`#set-paypal`)?.value||``,t=N.querySelector(`#set-steam`)?.value||``;try{ur=await g.admin.saveSettings({paypalUrl:e,steamTradeUrl:t}),I(`Donate links saved.`,`ok`),document.dispatchEvent(new CustomEvent(`aimkit:settings-updated`))}catch(e){I(e.message,`error`)}}async function Tr(){N=document.querySelector(`#profile-tool`),N&&(P=Ae(),je(async e=>{P=e,await pr(),gr()}),gr(),await pr(),gr())}var L,Er=null,Dr=[],Or=`top`,kr=!1,Ar={text:``,kind:``},jr=new Set;function Mr(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Nr(e,t=``){Ar={text:e,kind:t};let n=L?.querySelector(`#configs-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function Pr(e){try{return new Date(e).toLocaleDateString()}catch{return``}}function Fr(e,t){let n=new Blob([t],{type:`text/plain`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=e,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r)}async function Ir(){try{Dr=await g.configs.list({sort:Or})}catch(e){Nr(e.message,`error`)}Vr()}function Lr(e){let t=Math.round(e),n=``;for(let e=1;e<=5;e+=1)n+=e<=t?`★`:`☆`;return n}function Rr(e){if(!Er)return`<button class="btn btn-sm" data-open-auth="login">Log in to rate</button>`;if(e.authorId===Er.id)return`<span class="hint">Your upload</span>`;let t=``;for(let n=1;n<=5;n+=1)t+=`<button class="star-btn ${n<=e.myRating?`on`:``}" data-rate="${e.id}" data-star="${n}" title="${n} star${n>1?`s`:``}">${n<=e.myRating?`★`:`☆`}</button>`;return`<span class="rate-label">Your rating:</span><span class="star-picker">${t}</span>`}function zr(e){let t=jr.has(e.id),n=Er&&(e.authorId===Er.id||h(Er));return`
    <article class="config-card" data-search="${Mr(`${e.title} ${e.description} ${e.authorName}`.toLowerCase())}">
      ...
      <div class="config-foot">
        <span>by ${Mr(e.authorName)} · ${Pr(e.createdAt)}</span>
    ...
    </section>`}function Vr(){L.innerHTML=`
    ...
    </div>`,Ur()}function Hr(e){let t=e.trim().toLowerCase();L.querySelectorAll(`.config-card`).forEach(e=>{e.classList.toggle(`hidden`,t&&!e.dataset.search.includes(t))})}function Ur(){L.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>Je(e.dataset.openAuth))),L.querySelectorAll(`[data-sort]`).forEach(e=>e.addEventListener(`click`,()=>{Or=e.dataset.sort,Ir()})),L.querySelector(`#cfg-search`)?.addEventListener(`input`,e=>Hr(e.target.value)),L.querySelector(`#cfg-new`)?.addEventListener(`click`,()=>{kr=!0,Vr()}),L.querySelector(`#cfg-cancel`)?.addEventListener(`click`,()=>{kr=!1,Vr()}),L.querySelector(`#cfg-submit`)?.addEventListener(`click`,Kr),L.querySelector(`#cfg-config-file`)?.addEventListener(`change`,e=>Gr(e.target,`#cfg-config`)),L.querySelector(`#cfg-video-file`)?.addEventListener(`change`,e=>Gr(e.target,`#cfg-video`)),L.querySelectorAll(`[data-dl]`).forEach(e=>e.addEventListener(`click`,()=>{let t=Dr.find(t=>String(t.id)===e.dataset.dl);t&&(e.dataset.kind===`config`?Fr(`${Wr(t.title)}.cfg`,t.configText):Fr(`cs2_video.txt`,t.videoText))})),L.querySelectorAll(`[data-view]`).forEach(e=>e.addEventListener(`click`,()=>{let t=Number(e.dataset.view);jr.has(t)?jr.delete(t):jr.add(t),Vr()})),L.querySelectorAll(`[data-del]`).forEach(e=>e.addEventListener(`click`,()=>Jr(Number(e.dataset.del)))),L.querySelectorAll(`[data-rate]`).forEach(e=>e.addEventListener(`click`,()=>qr(Number(e.dataset.rate),Number(e.dataset.star))))}function Wr(e){return(e||`config`).toLowerCase().replace(/[^a-z0-9]+/g,`_`).replace(/^_|_$/g,``).slice(0,40)||`config`}function Gr(e,t){let n=e.files?.[0];if(!n)return;let r=new FileReader;r.onload=()=>{let e=L.querySelector(t);e&&(e.value=String(r.result||``))},r.readAsText(n)}async function Kr(){let e=L.querySelector(`#cfg-title`)?.value||``,t=L.querySelector(`#cfg-desc`)?.value||``,n=L.querySelector(`#cfg-config`)?.value||``,r=L.querySelector(`#cfg-video`)?.value||``;try{await g.configs.create({title:e,description:t,configText:n,videoText:r}),kr=!1,Or=`new`,await Ir(),Nr(`Config published!`,`ok`)}catch(e){Nr(e.message,`error`)}}async function qr(e,t){try{let n=await g.configs.rate(e,t),r=Dr.find(t=>t.id===e);r&&(r.avgRating=n.avgRating,r.ratingCount=n.ratingCount,r.myRating=n.myRating),Vr(),Nr(`Thanks for rating!`,`ok`)}catch(e){Nr(e.message,`error`)}}async function Jr(e){try{await g.configs.remove(e),await Ir(),Nr(`Config deleted.`,`ok`)}catch(e){Nr(e.message,`error`)}}async function Yr(){L=document.querySelector(`#configs-tool`),L&&(Er=Ae(),je(async e=>{Er=e,await Ir()}),Vr(),await Ir())}var R,z=null,Xr=[],Zr=[],Qr={text:``,kind:``},$r=!1,ei=null;function B(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function ti(e,t=``){Qr={text:e,kind:t};let n=R?.querySelector(`#highlights-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function ni(e){try{return new Date(e).toLocaleDateString()}catch{return``}}function ri(e){let t=/(?:youtube\.com\/(?:watch\?v=|embed\/|shorts\/)|youtu\.be\/)([\w-]{6,})/.exec(e||``);return t?t[1]:null}function ii(e){return/^https?:\/\//.test(e||``)?e:``}function ai(e){let t=ii(e);if(!t)return``;let n=ri(e);return n?`<iframe class="hl-embed" src="https://www.youtube.com/embed/${B(n)}" title="highlight" allowfullscreen loading="lazy"></iframe>`:/\.(mp4|webm|mov)(\?|$)/i.test(e)?`<video class="hl-embed" src="${B(t)}" controls preload="none"></video>`:`<a class="btn ghost" href="${B(t)}" target="_blank" rel="noopener noreferrer">Open highlight ↗</a>`}async function oi(){try{Xr=await g.highlights.list({}),Zr=h(z)?await g.admin.highlightReports():[]}catch(e){ti(e.message,`error`)}ui()}function si(){return!h(z)||!Zr.length?``:`
    ...
    </section>`}function ci(e){let t=z&&(e.authorId===z.id||h(z));return`
    ...
    </article>`}function li(){return!z||!$r?``:`
    <section class="panel config-upload">
    ...
    </section>`}function ui(){R.innerHTML=`
    ...
    </div>`,fi()}function di(e){let t=e.trim().toLowerCase();R.querySelectorAll(`.hl-card`).forEach(e=>{e.classList.toggle(`hidden`,t&&!e.dataset.search.includes(t))})}function fi(){R.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>Je(e.dataset.openAuth))),R.querySelector(`#hl-search`)?.addEventListener(`input`,e=>di(e.target.value)),R.querySelector(`#hl-new`)?.addEventListener(`click`,()=>{$r=!0,ui()}),R.querySelector(`#hl-cancel`)?.addEventListener(`click`,()=>{$r=!1,ui()}),R.querySelector(`#hl-submit`)?.addEventListener(`click`,pi),R.querySelectorAll(`[data-report]`).forEach(e=>e.addEventListener(`click`,()=>{ei=Number(e.dataset.report),ui()})),R.querySelector(`[data-cancel-report]`)?.addEventListener(`click`,()=>{ei=null,ui()}),R.querySelector(`[data-report-form]`)?.addEventListener(`submit`,e=>{e.preventDefault(),mi(Number(e.currentTarget.dataset.reportForm),e.currentTarget.querySelector(`input`).value)}),R.querySelectorAll(`[data-del]`).forEach(e=>e.addEventListener(`click`,()=>hi(Number(e.dataset.del)))),R.querySelectorAll(`[data-keep]`).forEach(e=>e.addEventListener(`click`,()=>gi(Number(e.dataset.keep),`keep`))),R.querySelectorAll(`[data-remove-hl]`).forEach(e=>e.addEventListener(`click`,()=>gi(Number(e.dataset.removeHl),`delete`)))}async function pi(){let e=R.querySelector(`#hl-title`)?.value||``,t=R.querySelector(`#hl-desc`)?.value||``,n=R.querySelector(`#hl-url`)?.value||``;try{await g.highlights.create({title:e,description:t,url:n}),$r=!1,await oi(),ti(`Highlight shared!`,`ok`)}catch(e){ti(e.message,`error`)}}async function mi(e,t){try{await g.highlights.report(e,t),ei=null,await oi(),ti(`Thanks — an admin will review your report.`,`ok`)}catch(e){ti(e.message,`error`)}}async function hi(e){try{await g.highlights.remove(e),await oi(),ti(`Highlight deleted.`,`ok`)}catch(e){ti(e.message,`error`)}}async function gi(e,t){try{await g.admin.reviewHighlight(e,t),await oi(),ti(t===`delete`?`Highlight removed.`:`Reports cleared — highlight kept.`,`ok`)}catch(e){ti(e.message,`error`)}}async function _i(){R=document.querySelector(`#highlights-tool`),R&&(z=Ae(),je(async e=>{z=e,await oi()}),ui(),await oi())}var V,vi=null,yi={pros:[],source:`seed`,lastSync:0},bi=`featured`,xi=``,Si=null,Ci={text:``,kind:``};function H(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function wi(e,t=``){Ci={text:e,kind:t};let n=V?.querySelector(`#pros-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}async function Ti(){try{yi=await g.pros.list({sort:bi,q:xi})}catch(e){wi(e.message,`error`)}Mi()}var Ei={"natus vincere":`#f4d000`,vitality:`#f5d20a`,falcons:`#0aa14f`,"team spirit":`#c8102e`,astralis:`#e4002b`,faze:`#e43b26`,g2:`#c8102e`};function Di(e){return Ei[(e||``).toLowerCase()]||`#33415a`}function Oi(e){let t=(e.team||e.player||`?`).trim(),n=t.split(/\s+/);return(n.length>1?n.slice(0,3).map(e=>e[0]).join(``):t.slice(0,2)).toUpperCase()}function ki(e){let t=e.photo||e.teamLogo||``,n=e.photo&&e.teamLogo?e.teamLogo:``,r=t?`<img class="pro-img" alt="${H(e.player)}" loading="lazy" src="${H(t)}"${n?` data-logo="${H(n)}"`:``} onerror="if(this.dataset.logo){this.src=this.dataset.logo;this.removeAttribute('data-logo');}else{this.remove();}" />`:``;return`<div class="pro-photo" style="--team:${Di(e.team)}"><span class="pro-monogram">${H(Oi(e))}</span>${r}</div>`}function Ai(e,t){return`<div class="pro-stat"><dt>${H(e)}</dt><dd>${t!=null&&t!==``?H(t):`—`}</dd></div>`}function ji(e){return`
    ...
    </article>`}function Mi(){let e=h(vi)?`<div class="pros-admin-actions">
    ...
    <div class="admin-logs">${i}</div>`}var $i={overview:Wi,nades:Gi,comments:Ki,reports:qi,users:Ji,sync:Yi,contact:Xi,logs:Qi,settings:Zi};async function ea(e){try{e===`overview`?await Ui():e===`nades`?G.nades=await g.admin.pending():e===`comments`?G.comments=await g.admin.pendingComments():e===`reports`?G.reports=await g.admin.highlightReports():e===`users`?G.users=await g.admin.users():e===`contact`?G.contact=await g.admin.contactMessages():e===`logs`?G.logs=await g.admin.ownerLogs({action:G.logsFilter||``}):e===`settings`&&(G.settings=await g.settings.get())}catch(e){Vi(e.message,`error`)}}function ta(){if(!U)return;if(!h(W)){U.innerHTML=`<div class="admin-shell"><div class="login-prompt">
    ...
    </div></div>`,U.querySelector(`[data-open-auth]`)?.addEventListener(`click`,()=>Je(`login`));return}(Li===`logs`||Li===`settings`)&&!Te(W)&&(Li=`overview`);let e=Bi.filter(e=>!e.ownerOnly||Te(W)).map(e=>`<button class="tool-tab ${Li===e.id?`active`:``}" data-section="${e.id}">${K(e.label)}${e.id===`nades`&&zi.nades?` (${zi.nades})`:``}${e.id===`comments`&&zi.comments?` (${zi.comments})`:``}${e.id===`reports`&&zi.reports?` (${zi.reports})`:``}</button>`).join(``),t=($i[Li]||Wi)();U.innerHTML=`
    ...
    </div>`,ra()}async function na(e){(e===`logs`||e===`settings`)&&(Te(W)||(e=`overview`)),Li=e,ta(),await ea(e),ta()}function ra(){U.querySelectorAll(`[data-section]`).forEach(e=>e.addEventListener(`click`,()=>na(e.dataset.section))),U.querySelectorAll(`[data-goto]`).forEach(e=>e.addEventListener(`click`,()=>na(e.dataset.goto)));let e=async(e,t)=>{try{await e(),t&&Vi(t,`ok`)}catch(e){Vi(e.message,`error`)}},t=async()=>{await ea(Li),await Ui(),ta()};U.querySelectorAll(`[data-nade-approve]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewNade(n.dataset.nadeApprove,`approved`),await t()},`Nade approved.`))),U.querySelectorAll(`[data-nade-reject]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewNade(n.dataset.nadeReject,`rejected`),await t()},`Nade rejected.`))),U.querySelectorAll(`[data-nade-delete]`).forEach(n=>n.addEventListener(`click`,()=>{confirm(`Permanently delete this nade and its media?`)&&e(async()=>{await g.nades.remove(n.dataset.nadeDelete),await t()},`Nade deleted.`)})),U.querySelectorAll(`[data-media-approve]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewMedia(n.dataset.mediaApprove,`approved`),await t()},`Media approved.`))),U.querySelectorAll(`[data-media-reject]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewMedia(n.dataset.mediaReject,`rejected`),await t()},`Media rejected.`))),U.querySelectorAll(`[data-media-delete]`).forEach(n=>n.addEventListener(`click`,()=>{confirm(`Permanently remove this media?`)&&e(async()=>{await g.admin.removeMedia(n.dataset.mediaDelete),await t()},`Media removed.`)}));let n=U.querySelector(`#admin-nade-select-all`),r=U.querySelector(`#admin-nade-bulk-approve`),i=U.querySelector(`#admin-nade-bulk-reject`),a=()=>{let e=U.querySelectorAll(`.admin-nade-check:checked`).length;r&&(r.disabled=e===0),i&&(i.disabled=e===0)};n?.addEventListener(`change`,()=>{U.querySelectorAll(`.admin-nade-check`).forEach(e=>{e.checked=n.checked}),a()}),U.querySelectorAll(`.admin-nade-check`).forEach(e=>e.addEventListener(`change`,a));let o=async n=>{let r=[...U.querySelectorAll(`.admin-nade-check:checked`)].map(e=>Number(e.value));r.length&&await e(async()=>{let e=await g.admin.reviewNadesBulk(r,n);await t(),Vi(`${n===`approved`?`Approved`:`Rejected`} ${e.updated} nade${e.updated===1?``:`s`}.`,`ok`)})};r?.addEventListener(`click`,()=>o(`approved`)),i?.addEventListener(`click`,()=>o(`rejected`)),U.querySelectorAll(`[data-comment-approve]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewComment(n.dataset.commentApprove,`approved`),await t()},`Comment approved.`))),U.querySelectorAll(`[data-comment-reject]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewComment(n.dataset.commentReject,`rejected`),await t()},`Comment rejected.`))),U.querySelectorAll(`[data-comment-delete]`).forEach(n=>n.addEventListener(`click`,()=>{confirm(`Permanently delete this comment?`)&&e(async()=>{await g.admin.removeComment(n.dataset.commentDelete),await t()},`Comment deleted.`)})),U.querySelectorAll(`[data-report-keep]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewHighlight(n.dataset.reportKeep,`keep`),await t()},`Kept highlight.`))),U.querySelectorAll(`[data-report-delete]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewHighlight(n.dataset.reportDelete,`delete`),await t()},`Highlight deleted.`))),U.querySelectorAll(`[data-role-set]`).forEach(n=>n.addEventListener(`click`,()=>{let r=n.dataset.role;e(async()=>{await g.admin.setRole(n.dataset.roleSet,r),await t()},r===`admin`?`Promoted to admin.`:`Admin access removed.`)})),U.querySelectorAll(`[data-unban]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.unbanUser(n.dataset.unban),await t()},`User unbanned.`))),U.querySelectorAll(`[data-ban]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{let e=Number(U.querySelector(`[data-ban-hrs="${n.dataset.ban}"]`)?.value);if(!Number.isFinite(e)||e<=0)return Vi(`Enter a positive number of hours.`,`error`);await g.admin.banUser(n.dataset.ban,{hours:e}),await t(),Vi(`User banned.`,`ok`)}))),U.querySelectorAll(`[data-ban-perma]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.banUser(n.dataset.banPerma,{permanent:!0}),await t()},`User banned permanently.`))),U.querySelector(`#sync-commands`)?.addEventListener(`click`,()=>e(async()=>{let e=await g.admin.syncCommands();Vi(e.synced?`Commands synced (${e.count}).`:`No sync: ${e.reason||`no source`}.`,e.synced?`ok`:`error`)})),U.querySelector(`#check-cs2`)?.addEventListener(`click`,()=>e(async()=>{let e=await g.admin.checkCommandsCs2();Vi(`CS2 build: ${e.build||`unknown`}${e.changed?` (changed → re-synced)`:``}.`,`ok`)})),U.querySelector(`#sync-pros`)?.addEventListener(`click`,()=>e(async()=>{let e=await g.admin.syncPros();Vi(e.synced?`Synced ${e.count} pros from ${e.source}.`:`Sync failed: ${e.reason}.`,e.synced?`ok`:`error`)})),U.querySelector(`#import-commands`)?.addEventListener(`click`,()=>Bn({title:`Import commands`,description:`Paste the CS2 console-commands wiki page (wikitext) or a JSON array of commands.`,sourceUrl:`https://developer.valvesoftware.com/wiki/List_of_Counter-Strike_2_console_command_variables`,sourceLabel:`Open wiki`,onImport:async e=>`Imported ${(await g.admin.importCommands(e)).count} commands.`})),U.querySelector(`#import-pros`)?.addEventListener(`click`,()=>Bn({title:`Import pro settings from HLTV`,description:`Open HLTV, complete the check, then paste a JSON list of players.`,sourceUrl:`https://www.hltv.org/stats/players`,sourceLabel:`Open HLTV`,onImport:async e=>{let t=await g.admin.importPros(e);return await ea(`sync`),`Imported ${t.count} players.`}})),U.querySelectorAll(`[data-contact-delete]`).forEach(n=>n.addEventListener(`click`,()=>{confirm(`Delete this contact message?`)&&e(async()=>{await g.admin.removeContact(n.dataset.contactDelete),await t()},`Message deleted.`)})),U.querySelector(`#save-settings`)?.addEventListener(`click`,()=>e(async()=>{let e=U.querySelector(`#set-paypal`)?.value||``,t=U.querySelector(`#set-steam`)?.value||``;G.settings=await g.admin.saveSettings({paypalUrl:e,steamTradeUrl:t}),document.dispatchEvent(new CustomEvent(`aimkit:settings-updated`))},`Donate links saved.`)),U.querySelector(`#owner-logs-filter`)?.addEventListener(`change`,t=>{G.logsFilter=t.target.value||``,e(async()=>{await ea(`logs`),ta()})}),U.querySelector(`#owner-logs-refresh`)?.addEventListener(`click`,()=>e(async()=>{await ea(`logs`),ta()},`Logs refreshed.`))}function ia(e){document.querySelectorAll(`.admin-only`).forEach(t=>t.classList.toggle(`hidden`,!h(e)))}async function aa(){U=document.querySelector(`#admin-tool`),U&&(W=Ae(),ia(W),je(async e=>{let t=h(W);W=e,ia(e),h(e)&&!t&&await Ui(),ta()}),ta(),h(W)&&(await Ui(),ta()))}function oa(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function sa(){let e=Ae(),t=document.createElement(`div`);t.className=`modal`,t.innerHTML=`
    <div class="modal-backdrop" data-close></div>
...
`;var wa=document.querySelector(`#preview-canvas`),Ta=document.querySelector(`#preview-stats`),Ea=document.querySelector(`#preview-res`),Da=document.querySelector(`#preview-res-scale`),Oa=`ingame`;function ka(){let e=Oa===`fullscreen`?1080:280;wa.width!==e&&(wa.width=e,wa.height=e),wa.style.imageRendering=Oa===`fullscreen`?`auto`:`pixelated`}ka();var Aa=[{id:`1920x1080`,h:1080,label:`1920 × 1080 (16:9)`},{id:`2560x1440`,h:1440,label:`2560 × 1440 (16:9)`},{id:`3840x2160`,h:2160,label:`3840 × 2160 (4K)`},{id:`1600x900`,h:900,label:`1600 × 900 (16:9)`},{id:`1366x768`,h:768,label:`1366 × 768 (16:9)`},{id:`1280x960`,h:960,label:`1280 × 960 (4:3)`},{id:`1024x768`,h:768,label:`1024 × 768 (4:3)`},{id:`1280x1024`,h:1024,label:`1280 × 1024 (5:4)`}],ja=null;function Ma(){return Oa===`fullscreen`?wa.height/1080:(Aa.find(e=>e.id===Ea?.value)||Aa[0]).h/1080}var Na=fa({source:wa,stage:document.querySelector(`.preview-stage`),toggleBtn:document.querySelector(`#magnifier-toggle`),zoomSelect:document.querySelector(`#magnifier-zoom`)});function Pa(e){if(ja=e,da(wa,e,Ma()),Da)if(e){let t=Aa.find(e=>e.id===Ea?.value)||Aa[0],n=t.h/1080;Da.textContent=`≈ ${Math.max(0,Math.round(e.length*n))}px arms · ${Math.max(1,Math.round(e.thickness*n))}px thick @ ${t.h}p`}else Da.textContent=``;Na.refresh()}function Fa(e){Oa=e===`fullscreen`?`fullscreen`:`ingame`,ka(),document.querySelectorAll(`.pmode`).forEach(e=>{let t=e.dataset.pmode===Oa;e.classList.toggle(`active`,t),e.setAttribute(`aria-selected`,String(t))});let t=document.querySelector(`#preview-mode-tag`);t&&(t.textContent=Oa===`fullscreen`?`Relative to full screen`:`Actual in-game size`),Pa(ja)}document.querySelectorAll(`.pmode`).forEach(e=>e.addEventListener(`click`,()=>Fa(e.dataset.pmode)));var Y=document.querySelector(`#crosshair-status`),Ia=document.querySelector(`#sensitivity-status`),La=document.querySelector(`#sharecode-input`),Ra=document.querySelector(`#commands-output`),za=document.querySelector(`#commands-input`),Ba=document.querySelector(`#sharecode-output`),Va=document.querySelector(`#sens-from-game`),X=document.querySelector(`#sens-to-game`),Ha=document.querySelector(`#sens-source`),Ua=document.querySelector(`#sens-target`),Wa=document.querySelector(`#sens-source-dpi`),Ga=document.querySelector(`#sens-target-dpi`),Ka=document.querySelector(`#sens-source-myaw`),qa=document.querySelector(`#sens-target-myaw`),Ja=document.querySelector(`#sens-source-yaw`),Ya=document.querySelector(`#sens-target-yaw`),Xa=document.querySelector(`#source-yaw-field`),Za=document.querySelector(`#target-yaw-field`),Qa=document.querySelector(`#m-yaw-fields`),$a=document.querySelector(`#sens-cm360`),eo=document.querySelector(`#sens-stats`),to=document.querySelector(`#sens-formula`),no=`CSGO-UseJt-3oTvn-47wPX-hEyER-WZfiK`,ro=`cl_crosshairstyle 4
cl_crosshairsize 3
cl_crosshairgap -2
...
cl_crosshair_recoil 0`;function Z(e,t,n=``){e&&(e.textContent=t,e.className=`status${n?` ${n}`:``}`)}function io(e){Pa(e),Ta.innerHTML=`
  ...
  `}function ao(e){return e.trim().replace(/\s+/g,``).replace(/^csgo/i,`CSGO`)}function oo(){let e=La.value.trim();if(!e){Z(Y,`Paste a crosshair share code first.`,`error`);return}let t=ao(e);if(!ba.test(t)){Z(Y,`Invalid format. Expected CSGO-xxxxx-xxxxx-xxxxx-xxxxx-xxxxx`,`error`);return}try{let e=d(t);La.value=t,Ra.value=ce(ee(e)),io(e),Z(Y,`Converted share code to console commands.`,`ok`)}catch(e){e instanceof i||e instanceof r?Z(Y,`That share code is not a valid crosshair code.`,`error`):Z(Y,e instanceof Error?e.message:`Failed to decode share code.`,`error`)}}function so(){let e=za.value.trim();if(!e){Z(Y,`Paste crosshair console commands first.`,`error`);return}try{let t=se(e);Ba.value=f(t),io(t),Z(Y,`Converted commands to share code.`,`ok`)}catch(e){Z(Y,e instanceof Error?e.message:`Failed to encode share code.`,`error`)}}async function co(e,t,n){if(!t){Z(e,`Nothing to copy for ${n}.`,`error`);return}try{await navigator.clipboard.writeText(t),Z(e,`Copied ${n} to clipboard.`,`ok`)}catch{Z(e,`Clipboard access failed. Select and copy manually.`,`error`)}}function lo(){let e=pa[Va.value]?.supportsMYaw||pa[X.value]?.supportsMYaw;Qa?.classList.toggle(`hidden`,!e),Xa?.classList.toggle(`hidden`,!pa[Va.value]?.custom),Za?.classList.toggle(`hidden`,!pa[X.value]?.custom)}function uo(){let e=Number(Ha.value),t=Number(Wa.value),n=Number(Ga.value),r=Number(Ka.value)||.022,i=Number(qa.value)||.022,a=Number(Ja.value),o=Number(Ya.value);if(lo(),pa[Va.value]?.custom&&!(a>0)){Z(Ia,`Enter a valid source custom yaw (° per count).`,`error`);return}if(pa[X.value]?.custom&&!(o>0)){Z(Ia,`Enter a valid target custom yaw (° per count).`,`error`);return}if(!Number.isFinite(e)||e<=0){Ua.value=``,$a.textContent=`—`,eo.innerHTML=``,to.textContent=``;return}if(!Number.isFinite(t)||t<=0||!Number.isFinite(n)||n<=0){Z(Ia,`Enter valid DPI values.`,`error`);return}let s=_a({sourceGame:Va.value,targetGame:X.value,sourceSens:e,sourceDpi:t,targetDpi:n,sourceMYaw:r,targetMYaw:i,sourceCustomYaw:a,targetCustomYaw:o}),c=pa[Va.value].name,l=pa[X.value].name,u=J(s.targetSensitivity);Ua.value=u,$a.textContent=va(s.cm360),eo.innerHTML=`
    <div><dt>Inches / 360°</dt><dd>${va(s.inches360)} in</dd></div>
    <div><dt>Source eDPI</dt><dd>${va(s.sourceEdpi,0)}</dd></div>
    <div><dt>Target eDPI</dt><dd>${va(s.targetEdpi,0)}</dd></div>
  ...
  `,Z(Ia,`${c} → ${l}: ${u}`,`ok`)}function fo(){let e=Va.value;Va.value=X.value,X.value=e,Ua.value&&(Ha.value=Ua.value),uo()}function po(){Va.value=`cs2`,X.value=`valorant`,Ha.value=`1.25`,Wa.value=`800`,Ga.value=`800`,uo()}var mo={crosshair:`Convert a crosshair share code into console commands, build a code from commands, or design one visually with a live preview.`,sensitivity:`Keep the same cm/360 aim feel across games — with custom yaw values and DPI changes handled for you.`,psa:`Dial in your ideal sensitivity with a guided 7-round A/B test (Perfect Sensitivity Approximation).`,nades:`Browse community grenade line-ups, or sign in to submit your own with a 2D throw guide, videos and photos.`,commands:`Copy up-to-date CS2 launch options and console commands, recommend the ones that help, and share tips in the comments.`,configs:`Share your CS2 configs and video settings, download other players’ setups, and rate the best ones.`,highlights:`Share your best CS2 clips, watch the community’s highlights, and report anything that breaks the rules.`,pros:`Browse pro players’ sensitivity, DPI, resolution and crosshair settings.`,profile:`Your account, contributions, and settings.`,admin:`Moderate content, manage users, sync data sources, and read contact messages.`},ho=document.querySelector(`#tool-desc`);function go(e){ho&&(ho.textContent=mo[e]||``)}function _o(e){document.querySelectorAll(`.tool-nav .tool-tab`).forEach(t=>{let n=t.getAttribute(`data-tool`)===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,String(n))}),document.querySelectorAll(`.tool-view`).forEach(t=>{t.classList.toggle(`active`,t.id===`${e}-tool`)}),go(e),window.scrollTo({top:0,behavior:`smooth`})}document.querySelectorAll(`.tool-nav .tool-tab`).forEach(e=>{e.addEventListener(`click`,()=>_o(e.getAttribute(`data-tool`)))}),document.addEventListener(`aimkit:navigate`,e=>_o(e.detail)),go(`crosshair`),document.querySelectorAll(`.converter-panel .tab`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-tab`);document.querySelectorAll(`.converter-panel .tab`).forEach(e=>{let n=e.getAttribute(`data-tab`)===t;e.classList.toggle(`active`,n),e.setAttribute(`aria-selected`,String(n))}),document.querySelectorAll(`.converter-panel .tab-panel`).forEach(e=>{e.classList.toggle(`active`,e.getAttribute(`data-panel`)===t)})})}),document.querySelector(`#decode-btn`)?.addEventListener(`click`,oo),document.querySelector(`#encode-btn`)?.addEventListener(`click`,so),La.addEventListener(`keydown`,e=>{e.key===`Enter`&&oo()}),za.addEventListener(`input`,()=>{let e=za.value.trim();if(!e){Pa(null),Ta.innerHTML=``;return}try{io(se(e))}catch{}}),La.addEventListener(`input`,()=>{let e=ao(La.value);if(ba.test(e))try{io(d(e))}catch{}}),document.querySelector(`#copy-commands`)?.addEventListener(`click`,()=>{co(Y,Ra.value,`commands`)}),document.querySelector(`#copy-code`)?.addEventListener(`click`,()=>{co(Y,Ba.value,`share code`)}),document.querySelector(`#copy-sharecode-cmd`)?.addEventListener(`click`,()=>{let e=ao(La.value);if(!e){Z(Y,`Enter a share code first.`,`error`);return}co(Y,`cl_crosshair_sharecode "${e}"`,`import command`)}),document.querySelector(`#load-example-code`)?.addEventListener(`click`,()=>{La.value=no,oo()}),document.querySelector(`#load-example-cmd`)?.addEventListener(`click`,()=>{za.value=ro,so()});var vo={0:[255,255,255],1:[50,250,50],2:[255,255,0],3:[50,50,250],4:[50,250,250]},Q={...ne},yo=document.querySelector(`#ed-style`),bo=document.querySelector(`#ed-color`),xo=document.querySelector(`#ed-custom-color`),So=document.querySelector(`#ed-custom-color-field`),Co=document.querySelector(`#ed-r`),wo=document.querySelector(`#ed-g`),To=document.querySelector(`#ed-b`),Eo=document.querySelector(`#ed-rgb-val`),Do=document.querySelector(`#ed-color-swatch`);function Oo(e,t){e&&document.activeElement!==e&&(e.value=String(t))}var ko=document.querySelector(`#ed-length`),Ao=document.querySelector(`#ed-thickness`),jo=document.querySelector(`#ed-gap`),Mo=document.querySelector(`#ed-outline`),No=document.querySelector(`#ed-alpha`),Po=document.querySelector(`#ed-dot`),Fo=document.querySelector(`#ed-tstyle`),Io=document.querySelector(`#ed-outline-on`),Lo=document.querySelector(`#ed-alpha-on`),Ro=document.querySelector(`#ed-sharecode`),zo=document.querySelector(`#ed-commands`),Bo=document.querySelector(`#ed-length-num`),Vo=document.querySelector(`#ed-thickness-num`),Ho=document.querySelector(`#ed-gap-num`),Uo=document.querySelector(`#ed-outline-num`),Wo=document.querySelector(`#ed-alpha-num`),Go=document.querySelector(`#ed-r-num`),Ko=document.querySelector(`#ed-g-num`),qo=document.querySelector(`#ed-b-num`),Jo=(e,t,n)=>Math.max(t,Math.min(n,e)),Yo=[{key:`length`,slider:ko,num:Bo,min:0,max:15},{key:`thickness`,slider:Ao,num:Vo,min:0,max:6},{key:`gap`,slider:jo,num:Ho,min:-10,max:10},{key:`outline`,slider:Mo,num:Uo,min:0,max:3},{key:`alpha`,slider:No,num:Wo,min:0,max:255}],Xo=[{key:`red`,slider:Co,num:Go},{key:`green`,slider:wo,num:Ko},{key:`blue`,slider:To,num:qo}];function Zo(e,t,n){let r=e=>Math.max(0,Math.min(255,Math.round(e))).toString(16).padStart(2,`0`);return`#${r(e)}${r(t)}${r(n)}`}function Qo(e){let t=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(e.trim());return t?{r:parseInt(t[1],16),g:parseInt(t[2],16),b:parseInt(t[3],16)}:{r:Q.red,g:Q.green,b:Q.blue}}function $o(){let e=Zo(Q.red,Q.green,Q.blue);bo.value=String(Q.color),Oo(xo,e);for(let e of Xo)Oo(e.slider,Q[e.key]),Oo(e.num,Q[e.key]);Eo&&(Eo.textContent=`${Q.red}, ${Q.green}, ${Q.blue}`),Do&&(Do.style.background=e),So?.classList.toggle(`hidden`,Q.color!==5)}function es(){for(let e of Yo)Oo(e.slider,Jo(Q[e.key],e.min,e.max)),Oo(e.num,Q[e.key])}function ts(){yo.value=String(Q.style),Po.checked=Q.centerDotEnabled,Fo.checked=Q.tStyleEnabled,Io.checked=Q.outlineEnabled,Lo.checked=Q.alphaEnabled,es(),$o()}function ns(){es();let e=!Q.outlineEnabled;Mo.disabled=e,Uo.disabled=e;let t=!Q.alphaEnabled;No.disabled=t,Wo.disabled=t;try{Ro.value=f(Q)}catch{Ro.value=``}zo.value=ce(ee(Q))}function rs(){io(Q),ns()}function is(){Q.style=Number(yo.value),Q.centerDotEnabled=Po.checked,Q.tStyleEnabled=Fo.checked,Q.outlineEnabled=Io.checked,Q.alphaEnabled=Lo.checked,rs()}function as(e){Q[e.key]=Number(e.slider.value),rs()}function os(e,t){let n=Number(e.num.value);if(e.num.value===``||!Number.isFinite(n)){t&&(e.num.value=String(Q[e.key]));return}Q[e.key]=Jo(n,e.min,e.max),t&&(e.num.value=String(Q[e.key])),rs()}function ss(){Q.color=5,Q.red=Jo(Number(Go.value)||0,0,255),Q.green=Jo(Number(Ko.value)||0,0,255),Q.blue=Jo(Number(qo.value)||0,0,255),$o(),rs()}function cs(){if(Q.color=Number(bo.value),Q.color!==5){let[e,t,n]=vo[Q.color]??vo[1];Q.red=e,Q.green=t,Q.blue=n}$o(),rs()}function ls(){Q.color=5,Q.red=Number(Co.value),Q.green=Number(wo.value),Q.blue=Number(To.value),$o(),rs()}function us(){Q.color=5;let{r:e,g:t,b:n}=Qo(xo.value);Q.red=e,Q.green=t,Q.blue=n,$o(),rs()}Yo.forEach(e=>{e.slider.addEventListener(`input`,()=>as(e)),e.num.addEventListener(`input`,()=>os(e,!1)),e.num.addEventListener(`change`,()=>os(e,!0))}),[yo,Po,Fo,Io,Lo].forEach(e=>e.addEventListener(`change`,is)),bo.addEventListener(`change`,cs),xo.addEventListener(`input`,us),xo.addEventListener(`change`,us),Xo.forEach(e=>{e.slider.addEventListener(`input`,ls),e.num.addEventListener(`input`,ss),e.num.addEventListener(`change`,ss)}),document.querySelector(`#ed-copy-code`)?.addEventListener(`click`,()=>{co(Y,Ro.value,`share code`)}),document.querySelector(`#ed-copy-commands`)?.addEventListener(`click`,()=>{co(Y,zo.value,`commands`)}),document.querySelector(`#ed-reset`)?.addEventListener(`click`,()=>{Object.assign(Q,ne),ts(),rs(),Z(Y,`Crosshair reset to defaults.`,`ok`)}),document.querySelector(`.converter-panel .tab[data-tab="visual"]`)?.addEventListener(`click`,rs),ts(),ns(),Va.innerHTML=ya(`cs2`),X.innerHTML=ya(`valorant`),[Va,X,Ha,Wa,Ga,Ka,qa,Ja,Ya].forEach(e=>{e.addEventListener(`input`,uo),e.addEventListener(`change`,uo)}),document.querySelector(`#sens-swap`)?.addEventListener(`click`,fo),document.querySelector(`#copy-sens`)?.addEventListener(`click`,()=>{co(Ia,Ua.value,`converted sensitivity`)}),document.querySelector(`#sens-cs2-val`)?.addEventListener(`click`,po);var ds=document.querySelector(`#psa-start`),fs=document.querySelector(`#psa-begin`),ps=document.querySelector(`#psa-round`),ms=document.querySelector(`#psa-round-num`),hs=document.querySelector(`#psa-bar-fill`),gs=document.querySelector(`#psa-lower`),_s=document.querySelector(`#psa-higher`),vs=document.querySelector(`#psa-lower-val`),ys=document.querySelector(`#psa-higher-val`),bs=document.querySelector(`#psa-undo`),xs=document.querySelector(`#psa-reset`),Ss=document.querySelector(`#psa-result`),Cs=document.querySelector(`#psa-result-label`),ws=document.querySelector(`#psa-stats`),Ts=document.querySelector(`#psa-history`),Es=document.querySelector(`#psa-status`),$=null;function Ds(){if(!$){ps?.classList.add(`hidden`),Ts?.classList.add(`hidden`),Ss.textContent=`—`,Cs.textContent=`recommended sensitivity`,ws.innerHTML=``;return}let e=fe($),t=e?_e($):pe($);if(Ss.textContent=J(t,3),Cs.textContent=e?`final recommended sensitivity`:`current estimate`,ws.innerHTML=`
    <div><dt>Range low</dt><dd>${J($.lo,3)}</dd></div>
    <div><dt>Range high</dt><dd>${J($.hi,3)}</dd></div>
    <div><dt>Spread</dt><dd>± ${J(me($)/2*100,1)}%</dd></div>
    <div><dt>Base</dt><dd>${J($.base,3)}</dd></div>
  `,e)ps?.classList.add(`hidden`),Z(Es,`Done — set your sensitivity to ${J(t,3)} and play a few sessions before changing again.`,`ok`);else{let{lower:e,higher:t}=de($);ps?.classList.remove(`hidden`),ms.textContent=String($.round),hs.style.width=`${($.round-1)/7*100}%`,vs.textContent=J(e,3),ys.textContent=J(t,3),Z(Es,`Round ${$.round} of 7: test both values, then pick the side that feels better.`,``)}$.choices.length>0?(Ts?.classList.remove(`hidden`),Ts.innerHTML=`<strong>History:</strong><br />${$.choices.map(e=>`Round ${e.round}: chose <strong>${e.side}</strong> (${J(e.lower,3)} vs ${J(e.higher,3)})`).join(`<br />`)}`):(Ts?.classList.add(`hidden`),Ts.innerHTML=``)}function Os(){let e=Number(ds.value);if(!Number.isFinite(e)||e<=0){Z(Es,`Enter a valid starting sensitivity greater than 0.`,`error`);return}$=ue(e),Ds()}function ks(e){!$||fe($)||($=he($,e),Ds())}fs?.addEventListener(`click`,Os),gs?.addEventListener(`click`,()=>ks(`lower`)),_s?.addEventListener(`click`,()=>ks(`higher`)),bs?.addEventListener(`click`,()=>{$&&($=ge($),Ds())}),xs?.addEventListener(`click`,()=>{$=null,Ds(),Z(Es,`Enter a starting sensitivity and press Start PSA.`,``)}),Ea.innerHTML=Aa.map(e=>`<option value="${e.id}">${e.label}</option>`).join(``),Ea.addEventListener(`change`,()=>Pa(ja)),Pa(null),oo(),po();function As(e){return String(e||``).replaceAll(`&`,`&amp;`).replaceAll(`"`,`&quot;`)}function js(e){let t=document.querySelector(`#donate-section`),n=document.querySelector(`#donate-actions`);if(!t||!n)return;let r=[];e.paypalUrl&&r.push(`<a class="btn donate-btn paypal" href="${As(e.paypalUrl)}" target="_blank" rel="noopener noreferrer">${xa}<span>Donate via PayPal</span></a>`),e.steamTradeUrl&&r.push(`<a class="btn donate-btn steam" href="${As(e.steamTradeUrl)}" target="_blank" rel="noopener noreferrer">${Sa}<span>Donate Steam skins</span></a>`),n.innerHTML=r.join(``),t.classList.toggle(`hidden`,r.length===0);let i=document.querySelector(`#donate-fab`);if(i){let t=[];e.paypalUrl&&t.push(`<a class="donate-fab-btn paypal" href="${As(e.paypalUrl)}" target="_blank" rel="noopener noreferrer" title="Donate via PayPal">${xa}<span>PayPal</span></a>`),e.steamTradeUrl&&t.push(`<a class="donate-fab-btn steam" href="${As(e.steamTradeUrl)}" target="_blank" rel="noopener noreferrer" title="Donate Steam skins">${Sa}<span>Steam</span></a>`),i.innerHTML=t.length?`<span class="donate-fab-label">Support AimKit</span>${t.join(``)}`:``,i.classList.toggle(`hidden`,t.length===0)}}async function Ms(){try{js(await g.settings.get())}catch{js({paypalUrl:``,steamTradeUrl:``})}}document.addEventListener(`aimkit:settings-updated`,Ms),document.querySelector(`#contact-open`)?.addEventListener(`click`,sa),Ye();var Ns=new URLSearchParams(window.location.search).get(`reset`);if(Ns){Ge(Ns);let e=new URL(window.location.href);e.searchParams.delete(`reset`),window.history.replaceState({},``,e)}var Ps=new URLSearchParams(window.location.search);if(Ps.get(`token`)){we(Ps.get(`token`)),Me();let e=new URL(window.location.href);e.searchParams.delete(`token`),window.history.replaceState({},``,e)}else if(Ps.get(`steam`)===`linked`){Me();let e=new URL(window.location.href);e.searchParams.delete(`steam`),window.history.replaceState({},``,e)}else if(Ps.get(`steam_error`)){let e=new URL(window.location.href);e.searchParams.delete(`steam_error`),window.history.replaceState({},``,e)}Rn(),cr(),Yr(),_i(),Ii(),Tr(),aa(),Ms();