...
`)}var ce=.5;function le(e){return{base:e,lo:e*(1-ce),hi:e*1.5,round:1,choices:[]}}function ue(e){return{lower:e.lo,higher:e.hi,mid:(e.lo+e.hi)/2}}function de(e){return e.round>7}function fe(e){return(e.lo+e.hi)/2}function pe(e){let t=fe(e);return t<=0?0:(e.hi-e.lo)/t}function me(e,t){if(de(e))return e;let n=(e.lo+e.hi)/2,r={round:e.round,side:t,lo:e.lo,hi:e.hi,lower:e.lo,higher:e.hi},i={...e,choices:[...e.choices,r],round:e.round+1};return t===`lower`?i.hi=n:i.lo=n,i}function he(e){if(e.choices.length===0)return e;let t=e.choices.slice(0,-1),n=e.choices[e.choices.length-1];return{...e,lo:n.lo,hi:n.hi,round:n.round,choices:t}}function ge(e){return fe(e)}var _e=`/api`,ve=`cs2utils.token`,ye=/^https?:\/\//.test(_e)?new URL(_e).origin:``;function be(){try{return localStorage.getItem(ve)}catch{return null}}function xe(e){try{e?localStorage.setItem(ve,e):localStorage.removeItem(ve)}catch{}}async function h(e,t,n,{auth:r=!1}={}){let i={};if(n!==void 0&&!(n instanceof FormData)&&(i[`Content-Type`]=`application/json`),r){let e=be();e&&(i.Authorization=`Bearer ${e}`)}let a;try{a=await fetch(`${_e}${t}`,{method:e,headers:i,body:n instanceof FormData?n:n===void 0?void 0:JSON.stringify(n)})}catch{throw Error(`Cannot reach the server. Is the API running?`)}let o=null,s=await a.text();if(s)try{o=JSON.parse(s)}catch{o=null}if(!a.ok){let e=Error(o&&o.error||`Request failed (${a.status}).`);throw e.status=a.status,e.data=o,e}return o}var Se=`${_e}/auth/steam`;function Ce(e){xe(e)}function g(e){return!!e&&(e.role===`admin`||e.role===`owner`)}function we(e){return!!e&&e.role===`owner`}function Te(e){return e?/^https?:\/\//.test(e)||e.startsWith(`data:`)?e:ye+e:``}var _={auth:{async register(e){let t=await h(`POST`,`/auth/register`,e);return xe(t.token),t.user},async login(e){let t=await h(`POST`,`/auth/login`,e);return xe(t.token),t.user},logout(){xe(null)},async captcha(){return h(`GET`,`/auth/captcha`)},async changePassword(e){return h(`POST`,`/auth/password`,e,{auth:!0})},async forgot(e){return h(`POST`,`/auth/forgot`,{email:e})},async reset(e,t){return h(`POST`,`/auth/reset`,{token:e,password:t})},async me(){if(!be())return null;try{return(await h(`GET`,`/auth/me`,void 0,{auth:!0})).user}catch{return xe(null),null}},async profile(){return h(`GET`,`/auth/profile`,void 0,{auth:!0})},async setAvatar(e){return(await h(`POST`,`/auth/avatar`,{url:e},{auth:!0})).user},async uploadAvatar(e){let t=new FormData;return t.append(`file`,e),(await h(`POST`,`/auth/avatar/upload`,t,{auth:!0})).user},async changePassword(e){return h(`POST`,`/auth/password`,e,{auth:!0})},async changeUsername(e){let t=await h(`POST`,`/auth/username`,{username:e},{auth:!0});return t.token&&xe(t.token),t.user},async setCredentials(e){let t=await h(`POST`,`/auth/credentials`,e,{auth:!0});return t.token&&xe(t.token),t.user},async forgot(e){return h(`POST`,`/auth/forgot`,{email:e})},async reset(e,t){return h(`POST`,`/auth/reset`,{token:e,password:t})},steamLoginUrl(){return`${_e}/auth/steam`},async steamLinkUrl(){return(await h(`GET`,`/auth/steam/link-url`,void 0,{auth:!0})).url},async steamUnlink(){return(await h(`POST`,`/auth/steam/unlink`,{},{auth:!0})).user}},settings:{async get(){return h(`GET`,`/settings`)}},contact:{async send(e){return h(`POST`,`/contact`,e)}},pros:{async list({q:e=``,sort:t=`name`}={}){let n=new URLSearchParams;e&&n.set(`q`,e),t&&n.set(`sort`,t);let r=n.toString();return h(`GET`,`/pros${r?`?${r}`:``}`)}},configs:{async list({sort:e=`top`,q:t=``}={}){let n=new URLSearchParams;e&&n.set(`sort`,e),t&&n.set(`q`,t);let r=n.toString();return(await h(`GET`,`/configs${r?`?${r}`:``}`,void 0,{auth:!0})).configs},async create(e){return(await h(`POST`,`/configs`,e,{auth:!0})).config},async rate(e,t){return h(`POST`,`/configs/${e}/rate`,{rating:t},{auth:!0})},async remove(e){return h(`DELETE`,`/configs/${e}`,void 0,{auth:!0})}},highlights:{async list({q:e=``}={}){return(await h(`GET`,`/highlights${e?`?q=${encodeURIComponent(e)}`:``}`,void 0,{auth:!0})).highlights},async create(e){return(await h(`POST`,`/highlights`,e,{auth:!0})).highlight},async report(e,t){return h(`POST`,`/highlights/${e}/report`,{reason:t},{auth:!0})},async remove(e){return h(`DELETE`,`/highlights/${e}`,void 0,{auth:!0})}},nades:{async list({map:e=``,type:t=``}={}){let n=new URLSearchParams;e&&n.set(`map`,e),t&&n.set(`type`,t);let r=n.toString();return(await h(`GET`,`/nades${r?`?${r}`:``}`)).nades},async mine(){return(await h(`GET`,`/nades/mine`,void 0,{auth:!0})).nades},async create(e){return(await h(`POST`,`/nades`,e,{auth:!0})).nade},async addMedia(e,t){return(await h(`POST`,`/nades/${e}/media`,t,{auth:!0})).media},async remove(e){return h(`DELETE`,`/nades/${e}`,void 0,{auth:!0})},async parseMapGuide(e){return h(`POST`,`/nades/map-guide/parse`,{text:e},{auth:!0})},async importMapGuide({text:e,nades:t,side:n,guideText:r,fileName:i}={}){return h(`POST`,`/nades/map-guide/import`,{text:e,nades:t,side:n,guideText:r,fileName:i},{auth:!0})},async practicePackFromText({text:e,map:t,importId:n}={}){return h(`POST`,`/nades/map-guide/practice-pack`,{text:e,map:t,importId:n},{auth:!0})},async practicePackFromImport(e){return h(`GET`,`/nades/map-guide/imports/${e}/practice-pack`,void 0,{auth:!!be()})},async practicePackFromNades(e){return h(`POST`,`/nades/map-guide/practice-pack-from-nades`,{nadeIds:e},{auth:!!be()})}},commands:{async catalog(){return h(`GET`,`/commands/catalog`)},async social(){return h(`GET`,`/commands/social`,void 0,{auth:!0})},async recommend(e){return h(`POST`,`/commands/${e}/recommend`,{},{auth:!0})},async addComment(e,t){return h(`POST`,`/commands/${e}/comments`,{body:t},{auth:!0})}},admin:{async pending(){return(await h(`GET`,`/admin/nades/pending`,void 0,{auth:!0})).nades},async pendingComments(){return(await h(`GET`,`/admin/comments/pending`,void 0,{auth:!0})).comments},async pendingCommentsCount(){return(await h(`GET`,`/admin/comments/pending/count`,void 0,{auth:!0})).count},async reviewComment(e,t){return h(`POST`,`/admin/comments/${e}/review`,{decision:t},{auth:!0})},async removeComment(e){return h(`DELETE`,`/admin/comments/${e}`,void 0,{auth:!0})},async syncCommands(){return h(`POST`,`/admin/commands/sync`,{},{auth:!0})},async checkCommandsCs2(){return h(`POST`,`/admin/commands/check-cs2`,{},{auth:!0})},async saveSettings(e){return h(`POST`,`/admin/settings`,e,{auth:!0})},async highlightReports(){return(await h(`GET`,`/admin/highlights/reports`,void 0,{auth:!0})).highlights},async highlightReportsCount(){return(await h(`GET`,`/admin/highlights/reports/count`,void 0,{auth:!0})).count},async reviewHighlight(e,t){return h(`POST`,`/admin/highlights/${e}/review`,{decision:t},{auth:!0})},async syncPros(){return h(`POST`,`/admin/pros/sync`,{},{auth:!0})},async importCommands(e){return h(`POST`,`/admin/commands/import`,{content:e},{auth:!0})},async importPros(e){return h(`POST`,`/admin/pros/import`,{content:e},{auth:!0})},async banUser(e,{hours:t,permanent:n}){return(await h(`POST`,`/admin/users/${e}/ban`,{hours:t,permanent:n},{auth:!0})).user},async unbanUser(e){return(await h(`POST`,`/admin/users/${e}/unban`,{},{auth:!0})).user},async pendingCount(){return(await h(`GET`,`/admin/nades/pending/count`,void 0,{auth:!0})).count},async reviewNade(e,t,n=``){return h(`POST`,`/admin/nades/${e}/review`,{decision:t,note:n},{auth:!0})},async reviewNadesBulk(e,t,n=``){return h(`POST`,`/admin/nades/review-bulk`,{ids:e,decision:t,note:n},{auth:!0})},async reviewMedia(e,t){return h(`POST`,`/admin/media/${e}/review`,{decision:t},{auth:!0})},async reviewMediaBulk(e,t){return h(`POST`,`/admin/media/review-bulk`,{ids:e,decision:t},{auth:!0})},async removeMedia(e){return h(`DELETE`,`/admin/media/${e}`,void 0,{auth:!0})},async users(){return(await h(`GET`,`/admin/users`,void 0,{auth:!0})).users},async setRole(e,t){return(await h(`POST`,`/admin/users/${e}/role`,{role:t},{auth:!0})).user},async contactMessages(){return(await h(`GET`,`/admin/contact`,void 0,{auth:!0})).messages},async removeContact(e){return h(`DELETE`,`/admin/contact/${e}`,void 0,{auth:!0})},async ownerLogs({limit:e=100,offset:t=0,action:n=``}={}){let r=new URLSearchParams;e&&r.set(`limit`,String(e)),t&&r.set(`offset`,String(t)),n&&r.set(`action`,n);let i=r.toString();return h(`GET`,`/admin/owner-logs${i?`?${i}`:``}`,void 0,{auth:!0})}},uploads:{async image(e){let t=new FormData;return t.append(`file`,e),await h(`POST`,`/uploads`,t,{auth:!0})}}},Ee=null,De=new Set;function Oe(){for(let e of De)e(Ee)}function ke(){return Ee}function Ae(e){return De.add(e),()=>De.delete(e)}async function je(){return Ee=await _.auth.me(),Oe(),Ee}async function Me(e){return Ee=await _.auth.login(e),Oe(),Ee}async function Ne(e){return Ee=await _.auth.register(e),Oe(),Ee}function Pe(){_.auth.logout(),Ee=null,Oe()}var Fe,v,Ie=`login`,Le={required:!1,token:null,svg:``};function Re(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function ze(){let e=ke();e?(Fe.innerHTML=`
    ...
    <div class="try-game-modal" role="dialog" aria-modal="true" aria-label="Try in game">
      <div class="try-game-card">
    ...
    </div>`}var yt=360,bt=100,y,b=null,x=`browse`,xt={text:``,kind:``},St=0,Ct=!1,wt={map:``,type:``},Tt=[],S=new Map,Et=[],Dt=[],Ot=[],C=At(),w=jt(),T=null,kt=1;function At(){return{map:`mirage`,type:`smoke`,side:`t`,technique:`stand`,title:``,description:``,start:null,end:null}}function jt(){return{text:``,fileName:``,side:`t`,parsed:null,selected:null}}function E(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Mt(e){let t=Te(e);return/^https?:\/\//.test(t)||t.startsWith(`data:image/`)?t:``}function Nt(e){let t=/(?:youtube\.com\/(?:watch\?v=|embed\/|shorts\/)|youtu\.be\/)([\w-]{6,})/.exec(e||``);return t?t[1]:null}function Pt(e,t){return e.map(e=>`<option value="${e.id}"${e.id===t?` selected`:``}>${E(e.name)}</option>`).join(``)}function D(e,t=``){xt={text:e,kind:t};let n=y?.querySelector(`#nades-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function Ft(e){return`<span class="nade-badge ${e}">${e}</span>`}function It(e){try{return new Date(e).toLocaleDateString()}catch{return``}}async function Lt(){if(g(b))try{St=await _.admin.pendingCount()}catch{St=0}else St=0}async function O(e){x=e,Ct=![`add`,`import`].includes(e),Ct&&k();try{x===`browse`&&(Tt=await _.nades.list(wt)),x===`mine`&&b&&(Et=await _.nades.mine()),x===`review`&&g(b)&&(Dt=await _.admin.pending(),St=await _.admin.pendingCount()),x===`users`&&g(b)&&(Ot=await _.admin.users())}catch(e){D(e.message,`error`)}Ct=!1,k()}function Rt(e){let t=Mt(e.url);if(!t)return``;if(e.kind===`video`){let n=Nt(e.url);return n?`<iframe class="nade-media-embed" src="https://www.youtube.com/embed/${E(n)}" title="nade video" allowfullscreen loading="lazy"></iframe>`:/\.(mp4|webm|mov)(\?|$)/i.test(e.url)?`<video class="nade-media-embed" src="${E(t)}" controls preload="none"></video>`:`<a class="btn ghost" href="${E(t)}" target="_blank" rel="noopener noreferrer">Open video ↗</a>`}return`<a href="${E(t)}" target="_blank" rel="noopener noreferrer"><img class="nade-media-img" src="${E(t)}" alt="${E(e.addedByName||`nade media`)}" loading="lazy" /></a>`}function zt(e,{showStatus:t=!1,showTryInGame:n=!1,adminRemove:r=!1}={}){let i=et(e.type),a=(e.media||[]).filter(e=>t?!0:e.status===`approved`),o=a.length?`<div class="nade-media">${a.map(e=>`<div class="nade-media-item">${Rt(e)}${t?`<div class="nade-media-meta">${Ft(e.status)} <span>by ${E(e.addedByName||``)}</span></div>`:``}</div>`).join(``)}</div>`:`<p class="hint">No approved media yet — a 2D throw preview is shown above.</p>`,s=n&&S.has(e.id),c=n?`<div class="nade-card-actions">
         <label class="browse-nade-check">
           <input type="checkbox" class="browse-select" value="${e.id}" data-map="${E(e.map)}" ${s?`checked`:``} />
           <span>Select</span>
         </label>
       ...
       </div>`:r&&g(b)?`<div class="nade-card-actions">
           <button class="btn ghost danger" type="button" data-delete-nade="${e.id}">Remove</button>
         </div>`:``;return`
    <article class="nade-card${n?` browse-nade-card`:``}${s?` selected`:``}"${n?` data-browse-nade="${e.id}" data-map="${E(e.map)}" tabindex="0" role="checkbox" aria-checked="${s?`true`:`false`}"`:``}>
      <div class="nade-card-head">
        <div>
          <h3>${E(e.title)}</h3>
          <p class="nade-sub">
            <span class="nade-chip" style="--chip:${i.color}">${E(i.name)}</span>
      ...
      ${o}
      <p class="nade-foot">by ${E(e.authorName)} · ${It(e.createdAt)}</p>
      ${c}
    </article>`}function Bt(){return[...S.keys()]}function Vt(){let e=Tt.length?Tt.map(e=>zt(e,{showTryInGame:!0,adminRemove:!0})).join(``):`<p class="hint">No approved nades yet${b?` — be the first to add one!`:` — log in and add the nades you found.`}</p>`,t=S.size;return`
    <div class="nades-filters">
      <label class="field">
        <span>Map</span>
        <select id="filter-map"><option value="">All maps</option>${Pt(Ye,wt.map)}</select>
      </label>
      <label class="field">
        <span>Type</span>
        <select id="filter-type"><option value="">All types</option>${Pt(Xe,wt.type)}</select>
      </label>
    </div>
    <div class="browse-select-bar">
      <span class="hint">Click a lineup to select it (up to ${bt}, same map) for one merged annotation file.</span>
    ...
    <div class="nade-add">
      ...
      <form class="nade-add-form" id="nade-add-form">
        ...
        <div class="sens-grid">
          <label class="field"><span>Map</span><select id="add-map">${Pt(Ye,C.map)}</select></label>
          <label class="field"><span>Type</span><select id="add-type">${Pt(Xe,C.type)}</select></label>
        </div>
        <div class="sens-grid">
          <label class="field"><span>Side</span><select id="add-side">${Pt(Qe,C.side)}</select></label>
          <label class="field"><span>Technique</span><select id="add-technique">${Pt(Ze,C.technique)}</select></label>
        </div>
    ...
    </div>`:Ht(`add nades`)}function Wt(){if(!b)return Ht(`import a CS2 map guide`);let e=w.parsed,t=e&&w.selected!=null?e.nades[w.selected]:e?.nades?.[0]||null,n=e?`<div class="guide-preview-list">
    ...
    <div class="nade-import">
      ...
      <div class="nade-add-form">
        ...
        <label class="field">
          ...
          <select id="guide-side">${Pt(Qe,w.side)}</select>
        </label>
        <div class="actions">
    ...
    </div>`}function Gt(){return b?Et.length?`<div class="nade-grid">${Et.map(e=>`
      <div class="nade-mine">
        ${zt(e,{showStatus:!0})}
      ...
      </div>`).join(``)}</div>`:`<p class="hint">You haven't added any nades yet.</p>`:Ht(`see and manage your nades`)}function Kt(){return g(b)?Dt.length?`
    ...
    <div class="nade-grid">${Dt.map(e=>{let t=e.media||[],n=t.length?`<div class="review-media">${t.map(e=>`<div class="review-media-item">${Rt(e)}
                  <div class="nade-media-meta">${Ft(e.status)} <span>by ${E(e.addedByName||``)}</span></div>
                  <div class="actions">
                 ...
                 <input type="text" class="review-note" data-nade="${e.id}" placeholder="Optional note to the author" />
               </div>`;return`<div class="nade-mine">${zt(e,{showStatus:!0})}${n}${r}</div>`}).join(``)}</div>`:`<p class="hint">Nothing pending review. Nice and clean.</p>`:`<p class="hint">Admins only.</p>`}function qt(e){if(!e.bannedUntil)return null;let t=new Date(e.bannedUntil);return t.getTime()<=Date.now()?null:t.getFullYear()>=9999?`permanently`:`until ${t.toLocaleString()}`}function Jt(){if(!g(b))return`<p class="hint">Admins only.</p>`;let e=we(b);return`<div class="users-table">
  ...
  </div>`}function Yt(){let e=[[`browse`,`Browse`]];return b&&e.push([`add`,`Add nade`],[`import`,`Import guide`],[`mine`,`My nades`]),g(b)&&e.push([`review`,`Review${St?` (${St})`:``}`],[`users`,`Users`]),`<nav class="nades-subnav">${e.map(([e,t])=>`<button class="tool-tab ${x===e?`active`:``}" data-view="${e}">${E(t)}</button>`).join(``)}</nav>`}function Xt(){if(Ct)return`<div class="nades-loading"><span class="spinner"></span> Loading…</div>`;switch(x){case`add`:return Ut();case`import`:return Wt();case`mine`:return Gt();case`review`:return Kt();case`users`:return Jt();default:return Vt()}}function k(){y.innerHTML=`
    <div class="nades-shell">
      ${Yt()}
      <div class="nades-body">${Xt()}</div>
      <div id="nades-status" class="status ${xt.kind}">${E(xt.text)}</div>
      ${T?vt(T,{esc:E,lineupCount:kt}):``}
    </div>`,en(),Zt()}function Zt(){y.querySelectorAll(`canvas.nade-canvas:not(.interactive):not(#guide-preview-canvas)`).forEach(e=>{lt(e,{mapId:e.dataset.map,type:e.dataset.type,start:{x:Number(e.dataset.sx),y:Number(e.dataset.sy)},end:{x:Number(e.dataset.ex),y:Number(e.dataset.ey)}})}),Qt(),$t()}function Qt(){let e=y.querySelector(`#nade-add-canvas`);e&&lt(e,{mapId:C.map,type:C.type,start:C.start,end:C.end})}function $t(){let e=y.querySelector(`#guide-preview-canvas`);if(!e)return;let t=w.parsed?.nades?.[w.selected??0];if(!t){lt(e,{mapId:`mirage`,type:`smoke`,start:null,end:null});return}lt(e,{mapId:t.map,type:t.type,start:t.start,end:t.end})}function en(){y.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>qe(e.dataset.openAuth))),y.querySelectorAll(`[data-view]`).forEach(e=>e.addEventListener(`click`,()=>O(e.dataset.view))),y.querySelector(`#filter-map`)?.addEventListener(`change`,e=>{wt.map=e.target.value,S=new Map,O(`browse`)}),y.querySelector(`#filter-type`)?.addEventListener(`change`,e=>{wt.type=e.target.value,O(`browse`)}),y.querySelectorAll(`.browse-select`).forEach(e=>e.addEventListener(`change`,()=>{cn(Number(e.value),e.dataset.map,e.checked),ln(e.closest(`.browse-nade-card`))})),y.querySelectorAll(`.browse-nade-card`).forEach(e=>{e.addEventListener(`click`,t=>{t.target.closest(`a, button, input, label`)||un(e)}),e.addEventListener(`keydown`,t=>{t.key!==` `&&t.key!==`Enter`||t.target.closest(`a, button, input, label`)||(t.preventDefault(),un(e))})}),y.querySelector(`#browse-select-clear`)?.addEventListener(`click`,()=>{S=new Map,k()}),y.querySelector(`#browse-try-selected`)?.addEventListener(`click`,()=>{fn(Bt())}),y.querySelectorAll(`[data-try-nades]`).forEach(e=>e.addEventListener(`click`,t=>{t.stopPropagation(),fn([Number(e.dataset.tryNades)])}));let e=y.querySelector(`#nade-add-canvas`);e&&e.addEventListener(`click`,t=>{let n=ft(e,t);!C.start||C.start&&C.end?(C.start=n,C.end=null):C.end=n;let r=y.querySelector(`#nade-add-coords`);r&&(r.textContent=C.end?`Throw + landing set. Adjust by clicking again to start over.`:`Now click the landing spot for the grenade.`),Qt()}),y.querySelector(`#add-map`)?.addEventListener(`change`,e=>{C.map=e.target.value,Qt()}),y.querySelector(`#add-type`)?.addEventListener(`change`,e=>{C.type=e.target.value,Qt()}),y.querySelector(`#add-clear`)?.addEventListener(`click`,()=>{C.start=null,C.end=null,Qt();let e=y.querySelector(`#nade-add-coords`);e&&(e.textContent=`Click the map to set the throw position, then click again for the landing spot.`)}),y.querySelector(`#nade-add-form`)?.addEventListener(`submit`,tn),y.querySelector(`#guide-file`)?.addEventListener(`change`,nn),y.querySelector(`#guide-text`)?.addEventListener(`input`,e=>{w.text=e.target.value}),y.querySelector(`#guide-side`)?.addEventListener(`change`,e=>{w.side=e.target.value}),y.querySelector(`#guide-parse`)?.addEventListener(`click`,rn),y.querySelector(`#guide-import`)?.addEventListener(`click`,an),y.querySelector(`#guide-try-game`)?.addEventListener(`click`,on),y.querySelector(`#guide-clear`)?.addEventListener(`click`,()=>{w=jt(),T=null,k(),D(`Cleared map guide.`,``)}),y.querySelectorAll(`[data-guide-idx]`).forEach(e=>e.addEventListener(`click`,()=>{w.selected=Number(e.dataset.guideIdx),k()})),y.querySelector(`[data-try-game-close]`)?.addEventListener(`click`,()=>{T=null,kt=1,k()}),y.querySelector(`[data-try-game-download]`)?.addEventListener(`click`,()=>{if(!T)return;let e=_t(y);if(!e.guide&&!e.cfg){let e=y.querySelector(`[data-try-game-status]`);e&&(e.textContent=`Choose at least one file to download, or just Open CS2 if you already have them.`);return}let t=mt(T,e),n=y.querySelector(`[data-try-game-status]`);n&&(n.textContent=t.length?`Downloaded ${t.join(` + `)}. Copy into your CS2 folders, then Open CS2.`:`Nothing selected to download.`)}),y.querySelector(`[data-try-game-open]`)?.addEventListener(`click`,pn),y.querySelector(`[data-try-game-copy-cmd]`)?.addEventListener(`click`,mn),y.querySelectorAll(`[data-add-media]`).forEach(e=>e.addEventListener(`click`,()=>hn(e.dataset.addMedia))),y.querySelectorAll(`[data-try-import]`).forEach(e=>e.addEventListener(`click`,()=>sn(e.dataset.tryImport))),y.querySelectorAll(`[data-delete-nade]`).forEach(e=>e.addEventListener(`click`,()=>gn(e.dataset.deleteNade))),y.querySelectorAll(`[data-delete-media]`).forEach(e=>e.addEventListener(`click`,()=>_n(e.dataset.deleteMedia))),y.querySelectorAll(`[data-approve-nade]`).forEach(e=>e.addEventListener(`click`,()=>vn(e.dataset.approveNade,`approved`))),y.querySelectorAll(`[data-reject-nade]`).forEach(e=>e.addEventListener(`click`,()=>vn(e.dataset.rejectNade,`rejected`))),y.querySelectorAll(`[data-approve-media]`).forEach(e=>e.addEventListener(`click`,()=>bn(e.dataset.approveMedia,`approved`))),y.querySelectorAll(`[data-reject-media]`).forEach(e=>e.addEventListener(`click`,()=>bn(e.dataset.rejectMedia,`rejected`)));let t=y.querySelector(`#review-select-all`),n=y.querySelector(`#review-bulk-approve`),r=y.querySelector(`#review-bulk-reject`),i=()=>{let e=y.querySelectorAll(`.review-nade-check:checked`).length;n&&(n.disabled=e===0),r&&(r.disabled=e===0)};t?.addEventListener(`change`,()=>{y.querySelectorAll(`.review-nade-check`).forEach(e=>{e.checked=t.checked}),i()}),y.querySelectorAll(`.review-nade-check`).forEach(e=>e.addEventListener(`change`,i)),n?.addEventListener(`click`,()=>yn(`approved`)),r?.addEventListener(`click`,()=>yn(`rejected`)),y.querySelectorAll(`[data-role-user]`).forEach(e=>e.addEventListener(`click`,()=>xn(e.dataset.roleUser,e.dataset.role))),y.querySelectorAll(`[data-ban]`).forEach(e=>e.addEventListener(`click`,()=>{let t=y.querySelector(`[data-ban-dur="${e.dataset.ban}"]`);Sn(e.dataset.ban,t?t.value:`24`)})),y.querySelectorAll(`[data-unban]`).forEach(e=>e.addEventListener(`click`,()=>Cn(e.dataset.unban)))}async function tn(e){if(e.preventDefault(),C.title=y.querySelector(`#add-title`)?.value||``,C.map=y.querySelector(`#add-map`)?.value||C.map,C.type=y.querySelector(`#add-type`)?.value||C.type,C.side=y.querySelector(`#add-side`)?.value||C.side,C.technique=y.querySelector(`#add-technique`)?.value||C.technique,C.description=y.querySelector(`#add-description`)?.value||``,!C.start||!C.end){D(`Click the map to set both the throw position and the landing spot.`,`error`);return}let t=[],n=(y.querySelector(`#add-video`)?.value||``).trim(),r=(y.querySelector(`#add-image`)?.value||``).trim();n&&t.push({url:n,kind:`video`}),r&&t.push({url:r,kind:rt(r)});let i=y.querySelector(`#add-upload`);try{if(i?.files?.[0]){D(`Uploading image…`,``);let e=await _.uploads.image(i.files[0]);t.push({url:e.url,kind:`image`})}await _.nades.create({...C,media:t}),C=At(),await O(`mine`),D(`Nade submitted! It will appear publicly once an admin approves it.`,`ok`)}catch(e){D(e.message,`error`)}}async function nn(e){let t=e.target.files?.[0];if(t)try{w.fileName=t.name,w.text=await t.text(),w.parsed=null,w.selected=null,k(),D(`Loaded ${t.name}. Click Preview lineups.`,`ok`)}catch{D(`Could not read that file.`,`error`)}}async function rn(){let e=(y.querySelector(`#guide-text`)?.value||w.text||``).trim();if(w.text=e,w.side=y.querySelector(`#guide-side`)?.value||w.side,!e){D(`Upload or paste a CS2 map guide .txt first.`,`error`);return}try{D(`Parsing map guide…`,``);let t=await _.nades.parseMapGuide(e);w.parsed=t,w.selected=0,k(),D(`Found ${t.nades.length} lineup${t.nades.length===1?``:`s`} on ${$e(t.map)}.`,`ok`)}catch(e){w.parsed=null,k(),D(e.message,`error`)}}async function an(){if(!w.parsed?.nades?.length){D(`Preview the guide first so you can confirm the lineups.`,`error`);return}w.side=y.querySelector(`#guide-side`)?.value||w.side;let e=(y.querySelector(`#guide-text`)?.value||w.text||``).trim();try{D(`Importing lineups…`,``);let t=await _.nades.importMapGuide({nades:w.parsed.nades,side:w.side,guideText:e,fileName:w.fileName});w=jt(),await O(`mine`),D(`Imported ${t.count} nade${t.count===1?``:`s`} — pending admin review.`,`ok`)}catch(e){D(e.message,`error`)}}async function on(){let e=(y.querySelector(`#guide-text`)?.value||w.text||``).trim(),t=w.parsed?.map;if(!e||!t){D(`Preview the map guide first.`,`error`);return}try{D(`Preparing CS2 practice pack…`,``),T=(await _.nades.practicePackFromText({text:e,map:t})).pack,kt=w.parsed?.nades?.length||1,k(),D(`Choose what to download (or skip if you already have the files), then Open CS2.`,`ok`)}catch(e){D(e.message,`error`)}}async function sn(e){try{D(`Preparing CS2 practice pack…`,``),T=(await _.nades.practicePackFromImport(e)).pack,kt=1,k(),D(`Choose what to download (or skip if you already have the files), then Open CS2.`,`ok`)}catch(e){D(e.message,`error`)}}function cn(e,t,n){if(!Number.isFinite(e)||e<=0)return!1;if(!n)return S.delete(e),dn(),!0;if(S.size>=bt&&!S.has(e))return D(`You can select at most ${bt} lineups.`,`error`),!1;for(let[,e]of S)if(e!==t)return D(`Selected lineups must be on the same map.`,`error`),!1;return S.set(e,t),dn(),!0}function ln(e){if(!e)return;let t=Number(e.dataset.browseNade),n=S.has(t);e.classList.toggle(`selected`,n),e.setAttribute(`aria-checked`,n?`true`:`false`);let r=e.querySelector(`.browse-select`);r&&(r.checked=n)}function un(e){let t=Number(e.dataset.browseNade),n=e.dataset.map;cn(t,n,!S.has(t)),ln(e)}function dn(){let e=y.querySelector(`#browse-try-selected`),t=y.querySelector(`#browse-select-clear`),n=S.size;e&&(e.disabled=n===0,e.textContent=`Try selected in game (${n}/${bt})`),t&&(t.disabled=n===0)}async function fn(e){let t=[...new Set((e||[]).map(Number).filter(e=>Number.isFinite(e)&&e>0))];if(!t.length){D(`Select at least one lineup (max ${bt}, same map).`,`error`);return}if(t.length>bt){D(`You can open at most ${bt} lineups at once.`,`error`);return}try{D(`Preparing CS2 practice pack…`,``),T=(await _.nades.practicePackFromNades(t)).pack,kt=t.length,k(),D(t.length>1?`Merged ${t.length} lineups into one annotation file. Download what you need, then Open CS2.`:`Choose what to download (or skip if you already have the files), then Open CS2.`,`ok`)}catch(e){D(e.message,`error`)}}function pn(){if(!T)return;let e=y.querySelector(`[data-try-game-status]`);try{ht(T);let t=`Opening CS2 private ${T.deMap}… Quit CS2 first if it was already running, otherwise paste in console: ${T.consoleCommand||`map ${T.deMap}; exec ${T.cfgBaseName}`}`;e&&(e.textContent=t),D(t,`ok`)}catch(t){e&&(e.textContent=t.message),D(t.message,`error`)}}async function mn(){if(!T)return;let e=y.querySelector(`[data-try-game-status]`);try{let t=`Copied: ${await gt(T)}`;e&&(e.textContent=t),D(t,`ok`)}catch(t){e&&(e.textContent=t.message),D(t.message,`error`)}}async function hn(e){let t=(y.querySelector(`.add-media-url[data-nade="${e}"]`)?.value||``).trim();if(!t){D(`Enter a media URL first.`,`error`);return}try{await _.nades.addMedia(e,{url:t,kind:rt(t)}),await O(`mine`),D(`Media added — pending admin review.`,`ok`)}catch(e){D(e.message,`error`)}}async function gn(e){if(confirm(`Permanently delete this nade and its media?`))try{await _.nades.remove(e),S.delete(Number(e)),await O(x),D(`Nade deleted.`,`ok`)}catch(e){D(e.message,`error`)}}async function _n(e){if(confirm(`Permanently remove this media?`))try{await _.admin.removeMedia(e),await O(x),D(`Media removed.`,`ok`)}catch(e){D(e.message,`error`)}}async function vn(e,t){let n=y.querySelector(`.review-note[data-nade="${e}"]`)?.value||``;try{await _.admin.reviewNade(e,t,n),await O(`review`),D(`Nade ${t}.`,`ok`)}catch(e){D(e.message,`error`)}}async function yn(e){let t=[...y.querySelectorAll(`.review-nade-check:checked`)].map(e=>Number(e.value));if(!t.length){D(`Select at least one pending nade.`,`error`);return}let n=y.querySelector(`#review-bulk-note`)?.value||``;try{let r=await _.admin.reviewNadesBulk(t,e,n);await O(`review`),D(`${e===`approved`?`Approved`:`Rejected`} ${r.updated} nade${r.updated===1?``:`s`}.`,`ok`)}catch(e){D(e.message,`error`)}}async function bn(e,t){try{await _.admin.reviewMedia(e,t),await O(`review`),D(`Media ${t}.`,`ok`)}catch(e){D(e.message,`error`)}}async function xn(e,t){try{await _.admin.setRole(e,t),await O(`users`),D(`Role updated.`,`ok`)}catch(e){D(e.message,`error`)}}async function Sn(e,t){try{t===`perma`?await _.admin.banUser(e,{permanent:!0}):await _.admin.banUser(e,{hours:Number(t)}),await O(`users`),D(`User banned.`,`ok`)}catch(e){D(e.message,`error`)}}async function Cn(e){try{await _.admin.unbanUser(e),await O(`users`),D(`User unbanned.`,`ok`)}catch(e){D(e.message,`error`)}}async function wn(){y=document.querySelector(`#nades-tool`),y&&(b=ke(),Ae(async e=>{b=e,await Lt(),!b&&[`add`,`import`,`mine`,`review`,`users`].includes(x)&&(x=`browse`),b&&!g(b)&&[`review`,`users`].includes(x)&&(x=`browse`),await O(x)}),await Lt(),k(),await O(`browse`))}function Tn(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function En(e){let t=document.createElement(`div`);t.className=`modal`,t.innerHTML=`
    <div class="modal-backdrop" data-close></div>
    <div class="modal-card import-card" role="dialog" aria-modal="true" aria-label="${Tn(e.title)}">
      <button class="modal-close" data-close aria-label="Close">&times;</button>
      <h2 class="modal-title">${Tn(e.title)}</h2>
      <p class="hint">${Tn(e.description)}</p>
      <ol class="import-steps">
        <li>Open the source and complete the verification: <a class="btn btn-sm" href="${Tn(e.sourceUrl)}" target="_blank" rel="noopener noreferrer">${Tn(e.sourceLabel)} ↗</a></li>
        <li>Copy the page content.</li>
        <li>Paste it below and import.</li>
      </ol>
      <textarea id="import-content" rows="9" spellcheck="false" placeholder="${Tn(e.placeholder||`Paste the page content here…`)}"></textarea>
      <div class="actions">
        <button class="btn primary" id="import-run">Import</button>
        <button class="btn ghost" data-close>Cancel</button>
      </div>
      <p class="status" id="import-status"></p>
    </div>`,document.body.appendChild(t);let n=()=>t.remove();t.querySelectorAll(`[data-close]`).forEach(e=>e.addEventListener(`click`,n));let r=e=>{e.key===`Escape`&&(n(),document.removeEventListener(`keydown`,r))};document.addEventListener(`keydown`,r);let i=t.querySelector(`#import-status`),a=t.querySelector(`#import-run`);a.addEventListener(`click`,async()=>{let r=t.querySelector(`#import-content`).value;if(!r.trim()){i.textContent=`Paste the page content first.`,i.className=`status error`;return}a.disabled=!0,i.textContent=`Importing…`,i.className=`status`;try{let t=await e.onImport(r);i.textContent=t||`Imported.`,i.className=`status ok`,setTimeout(n,900)}catch(e){i.textContent=e.message,i.className=`status error`,a.disabled=!1}}),t.querySelector(`#import-content`)?.focus()}var A,Dn=null,j={commands:[],categories:[],recommendedLaunchOptions:``,source:`seed`,lastSync:0,cs2Build:``,cs2Version:``,remoteConfigured:!1},On={counts:{},mine:[],comments:{}},kn=[],An={text:``,kind:``},jn=new Set;function M(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function N(e,t=``){An={text:e,kind:t};let n=A?.querySelector(`#commands-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function Mn(e){if(!e)return`—`;try{return new Date(e).toLocaleString()}catch{return`—`}}async function Nn(){try{j=await _.commands.catalog()}catch(e){N(`Could not load command catalog: ${e.message}`,`error`)}try{On=await _.commands.social()}catch{}if(g(Dn))try{kn=await _.admin.pendingComments()}catch{kn=[]}else kn=[]}function Pn(e){let t=On.comments[e.key]||[];return`<div class="cmd-comments">${t.length?t.map(e=>`<div class="cmd-comment">
            <div class="cmd-comment-body"><strong>${M(e.username)}</strong><span>${M(e.body)}</span></div>
            ${g(Dn)?`<button class="btn btn-sm ghost danger" type="button" data-remove-comment="${e.id}">Remove</button>`:``}
          </div>`).join(``):`<p class="hint">No comments yet.</p>`}${Dn?`<form class="cmd-comment-form" data-comment-key="${M(e.key)}">
       ...
       <p class="hint">Comments are reviewed by an admin before appearing.</p>`:`<button class="btn btn-sm" data-open-auth="login">Log in to comment</button>`}</div>`}function Fn(e){let t=On.counts[e.key]||0,n=On.mine.includes(e.key),r=(On.comments[e.key]||[]).length,i=jn.has(e.key);return`
    <article class="cmd-card" data-search="${M(`${e.command} ${e.title} ${e.description}`.toLowerCase())}">
      ...
      ${i?Pn(e):``}
    </article>`}function In(e){let t=j.commands.filter(t=>t.category===e.id);return t.length?`
    <section class="cmd-category" data-category="${M(e.id)}">
      <h3 class="cmd-cat-title">${M(e.name)} <span class="cmd-count">${t.length}</span></h3>
      <div class="cmd-grid">${t.map(Fn).join(``)}</div>
    </section>`:``}function Ln(){let e=j.commands.filter(e=>e.isNew).length,t=g(Dn)?`<div class="actions">
    ...
    <section class="cmd-status-bar">
      <div>
        ...
        <strong>Last synced:</strong> ${Mn(j.lastSync)}
        ${e?` · <span class="nade-badge new">${e} new</span>`:``}
      </div>
      ${t}
    </section>`}function Rn(){return!g(Dn)||!kn.length?``:`
    <section class="cmd-review panel-review">
      <h3>Comments awaiting review (${kn.length})</h3>
      ${kn.map(e=>`<div class="review-comment">
    ...
    </section>`}function zn(){A.innerHTML=`
    <div class="commands-shell">
      ...
      ${j.categories.map(In).join(``)}
      <div id="commands-status" class="status ${An.kind}">${M(An.text)}</div>
    </div>`,Vn()}function Bn(e){let t=e.trim().toLowerCase();A.querySelectorAll(`.cmd-category`).forEach(e=>{let n=0;e.querySelectorAll(`.cmd-card`).forEach(e=>{let r=!t||e.dataset.search.includes(t);e.classList.toggle(`hidden`,!r),r&&(n+=1)}),e.classList.toggle(`hidden`,n===0)})}function Vn(){A.querySelectorAll(`[data-copy]`).forEach(e=>e.addEventListener(`click`,async()=>{try{await navigator.clipboard.writeText(e.dataset.copy),N(`Copied to clipboard.`,`ok`)}catch{N(`Clipboard blocked — select and copy manually.`,`error`)}})),A.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>qe(e.dataset.openAuth))),A.querySelectorAll(`[data-recommend]`).forEach(e=>e.addEventListener(`click`,()=>Hn(e.dataset.recommend))),A.querySelectorAll(`[data-toggle-comments]`).forEach(e=>e.addEventListener(`click`,()=>{let t=e.dataset.toggleComments;jn.has(t)?jn.delete(t):jn.add(t),zn()})),A.querySelectorAll(`.cmd-comment-form`).forEach(e=>e.addEventListener(`submit`,t=>{t.preventDefault(),Un(e.dataset.commentKey,e.querySelector(`input`))})),A.querySelectorAll(`[data-approve-comment]`).forEach(e=>e.addEventListener(`click`,()=>Wn(e.dataset.approveComment,`approved`))),A.querySelectorAll(`[data-reject-comment]`).forEach(e=>e.addEventListener(`click`,()=>Wn(e.dataset.rejectComment,`rejected`))),A.querySelectorAll(`[data-remove-comment]`).forEach(e=>e.addEventListener(`click`,()=>Gn(e.dataset.removeComment))),A.querySelector(`#cmd-search`)?.addEventListener(`input`,e=>Bn(e.target.value)),A.querySelector(`#cmd-sync`)?.addEventListener(`click`,Kn),A.querySelector(`#cmd-check-cs2`)?.addEventListener(`click`,qn)}async function Hn(e){if(!Dn){qe(`login`);return}try{let t=await _.commands.recommend(e);On.counts[e]=t.count,On.mine=t.recommended?[...On.mine.filter(t=>t!==e),e]:On.mine.filter(t=>t!==e),zn()}catch(e){N(e.message,`error`)}}async function Un(e,t){let n=(t?.value||``).trim();if(!n){N(`Write something first.`,`error`);return}try{await _.commands.addComment(e,n),N(`Comment submitted — an admin will review it before it appears.`,`ok`),t&&(t.value=``)}catch(e){N(e.message,`error`)}}async function Wn(e,t){try{await _.admin.reviewComment(e,t),await Nn(),zn(),N(`Comment ${t}.`,`ok`)}catch(e){N(e.message,`error`)}}async function Gn(e){if(confirm(`Permanently delete this comment?`))try{await _.admin.removeComment(e),await Nn(),zn(),N(`Comment deleted.`,`ok`)}catch(e){N(e.message,`error`)}}function Kn(){En({title:`Sync commands from the CS2 wiki`,description:`The Valve wiki has a bot check that blocks servers. Open it in your browser, complete the verification, then copy the page source (wikitext) and paste it here — the server will parse it.`,sourceUrl:`https://developer.valvesoftware.com/w/index.php?title=List_of_Counter-Strike_2_console_command_variables&action=raw`,sourceLabel:`Open CS2 wiki source`,placeholder:`Paste the wiki page source (wikitext), or a JSON list of commands…`,onImport:async e=>{let t=await _.admin.importCommands(e);return await Nn(),zn(),`Imported ${t.count} commands.`}})}async function qn(){N(`Checking the current CS2 build…`,``);try{let e=await _.admin.checkCommandsCs2();await Nn(),zn(),N(e.ok?`CS2 build ${e.build}${e.changed?` — changed, catalog re-synced`:` — no change`}.`:`Check failed: ${e.reason}`,e.ok?`ok`:`error`)}catch(e){N(e.message,`error`)}}async function Jn(){A=document.querySelector(`#commands-tool`),A&&(Dn=ke(),Ae(async e=>{Dn=e,await Nn(),zn()}),zn(),await Nn(),zn())}var P,F=null,Yn=null,Xn={paypalUrl:``,steamTradeUrl:``},Zn={text:``,kind:``};function I(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function L(e,t=``){Zn={text:e,kind:t};let n=P?.querySelector(`#profile-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function Qn(e){try{return new Date(e).toLocaleDateString()}catch{return`—`}}async function $n(){if(F){try{Yn=(await _.auth.profile()).stats}catch(e){L(e.message,`error`)}if(we(F))try{Xn=await _.settings.get()}catch{}}}function er(e,t){return`<div class="profile-stat"><dt>${I(e)}</dt><dd>${I(t)}</dd></div>`}function tr(){return we(F)?`
    <section class="panel profile-settings">
      ...
      <div class="profile-settings-body">
        ...
        <label class="field">
          ...
          <input id="set-paypal" type="url" placeholder="https://www.paypal.com/paypalme/yourname" value="${I(Xn.paypalUrl)}" />
        </label>
        <label class="field">
          <span>Steam trade link</span>
          <input id="set-steam" type="url" placeholder="https://steamcommunity.com/tradeoffer/new/?partner=...&token=..." value="${I(Xn.steamTradeUrl)}" />
        </label>
        <div class="actions">
          <button class="btn primary" id="set-save">Save donate links</button>
        </div>
      </div>
    </section>`:``}function nr(){if(!F){P.innerHTML=`<div class="profile-shell"><div class="login-prompt">
    ...
    </div></div>`,P.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>qe(e.dataset.openAuth)));return}let e=(F.username||`?`).charAt(0).toUpperCase(),t=Yn||{nadesTotal:0,nadesApproved:0,nadesPending:0,recommendations:0,comments:0};P.innerHTML=`
    <div class="profile-shell">
      <section class="panel profile-card">
        <div class="profile-head">
          ...
          <div>
            ...
            <p class="hint">${F.email?I(F.email):`No email set`} · member since ${Qn(F.createdAt)}</p>
        ...
        <dl class="profile-stats">
          ${er(`Nades submitted`,t.nadesTotal)}
          ${er(`Approved`,t.nadesApproved)}
          ${er(`Pending`,t.nadesPending)}
          ${er(`Commands recommended`,t.recommendations)}
          ${er(`Comments`,t.comments)}
        </dl>
      </section>
      ...
      ${tr()}
      <div id="profile-status" class="status ${Zn.kind}">${I(Zn.text)}</div>
    </div>`,P.querySelector(`#set-save`)?.addEventListener(`click`,ur),P.querySelector(`#pw-save`)?.addEventListener(`click`,ir),P.querySelector(`#username-save`)?.addEventListener(`click`,or),P.querySelector(`#cred-save`)?.addEventListener(`click`,sr),P.querySelector(`#steam-link`)?.addEventListener(`click`,cr),P.querySelector(`#steam-unlink`)?.addEventListener(`click`,lr);let n=P.querySelector(`#avatar-file`);P.querySelector(`#avatar-upload`)?.addEventListener(`click`,()=>n?.click()),n?.addEventListener(`change`,e=>rr(e.target.files?.[0])),P.querySelector(`#avatar-remove`)?.addEventListener(`click`,ar)}async function rr(e){if(e){L(`Uploading image…`,``);try{await _.auth.uploadAvatar(e),await je(),L(`Profile image updated.`,`ok`)}catch(e){L(e.message,`error`)}}}async function ir(){let e=P.querySelector(`#pw-current`)?.value||``,t=P.querySelector(`#pw-new`)?.value||``;try{await _.auth.changePassword({currentPassword:e,newPassword:t}),P.querySelector(`#pw-current`).value=``,P.querySelector(`#pw-new`).value=``,L(`Password updated.`,`ok`)}catch(e){L(e.message,`error`)}}async function ar(){try{await _.auth.setAvatar(``),await je(),L(`Profile image removed.`,`ok`)}catch(e){L(e.message,`error`)}}async function or(){let e=P.querySelector(`#acc-username`)?.value||``;try{await _.auth.changeUsername(e),await je(),L(`Username updated.`,`ok`)}catch(e){L(e.message,`error`)}}async function sr(){let e=P.querySelector(`#cred-email`)?.value||``,t=P.querySelector(`#cred-password`)?.value||``;try{await _.auth.setCredentials({email:e,password:t}),await je(),L(`Email & password saved — you can now log in without Steam.`,`ok`)}catch(e){L(e.message,`error`)}}async function cr(){try{let e=await _.auth.steamLinkUrl();window.location.href=e}catch(e){L(e.message,`error`)}}async function lr(){try{await _.auth.steamUnlink(),await je(),L(`Steam unlinked.`,`ok`)}catch(e){L(e.message,`error`)}}async function ur(){let e=P.querySelector(`#set-paypal`)?.value||``,t=P.querySelector(`#set-steam`)?.value||``;try{Xn=await _.admin.saveSettings({paypalUrl:e,steamTradeUrl:t}),L(`Donate links saved.`,`ok`),document.dispatchEvent(new CustomEvent(`aimkit:settings-updated`))}catch(e){L(e.message,`error`)}}async function dr(){P=document.querySelector(`#profile-tool`),P&&(F=ke(),Ae(async e=>{F=e,await $n(),nr()}),nr(),await $n(),nr())}var R,fr=null,pr=[],mr=`top`,hr=!1,gr={text:``,kind:``},_r=new Set;function vr(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function yr(e,t=``){gr={text:e,kind:t};let n=R?.querySelector(`#configs-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function br(e){try{return new Date(e).toLocaleDateString()}catch{return``}}function xr(e,t){let n=new Blob([t],{type:`text/plain`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=e,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r)}async function Sr(){try{pr=await _.configs.list({sort:mr})}catch(e){yr(e.message,`error`)}Dr()}function Cr(e){let t=Math.round(e),n=``;for(let e=1;e<=5;e+=1)n+=e<=t?`★`:`☆`;return n}function wr(e){if(!fr)return`<button class="btn btn-sm" data-open-auth="login">Log in to rate</button>`;if(e.authorId===fr.id)return`<span class="hint">Your upload</span>`;let t=``;for(let n=1;n<=5;n+=1)t+=`<button class="star-btn ${n<=e.myRating?`on`:``}" data-rate="${e.id}" data-star="${n}" title="${n} star${n>1?`s`:``}">${n<=e.myRating?`★`:`☆`}</button>`;return`<span class="rate-label">Your rating:</span><span class="star-picker">${t}</span>`}function Tr(e){let t=_r.has(e.id),n=fr&&(e.authorId===fr.id||g(fr));return`
    <article class="config-card" data-search="${vr(`${e.title} ${e.description} ${e.authorName}`.toLowerCase())}">
      <div class="config-head">
        <h3>${vr(e.title)}</h3>
        <div class="config-rating" title="${e.avgRating} from ${e.ratingCount} rating(s)">
          <span class="stars">${Cr(e.avgRating)}</span>
          <span class="rating-num">${e.avgRating||`—`} (${e.ratingCount})</span>
        </div>
      </div>
      ${e.description?`<p class="config-desc">${vr(e.description)}</p>`:``}
      ...
      ${t?`<div class="config-view">
               ${e.hasConfig?`<div><strong>Config</strong><pre>${vr(e.configText)}</pre></div>`:``}
               ${e.hasVideo?`<div><strong>Video settings</strong><pre>${vr(e.videoText)}</pre></div>`:``}
             </div>`:``}
      <div class="config-foot">
        <span>by ${vr(e.authorName)} · ${br(e.createdAt)}</span>
        <span class="config-rate">${wr(e)}</span>
      </div>
    </article>`}function Er(){return!fr||!hr?``:`
    ...
    </section>`}function Dr(){R.innerHTML=`
    <div class="configs-shell">
      <div class="configs-controls">
        <div class="sort-tabs">
          <button class="tool-tab ${mr===`top`?`active`:``}" data-sort="top">Most rated</button>
          <button class="tool-tab ${mr===`new`?`active`:``}" data-sort="new">Last uploaded</button>
        </div>
        <input id="cfg-search" type="search" class="cfg-search" placeholder="Search configs by title, author…" />
        ${fr?`<button class="btn primary" id="cfg-new">Upload config</button>`:`<button class="btn primary" data-open-auth="login">Log in to upload</button>`}
      </div>
      ${Er()}
      <div class="config-grid">
        ${pr.length?pr.map(Tr).join(``):`<p class="hint">No configs yet — be the first to upload one!</p>`}
      </div>
      <div id="configs-status" class="status ${gr.kind}">${vr(gr.text)}</div>
    </div>`,kr()}function Or(e){let t=e.trim().toLowerCase();R.querySelectorAll(`.config-card`).forEach(e=>{e.classList.toggle(`hidden`,t&&!e.dataset.search.includes(t))})}function kr(){R.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>qe(e.dataset.openAuth))),R.querySelectorAll(`[data-sort]`).forEach(e=>e.addEventListener(`click`,()=>{mr=e.dataset.sort,Sr()})),R.querySelector(`#cfg-search`)?.addEventListener(`input`,e=>Or(e.target.value)),R.querySelector(`#cfg-new`)?.addEventListener(`click`,()=>{hr=!0,Dr()}),R.querySelector(`#cfg-cancel`)?.addEventListener(`click`,()=>{hr=!1,Dr()}),R.querySelector(`#cfg-submit`)?.addEventListener(`click`,Mr),R.querySelector(`#cfg-config-file`)?.addEventListener(`change`,e=>jr(e.target,`#cfg-config`)),R.querySelector(`#cfg-video-file`)?.addEventListener(`change`,e=>jr(e.target,`#cfg-video`)),R.querySelectorAll(`[data-dl]`).forEach(e=>e.addEventListener(`click`,()=>{let t=pr.find(t=>String(t.id)===e.dataset.dl);t&&(e.dataset.kind===`config`?xr(`${Ar(t.title)}.cfg`,t.configText):xr(`cs2_video.txt`,t.videoText))})),R.querySelectorAll(`[data-view]`).forEach(e=>e.addEventListener(`click`,()=>{let t=Number(e.dataset.view);_r.has(t)?_r.delete(t):_r.add(t),Dr()})),R.querySelectorAll(`[data-del]`).forEach(e=>e.addEventListener(`click`,()=>Pr(Number(e.dataset.del)))),R.querySelectorAll(`[data-rate]`).forEach(e=>e.addEventListener(`click`,()=>Nr(Number(e.dataset.rate),Number(e.dataset.star))))}function Ar(e){return(e||`config`).toLowerCase().replace(/[^a-z0-9]+/g,`_`).replace(/^_|_$/g,``).slice(0,40)||`config`}function jr(e,t){let n=e.files?.[0];if(!n)return;let r=new FileReader;r.onload=()=>{let e=R.querySelector(t);e&&(e.value=String(r.result||``))},r.readAsText(n)}async function Mr(){let e=R.querySelector(`#cfg-title`)?.value||``,t=R.querySelector(`#cfg-desc`)?.value||``,n=R.querySelector(`#cfg-config`)?.value||``,r=R.querySelector(`#cfg-video`)?.value||``;try{await _.configs.create({title:e,description:t,configText:n,videoText:r}),hr=!1,mr=`new`,await Sr(),yr(`Config published!`,`ok`)}catch(e){yr(e.message,`error`)}}async function Nr(e,t){try{let n=await _.configs.rate(e,t),r=pr.find(t=>t.id===e);r&&(r.avgRating=n.avgRating,r.ratingCount=n.ratingCount,r.myRating=n.myRating),Dr(),yr(`Thanks for rating!`,`ok`)}catch(e){yr(e.message,`error`)}}async function Pr(e){try{await _.configs.remove(e),await Sr(),yr(`Config deleted.`,`ok`)}catch(e){yr(e.message,`error`)}}async function Fr(){R=document.querySelector(`#configs-tool`),R&&(fr=ke(),Ae(async e=>{fr=e,await Sr()}),Dr(),await Sr())}var z,B=null,Ir=[],Lr=[],Rr={text:``,kind:``},zr=!1,Br=null;function V(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Vr(e,t=``){Rr={text:e,kind:t};let n=z?.querySelector(`#highlights-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function Hr(e){try{return new Date(e).toLocaleDateString()}catch{return``}}function Ur(e){let t=/(?:youtube\.com\/(?:watch\?v=|embed\/|shorts\/)|youtu\.be\/)([\w-]{6,})/.exec(e||``);return t?t[1]:null}function Wr(e){return/^https?:\/\//.test(e||``)?e:``}function Gr(e){let t=Wr(e);if(!t)return``;let n=Ur(e);return n?`<iframe class="hl-embed" src="https://www.youtube.com/embed/${V(n)}" title="highlight" allowfullscreen loading="lazy"></iframe>`:/\.(mp4|webm|mov)(\?|$)/i.test(e)?`<video class="hl-embed" src="${V(t)}" controls preload="none"></video>`:`<a class="btn ghost" href="${V(t)}" target="_blank" rel="noopener noreferrer">Open highlight ↗</a>`}async function Kr(){try{Ir=await _.highlights.list({}),Lr=g(B)?await _.admin.highlightReports():[]}catch(e){Vr(e.message,`error`)}Xr()}function qr(){return!g(B)||!Lr.length?``:`
    <section class="panel panel-review">
      <h3>Reported highlights (${Lr.length})</h3>
      ${Lr.map(e=>`<div class="report-item">
            <div class="report-media">${Gr(e.url)}</div>
    ...
    </article>`}function Yr(){return!B||!zr?``:`
    <section class="panel config-upload">
    ...
    </section>`}function Xr(){z.innerHTML=`
    <div class="highlights-shell">
      ...
      ${Yr()}
      <div class="hl-grid">
        ${Ir.length?Ir.map(Jr).join(``):`<p class="hint">No highlights yet — share the first one!</p>`}
      </div>
      <div id="highlights-status" class="status ${Rr.kind}">${V(Rr.text)}</div>
    </div>`,Qr()}function Zr(e){let t=e.trim().toLowerCase();z.querySelectorAll(`.hl-card`).forEach(e=>{e.classList.toggle(`hidden`,t&&!e.dataset.search.includes(t))})}function Qr(){z.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>qe(e.dataset.openAuth))),z.querySelector(`#hl-search`)?.addEventListener(`input`,e=>Zr(e.target.value)),z.querySelector(`#hl-new`)?.addEventListener(`click`,()=>{zr=!0,Xr()}),z.querySelector(`#hl-cancel`)?.addEventListener(`click`,()=>{zr=!1,Xr()}),z.querySelector(`#hl-submit`)?.addEventListener(`click`,$r),z.querySelectorAll(`[data-report]`).forEach(e=>e.addEventListener(`click`,()=>{Br=Number(e.dataset.report),Xr()})),z.querySelector(`[data-cancel-report]`)?.addEventListener(`click`,()=>{Br=null,Xr()}),z.querySelector(`[data-report-form]`)?.addEventListener(`submit`,e=>{e.preventDefault(),ei(Number(e.currentTarget.dataset.reportForm),e.currentTarget.querySelector(`input`).value)}),z.querySelectorAll(`[data-del]`).forEach(e=>e.addEventListener(`click`,()=>ti(Number(e.dataset.del)))),z.querySelectorAll(`[data-keep]`).forEach(e=>e.addEventListener(`click`,()=>ni(Number(e.dataset.keep),`keep`))),z.querySelectorAll(`[data-remove-hl]`).forEach(e=>e.addEventListener(`click`,()=>ni(Number(e.dataset.removeHl),`delete`)))}async function $r(){let e=z.querySelector(`#hl-title`)?.value||``,t=z.querySelector(`#hl-desc`)?.value||``,n=z.querySelector(`#hl-url`)?.value||``;try{await _.highlights.create({title:e,description:t,url:n}),zr=!1,await Kr(),Vr(`Highlight shared!`,`ok`)}catch(e){Vr(e.message,`error`)}}async function ei(e,t){try{await _.highlights.report(e,t),Br=null,await Kr(),Vr(`Thanks — an admin will review your report.`,`ok`)}catch(e){Vr(e.message,`error`)}}async function ti(e){try{await _.highlights.remove(e),await Kr(),Vr(`Highlight deleted.`,`ok`)}catch(e){Vr(e.message,`error`)}}async function ni(e,t){try{await _.admin.reviewHighlight(e,t),await Kr(),Vr(t===`delete`?`Highlight removed.`:`Reports cleared — highlight kept.`,`ok`)}catch(e){Vr(e.message,`error`)}}async function ri(){z=document.querySelector(`#highlights-tool`),z&&(B=ke(),Ae(async e=>{B=e,await Kr()}),Xr(),await Kr())}var H,ii=null,ai={pros:[],source:`seed`,lastSync:0},oi=`featured`,si=``,ci=null,li={text:``,kind:``};function U(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function ui(e,t=``){li={text:e,kind:t};let n=H?.querySelector(`#pros-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}async function di(){try{ai=await _.pros.list({sort:oi,q:si})}catch(e){ui(e.message,`error`)}vi()}var fi={"natus vincere":`#f4d000`,vitality:`#f5d20a`,falcons:`#0aa14f`,"team spirit":`#c8102e`,astralis:`#e4002b`,faze:`#e43b26`,g2:`#c8102e`};function pi(e){return fi[(e||``).toLowerCase()]||`#33415a`}function mi(e){let t=(e.team||e.player||`?`).trim(),n=t.split(/\s+/);return(n.length>1?n.slice(0,3).map(e=>e[0]).join(``):t.slice(0,2)).toUpperCase()}function hi(e){let t=e.photo||e.teamLogo||``,n=e.photo&&e.teamLogo?e.teamLogo:``,r=t?`<img class="pro-img" alt="${U(e.player)}" loading="lazy" src="${U(t)}"${n?` data-logo="${U(n)}"`:``} onerror="if(this.dataset.logo){this.src=this.dataset.logo;this.removeAttribute('data-logo');}else{this.remove();}" />`:``;return`<div class="pro-photo" style="--team:${pi(e.team)}"><span class="pro-monogram">${U(mi(e))}</span>${r}</div>`}function gi(e,t){return`<div class="pro-stat"><dt>${U(e)}</dt><dd>${t!=null&&t!==``?U(t):`—`}</dd></div>`}function _i(e){return`
    <article class="pro-card" data-search="${U(`${e.player} ${e.team||``}`.toLowerCase())}">
      ...
      <dl class="pro-stats">
        ...
        ${gi(`Zoom`,e.zoomSens)}
        ${gi(`Hz`,e.hz)}
        ${gi(`Resolution`,e.resolution)}
        ${gi(`Aspect`,e.aspectRatio)}
      </dl>
    </article>`}function vi(){let e=g(ii)?`<div class="pros-admin-actions">
    ...
    <div class="pros-shell">
      <div class="cmd-status-bar">
        <div><strong>Source:</strong> ${U(ai.source)} · <strong>${ai.pros.length}</strong> players${ai.lastSync?` · synced ${U(new Date(ai.lastSync).toLocaleDateString())}`:``}</div>
        ${e}
      </div>
      <div class="configs-controls">
        <div class="sort-tabs">
          <button class="tool-tab ${oi===`featured`?`active`:``}" data-sort="featured">Featured</button>
          <button class="tool-tab ${oi===`name`?`active`:``}" data-sort="name">Name</button>
          <button class="tool-tab ${oi===`edpi`?`active`:``}" data-sort="edpi">Lowest eDPI</button>
          <button class="tool-tab ${oi===`edpi-desc`?`active`:``}" data-sort="edpi-desc">Highest eDPI</button>
        </div>
        <input id="pros-search" type="search" class="cfg-search" placeholder="Search player or team…" value="${U(si)}" />
      </div>
      <p class="hint">${ai.source===`prosettings`?`Live from prosettings.net.`:ai.source===`seed`?`Built-in list. Admins can sync live data from prosettings.net.`:`Source: ${U(ai.source)}.`}</p>
      <div class="pro-grid">
        ${ai.pros.length?ai.pros.map(_i).join(``):`<p class="hint">No pro settings yet.</p>`}
      </div>
      <div id="pros-status" class="status ${li.kind}">${U(li.text)}</div>
    </div>`,yi()}function yi(){H.querySelectorAll(`[data-sort]`).forEach(e=>e.addEventListener(`click`,()=>{oi=e.dataset.sort,di()}));let e=H.querySelector(`#pros-search`);e&&e.addEventListener(`input`,e=>{si=e.target.value,clearTimeout(ci),ci=setTimeout(async()=>{await di();let e=H.querySelector(`#pros-search`);e&&(e.focus(),e.setSelectionRange(e.value.length,e.value.length))},300)}),H.querySelector(`#pros-sync`)?.addEventListener(`click`,bi),H.querySelector(`#pros-import`)?.addEventListener(`click`,xi)}async function bi(){let e=H.querySelector(`#pros-sync`);e&&(e.disabled=!0),ui(`Syncing from prosettings.net…`,``);try{let e=await _.admin.syncPros();await di(),e.synced?ui(`Synced ${e.count} players from ${e.source}.`,`ok`):ui(`Sync failed: ${e.reason||`unknown error`}. Kept the current list.`,`error`)}catch(e){ui(e.message,`error`)}finally{let e=H.querySelector(`#pros-sync`);e&&(e.disabled=!1)}}function xi(){En({title:`Import pro settings from HLTV`,description:`HLTV has a Cloudflare check that blocks servers. Open HLTV in your browser, complete the verification, then paste a JSON list of players here. Each item: {"player","team","dpi","sens","zoomSens","hz","resolution","aspectRatio","photo","teamLogo"}.`,sourceUrl:`https://www.hltv.org/stats/players`,sourceLabel:`Open HLTV`,placeholder:`[{"player":"s1mple","team":"Natus Vincere","dpi":400,"sens":3.09,"hz":1000,"resolution":"1280x960","aspectRatio":"4:3"}]`,onImport:async e=>{let t=await _.admin.importPros(e);return await di(),`Imported ${t.count} players.`}})}async function Si(){H=document.querySelector(`#pros-tool`),H&&(ii=ke(),Ae(e=>{ii=e,vi()}),vi(),await di())}var W,G=null,Ci=`overview`,wi={text:``,kind:``},Ti={nades:0,comments:0,reports:0},K={},Ei=[{id:`overview`,label:`Overview`},{id:`nades`,label:`Nades`},{id:`comments`,label:`Comments`},{id:`reports`,label:`Reports`},{id:`users`,label:`Users`},{id:`sync`,label:`Data sync`},{id:`contact`,label:`Contact`},{id:`logs`,label:`Logs`,ownerOnly:!0},{id:`settings`,label:`Site settings`,ownerOnly:!0}];function q(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Di(e,t=``){wi={text:e,kind:t};let n=W?.querySelector(`#admin-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function Oi(e){try{return new Date(e).toLocaleString()}catch{return`—`}}async function ki(){try{let[e,t,n]=await Promise.all([_.admin.pendingCount().catch(()=>0),_.admin.pendingCommentsCount().catch(()=>0),_.admin.highlightReportsCount().catch(()=>0)]);Ti={nades:e,comments:t,reports:n}}catch{}}function Ai(){let e=(e,t,n)=>`<button class="admin-stat" data-goto="${n}">
       <span class="admin-stat-num">${t}</span>
       <span class="admin-stat-label">${q(e)}</span>
     </button>`;return`
    <div class="admin-stats">
      ${e(`Nades to review`,Ti.nades,`nades`)}
      ${e(`Comments to review`,Ti.comments,`comments`)}
      ${e(`Highlight reports`,Ti.reports,`reports`)}
    </div>
    <p class="hint">Use the tabs above to moderate content, manage users, sync data sources, and read contact messages.</p>`}function ji(){let e=K.nades||[];return e.length?`
    <div class="review-bulk-bar">
      <label class="review-select-all">
    ...
    ${e.map(e=>{let t=(e.media||[]).map(e=>`
        ...
        </article>`}).join(``)}`:`<p class="hint">Nothing pending. All nades are reviewed.</p>`}function Mi(){let e=K.comments||[];return e.length?e.map(e=>`
      <article class="panel admin-item">
        <p>${q(e.body)}</p>
        <p class="hint">by ${q(e.username)} on <code>${q(e.commandKey)}</code> · ${Oi(e.createdAt)}</p>
        <div class="actions">
      ...
      </article>`).join(``):`<p class="hint">No comments pending review.</p>`}function Ni(){let e=K.reports||[];return e.length?e.map(e=>{let t=(e.reports||[]).map(e=>`<li>${q(e.reason||`No reason`)} — <span class="hint">${q(e.reporterName||`?`)}</span></li>`).join(``);return`
        <article class="panel admin-item">
          <div class="admin-item-head">
    ...
    <div class="admin-users">${r}</div>`}function Fi(){return`
    <div class="admin-sync">
    ...
    </div>`}function Ii(){let e=K.contact||[];return e.length?e.map(e=>`
      <article class="panel admin-item">
        <div class="admin-item-head">
          <strong>${q(e.subject||`(no subject)`)}</strong>
          <span class="hint">${Oi(e.created_at)}</span>
        </div>
      ...
      </article>`).join(``):`<p class="hint">No contact messages.</p>`}function Li(){let e=K.settings||{paypalUrl:``,steamTradeUrl:``};return`
    <div class="panel admin-item">
    ...
    <div class="admin-logs">${i}</div>`}var zi={overview:Ai,nades:ji,comments:Mi,reports:Ni,users:Pi,sync:Fi,contact:Ii,logs:Ri,settings:Li};async function Bi(e){try{e===`overview`?await ki():e===`nades`?K.nades=await _.admin.pending():e===`comments`?K.comments=await _.admin.pendingComments():e===`reports`?K.reports=await _.admin.highlightReports():e===`users`?K.users=await _.admin.users():e===`contact`?K.contact=await _.admin.contactMessages():e===`logs`?K.logs=await _.admin.ownerLogs({action:K.logsFilter||``}):e===`settings`&&(K.settings=await _.settings.get())}catch(e){Di(e.message,`error`)}}function Vi(){if(!W)return;if(!g(G)){W.innerHTML=`<div class="admin-shell"><div class="login-prompt">
    ...
    </div></div>`,W.querySelector(`[data-open-auth]`)?.addEventListener(`click`,()=>qe(`login`));return}(Ci===`logs`||Ci===`settings`)&&!we(G)&&(Ci=`overview`);let e=Ei.filter(e=>!e.ownerOnly||we(G)).map(e=>`<button class="tool-tab ${Ci===e.id?`active`:``}" data-section="${e.id}">${q(e.label)}${e.id===`nades`&&Ti.nades?` (${Ti.nades})`:``}${e.id===`comments`&&Ti.comments?` (${Ti.comments})`:``}${e.id===`reports`&&Ti.reports?` (${Ti.reports})`:``}</button>`).join(``),t=(zi[Ci]||Ai)();W.innerHTML=`
    ...
    <div class="modal-card" role="dialog" aria-modal="true" aria-label="Contact us">
      ...
      <form id="contact-form" class="auth-form-modal">
        <label class="field"><span>Your name</span><input id="contact-name" type="text" value="${Ki(e?.username||``)}" /></label>
        <label class="field"><span>Your email</span><input id="contact-email" type="email" value="${Ki(e?.email||``)}" /></label>
...
`;var ua=document.querySelector(`#preview-canvas`),da=document.querySelector(`#preview-stats`),fa=document.querySelector(`#preview-res`),pa=document.querySelector(`#preview-res-scale`),ma=`ingame`;function ha(){let e=ma===`fullscreen`?1080:280;ua.width!==e&&(ua.width=e,ua.height=e),ua.style.imageRendering=ma===`fullscreen`?`auto`:`pixelated`}ha();var ga=[{id:`1920x1080`,h:1080,label:`1920 × 1080 (16:9)`},{id:`2560x1440`,h:1440,label:`2560 × 1440 (16:9)`},{id:`3840x2160`,h:2160,label:`3840 × 2160 (4K)`},{id:`1600x900`,h:900,label:`1600 × 900 (16:9)`},{id:`1366x768`,h:768,label:`1366 × 768 (16:9)`},{id:`1280x960`,h:960,label:`1280 × 960 (4:3)`},{id:`1024x768`,h:768,label:`1024 × 768 (4:3)`},{id:`1280x1024`,h:1024,label:`1280 × 1024 (5:4)`}],_a=null;function va(){return ma===`fullscreen`?ua.height/1080:(ga.find(e=>e.id===fa?.value)||ga[0]).h/1080}var ya=Qi({source:ua,stage:document.querySelector(`.preview-stage`),toggleBtn:document.querySelector(`#magnifier-toggle`),zoomSelect:document.querySelector(`#magnifier-zoom`)});function ba(e){if(_a=e,Zi(ua,e,va()),pa)if(e){let t=ga.find(e=>e.id===fa?.value)||ga[0],n=t.h/1080;pa.textContent=`≈ ${Math.max(0,Math.round(e.length*n))}px arms · ${Math.max(1,Math.round(e.thickness*n))}px thick @ ${t.h}p`}else pa.textContent=``;ya.refresh()}function xa(e){ma=e===`fullscreen`?`fullscreen`:`ingame`,ha(),document.querySelectorAll(`.pmode`).forEach(e=>{let t=e.dataset.pmode===ma;e.classList.toggle(`active`,t),e.setAttribute(`aria-selected`,String(t))});let t=document.querySelector(`#preview-mode-tag`);t&&(t.textContent=ma===`fullscreen`?`Relative to full screen`:`Actual in-game size`),ba(_a)}document.querySelectorAll(`.pmode`).forEach(e=>e.addEventListener(`click`,()=>xa(e.dataset.pmode)));var X=document.querySelector(`#crosshair-status`),Sa=document.querySelector(`#sensitivity-status`),Ca=document.querySelector(`#sharecode-input`),wa=document.querySelector(`#commands-output`),Ta=document.querySelector(`#commands-input`),Ea=document.querySelector(`#sharecode-output`),Da=document.querySelector(`#sens-from-game`),Oa=document.querySelector(`#sens-to-game`),ka=document.querySelector(`#sens-source`),Aa=document.querySelector(`#sens-target`),ja=document.querySelector(`#sens-source-dpi`),Ma=document.querySelector(`#sens-target-dpi`),Na=document.querySelector(`#sens-source-myaw`),Pa=document.querySelector(`#sens-target-myaw`),Fa=document.querySelector(`#sens-source-yaw`),Ia=document.querySelector(`#sens-target-yaw`),La=document.querySelector(`#source-yaw-field`),Ra=document.querySelector(`#target-yaw-field`),za=document.querySelector(`#m-yaw-fields`),Ba=document.querySelector(`#sens-cm360`),Va=document.querySelector(`#sens-stats`),Ha=document.querySelector(`#sens-formula`),Ua=`CSGO-UseJt-3oTvn-47wPX-hEyER-WZfiK`,Wa=`cl_crosshairstyle 4
cl_crosshairsize 3
cl_crosshairgap -2
...
cl_crosshair_recoil 0`;function Z(e,t,n=``){e&&(e.textContent=t,e.className=`status${n?` ${n}`:``}`)}function Ga(e){ba(e),da.innerHTML=`
  ...
  `}function Ka(e){return e.trim().replace(/\s+/g,``).replace(/^csgo/i,`CSGO`)}function qa(){let e=Ca.value.trim();if(!e){Z(X,`Paste a crosshair share code first.`,`error`);return}let t=Ka(e);if(!oa.test(t)){Z(X,`Invalid format. Expected CSGO-xxxxx-xxxxx-xxxxx-xxxxx-xxxxx`,`error`);return}try{let e=d(t);Ca.value=t,wa.value=se(ee(e)),Ga(e),Z(X,`Converted share code to console commands.`,`ok`)}catch(e){e instanceof i||e instanceof r?Z(X,`That share code is not a valid crosshair code.`,`error`):Z(X,e instanceof Error?e.message:`Failed to decode share code.`,`error`)}}function Ja(){let e=Ta.value.trim();if(!e){Z(X,`Paste crosshair console commands first.`,`error`);return}try{let t=oe(e);Ea.value=f(t),Ga(t),Z(X,`Converted commands to share code.`,`ok`)}catch(e){Z(X,e instanceof Error?e.message:`Failed to encode share code.`,`error`)}}async function Ya(e,t,n){if(!t){Z(e,`Nothing to copy for ${n}.`,`error`);return}try{await navigator.clipboard.writeText(t),Z(e,`Copied ${n} to clipboard.`,`ok`)}catch{Z(e,`Clipboard access failed. Select and copy manually.`,`error`)}}function Xa(){let e=$i[Da.value]?.supportsMYaw||$i[Oa.value]?.supportsMYaw;za?.classList.toggle(`hidden`,!e),La?.classList.toggle(`hidden`,!$i[Da.value]?.custom),Ra?.classList.toggle(`hidden`,!$i[Oa.value]?.custom)}function Za(){let e=Number(ka.value),t=Number(ja.value),n=Number(Ma.value),r=Number(Na.value)||.022,i=Number(Pa.value)||.022,a=Number(Fa.value),o=Number(Ia.value);if(Xa(),$i[Da.value]?.custom&&!(a>0)){Z(Sa,`Enter a valid source custom yaw (° per count).`,`error`);return}if($i[Oa.value]?.custom&&!(o>0)){Z(Sa,`Enter a valid target custom yaw (° per count).`,`error`);return}if(!Number.isFinite(e)||e<=0){Aa.value=``,Ba.textContent=`—`,Va.innerHTML=``,Ha.textContent=``;return}if(!Number.isFinite(t)||t<=0||!Number.isFinite(n)||n<=0){Z(Sa,`Enter valid DPI values.`,`error`);return}let s=ra({sourceGame:Da.value,targetGame:Oa.value,sourceSens:e,sourceDpi:t,targetDpi:n,sourceMYaw:r,targetMYaw:i,sourceCustomYaw:a,targetCustomYaw:o}),c=$i[Da.value].name,l=$i[Oa.value].name,u=Y(s.targetSensitivity);Aa.value=u,Ba.textContent=ia(s.cm360),Va.innerHTML=`
    <div><dt>Inches / 360°</dt><dd>${ia(s.inches360)} in</dd></div>
    <div><dt>Source eDPI</dt><dd>${ia(s.sourceEdpi,0)}</dd></div>
    <div><dt>Target eDPI</dt><dd>${ia(s.targetEdpi,0)}</dd></div>
  ...
  `,Z(Sa,`${c} → ${l}: ${u}`,`ok`)}function Qa(){let e=Da.value;Da.value=Oa.value,Oa.value=e,Aa.value&&(ka.value=Aa.value),Za()}function $a(){Da.value=`cs2`,Oa.value=`valorant`,ka.value=`1.25`,ja.value=`800`,Ma.value=`800`,Za()}var eo={crosshair:`Convert a crosshair share code into console commands, build a code from commands, or design one visually with a live preview.`,sensitivity:`Keep the same cm/360 aim feel across games — with custom yaw values and DPI changes handled for you.`,psa:`Dial in your ideal sensitivity with a guided 7-round A/B test (Perfect Sensitivity Approximation).`,nades:`Browse community grenade line-ups, or sign in to submit your own with a 2D throw guide, videos and photos.`,commands:`Copy up-to-date CS2 launch options and console commands, recommend the ones that help, and share tips in the comments.`,configs:`Share your CS2 configs and video settings, download other players’ setups, and rate the best ones.`,highlights:`Share your best CS2 clips, watch the community’s highlights, and report anything that breaks the rules.`,pros:`Browse pro players’ sensitivity, DPI, resolution and crosshair settings.`,profile:`Your account, contributions, and settings.`,admin:`Moderate content, manage users, sync data sources, and read contact messages.`},to=document.querySelector(`#tool-desc`);function no(e){to&&(to.textContent=eo[e]||``)}function ro(e){document.querySelectorAll(`.tool-nav .tool-tab`).forEach(t=>{let n=t.getAttribute(`data-tool`)===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,String(n))}),document.querySelectorAll(`.tool-view`).forEach(t=>{t.classList.toggle(`active`,t.id===`${e}-tool`)}),no(e),window.scrollTo({top:0,behavior:`smooth`})}document.querySelectorAll(`.tool-nav .tool-tab`).forEach(e=>{e.addEventListener(`click`,()=>ro(e.getAttribute(`data-tool`)))}),document.addEventListener(`aimkit:navigate`,e=>ro(e.detail)),no(`crosshair`),document.querySelectorAll(`.converter-panel .tab`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-tab`);document.querySelectorAll(`.converter-panel .tab`).forEach(e=>{let n=e.getAttribute(`data-tab`)===t;e.classList.toggle(`active`,n),e.setAttribute(`aria-selected`,String(n))}),document.querySelectorAll(`.converter-panel .tab-panel`).forEach(e=>{e.classList.toggle(`active`,e.getAttribute(`data-panel`)===t)})})}),document.querySelector(`#decode-btn`)?.addEventListener(`click`,qa),document.querySelector(`#encode-btn`)?.addEventListener(`click`,Ja),Ca.addEventListener(`keydown`,e=>{e.key===`Enter`&&qa()}),Ta.addEventListener(`input`,()=>{let e=Ta.value.trim();if(!e){ba(null),da.innerHTML=``;return}try{Ga(oe(e))}catch{}}),Ca.addEventListener(`input`,()=>{let e=Ka(Ca.value);if(oa.test(e))try{Ga(d(e))}catch{}}),document.querySelector(`#copy-commands`)?.addEventListener(`click`,()=>{Ya(X,wa.value,`commands`)}),document.querySelector(`#copy-code`)?.addEventListener(`click`,()=>{Ya(X,Ea.value,`share code`)}),document.querySelector(`#copy-sharecode-cmd`)?.addEventListener(`click`,()=>{let e=Ka(Ca.value);if(!e){Z(X,`Enter a share code first.`,`error`);return}Ya(X,`cl_crosshair_sharecode "${e}"`,`import command`)}),document.querySelector(`#load-example-code`)?.addEventListener(`click`,()=>{Ca.value=Ua,qa()}),document.querySelector(`#load-example-cmd`)?.addEventListener(`click`,()=>{Ta.value=Wa,Ja()});var io={0:[255,255,255],1:[50,250,50],2:[255,255,0],3:[50,50,250],4:[50,250,250]},Q={...ne},ao=document.querySelector(`#ed-style`),oo=document.querySelector(`#ed-color`),so=document.querySelector(`#ed-custom-color`),co=document.querySelector(`#ed-custom-color-field`),lo=document.querySelector(`#ed-r`),uo=document.querySelector(`#ed-g`),fo=document.querySelector(`#ed-b`),po=document.querySelector(`#ed-rgb-val`),mo=document.querySelector(`#ed-color-swatch`);function ho(e,t){e&&document.activeElement!==e&&(e.value=String(t))}var go=document.querySelector(`#ed-length`),_o=document.querySelector(`#ed-thickness`),vo=document.querySelector(`#ed-gap`),yo=document.querySelector(`#ed-outline`),bo=document.querySelector(`#ed-alpha`),xo=document.querySelector(`#ed-dot`),So=document.querySelector(`#ed-tstyle`),Co=document.querySelector(`#ed-outline-on`),wo=document.querySelector(`#ed-alpha-on`),To=document.querySelector(`#ed-sharecode`),Eo=document.querySelector(`#ed-commands`),Do=document.querySelector(`#ed-length-num`),Oo=document.querySelector(`#ed-thickness-num`),ko=document.querySelector(`#ed-gap-num`),Ao=document.querySelector(`#ed-outline-num`),jo=document.querySelector(`#ed-alpha-num`),Mo=document.querySelector(`#ed-r-num`),No=document.querySelector(`#ed-g-num`),Po=document.querySelector(`#ed-b-num`),Fo=(e,t,n)=>Math.max(t,Math.min(n,e)),Io=[{key:`length`,slider:go,num:Do,min:0,max:15},{key:`thickness`,slider:_o,num:Oo,min:0,max:6},{key:`gap`,slider:vo,num:ko,min:-10,max:10},{key:`outline`,slider:yo,num:Ao,min:0,max:3},{key:`alpha`,slider:bo,num:jo,min:0,max:255}],Lo=[{key:`red`,slider:lo,num:Mo},{key:`green`,slider:uo,num:No},{key:`blue`,slider:fo,num:Po}];function Ro(e,t,n){let r=e=>Math.max(0,Math.min(255,Math.round(e))).toString(16).padStart(2,`0`);return`#${r(e)}${r(t)}${r(n)}`}function zo(e){let t=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(e.trim());return t?{r:parseInt(t[1],16),g:parseInt(t[2],16),b:parseInt(t[3],16)}:{r:Q.red,g:Q.green,b:Q.blue}}function Bo(){let e=Ro(Q.red,Q.green,Q.blue);oo.value=String(Q.color),ho(so,e);for(let e of Lo)ho(e.slider,Q[e.key]),ho(e.num,Q[e.key]);po&&(po.textContent=`${Q.red}, ${Q.green}, ${Q.blue}`),mo&&(mo.style.background=e),co?.classList.toggle(`hidden`,Q.color!==5)}function Vo(){for(let e of Io)ho(e.slider,Fo(Q[e.key],e.min,e.max)),ho(e.num,Q[e.key])}function Ho(){ao.value=String(Q.style),xo.checked=Q.centerDotEnabled,So.checked=Q.tStyleEnabled,Co.checked=Q.outlineEnabled,wo.checked=Q.alphaEnabled,Vo(),Bo()}function Uo(){Vo();let e=!Q.outlineEnabled;yo.disabled=e,Ao.disabled=e;let t=!Q.alphaEnabled;bo.disabled=t,jo.disabled=t;try{To.value=f(Q)}catch{To.value=``}Eo.value=se(ee(Q))}function Wo(){Ga(Q),Uo()}function Go(){Q.style=Number(ao.value),Q.centerDotEnabled=xo.checked,Q.tStyleEnabled=So.checked,Q.outlineEnabled=Co.checked,Q.alphaEnabled=wo.checked,Wo()}function Ko(e){Q[e.key]=Number(e.slider.value),Wo()}function qo(e,t){let n=Number(e.num.value);if(e.num.value===``||!Number.isFinite(n)){t&&(e.num.value=String(Q[e.key]));return}Q[e.key]=Fo(n,e.min,e.max),t&&(e.num.value=String(Q[e.key])),Wo()}function Jo(){Q.color=5,Q.red=Fo(Number(Mo.value)||0,0,255),Q.green=Fo(Number(No.value)||0,0,255),Q.blue=Fo(Number(Po.value)||0,0,255),Bo(),Wo()}function Yo(){if(Q.color=Number(oo.value),Q.color!==5){let[e,t,n]=io[Q.color]??io[1];Q.red=e,Q.green=t,Q.blue=n}Bo(),Wo()}function Xo(){Q.color=5,Q.red=Number(lo.value),Q.green=Number(uo.value),Q.blue=Number(fo.value),Bo(),Wo()}function Zo(){Q.color=5;let{r:e,g:t,b:n}=zo(so.value);Q.red=e,Q.green=t,Q.blue=n,Bo(),Wo()}Io.forEach(e=>{e.slider.addEventListener(`input`,()=>Ko(e)),e.num.addEventListener(`input`,()=>qo(e,!1)),e.num.addEventListener(`change`,()=>qo(e,!0))}),[ao,xo,So,Co,wo].forEach(e=>e.addEventListener(`change`,Go)),oo.addEventListener(`change`,Yo),so.addEventListener(`input`,Zo),so.addEventListener(`change`,Zo),Lo.forEach(e=>{e.slider.addEventListener(`input`,Xo),e.num.addEventListener(`input`,Jo),e.num.addEventListener(`change`,Jo)}),document.querySelector(`#ed-copy-code`)?.addEventListener(`click`,()=>{Ya(X,To.value,`share code`)}),document.querySelector(`#ed-copy-commands`)?.addEventListener(`click`,()=>{Ya(X,Eo.value,`commands`)}),document.querySelector(`#ed-reset`)?.addEventListener(`click`,()=>{Object.assign(Q,ne),Ho(),Wo(),Z(X,`Crosshair reset to defaults.`,`ok`)}),document.querySelector(`.converter-panel .tab[data-tab="visual"]`)?.addEventListener(`click`,Wo),Ho(),Uo(),Da.innerHTML=aa(`cs2`),Oa.innerHTML=aa(`valorant`),[Da,Oa,ka,ja,Ma,Na,Pa,Fa,Ia].forEach(e=>{e.addEventListener(`input`,Za),e.addEventListener(`change`,Za)}),document.querySelector(`#sens-swap`)?.addEventListener(`click`,Qa),document.querySelector(`#copy-sens`)?.addEventListener(`click`,()=>{Ya(Sa,Aa.value,`converted sensitivity`)}),document.querySelector(`#sens-cs2-val`)?.addEventListener(`click`,$a);var Qo=document.querySelector(`#psa-start`),$o=document.querySelector(`#psa-begin`),es=document.querySelector(`#psa-round`),ts=document.querySelector(`#psa-round-num`),ns=document.querySelector(`#psa-bar-fill`),rs=document.querySelector(`#psa-lower`),is=document.querySelector(`#psa-higher`),as=document.querySelector(`#psa-lower-val`),os=document.querySelector(`#psa-higher-val`),ss=document.querySelector(`#psa-undo`),cs=document.querySelector(`#psa-reset`),ls=document.querySelector(`#psa-result`),us=document.querySelector(`#psa-result-label`),ds=document.querySelector(`#psa-stats`),fs=document.querySelector(`#psa-history`),ps=document.querySelector(`#psa-status`),$=null;function ms(){if(!$){es?.classList.add(`hidden`),fs?.classList.add(`hidden`),ls.textContent=`—`,us.textContent=`recommended sensitivity`,ds.innerHTML=``;return}let e=de($),t=e?ge($):fe($);if(ls.textContent=Y(t,3),us.textContent=e?`final recommended sensitivity`:`current estimate`,ds.innerHTML=`
  ...
  `,e)es?.classList.add(`hidden`),Z(ps,`Done — set your sensitivity to ${Y(t,3)} and play a few sessions before changing again.`,`ok`);else{let{lower:e,higher:t}=ue($);es?.classList.remove(`hidden`),ts.textContent=String($.round),ns.style.width=`${($.round-1)/7*100}%`,as.textContent=Y(e,3),os.textContent=Y(t,3),Z(ps,`Round ${$.round} of 7: test both values, then pick the side that feels better.`,``)}$.choices.length>0?(fs?.classList.remove(`hidden`),fs.innerHTML=`<strong>History:</strong><br />${$.choices.map(e=>`Round ${e.round}: chose <strong>${e.side}</strong> (${Y(e.lower,3)} vs ${Y(e.higher,3)})`).join(`<br />`)}`):(fs?.classList.add(`hidden`),fs.innerHTML=``)}function hs(){let e=Number(Qo.value);if(!Number.isFinite(e)||e<=0){Z(ps,`Enter a valid starting sensitivity greater than 0.`,`error`);return}$=le(e),ms()}function gs(e){!$||de($)||($=me($,e),ms())}$o?.addEventListener(`click`,hs),rs?.addEventListener(`click`,()=>gs(`lower`)),is?.addEventListener(`click`,()=>gs(`higher`)),ss?.addEventListener(`click`,()=>{$&&($=he($),ms())}),cs?.addEventListener(`click`,()=>{$=null,ms(),Z(ps,`Enter a starting sensitivity and press Start PSA.`,``)}),fa.innerHTML=ga.map(e=>`<option value="${e.id}">${e.label}</option>`).join(``),fa.addEventListener(`change`,()=>ba(_a)),ba(null),qa(),$a();function _s(e){return String(e||``).replaceAll(`&`,`&amp;`).replaceAll(`"`,`&quot;`)}function vs(e){let t=document.querySelector(`#donate-section`),n=document.querySelector(`#donate-actions`);if(!t||!n)return;let r=[];e.paypalUrl&&r.push(`<a class="btn donate-btn paypal" href="${_s(e.paypalUrl)}" target="_blank" rel="noopener noreferrer">${sa}<span>Donate via PayPal</span></a>`),e.steamTradeUrl&&r.push(`<a class="btn donate-btn steam" href="${_s(e.steamTradeUrl)}" target="_blank" rel="noopener noreferrer">${ca}<span>Donate Steam skins</span></a>`),n.innerHTML=r.join(``),t.classList.toggle(`hidden`,r.length===0);let i=document.querySelector(`#donate-fab`);if(i){let t=[];e.paypalUrl&&t.push(`<a class="donate-fab-btn paypal" href="${_s(e.paypalUrl)}" target="_blank" rel="noopener noreferrer" title="Donate via PayPal">${sa}<span>PayPal</span></a>`),e.steamTradeUrl&&t.push(`<a class="donate-fab-btn steam" href="${_s(e.steamTradeUrl)}" target="_blank" rel="noopener noreferrer" title="Donate Steam skins">${ca}<span>Steam</span></a>`),i.innerHTML=t.length?`<span class="donate-fab-label">Support AimKit</span>${t.join(``)}`:``,i.classList.toggle(`hidden`,t.length===0)}}async function ys(){try{vs(await _.settings.get())}catch{vs({paypalUrl:``,steamTradeUrl:``})}}document.addEventListener(`aimkit:settings-updated`,ys),document.querySelector(`#contact-open`)?.addEventListener(`click`,qi),Je();var bs=new URLSearchParams(window.location.search).get(`reset`);if(bs){We(bs);let e=new URL(window.location.href);e.searchParams.delete(`reset`),window.history.replaceState({},``,e)}var xs=new URLSearchParams(window.location.search);if(xs.get(`token`)){Ce(xs.get(`token`)),je();let e=new URL(window.location.href);e.searchParams.delete(`token`),window.history.replaceState({},``,e)}else if(xs.get(`steam`)===`linked`){je();let e=new URL(window.location.href);e.searchParams.delete(`steam`),window.history.replaceState({},``,e)}else if(xs.get(`steam_error`)){let e=new URL(window.location.href);e.searchParams.delete(`steam_error`),window.history.replaceState({},``,e)}wn(),Jn(),Fr(),ri(),Si(),dr(),Gi(),ys();