...
`)}var le=.5;function ue(e){return{base:e,lo:e*(1-le),hi:e*1.5,round:1,choices:[]}}function de(e){return{lower:e.lo,higher:e.hi,mid:(e.lo+e.hi)/2}}function fe(e){return e.round>7}function pe(e){return(e.lo+e.hi)/2}function me(e){let t=pe(e);return t<=0?0:(e.hi-e.lo)/t}function he(e,t){if(fe(e))return e;let n=(e.lo+e.hi)/2,r={round:e.round,side:t,lo:e.lo,hi:e.hi,lower:e.lo,higher:e.hi},i={...e,choices:[...e.choices,r],round:e.round+1};return t===`lower`?i.hi=n:i.lo=n,i}function ge(e){if(e.choices.length===0)return e;let t=e.choices.slice(0,-1),n=e.choices[e.choices.length-1];return{...e,lo:n.lo,hi:n.hi,round:n.round,choices:t}}function _e(e){return pe(e)}var ve=`/api`,ye=`cs2utils.token`,be=/^https?:\/\//.test(ve)?new URL(ve).origin:``;function xe(){try{return localStorage.getItem(ye)}catch{return null}}function Se(e){try{e?localStorage.setItem(ye,e):localStorage.removeItem(ye)}catch{}}async function m(e,t,n,{auth:r=!1}={}){let i={};if(n!==void 0&&!(n instanceof FormData)&&(i[`Content-Type`]=`application/json`),r){let e=xe();e&&(i.Authorization=`Bearer ${e}`)}let a;try{a=await fetch(`${ve}${t}`,{method:e,headers:i,body:n instanceof FormData?n:n===void 0?void 0:JSON.stringify(n)})}catch{throw Error(`Cannot reach the server. Is the API running?`)}let o=null,s=await a.text();if(s)try{o=JSON.parse(s)}catch{o=null}if(!a.ok){let e=Error(o&&o.error||`Request failed (${a.status}).`);throw e.status=a.status,e.data=o,e}return o}var Ce=`${ve}/auth/steam`;function we(e){Se(e)}function h(e){return!!e&&(e.role===`admin`||e.role===`owner`)}function Te(e){return!!e&&e.role===`owner`}function Ee(e){return e?/^https?:\/\//.test(e)||e.startsWith(`data:`)?e:be+e:``}var g={auth:{async register(e){let t=await m(`POST`,`/auth/register`,e);return Se(t.token),t.user},async login(e){let t=await m(`POST`,`/auth/login`,e);return Se(t.token),t.user},logout(){Se(null)},async captcha(){return m(`GET`,`/auth/captcha`)},async changePassword(e){return m(`POST`,`/auth/password`,e,{auth:!0})},async forgot(e){return m(`POST`,`/auth/forgot`,{email:e})},async reset(e,t){return m(`POST`,`/auth/reset`,{token:e,password:t})},async me(){if(!xe())return null;try{return(await m(`GET`,`/auth/me`,void 0,{auth:!0})).user}catch{return Se(null),null}},async profile(){return m(`GET`,`/auth/profile`,void 0,{auth:!0})},async setAvatar(e){return(await m(`POST`,`/auth/avatar`,{url:e},{auth:!0})).user},async uploadAvatar(e){let t=new FormData;return t.append(`file`,e),(await m(`POST`,`/auth/avatar/upload`,t,{auth:!0})).user},async changePassword(e){return m(`POST`,`/auth/password`,e,{auth:!0})},async changeUsername(e){let t=await m(`POST`,`/auth/username`,{username:e},{auth:!0});return t.token&&Se(t.token),t.user},async setCredentials(e){let t=await m(`POST`,`/auth/credentials`,e,{auth:!0});return t.token&&Se(t.token),t.user},async forgot(e){return m(`POST`,`/auth/forgot`,{email:e})},async reset(e,t){return m(`POST`,`/auth/reset`,{token:e,password:t})},steamLoginUrl(){return`${ve}/auth/steam`},async steamLinkUrl(){return(await m(`GET`,`/auth/steam/link-url`,void 0,{auth:!0})).url},async steamUnlink(){return(await m(`POST`,`/auth/steam/unlink`,{},{auth:!0})).user}},settings:{async get(){return m(`GET`,`/settings`)}},contact:{async send(e){return m(`POST`,`/contact`,e)}},pros:{async list({q:e=``,sort:t=`name`}={}){let n=new URLSearchParams;e&&n.set(`q`,e),t&&n.set(`sort`,t);let r=n.toString();return m(`GET`,`/pros${r?`?${r}`:``}`)}},configs:{async list({sort:e=`top`,q:t=``}={}){let n=new URLSearchParams;e&&n.set(`sort`,e),t&&n.set(`q`,t);let r=n.toString();return(await m(`GET`,`/configs${r?`?${r}`:``}`,void 0,{auth:!0})).configs},async create(e){return(await m(`POST`,`/configs`,e,{auth:!0})).config},async rate(e,t){return m(`POST`,`/configs/${e}/rate`,{rating:t},{auth:!0})},async remove(e){return m(`DELETE`,`/configs/${e}`,void 0,{auth:!0})}},highlights:{async list({q:e=``}={}){return(await m(`GET`,`/highlights${e?`?q=${encodeURIComponent(e)}`:``}`,void 0,{auth:!0})).highlights},async create(e){return(await m(`POST`,`/highlights`,e,{auth:!0})).highlight},async report(e,t){return m(`POST`,`/highlights/${e}/report`,{reason:t},{auth:!0})},async remove(e){return m(`DELETE`,`/highlights/${e}`,void 0,{auth:!0})}},nades:{async list({map:e=``,type:t=``}={}){let n=new URLSearchParams;e&&n.set(`map`,e),t&&n.set(`type`,t);let r=n.toString();return(await m(`GET`,`/nades${r?`?${r}`:``}`)).nades},async mine(){return(await m(`GET`,`/nades/mine`,void 0,{auth:!0})).nades},async create(e){return(await m(`POST`,`/nades`,e,{auth:!0})).nade},async addMedia(e,t){return(await m(`POST`,`/nades/${e}/media`,t,{auth:!0})).media},async remove(e){return m(`DELETE`,`/nades/${e}`,void 0,{auth:!0})},async parseMapGuide(e){return m(`POST`,`/nades/map-guide/parse`,{text:e},{auth:!0})},async importMapGuide({text:e,nades:t,side:n,guideText:r,fileName:i}={}){return m(`POST`,`/nades/map-guide/import`,{text:e,nades:t,side:n,guideText:r,fileName:i},{auth:!0})},async practicePackFromText({text:e,map:t,importId:n}={}){return m(`POST`,`/nades/map-guide/practice-pack`,{text:e,map:t,importId:n},{auth:!0})},async practicePackFromImport(e){return m(`GET`,`/nades/map-guide/imports/${e}/practice-pack`,void 0,{auth:!!xe()})},async practicePackFromNades(e){return m(`POST`,`/nades/map-guide/practice-pack-from-nades`,{nadeIds:e},{auth:!!xe()})}},commands:{async catalog(){return m(`GET`,`/commands/catalog`)},async social(){return m(`GET`,`/commands/social`,void 0,{auth:!0})},async recommend(e){return m(`POST`,`/commands/${e}/recommend`,{},{auth:!0})},async addComment(e,t){return m(`POST`,`/commands/${e}/comments`,{body:t},{auth:!0})}},admin:{async pending(){return(await m(`GET`,`/admin/nades/pending`,void 0,{auth:!0})).nades},async pendingComments(){return(await m(`GET`,`/admin/comments/pending`,void 0,{auth:!0})).comments},async pendingCommentsCount(){return(await m(`GET`,`/admin/comments/pending/count`,void 0,{auth:!0})).count},async reviewComment(e,t){return m(`POST`,`/admin/comments/${e}/review`,{decision:t},{auth:!0})},async removeComment(e){return m(`DELETE`,`/admin/comments/${e}`,void 0,{auth:!0})},async syncCommands(){return m(`POST`,`/admin/commands/sync`,{},{auth:!0})},async checkCommandsCs2(){return m(`POST`,`/admin/commands/check-cs2`,{},{auth:!0})},async saveSettings(e){return m(`POST`,`/admin/settings`,e,{auth:!0})},async highlightReports(){return(await m(`GET`,`/admin/highlights/reports`,void 0,{auth:!0})).highlights},async highlightReportsCount(){return(await m(`GET`,`/admin/highlights/reports/count`,void 0,{auth:!0})).count},async reviewHighlight(e,t){return m(`POST`,`/admin/highlights/${e}/review`,{decision:t},{auth:!0})},async syncPros(){return m(`POST`,`/admin/pros/sync`,{},{auth:!0})},async importCommands(e){return m(`POST`,`/admin/commands/import`,{content:e},{auth:!0})},async importPros(e){return m(`POST`,`/admin/pros/import`,{content:e},{auth:!0})},async banUser(e,{hours:t,permanent:n}){return(await m(`POST`,`/admin/users/${e}/ban`,{hours:t,permanent:n},{auth:!0})).user},async unbanUser(e){return(await m(`POST`,`/admin/users/${e}/unban`,{},{auth:!0})).user},async pendingCount(){return(await m(`GET`,`/admin/nades/pending/count`,void 0,{auth:!0})).count},async reviewNade(e,t,n=``){return m(`POST`,`/admin/nades/${e}/review`,{decision:t,note:n},{auth:!0})},async reviewNadesBulk(e,t,n=``){return m(`POST`,`/admin/nades/review-bulk`,{ids:e,decision:t,note:n},{auth:!0})},async reviewMedia(e,t){return m(`POST`,`/admin/media/${e}/review`,{decision:t},{auth:!0})},async reviewMediaBulk(e,t){return m(`POST`,`/admin/media/review-bulk`,{ids:e,decision:t},{auth:!0})},async removeMedia(e){return m(`DELETE`,`/admin/media/${e}`,void 0,{auth:!0})},async users(){return(await m(`GET`,`/admin/users`,void 0,{auth:!0})).users},async setRole(e,t){return(await m(`POST`,`/admin/users/${e}/role`,{role:t},{auth:!0})).user},async contactMessages(){return(await m(`GET`,`/admin/contact`,void 0,{auth:!0})).messages},async removeContact(e){return m(`DELETE`,`/admin/contact/${e}`,void 0,{auth:!0})}},uploads:{async image(e){let t=new FormData;return t.append(`file`,e),await m(`POST`,`/uploads`,t,{auth:!0})}}},De=null,Oe=new Set;function ke(){for(let e of Oe)e(De)}function Ae(){return De}function je(e){return Oe.add(e),()=>Oe.delete(e)}async function Me(){return De=await g.auth.me(),ke(),De}async function Ne(e){return De=await g.auth.login(e),ke(),De}async function Pe(e){return De=await g.auth.register(e),ke(),De}function Fe(){g.auth.logout(),De=null,ke()}var Ie,_,Le=`login`,Re={required:!1,token:null,svg:``};function ze(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Be(){let e=Ae();e?(Ie.innerHTML=`
    ...
    <div class="nade-grid">${Dt.map(e=>{let t=e.media||[],n=t.length?`<div class="review-media">${t.map(e=>`<div class="review-media-item">${Rt(e)}
                 ...
                 <input type="text" class="review-note" data-nade="${e.id}" placeholder="Optional note to the author" />
               </div>`;return`<div class="nade-mine">${zt(e,{showStatus:!0})}${n}${r}</div>`}).join(``)}</div>`:`<p class="hint">Nothing pending review. Nice and clean.</p>`:`<p class="hint">Admins only.</p>`}function qt(e){if(!e.bannedUntil)return null;let t=new Date(e.bannedUntil);return t.getTime()<=Date.now()?null:t.getFullYear()>=9999?`permanently`:`until ${t.toLocaleString()}`}function Jt(){return h(y)?`<div class="users-table">
    ...
    <article class="pro-card" data-search="${U(`${e.player} ${e.team||``}`.toLowerCase())}">
      ...
      <dl class="pro-stats">
        ...
        ${mi(`Zoom`,e.zoomSens)}
        ${mi(`Hz`,e.hz)}
        ${mi(`Resolution`,e.resolution)}
        ${mi(`Aspect`,e.aspectRatio)}
      </dl>
    </article>`}function gi(){let e=h(ri)?`<div class="pros-admin-actions">
    ...
    <div class="pros-shell">
      ...
      <div class="configs-controls">
        <div class="sort-tabs">
          <button class="tool-tab ${ii===`featured`?`active`:``}" data-sort="featured">Featured</button>
          <button class="tool-tab ${ii===`name`?`active`:``}" data-sort="name">Name</button>
          <button class="tool-tab ${ii===`edpi`?`active`:``}" data-sort="edpi">Lowest eDPI</button>
          <button class="tool-tab ${ii===`edpi-desc`?`active`:``}" data-sort="edpi-desc">Highest eDPI</button>
        </div>
        <input id="pros-search" type="search" class="cfg-search" placeholder="Search player or team…" value="${U(ai)}" />
      </div>
      ...
      <div class="pro-grid">
        ${H.pros.length?H.pros.map(hi).join(``):`<p class="hint">No pro settings yet.</p>`}
      </div>
      <div id="pros-status" class="status ${si.kind}">${U(si.text)}</div>
    </div>`,_i()}function _i(){V.querySelectorAll(`[data-sort]`).forEach(e=>e.addEventListener(`click`,()=>{ii=e.dataset.sort,li()}));let e=V.querySelector(`#pros-search`);e&&e.addEventListener(`input`,e=>{ai=e.target.value,clearTimeout(oi),oi=setTimeout(async()=>{await li();let e=V.querySelector(`#pros-search`);e&&(e.focus(),e.setSelectionRange(e.value.length,e.value.length))},300)}),V.querySelector(`#pros-sync`)?.addEventListener(`click`,vi),V.querySelector(`#pros-import`)?.addEventListener(`click`,yi)}async function vi(){let e=V.querySelector(`#pros-sync`);e&&(e.disabled=!0),ci(`Syncing from prosettings.net…`,``);try{let e=await g.admin.syncPros();await li(),e.synced?ci(`Synced ${e.count} players from ${e.source}.`,`ok`):ci(`Sync failed: ${e.reason||`unknown error`}. Kept the current list.`,`error`)}catch(e){ci(e.message,`error`)}finally{let e=V.querySelector(`#pros-sync`);e&&(e.disabled=!1)}}function yi(){Tn({title:`Import pro settings from HLTV`,description:`HLTV has a Cloudflare check that blocks servers. Open HLTV in your browser, complete the verification, then paste a JSON list of players here. Each item: {"player","team","dpi","sens","zoomSens","hz","resolution","aspectRatio","photo","teamLogo"}.`,sourceUrl:`https://www.hltv.org/stats/players`,sourceLabel:`Open HLTV`,placeholder:`[{"player":"s1mple","team":"Natus Vincere","dpi":400,"sens":3.09,"hz":1000,"resolution":"1280x960","aspectRatio":"4:3"}]`,onImport:async e=>{let t=await g.admin.importPros(e);return await li(),`Imported ${t.count} players.`}})}async function bi(){V=document.querySelector(`#pros-tool`),V&&(ri=Ae(),je(e=>{ri=e,gi()}),gi(),await li())}var W,xi=null,Si=`overview`,Ci={text:``,kind:``},G={nades:0,comments:0,reports:0},K={},wi=[{id:`overview`,label:`Overview`},{id:`nades`,label:`Nades`},{id:`comments`,label:`Comments`},{id:`reports`,label:`Reports`},{id:`users`,label:`Users`},{id:`sync`,label:`Data sync`},{id:`contact`,label:`Contact`},{id:`settings`,label:`Site settings`,ownerOnly:!0}];function q(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Ti(e,t=``){Ci={text:e,kind:t};let n=W?.querySelector(`#admin-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function Ei(e){try{return new Date(e).toLocaleString()}catch{return`—`}}async function Di(){try{let[e,t,n]=await Promise.all([g.admin.pendingCount().catch(()=>0),g.admin.pendingCommentsCount().catch(()=>0),g.admin.highlightReportsCount().catch(()=>0)]);G={nades:e,comments:t,reports:n}}catch{}}function Oi(){let e=(e,t,n)=>`<button class="admin-stat" data-goto="${n}">
    ...
    ${e.map(e=>{let t=(e.media||[]).map(e=>`
        ...
        </article>`}).join(``)}`:`<p class="hint">Nothing pending. All nades are reviewed.</p>`}function Ai(){let e=K.comments||[];return e.length?e.map(e=>`
      <article class="panel admin-item">
        <p>${q(e.body)}</p>
        <p class="hint">by ${q(e.username)} on <code>${q(e.commandKey)}</code> · ${Ei(e.createdAt)}</p>
        <div class="actions">
        ...
        </article>`}).join(``):`<p class="hint">No open highlight reports.</p>`}function Mi(){let e=K.users||[];if(!e.length)return`<p class="hint">No users.</p>`;let t=Date.now();return`<div class="admin-users">${e.map(e=>{let n=e.bannedUntil&&new Date(e.bannedUntil).getTime()>t,r=e.role===`owner`;return`
        ...
        </div>`}).join(``)}</div>`}function Ni(){return`
    <div class="admin-sync">
    ...
    </div>`}function Pi(){let e=K.contact||[];return e.length?e.map(e=>`
      <article class="panel admin-item">
        <div class="admin-item-head">
          <strong>${q(e.subject||`(no subject)`)}</strong>
          <span class="hint">${Ei(e.created_at)}</span>
        </div>
      ...
      </article>`).join(``):`<p class="hint">No contact messages.</p>`}function Fi(){let e=K.settings||{paypalUrl:``,steamTradeUrl:``};return`
    <div class="panel admin-item">
    ...
    </div>`}var Ii={overview:Oi,nades:ki,comments:Ai,reports:ji,users:Mi,sync:Ni,contact:Pi,settings:Fi};async function Li(e){try{e===`overview`?await Di():e===`nades`?K.nades=await g.admin.pending():e===`comments`?K.comments=await g.admin.pendingComments():e===`reports`?K.reports=await g.admin.highlightReports():e===`users`?K.users=await g.admin.users():e===`contact`?K.contact=await g.admin.contactMessages():e===`settings`&&(K.settings=await g.settings.get())}catch(e){Ti(e.message,`error`)}}function Ri(){if(!W)return;if(!h(xi)){W.innerHTML=`<div class="admin-shell"><div class="login-prompt">
      <p class="hint">This area is for admins only.</p>
      ${xi?``:`<div class="actions"><button class="btn primary" data-open-auth="login">Log in</button></div>`}
    </div></div>`,W.querySelector(`[data-open-auth]`)?.addEventListener(`click`,()=>Je(`login`));return}let e=wi.filter(e=>!e.ownerOnly||Te(xi)).map(e=>`<button class="tool-tab ${Si===e.id?`active`:``}" data-section="${e.id}">${q(e.label)}${e.id===`nades`&&G.nades?` (${G.nades})`:``}${e.id===`comments`&&G.comments?` (${G.comments})`:``}${e.id===`reports`&&G.reports?` (${G.reports})`:``}</button>`).join(``),t=(Ii[Si]||Oi)();W.innerHTML=`
    <div class="admin-shell">
      <h2 class="admin-title">Admin</h2>
      <div class="admin-nav sort-tabs">${e}</div>
      <div class="admin-body">${t}</div>
      <div id="admin-status" class="status ${Ci.kind}">${q(Ci.text)}</div>
    </div>`,Bi()}async function zi(e){Si=e,Ri(),await Li(e),Ri()}function Bi(){W.querySelectorAll(`[data-section]`).forEach(e=>e.addEventListener(`click`,()=>zi(e.dataset.section))),W.querySelectorAll(`[data-goto]`).forEach(e=>e.addEventListener(`click`,()=>zi(e.dataset.goto)));let e=async(e,t)=>{try{await e(),t&&Ti(t,`ok`)}catch(e){Ti(e.message,`error`)}},t=async()=>{await Li(Si),await Di(),Ri()};W.querySelectorAll(`[data-nade-approve]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewNade(n.dataset.nadeApprove,`approved`),await t()},`Nade approved.`))),W.querySelectorAll(`[data-nade-reject]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewNade(n.dataset.nadeReject,`rejected`),await t()},`Nade rejected.`))),W.querySelectorAll(`[data-nade-delete]`).forEach(n=>n.addEventListener(`click`,()=>{confirm(`Permanently delete this nade and its media?`)&&e(async()=>{await g.nades.remove(n.dataset.nadeDelete),await t()},`Nade deleted.`)})),W.querySelectorAll(`[data-media-approve]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewMedia(n.dataset.mediaApprove,`approved`),await t()},`Media approved.`))),W.querySelectorAll(`[data-media-reject]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewMedia(n.dataset.mediaReject,`rejected`),await t()},`Media rejected.`))),W.querySelectorAll(`[data-media-delete]`).forEach(n=>n.addEventListener(`click`,()=>{confirm(`Permanently remove this media?`)&&e(async()=>{await g.admin.removeMedia(n.dataset.mediaDelete),await t()},`Media removed.`)}));let n=W.querySelector(`#admin-nade-select-all`),r=W.querySelector(`#admin-nade-bulk-approve`),i=W.querySelector(`#admin-nade-bulk-reject`),a=()=>{let e=W.querySelectorAll(`.admin-nade-check:checked`).length;r&&(r.disabled=e===0),i&&(i.disabled=e===0)};n?.addEventListener(`change`,()=>{W.querySelectorAll(`.admin-nade-check`).forEach(e=>{e.checked=n.checked}),a()}),W.querySelectorAll(`.admin-nade-check`).forEach(e=>e.addEventListener(`change`,a));let o=async n=>{let r=[...W.querySelectorAll(`.admin-nade-check:checked`)].map(e=>Number(e.value));r.length&&await e(async()=>{let e=await g.admin.reviewNadesBulk(r,n);await t(),Ti(`${n===`approved`?`Approved`:`Rejected`} ${e.updated} nade${e.updated===1?``:`s`}.`,`ok`)})};r?.addEventListener(`click`,()=>o(`approved`)),i?.addEventListener(`click`,()=>o(`rejected`)),W.querySelectorAll(`[data-comment-approve]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewComment(n.dataset.commentApprove,`approved`),await t()},`Comment approved.`))),W.querySelectorAll(`[data-comment-reject]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewComment(n.dataset.commentReject,`rejected`),await t()},`Comment rejected.`))),W.querySelectorAll(`[data-comment-delete]`).forEach(n=>n.addEventListener(`click`,()=>{confirm(`Permanently delete this comment?`)&&e(async()=>{await g.admin.removeComment(n.dataset.commentDelete),await t()},`Comment deleted.`)})),W.querySelectorAll(`[data-report-keep]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewHighlight(n.dataset.reportKeep,`keep`),await t()},`Kept highlight.`))),W.querySelectorAll(`[data-report-delete]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewHighlight(n.dataset.reportDelete,`delete`),await t()},`Highlight deleted.`))),W.querySelectorAll(`[data-role]`).forEach(n=>n.addEventListener(`change`,()=>e(async()=>{await g.admin.setRole(n.dataset.role,n.value),await t()},`Role updated.`))),W.querySelectorAll(`[data-unban]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.unbanUser(n.dataset.unban),await t()},`User unbanned.`))),W.querySelectorAll(`[data-ban]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{let e=Number(W.querySelector(`[data-ban-hrs="${n.dataset.ban}"]`)?.value);if(!Number.isFinite(e)||e<=0)return Ti(`Enter a positive number of hours.`,`error`);await g.admin.banUser(n.dataset.ban,{hours:e}),await t(),Ti(`User banned.`,`ok`)}))),W.querySelectorAll(`[data-ban-perma]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.banUser(n.dataset.banPerma,{permanent:!0}),await t()},`User banned permanently.`))),W.querySelector(`#sync-commands`)?.addEventListener(`click`,()=>e(async()=>{let e=await g.admin.syncCommands();Ti(e.synced?`Commands synced (${e.count}).`:`No sync: ${e.reason||`no source`}.`,e.synced?`ok`:`error`)})),W.querySelector(`#check-cs2`)?.addEventListener(`click`,()=>e(async()=>{let e=await g.admin.checkCommandsCs2();Ti(`CS2 build: ${e.build||`unknown`}${e.changed?` (changed → re-synced)`:``}.`,`ok`)})),W.querySelector(`#sync-pros`)?.addEventListener(`click`,()=>e(async()=>{let e=await g.admin.syncPros();Ti(e.synced?`Synced ${e.count} pros from ${e.source}.`:`Sync failed: ${e.reason}.`,e.synced?`ok`:`error`)})),W.querySelector(`#import-commands`)?.addEventListener(`click`,()=>Tn({title:`Import commands`,description:`Paste the CS2 console-commands wiki page (wikitext) or a JSON array of commands.`,sourceUrl:`https://developer.valvesoftware.com/wiki/List_of_Counter-Strike_2_console_command_variables`,sourceLabel:`Open wiki`,onImport:async e=>`Imported ${(await g.admin.importCommands(e)).count} commands.`})),W.querySelector(`#import-pros`)?.addEventListener(`click`,()=>Tn({title:`Import pro settings from HLTV`,description:`Open HLTV, complete the check, then paste a JSON list of players.`,sourceUrl:`https://www.hltv.org/stats/players`,sourceLabel:`Open HLTV`,onImport:async e=>{let t=await g.admin.importPros(e);return await Li(`sync`),`Imported ${t.count} players.`}})),W.querySelectorAll(`[data-contact-delete]`).forEach(n=>n.addEventListener(`click`,()=>{confirm(`Delete this contact message?`)&&e(async()=>{await g.admin.removeContact(n.dataset.contactDelete),await t()},`Message deleted.`)})),W.querySelector(`#save-settings`)?.addEventListener(`click`,()=>e(async()=>{let e=W.querySelector(`#set-paypal`)?.value||``,t=W.querySelector(`#set-steam`)?.value||``;K.settings=await g.admin.saveSettings({paypalUrl:e,steamTradeUrl:t}),document.dispatchEvent(new CustomEvent(`aimkit:settings-updated`))},`Donate links saved.`))}function Vi(e){document.querySelectorAll(`.admin-only`).forEach(t=>t.classList.toggle(`hidden`,!h(e)))}async function Hi(){W=document.querySelector(`#admin-tool`),W&&(xi=Ae(),Vi(xi),je(async e=>{let t=h(xi);xi=e,Vi(e),h(e)&&!t&&await Di(),Ri()}),Ri(),h(xi)&&(await Di(),Ri()))}function Ui(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Wi(){let e=Ae(),t=document.createElement(`div`);t.className=`modal`,t.innerHTML=`
    <div class="modal-backdrop" data-close></div>
    <div class="modal-card" role="dialog" aria-modal="true" aria-label="Contact us">
      ...
      <form id="contact-form" class="auth-form-modal">
        <label class="field"><span>Your name</span><input id="contact-name" type="text" value="${Ui(e?.username||``)}" /></label>
        <label class="field"><span>Your email</span><input id="contact-email" type="email" value="${Ui(e?.email||``)}" /></label>
...
`;var sa=document.querySelector(`#preview-canvas`),ca=document.querySelector(`#preview-stats`),la=document.querySelector(`#preview-res`),ua=document.querySelector(`#preview-res-scale`),da=`ingame`;function fa(){let e=da===`fullscreen`?1080:280;sa.width!==e&&(sa.width=e,sa.height=e),sa.style.imageRendering=da===`fullscreen`?`auto`:`pixelated`}fa();var pa=[{id:`1920x1080`,h:1080,label:`1920 × 1080 (16:9)`},{id:`2560x1440`,h:1440,label:`2560 × 1440 (16:9)`},{id:`3840x2160`,h:2160,label:`3840 × 2160 (4K)`},{id:`1600x900`,h:900,label:`1600 × 900 (16:9)`},{id:`1366x768`,h:768,label:`1366 × 768 (16:9)`},{id:`1280x960`,h:960,label:`1280 × 960 (4:3)`},{id:`1024x768`,h:768,label:`1024 × 768 (4:3)`},{id:`1280x1024`,h:1024,label:`1280 × 1024 (5:4)`}],ma=null;function ha(){return da===`fullscreen`?sa.height/1080:(pa.find(e=>e.id===la?.value)||pa[0]).h/1080}var ga=Yi({source:sa,stage:document.querySelector(`.preview-stage`),toggleBtn:document.querySelector(`#magnifier-toggle`),zoomSelect:document.querySelector(`#magnifier-zoom`)});function _a(e){if(ma=e,Ji(sa,e,ha()),ua)if(e){let t=pa.find(e=>e.id===la?.value)||pa[0],n=t.h/1080;ua.textContent=`≈ ${Math.max(0,Math.round(e.length*n))}px arms · ${Math.max(1,Math.round(e.thickness*n))}px thick @ ${t.h}p`}else ua.textContent=``;ga.refresh()}function va(e){da=e===`fullscreen`?`fullscreen`:`ingame`,fa(),document.querySelectorAll(`.pmode`).forEach(e=>{let t=e.dataset.pmode===da;e.classList.toggle(`active`,t),e.setAttribute(`aria-selected`,String(t))});let t=document.querySelector(`#preview-mode-tag`);t&&(t.textContent=da===`fullscreen`?`Relative to full screen`:`Actual in-game size`),_a(ma)}document.querySelectorAll(`.pmode`).forEach(e=>e.addEventListener(`click`,()=>va(e.dataset.pmode)));var X=document.querySelector(`#crosshair-status`),ya=document.querySelector(`#sensitivity-status`),ba=document.querySelector(`#sharecode-input`),xa=document.querySelector(`#commands-output`),Sa=document.querySelector(`#commands-input`),Ca=document.querySelector(`#sharecode-output`),wa=document.querySelector(`#sens-from-game`),Ta=document.querySelector(`#sens-to-game`),Ea=document.querySelector(`#sens-source`),Da=document.querySelector(`#sens-target`),Oa=document.querySelector(`#sens-source-dpi`),ka=document.querySelector(`#sens-target-dpi`),Aa=document.querySelector(`#sens-source-myaw`),ja=document.querySelector(`#sens-target-myaw`),Ma=document.querySelector(`#sens-source-yaw`),Na=document.querySelector(`#sens-target-yaw`),Pa=document.querySelector(`#source-yaw-field`),Fa=document.querySelector(`#target-yaw-field`),Ia=document.querySelector(`#m-yaw-fields`),La=document.querySelector(`#sens-cm360`),Ra=document.querySelector(`#sens-stats`),za=document.querySelector(`#sens-formula`),Ba=`CSGO-UseJt-3oTvn-47wPX-hEyER-WZfiK`,Va=`cl_crosshairstyle 4
cl_crosshairsize 3
cl_crosshairgap -2
...
cl_crosshair_recoil 0`;function Z(e,t,n=``){e&&(e.textContent=t,e.className=`status${n?` ${n}`:``}`)}function Ha(e){_a(e),ca.innerHTML=`
  ...
  `}function Ua(e){return e.trim().replace(/\s+/g,``).replace(/^csgo/i,`CSGO`)}function Wa(){let e=ba.value.trim();if(!e){Z(X,`Paste a crosshair share code first.`,`error`);return}let t=Ua(e);if(!ra.test(t)){Z(X,`Invalid format. Expected CSGO-xxxxx-xxxxx-xxxxx-xxxxx-xxxxx`,`error`);return}try{let e=d(t);ba.value=t,xa.value=ce(ee(e)),Ha(e),Z(X,`Converted share code to console commands.`,`ok`)}catch(e){e instanceof i||e instanceof r?Z(X,`That share code is not a valid crosshair code.`,`error`):Z(X,e instanceof Error?e.message:`Failed to decode share code.`,`error`)}}function Ga(){let e=Sa.value.trim();if(!e){Z(X,`Paste crosshair console commands first.`,`error`);return}try{let t=se(e);Ca.value=f(t),Ha(t),Z(X,`Converted commands to share code.`,`ok`)}catch(e){Z(X,e instanceof Error?e.message:`Failed to encode share code.`,`error`)}}async function Ka(e,t,n){if(!t){Z(e,`Nothing to copy for ${n}.`,`error`);return}try{await navigator.clipboard.writeText(t),Z(e,`Copied ${n} to clipboard.`,`ok`)}catch{Z(e,`Clipboard access failed. Select and copy manually.`,`error`)}}function qa(){let e=Xi[wa.value]?.supportsMYaw||Xi[Ta.value]?.supportsMYaw;Ia?.classList.toggle(`hidden`,!e),Pa?.classList.toggle(`hidden`,!Xi[wa.value]?.custom),Fa?.classList.toggle(`hidden`,!Xi[Ta.value]?.custom)}function Ja(){let e=Number(Ea.value),t=Number(Oa.value),n=Number(ka.value),r=Number(Aa.value)||.022,i=Number(ja.value)||.022,a=Number(Ma.value),o=Number(Na.value);if(qa(),Xi[wa.value]?.custom&&!(a>0)){Z(ya,`Enter a valid source custom yaw (° per count).`,`error`);return}if(Xi[Ta.value]?.custom&&!(o>0)){Z(ya,`Enter a valid target custom yaw (° per count).`,`error`);return}if(!Number.isFinite(e)||e<=0){Da.value=``,La.textContent=`—`,Ra.innerHTML=``,za.textContent=``;return}if(!Number.isFinite(t)||t<=0||!Number.isFinite(n)||n<=0){Z(ya,`Enter valid DPI values.`,`error`);return}let s=ea({sourceGame:wa.value,targetGame:Ta.value,sourceSens:e,sourceDpi:t,targetDpi:n,sourceMYaw:r,targetMYaw:i,sourceCustomYaw:a,targetCustomYaw:o}),c=Xi[wa.value].name,l=Xi[Ta.value].name,u=Y(s.targetSensitivity);Da.value=u,La.textContent=ta(s.cm360),Ra.innerHTML=`
    <div><dt>Inches / 360°</dt><dd>${ta(s.inches360)} in</dd></div>
    <div><dt>Source eDPI</dt><dd>${ta(s.sourceEdpi,0)}</dd></div>
    <div><dt>Target eDPI</dt><dd>${ta(s.targetEdpi,0)}</dd></div>
  ...
  `,Z(ya,`${c} → ${l}: ${u}`,`ok`)}function Ya(){let e=wa.value;wa.value=Ta.value,Ta.value=e,Da.value&&(Ea.value=Da.value),Ja()}function Xa(){wa.value=`cs2`,Ta.value=`valorant`,Ea.value=`1.25`,Oa.value=`800`,ka.value=`800`,Ja()}var Za={crosshair:`Convert a crosshair share code into console commands, build a code from commands, or design one visually with a live preview.`,sensitivity:`Keep the same cm/360 aim feel across games — with custom yaw values and DPI changes handled for you.`,psa:`Dial in your ideal sensitivity with a guided 7-round A/B test (Perfect Sensitivity Approximation).`,nades:`Browse community grenade line-ups, or sign in to submit your own with a 2D throw guide, videos and photos.`,commands:`Copy up-to-date CS2 launch options and console commands, recommend the ones that help, and share tips in the comments.`,configs:`Share your CS2 configs and video settings, download other players’ setups, and rate the best ones.`,highlights:`Share your best CS2 clips, watch the community’s highlights, and report anything that breaks the rules.`,pros:`Browse pro players’ sensitivity, DPI, resolution and crosshair settings.`,profile:`Your account, contributions, and settings.`,admin:`Moderate content, manage users, sync data sources, and read contact messages.`},Qa=document.querySelector(`#tool-desc`);function $a(e){Qa&&(Qa.textContent=Za[e]||``)}function eo(e){document.querySelectorAll(`.tool-nav .tool-tab`).forEach(t=>{let n=t.getAttribute(`data-tool`)===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,String(n))}),document.querySelectorAll(`.tool-view`).forEach(t=>{t.classList.toggle(`active`,t.id===`${e}-tool`)}),$a(e),window.scrollTo({top:0,behavior:`smooth`})}document.querySelectorAll(`.tool-nav .tool-tab`).forEach(e=>{e.addEventListener(`click`,()=>eo(e.getAttribute(`data-tool`)))}),document.addEventListener(`aimkit:navigate`,e=>eo(e.detail)),$a(`crosshair`),document.querySelectorAll(`.converter-panel .tab`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-tab`);document.querySelectorAll(`.converter-panel .tab`).forEach(e=>{let n=e.getAttribute(`data-tab`)===t;e.classList.toggle(`active`,n),e.setAttribute(`aria-selected`,String(n))}),document.querySelectorAll(`.converter-panel .tab-panel`).forEach(e=>{e.classList.toggle(`active`,e.getAttribute(`data-panel`)===t)})})}),document.querySelector(`#decode-btn`)?.addEventListener(`click`,Wa),document.querySelector(`#encode-btn`)?.addEventListener(`click`,Ga),ba.addEventListener(`keydown`,e=>{e.key===`Enter`&&Wa()}),Sa.addEventListener(`input`,()=>{let e=Sa.value.trim();if(!e){_a(null),ca.innerHTML=``;return}try{Ha(se(e))}catch{}}),ba.addEventListener(`input`,()=>{let e=Ua(ba.value);if(ra.test(e))try{Ha(d(e))}catch{}}),document.querySelector(`#copy-commands`)?.addEventListener(`click`,()=>{Ka(X,xa.value,`commands`)}),document.querySelector(`#copy-code`)?.addEventListener(`click`,()=>{Ka(X,Ca.value,`share code`)}),document.querySelector(`#copy-sharecode-cmd`)?.addEventListener(`click`,()=>{let e=Ua(ba.value);if(!e){Z(X,`Enter a share code first.`,`error`);return}Ka(X,`cl_crosshair_sharecode "${e}"`,`import command`)}),document.querySelector(`#load-example-code`)?.addEventListener(`click`,()=>{ba.value=Ba,Wa()}),document.querySelector(`#load-example-cmd`)?.addEventListener(`click`,()=>{Sa.value=Va,Ga()});var to={0:[255,255,255],1:[50,250,50],2:[255,255,0],3:[50,50,250],4:[50,250,250]},Q={...ne},no=document.querySelector(`#ed-style`),ro=document.querySelector(`#ed-color`),io=document.querySelector(`#ed-custom-color`),ao=document.querySelector(`#ed-custom-color-field`),oo=document.querySelector(`#ed-r`),so=document.querySelector(`#ed-g`),co=document.querySelector(`#ed-b`),lo=document.querySelector(`#ed-rgb-val`),uo=document.querySelector(`#ed-color-swatch`);function fo(e,t){e&&document.activeElement!==e&&(e.value=String(t))}var po=document.querySelector(`#ed-length`),mo=document.querySelector(`#ed-thickness`),ho=document.querySelector(`#ed-gap`),go=document.querySelector(`#ed-outline`),_o=document.querySelector(`#ed-alpha`),vo=document.querySelector(`#ed-dot`),yo=document.querySelector(`#ed-tstyle`),bo=document.querySelector(`#ed-outline-on`),xo=document.querySelector(`#ed-alpha-on`),So=document.querySelector(`#ed-sharecode`),Co=document.querySelector(`#ed-commands`),wo=document.querySelector(`#ed-length-num`),To=document.querySelector(`#ed-thickness-num`),Eo=document.querySelector(`#ed-gap-num`),Do=document.querySelector(`#ed-outline-num`),Oo=document.querySelector(`#ed-alpha-num`),ko=document.querySelector(`#ed-r-num`),Ao=document.querySelector(`#ed-g-num`),jo=document.querySelector(`#ed-b-num`),Mo=(e,t,n)=>Math.max(t,Math.min(n,e)),No=[{key:`length`,slider:po,num:wo,min:0,max:15},{key:`thickness`,slider:mo,num:To,min:0,max:6},{key:`gap`,slider:ho,num:Eo,min:-10,max:10},{key:`outline`,slider:go,num:Do,min:0,max:3},{key:`alpha`,slider:_o,num:Oo,min:0,max:255}],Po=[{key:`red`,slider:oo,num:ko},{key:`green`,slider:so,num:Ao},{key:`blue`,slider:co,num:jo}];function Fo(e,t,n){let r=e=>Math.max(0,Math.min(255,Math.round(e))).toString(16).padStart(2,`0`);return`#${r(e)}${r(t)}${r(n)}`}function Io(e){let t=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(e.trim());return t?{r:parseInt(t[1],16),g:parseInt(t[2],16),b:parseInt(t[3],16)}:{r:Q.red,g:Q.green,b:Q.blue}}function Lo(){let e=Fo(Q.red,Q.green,Q.blue);ro.value=String(Q.color),fo(io,e);for(let e of Po)fo(e.slider,Q[e.key]),fo(e.num,Q[e.key]);lo&&(lo.textContent=`${Q.red}, ${Q.green}, ${Q.blue}`),uo&&(uo.style.background=e),ao?.classList.toggle(`hidden`,Q.color!==5)}function Ro(){for(let e of No)fo(e.slider,Mo(Q[e.key],e.min,e.max)),fo(e.num,Q[e.key])}function zo(){no.value=String(Q.style),vo.checked=Q.centerDotEnabled,yo.checked=Q.tStyleEnabled,bo.checked=Q.outlineEnabled,xo.checked=Q.alphaEnabled,Ro(),Lo()}function Bo(){Ro();let e=!Q.outlineEnabled;go.disabled=e,Do.disabled=e;let t=!Q.alphaEnabled;_o.disabled=t,Oo.disabled=t;try{So.value=f(Q)}catch{So.value=``}Co.value=ce(ee(Q))}function Vo(){Ha(Q),Bo()}function Ho(){Q.style=Number(no.value),Q.centerDotEnabled=vo.checked,Q.tStyleEnabled=yo.checked,Q.outlineEnabled=bo.checked,Q.alphaEnabled=xo.checked,Vo()}function Uo(e){Q[e.key]=Number(e.slider.value),Vo()}function Wo(e,t){let n=Number(e.num.value);if(e.num.value===``||!Number.isFinite(n)){t&&(e.num.value=String(Q[e.key]));return}Q[e.key]=Mo(n,e.min,e.max),t&&(e.num.value=String(Q[e.key])),Vo()}function Go(){Q.color=5,Q.red=Mo(Number(ko.value)||0,0,255),Q.green=Mo(Number(Ao.value)||0,0,255),Q.blue=Mo(Number(jo.value)||0,0,255),Lo(),Vo()}function Ko(){if(Q.color=Number(ro.value),Q.color!==5){let[e,t,n]=to[Q.color]??to[1];Q.red=e,Q.green=t,Q.blue=n}Lo(),Vo()}function qo(){Q.color=5,Q.red=Number(oo.value),Q.green=Number(so.value),Q.blue=Number(co.value),Lo(),Vo()}function Jo(){Q.color=5;let{r:e,g:t,b:n}=Io(io.value);Q.red=e,Q.green=t,Q.blue=n,Lo(),Vo()}No.forEach(e=>{e.slider.addEventListener(`input`,()=>Uo(e)),e.num.addEventListener(`input`,()=>Wo(e,!1)),e.num.addEventListener(`change`,()=>Wo(e,!0))}),[no,vo,yo,bo,xo].forEach(e=>e.addEventListener(`change`,Ho)),ro.addEventListener(`change`,Ko),io.addEventListener(`input`,Jo),io.addEventListener(`change`,Jo),Po.forEach(e=>{e.slider.addEventListener(`input`,qo),e.num.addEventListener(`input`,Go),e.num.addEventListener(`change`,Go)}),document.querySelector(`#ed-copy-code`)?.addEventListener(`click`,()=>{Ka(X,So.value,`share code`)}),document.querySelector(`#ed-copy-commands`)?.addEventListener(`click`,()=>{Ka(X,Co.value,`commands`)}),document.querySelector(`#ed-reset`)?.addEventListener(`click`,()=>{Object.assign(Q,ne),zo(),Vo(),Z(X,`Crosshair reset to defaults.`,`ok`)}),document.querySelector(`.converter-panel .tab[data-tab="visual"]`)?.addEventListener(`click`,Vo),zo(),Bo(),wa.innerHTML=na(`cs2`),Ta.innerHTML=na(`valorant`),[wa,Ta,Ea,Oa,ka,Aa,ja,Ma,Na].forEach(e=>{e.addEventListener(`input`,Ja),e.addEventListener(`change`,Ja)}),document.querySelector(`#sens-swap`)?.addEventListener(`click`,Ya),document.querySelector(`#copy-sens`)?.addEventListener(`click`,()=>{Ka(ya,Da.value,`converted sensitivity`)}),document.querySelector(`#sens-cs2-val`)?.addEventListener(`click`,Xa);var Yo=document.querySelector(`#psa-start`),Xo=document.querySelector(`#psa-begin`),Zo=document.querySelector(`#psa-round`),Qo=document.querySelector(`#psa-round-num`),$o=document.querySelector(`#psa-bar-fill`),es=document.querySelector(`#psa-lower`),ts=document.querySelector(`#psa-higher`),ns=document.querySelector(`#psa-lower-val`),rs=document.querySelector(`#psa-higher-val`),is=document.querySelector(`#psa-undo`),as=document.querySelector(`#psa-reset`),os=document.querySelector(`#psa-result`),ss=document.querySelector(`#psa-result-label`),cs=document.querySelector(`#psa-stats`),ls=document.querySelector(`#psa-history`),us=document.querySelector(`#psa-status`),$=null;function ds(){if(!$){Zo?.classList.add(`hidden`),ls?.classList.add(`hidden`),os.textContent=`—`,ss.textContent=`recommended sensitivity`,cs.innerHTML=``;return}let e=fe($),t=e?_e($):pe($);if(os.textContent=Y(t,3),ss.textContent=e?`final recommended sensitivity`:`current estimate`,cs.innerHTML=`
  ...
  `,e)Zo?.classList.add(`hidden`),Z(us,`Done — set your sensitivity to ${Y(t,3)} and play a few sessions before changing again.`,`ok`);else{let{lower:e,higher:t}=de($);Zo?.classList.remove(`hidden`),Qo.textContent=String($.round),$o.style.width=`${($.round-1)/7*100}%`,ns.textContent=Y(e,3),rs.textContent=Y(t,3),Z(us,`Round ${$.round} of 7: test both values, then pick the side that feels better.`,``)}$.choices.length>0?(ls?.classList.remove(`hidden`),ls.innerHTML=`<strong>History:</strong><br />${$.choices.map(e=>`Round ${e.round}: chose <strong>${e.side}</strong> (${Y(e.lower,3)} vs ${Y(e.higher,3)})`).join(`<br />`)}`):(ls?.classList.add(`hidden`),ls.innerHTML=``)}function fs(){let e=Number(Yo.value);if(!Number.isFinite(e)||e<=0){Z(us,`Enter a valid starting sensitivity greater than 0.`,`error`);return}$=ue(e),ds()}function ps(e){!$||fe($)||($=he($,e),ds())}Xo?.addEventListener(`click`,fs),es?.addEventListener(`click`,()=>ps(`lower`)),ts?.addEventListener(`click`,()=>ps(`higher`)),is?.addEventListener(`click`,()=>{$&&($=ge($),ds())}),as?.addEventListener(`click`,()=>{$=null,ds(),Z(us,`Enter a starting sensitivity and press Start PSA.`,``)}),la.innerHTML=pa.map(e=>`<option value="${e.id}">${e.label}</option>`).join(``),la.addEventListener(`change`,()=>_a(ma)),_a(null),Wa(),Xa();function ms(e){return String(e||``).replaceAll(`&`,`&amp;`).replaceAll(`"`,`&quot;`)}function hs(e){let t=document.querySelector(`#donate-section`),n=document.querySelector(`#donate-actions`);if(!t||!n)return;let r=[];e.paypalUrl&&r.push(`<a class="btn donate-btn paypal" href="${ms(e.paypalUrl)}" target="_blank" rel="noopener noreferrer">${ia}<span>Donate via PayPal</span></a>`),e.steamTradeUrl&&r.push(`<a class="btn donate-btn steam" href="${ms(e.steamTradeUrl)}" target="_blank" rel="noopener noreferrer">${aa}<span>Donate Steam skins</span></a>`),n.innerHTML=r.join(``),t.classList.toggle(`hidden`,r.length===0);let i=document.querySelector(`#donate-fab`);if(i){let t=[];e.paypalUrl&&t.push(`<a class="donate-fab-btn paypal" href="${ms(e.paypalUrl)}" target="_blank" rel="noopener noreferrer" title="Donate via PayPal">${ia}<span>PayPal</span></a>`),e.steamTradeUrl&&t.push(`<a class="donate-fab-btn steam" href="${ms(e.steamTradeUrl)}" target="_blank" rel="noopener noreferrer" title="Donate Steam skins">${aa}<span>Steam</span></a>`),i.innerHTML=t.length?`<span class="donate-fab-label">Support AimKit</span>${t.join(``)}`:``,i.classList.toggle(`hidden`,t.length===0)}}async function gs(){try{hs(await g.settings.get())}catch{hs({paypalUrl:``,steamTradeUrl:``})}}document.addEventListener(`aimkit:settings-updated`,gs),document.querySelector(`#contact-open`)?.addEventListener(`click`,Wi),Ye();var _s=new URLSearchParams(window.location.search).get(`reset`);if(_s){Ge(_s);let e=new URL(window.location.href);e.searchParams.delete(`reset`),window.history.replaceState({},``,e)}var vs=new URLSearchParams(window.location.search);if(vs.get(`token`)){we(vs.get(`token`)),Me();let e=new URL(window.location.href);e.searchParams.delete(`token`),window.history.replaceState({},``,e)}else if(vs.get(`steam`)===`linked`){Me();let e=new URL(window.location.href);e.searchParams.delete(`steam`),window.history.replaceState({},``,e)}else if(vs.get(`steam_error`)){let e=new URL(window.location.href);e.searchParams.delete(`steam_error`),window.history.replaceState({},``,e)}Cn(),qn(),Pr(),ni(),bi(),ur(),Hi(),gs();