...
`)}var ce=.5;function le(e){return{base:e,lo:e*(1-ce),hi:e*1.5,round:1,choices:[]}}function ue(e){let t=(e.lo+e.hi)/2;return{lower:(e.lo+t)/2,higher:(t+e.hi)/2,mid:t}}function de(e){return e.round>7}function fe(e){return(e.lo+e.hi)/2}function pe(e){let t=fe(e);return t<=0?0:(e.hi-e.lo)/t}function me(e,t){if(de(e))return e;let n=(e.lo+e.hi)/2,{lower:r,higher:i}=ue(e),a={round:e.round,side:t,lo:e.lo,hi:e.hi,lower:r,higher:i},o={...e,choices:[...e.choices,a],round:e.round+1};return t===`lower`?o.hi=n:o.lo=n,o}function he(e){if(e.choices.length===0)return e;let t=e.choices.slice(0,-1),n=e.choices[e.choices.length-1];return{...e,lo:n.lo,hi:n.hi,round:n.round,choices:t}}function ge(e){return fe(e)}var _e=`https://cs2utils.vercel.app/api`,ve=`cs2utils.token`,ye=/^https?:\/\//.test(_e)?new URL(_e).origin:``;function be(){try{return localStorage.getItem(ve)}catch{return null}}function xe(e){try{e?localStorage.setItem(ve,e):localStorage.removeItem(ve)}catch{}}async function h(e,t,n,{auth:r=!1}={}){let i={};if(n!==void 0&&!(n instanceof FormData)&&(i[`Content-Type`]=`application/json`),r){let e=be();if(!e)throw Error(`Please log in first.`);i.Authorization=`Bearer ${e}`,i[`X-AimKit-Token`]=`Bearer ${e}`}let a;try{a=await fetch(`${_e}${t}`,{method:e,headers:i,body:n instanceof FormData?n:n===void 0?void 0:JSON.stringify(n)})}catch{throw Error(`Cannot reach the server. Is the API running?`)}let o=null,s=await a.text();if(s)try{o=JSON.parse(s)}catch{o=null}if(!a.ok){let e=o&&o.error||`Request failed (${a.status}).`,t=o&&typeof o.detail==`string`?o.detail.trim():``,n=t&&t!==e?`${e} ${t}`:e,r=Error(n);throw r.status=a.status,r.data=o,r}return o}var Se=`${_e}/auth/steam`;function Ce(e){xe(e)}function g(e){return!!e&&(e.role===`admin`||e.role===`owner`)}function we(e){return!!e&&e.role===`owner`}function Te(e){return e?/^https?:\/\//.test(e)||e.startsWith(`data:`)?e:ye+e:``}var _={auth:{async register(e){let t=await h(`POST`,`/auth/register`,e);return xe(t.token),t.user},async login(e){let t=await h(`POST`,`/auth/login`,e);return xe(t.token),t.user},logout(){xe(null)},async captcha(){return h(`GET`,`/auth/captcha`)},async changePassword(e){return h(`POST`,`/auth/password`,e,{auth:!0})},async forgot(e){return h(`POST`,`/auth/forgot`,{email:e})},async reset(e,t){return h(`POST`,`/auth/reset`,{token:e,password:t})},async me(){if(!be())return null;try{return(await h(`GET`,`/auth/me`,void 0,{auth:!0})).user}catch{return xe(null),null}},async profile(){return h(`GET`,`/auth/profile`,void 0,{auth:!0})},async setAvatar(e){return(await h(`POST`,`/auth/avatar`,{url:e},{auth:!0})).user},async uploadAvatar(e){let t=new FormData;return t.append(`file`,e),(await h(`POST`,`/auth/avatar/upload`,t,{auth:!0})).user},async changePassword(e){return h(`POST`,`/auth/password`,e,{auth:!0})},async changeUsername(e){let t=await h(`POST`,`/auth/username`,{username:e},{auth:!0});return t.token&&xe(t.token),t.user},async setCredentials(e){let t=await h(`POST`,`/auth/credentials`,e,{auth:!0});return t.token&&xe(t.token),t.user},async forgot(e){return h(`POST`,`/auth/forgot`,{email:e})},async reset(e,t){return h(`POST`,`/auth/reset`,{token:e,password:t})},steamLoginUrl(){return`${_e}/auth/steam`},async steamLinkUrl(){return(await h(`GET`,`/auth/steam/link-url`,void 0,{auth:!0})).url},async steamUnlink(){return(await h(`POST`,`/auth/steam/unlink`,{},{auth:!0})).user}},settings:{async get(){return h(`GET`,`/settings`)}},contact:{async send(e){return h(`POST`,`/contact`,e)}},pros:{async list({q:e=``,sort:t=`name`}={}){let n=new URLSearchParams;e&&n.set(`q`,e),t&&n.set(`sort`,t);let r=n.toString();return h(`GET`,`/pros${r?`?${r}`:``}`)}},configs:{async list({sort:e=`top`,q:t=``}={}){let n=new URLSearchParams;e&&n.set(`sort`,e),t&&n.set(`q`,t);let r=n.toString();return(await h(`GET`,`/configs${r?`?${r}`:``}`,void 0,{auth:!0})).configs},async create(e){return(await h(`POST`,`/configs`,e,{auth:!0})).config},async rate(e,t){return h(`POST`,`/configs/${e}/rate`,{rating:t},{auth:!0})},async remove(e){return h(`DELETE`,`/configs/${e}`,void 0,{auth:!0})}},highlights:{async list({q:e=``}={}){return(await h(`GET`,`/highlights${e?`?q=${encodeURIComponent(e)}`:``}`,void 0,{auth:!0})).highlights},async create(e){return(await h(`POST`,`/highlights`,e,{auth:!0})).highlight},async report(e,t){return h(`POST`,`/highlights/${e}/report`,{reason:t},{auth:!0})},async remove(e){return h(`DELETE`,`/highlights/${e}`,void 0,{auth:!0})}},nades:{async list({map:e=``,type:t=``}={}){let n=new URLSearchParams;e&&n.set(`map`,e),t&&n.set(`type`,t);let r=n.toString();return(await h(`GET`,`/nades${r?`?${r}`:``}`)).nades},async mine(){return(await h(`GET`,`/nades/mine`,void 0,{auth:!0})).nades},async favorites({map:e=``,type:t=``}={}){let n=new URLSearchParams;e&&n.set(`map`,e),t&&n.set(`type`,t);let r=n.toString();return(await h(`GET`,`/nades/favorites${r?`?${r}`:``}`,void 0,{auth:!0})).nades},async social(){return h(`GET`,`/nades/social`,void 0,{auth:!!be()})},async favorite(e){return h(`POST`,`/nades/${e}/favorite`,{},{auth:!0})},async create(e){return(await h(`POST`,`/nades`,e,{auth:!0})).nade},async addMedia(e,t){return(await h(`POST`,`/nades/${e}/media`,t,{auth:!0})).media},async remove(e){return h(`DELETE`,`/nades/${e}`,void 0,{auth:!0})},async parseMapGuide(e){return h(`POST`,`/nades/map-guide/parse`,{text:e},{auth:!0})},async importMapGuide({text:e,nades:t,side:n,guideText:r,fileName:i}={}){return h(`POST`,`/nades/map-guide/import`,{text:e,nades:t,side:n,guideText:r,fileName:i},{auth:!0})},async practicePackFromText({text:e,map:t,importId:n}={}){return h(`POST`,`/nades/map-guide/practice-pack`,{text:e,map:t,importId:n},{auth:!0})},async practicePackFromImport(e){return h(`GET`,`/nades/map-guide/imports/${e}/practice-pack`,void 0,{auth:!!be()})},async practicePackFromNades(e){return h(`POST`,`/nades/map-guide/practice-pack-from-nades`,{nadeIds:e},{auth:!!be()})}},commands:{async catalog(){return h(`GET`,`/commands/catalog`)},async social(){return h(`GET`,`/commands/social`,void 0,{auth:!0})},async recommend(e){return h(`POST`,`/commands/${e}/recommend`,{},{auth:!0})},async addComment(e,t){return h(`POST`,`/commands/${e}/comments`,{body:t},{auth:!0})}},admin:{async pending(){return(await h(`GET`,`/admin/nades/pending`,void 0,{auth:!0})).nades},async pendingComments(){return(await h(`GET`,`/admin/comments/pending`,void 0,{auth:!0})).comments},async pendingCommentsCount(){return(await h(`GET`,`/admin/comments/pending/count`,void 0,{auth:!0})).count},async reviewComment(e,t){return h(`POST`,`/admin/comments/${e}/review`,{decision:t},{auth:!0})},async removeComment(e){return h(`DELETE`,`/admin/comments/${e}`,void 0,{auth:!0})},async syncCommands(){return h(`POST`,`/admin/commands/sync`,{},{auth:!0})},async checkCommandsCs2(){return h(`POST`,`/admin/commands/check-cs2`,{},{auth:!0})},async saveSettings(e){return h(`POST`,`/admin/settings`,e,{auth:!0})},async highlightReports(){return(await h(`GET`,`/admin/highlights/reports`,void 0,{auth:!0})).highlights},async highlightReportsCount(){return(await h(`GET`,`/admin/highlights/reports/count`,void 0,{auth:!0})).count},async reviewHighlight(e,t){return h(`POST`,`/admin/highlights/${e}/review`,{decision:t},{auth:!0})},async syncPros(){return h(`POST`,`/admin/pros/sync`,{},{auth:!0})},async importCommands(e){return h(`POST`,`/admin/commands/import`,{content:e},{auth:!0})},async importPros(e){return h(`POST`,`/admin/pros/import`,{content:e},{auth:!0})},async banUser(e,{hours:t,permanent:n}){return(await h(`POST`,`/admin/users/${e}/ban`,{hours:t,permanent:n},{auth:!0})).user},async unbanUser(e){return(await h(`POST`,`/admin/users/${e}/unban`,{},{auth:!0})).user},async pendingCount(){return(await h(`GET`,`/admin/nades/pending/count`,void 0,{auth:!0})).count},async reviewNade(e,t,n=``){return h(`POST`,`/admin/nades/${e}/review`,{decision:t,note:n},{auth:!0})},async reviewNadesBulk(e,t,n=``){return h(`POST`,`/admin/nades/review-bulk`,{ids:e,decision:t,note:n},{auth:!0})},async reviewMedia(e,t){return h(`POST`,`/admin/media/${e}/review`,{decision:t},{auth:!0})},async reviewMediaBulk(e,t){return h(`POST`,`/admin/media/review-bulk`,{ids:e,decision:t},{auth:!0})},async removeMedia(e){return h(`DELETE`,`/admin/media/${e}`,void 0,{auth:!0})},async users(){return(await h(`GET`,`/admin/users`,void 0,{auth:!0})).users},async setRole(e,t){return(await h(`POST`,`/admin/users/${e}/role`,{role:t},{auth:!0})).user},async contactMessages(){return(await h(`GET`,`/admin/contact`,void 0,{auth:!0})).messages},async removeContact(e){return h(`DELETE`,`/admin/contact/${e}`,void 0,{auth:!0})},async ownerLogs({limit:e=100,offset:t=0,action:n=``}={}){let r=new URLSearchParams;e&&r.set(`limit`,String(e)),t&&r.set(`offset`,String(t)),n&&r.set(`action`,n);let i=r.toString();return h(`GET`,`/admin/owner-logs${i?`?${i}`:``}`,void 0,{auth:!0})}},uploads:{async image(e){let t=new FormData;return t.append(`file`,e),await h(`POST`,`/uploads`,t,{auth:!0})}}},Ee=null,De=new Set;function Oe(){for(let e of De)e(Ee)}function ke(){return Ee}function Ae(e){return De.add(e),()=>De.delete(e)}async function je(){return Ee=await _.auth.me(),Oe(),Ee}async function Me(e){return Ee=await _.auth.login(e),Oe(),Ee}async function Ne(e){return Ee=await _.auth.register(e),Oe(),Ee}function Pe(){_.auth.logout(),Ee=null,Oe()}var Fe,v,Ie=`login`,Le={required:!1,token:null,svg:``};function Re(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function ze(){let e=ke();e?(Fe.innerHTML=`
    ...
    <button type="button" class="app-toast-close" aria-label="Dismiss">&times;</button>`;let c=()=>{wt(),s.classList.remove(`app-toast-in`),s.classList.add(`app-toast-out`),St=setTimeout(()=>{s.parentNode===o&&s.remove()},220)};s.querySelector(`.app-toast-close`)?.addEventListener(`click`,c),o.appendChild(s),requestAnimationFrame(()=>{requestAnimationFrame(()=>s.classList.add(`app-toast-in`))}),xt=setTimeout(c,i)}var Et=360,Dt=100,b,x=null,S=`browse`,Ot={text:``,kind:``},kt=0,At=!1,jt={map:``,type:``},Mt=[],C=new Map,Nt={counts:{},mine:[]},Pt=[],Ft=[],It=[],Lt=[],w=zt(),T=Bt(),E=null,Rt=1;function zt(){return{map:`mirage`,type:`smoke`,side:`t`,technique:`stand`,title:``,description:``,start:null,end:null}}function Bt(){return{text:``,fileName:``,side:`t`,parsed:null,selected:null}}function D(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Vt(e){let t=Te(e);return/^https?:\/\//.test(t)||t.startsWith(`data:image/`)?t:``}function Ht(e){let t=/(?:youtube\.com\/(?:watch\?v=|embed\/|shorts\/)|youtu\.be\/)([\w-]{6,})/.exec(e||``);return t?t[1]:null}function Ut(e,t){return e.map(e=>`<option value="${e.id}"${e.id===t?` selected`:``}>${D(e.name)}</option>`).join(``)}function O(e,t=``,n={}){Ot={text:e,kind:t};let r=b?.querySelector(`#nades-status`);r&&(r.textContent=e,r.className=`status${t?` ${t}`:``}`),(t===`error`||t===`warn`)&&e&&Tt(e,{kind:t,title:n.title})}function Wt(e){return`<span class="nade-badge ${e}">${e}</span>`}function Gt(e){try{return new Date(e).toLocaleDateString()}catch{return``}}async function Kt(){if(g(x))try{kt=await _.admin.pendingCount()}catch{kt=0}else kt=0}async function qt(){try{Nt=await _.nades.social()}catch{Nt={counts:{},mine:[]}}}async function k(e){S=e,At=![`add`,`import`].includes(e),At&&A();try{S===`browse`&&(Mt=await _.nades.list(jt),await qt()),S===`favorites`&&(x?(Pt=await _.nades.favorites(jt),await qt()):Pt=[]),S===`mine`&&x&&(Ft=await _.nades.mine()),S===`review`&&g(x)&&(It=await _.admin.pending(),kt=await _.admin.pendingCount()),S===`users`&&g(x)&&(Lt=await _.admin.users())}catch(e){O(e.message,`error`)}At=!1,A()}function Jt(e){let t=Vt(e.url);if(!t)return``;if(e.kind===`video`){let n=Ht(e.url);return n?`<iframe class="nade-media-embed" src="https://www.youtube.com/embed/${D(n)}" title="nade video" allowfullscreen loading="lazy"></iframe>`:/\.(mp4|webm|mov)(\?|$)/i.test(e.url)?`<video class="nade-media-embed" src="${D(t)}" controls preload="none"></video>`:`<a class="btn ghost" href="${D(t)}" target="_blank" rel="noopener noreferrer">Open video ↗</a>`}return`<a href="${D(t)}" target="_blank" rel="noopener noreferrer"><img class="nade-media-img" src="${D(t)}" alt="${D(e.addedByName||`nade media`)}" loading="lazy" /></a>`}function Yt(e,{showStatus:t=!1,showTryInGame:n=!1,adminRemove:r=!1,showFavorite:i=!1}={}){let a=$e(e.type),o=(e.media||[]).filter(e=>t?!0:e.status===`approved`),s=o.length?`<div class="nade-media">${o.map(e=>`<div class="nade-media-item">${Jt(e)}${t?`<div class="nade-media-meta">${Wt(e.status)} <span>by ${D(e.addedByName||``)}</span></div>`:``}</div>`).join(``)}</div>`:`<p class="hint">No approved media yet — a 2D throw preview is shown above.</p>`,c=n&&C.has(e.id),l=Nt.mine.includes(e.id),u=Nt.counts[e.id]||0,d=i?`<button class="btn btn-sm favorite ${l?`active`:``}" type="button" data-favorite-nade="${e.id}" title="${l?`Remove from favorites`:`Add to favorites`}">${l?`★ Favorited`:`☆ Favorite`}${u?` <span class="fav-count">${u}</span>`:``}</button>`:``,f=n?`<div class="nade-card-actions">
    ...
    <article class="nade-card${n?` browse-nade-card`:``}${c?` selected`:``}${l&&i?` favorited`:``}"${n?` data-browse-nade="${e.id}" data-map="${D(e.map)}" tabindex="0" role="checkbox" aria-checked="${c?`true`:`false`}"`:``}>
      ...
      <canvas class="nade-canvas" width="${Et}" height="${Et}"
      ...
      ${s}
      <p class="nade-foot">by ${D(e.authorName)} · ${Gt(e.createdAt)}</p>
      ${f}
    </article>`}function Xt(){return[...C.keys()]}function Zt(){let e=Mt.length?Mt.map(e=>Yt(e,{showTryInGame:!0,adminRemove:!0,showFavorite:!0})).join(``):`<p class="hint">No approved nades yet${x?` — be the first to add one!`:` — log in and add the nades you found.`}</p>`,t=C.size;return`
    <div class="nades-filters">
      <label class="field">
        <span>Map</span>
        <select id="filter-map"><option value="">All maps</option>${Ut(Je,jt.map)}</select>
      </label>
      <label class="field">
        <span>Type</span>
        <select id="filter-type"><option value="">All types</option>${Ut(Ye,jt.type)}</select>
      </label>
    </div>
    <div class="browse-select-bar">
      <span class="hint">Click a lineup to select it (up to ${Dt}, same map) for one merged annotation file.</span>
      ...
      <button class="btn primary" type="button" id="browse-try-selected" ${t?``:`disabled`}>
        Try selected in game (${t}/${Dt})
      </button>
    </div>
    <div class="nade-grid">${e}</div>`}function Qt(){if(!x)return $t(`save favorite nades`);let e=Pt.length?Pt.map(e=>Yt(e,{showTryInGame:!0,adminRemove:!0,showFavorite:!0})).join(``):`<p class="hint">No favorites yet — star lineups in Browse to save them here.</p>`,t=C.size;return`
    <div class="nades-filters">
      <label class="field">
        <span>Map</span>
        <select id="filter-map"><option value="">All maps</option>${Ut(Je,jt.map)}</select>
    ...
    <div class="browse-select-bar">
      <span class="hint">Your saved lineups. Select up to ${Dt} (same map) to try in game.</span>
      <button class="btn ghost" type="button" id="browse-select-clear" ${t?``:`disabled`}>Clear selection</button>
      <button class="btn primary" type="button" id="browse-try-selected" ${t?``:`disabled`}>
        Try selected in game (${t}/${Dt})
      </button>
    </div>
    <div class="nade-grid">${e}</div>`}function $t(e){return`<div class="login-prompt">
    ...
    <div class="nade-add">
      <div class="nade-add-map">
        ...
        <canvas id="nade-add-canvas" class="nade-canvas interactive" width="${Et}" height="${Et}"></canvas>
      ...
      <form class="nade-add-form" id="nade-add-form">
        ...
        <div class="sens-grid">
          <label class="field"><span>Map</span><select id="add-map">${Ut(Je,w.map)}</select></label>
          <label class="field"><span>Type</span><select id="add-type">${Ut(Ye,w.type)}</select></label>
        </div>
        <div class="sens-grid">
          <label class="field"><span>Side</span><select id="add-side">${Ut(Ze,w.side)}</select></label>
          <label class="field"><span>Technique</span><select id="add-technique">${Ut(Xe,w.technique)}</select></label>
        </div>
    ...
    </div>`:$t(`add nades`)}function tn(){if(!x)return $t(`import a CS2 map guide`);let e=T.parsed,t=e&&T.selected!=null?e.nades[T.selected]:e?.nades?.[0]||null,n=e?`<div class="guide-preview-list">
    ...
    <div class="nade-import">
      <div class="nade-add-map">
        ...
        <canvas id="guide-preview-canvas" class="nade-canvas" width="${Et}" height="${Et}"></canvas>
      ...
      <div class="nade-add-form">
        ...
        <label class="field">
          ...
          <select id="guide-side">${Ut(Ze,T.side)}</select>
        </label>
        <div class="actions">
    ...
    </div>`}function nn(){return x?Ft.length?`<div class="nade-grid">${Ft.map(e=>`
      <div class="nade-mine">
        ${Yt(e,{showStatus:!0})}
      ...
      </div>`).join(``)}</div>`:`<p class="hint">You haven't added any nades yet.</p>`:$t(`see and manage your nades`)}function rn(){return g(x)?It.length?`
    <div class="review-bulk-bar">
      <label class="review-select-all">
        <input type="checkbox" id="review-select-all" />
        <span>Select all pending nades (${It.filter(e=>e.status===`pending`).length})</span>
      </label>
    ...
    <div class="nade-grid">${It.map(e=>{let t=e.media||[],n=t.length?`<div class="review-media">${t.map(e=>`<div class="review-media-item">${Jt(e)}
                  <div class="nade-media-meta">${Wt(e.status)} <span>by ${D(e.addedByName||``)}</span></div>
                  <div class="actions">
                 ...
                 <input type="text" class="review-note" data-nade="${e.id}" placeholder="Optional note to the author" />
               </div>`;return`<div class="nade-mine">${Yt(e,{showStatus:!0})}${n}${r}</div>`}).join(``)}</div>`:`<p class="hint">Nothing pending review. Nice and clean.</p>`:`<p class="hint">Admins only.</p>`}function an(e){if(!e.bannedUntil)return null;let t=new Date(e.bannedUntil);return t.getTime()<=Date.now()?null:t.getFullYear()>=9999?`permanently`:`until ${t.toLocaleString()}`}function on(){if(!g(x))return`<p class="hint">Admins only.</p>`;let e=we(x);return`<div class="users-table">
  ...
  </div>`}function sn(){let e=Nt.mine?.length||0,t=[[`browse`,`Browse`]];return x&&(t.push([`favorites`,`Favorites${e?` (${e})`:``}`]),t.push([`add`,`Add nade`],[`import`,`Import guide`],[`mine`,`My nades`])),g(x)&&t.push([`review`,`Review${kt?` (${kt})`:``}`],[`users`,`Users`]),`<nav class="nades-subnav">${t.map(([e,t])=>`<button class="tool-tab ${S===e?`active`:``}" data-view="${e}">${D(t)}</button>`).join(``)}</nav>`}function cn(){if(At)return`<div class="nades-loading"><span class="spinner"></span> Loading…</div>`;switch(S){case`add`:return en();case`import`:return tn();case`favorites`:return Qt();case`mine`:return nn();case`review`:return rn();case`users`:return on();default:return Zt()}}function A(){b.innerHTML=`
    <div class="nades-shell">
      ${sn()}
      <div class="nades-body">${cn()}</div>
      <div id="nades-status" class="status ${Ot.kind}">${D(Ot.text)}</div>
      ${E?_t(E,{esc:D,lineupCount:Rt}):``}
    </div>`,fn(),ln()}function ln(){b.querySelectorAll(`canvas.nade-canvas:not(.interactive):not(#guide-preview-canvas)`).forEach(e=>{ct(e,{mapId:e.dataset.map,type:e.dataset.type,start:{x:Number(e.dataset.sx),y:Number(e.dataset.sy)},end:{x:Number(e.dataset.ex),y:Number(e.dataset.ey)}})}),un(),dn()}function un(){let e=b.querySelector(`#nade-add-canvas`);e&&ct(e,{mapId:w.map,type:w.type,start:w.start,end:w.end})}function dn(){let e=b.querySelector(`#guide-preview-canvas`);if(!e)return;let t=T.parsed?.nades?.[T.selected??0];if(!t){ct(e,{mapId:`mirage`,type:`smoke`,start:null,end:null});return}ct(e,{mapId:t.map,type:t.type,start:t.start,end:t.end})}function fn(){b.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>y(e.dataset.openAuth))),b.querySelectorAll(`[data-view]`).forEach(e=>e.addEventListener(`click`,()=>k(e.dataset.view))),b.querySelector(`#filter-map`)?.addEventListener(`change`,e=>{jt.map=e.target.value,C=new Map,k(S===`favorites`?`favorites`:`browse`)}),b.querySelector(`#filter-type`)?.addEventListener(`change`,e=>{jt.type=e.target.value,k(S===`favorites`?`favorites`:`browse`)}),b.querySelectorAll(`.browse-select`).forEach(e=>e.addEventListener(`change`,()=>{yn(Number(e.value),e.dataset.map,e.checked),bn(e.closest(`.browse-nade-card`))})),b.querySelectorAll(`.browse-nade-card`).forEach(e=>{e.addEventListener(`click`,t=>{t.target.closest(`a, button, input, label`)||xn(e)}),e.addEventListener(`keydown`,t=>{t.key!==` `&&t.key!==`Enter`||t.target.closest(`a, button, input, label`)||(t.preventDefault(),xn(e))})}),b.querySelector(`#browse-select-clear`)?.addEventListener(`click`,()=>{C=new Map,A()}),b.querySelector(`#browse-try-selected`)?.addEventListener(`click`,()=>{Cn(Xt())}),b.querySelectorAll(`[data-try-nades]`).forEach(e=>e.addEventListener(`click`,t=>{t.stopPropagation(),Cn([Number(e.dataset.tryNades)])})),b.querySelectorAll(`[data-favorite-nade]`).forEach(e=>e.addEventListener(`click`,t=>{t.stopPropagation(),wn(Number(e.dataset.favoriteNade))}));let e=b.querySelector(`#nade-add-canvas`);e&&e.addEventListener(`click`,t=>{let n=dt(e,t);!w.start||w.start&&w.end?(w.start=n,w.end=null):w.end=n;let r=b.querySelector(`#nade-add-coords`);r&&(r.textContent=w.end?`Throw + landing set. Adjust by clicking again to start over.`:`Now click the landing spot for the grenade.`),un()}),b.querySelector(`#add-map`)?.addEventListener(`change`,e=>{w.map=e.target.value,un()}),b.querySelector(`#add-type`)?.addEventListener(`change`,e=>{w.type=e.target.value,un()}),b.querySelector(`#add-clear`)?.addEventListener(`click`,()=>{w.start=null,w.end=null,un();let e=b.querySelector(`#nade-add-coords`);e&&(e.textContent=`Click the map to set the throw position, then click again for the landing spot.`)}),b.querySelector(`#nade-add-form`)?.addEventListener(`submit`,pn),b.querySelector(`#guide-file`)?.addEventListener(`change`,mn),b.querySelector(`#guide-text`)?.addEventListener(`input`,e=>{T.text=e.target.value}),b.querySelector(`#guide-side`)?.addEventListener(`change`,e=>{T.side=e.target.value}),b.querySelector(`#guide-parse`)?.addEventListener(`click`,hn),b.querySelector(`#guide-import`)?.addEventListener(`click`,gn),b.querySelector(`#guide-try-game`)?.addEventListener(`click`,_n),b.querySelector(`#guide-clear`)?.addEventListener(`click`,()=>{T=Bt(),E=null,A(),O(`Cleared map guide.`,``)}),b.querySelectorAll(`[data-guide-idx]`).forEach(e=>e.addEventListener(`click`,()=>{T.selected=Number(e.dataset.guideIdx),A()})),b.querySelector(`[data-try-game-close]`)?.addEventListener(`click`,()=>{E=null,Rt=1,A()}),b.querySelector(`[data-try-game-download]`)?.addEventListener(`click`,()=>{if(!E)return;let e=gt(b);if(!e.guide&&!e.cfg){let e=b.querySelector(`[data-try-game-status]`);e&&(e.textContent=`Choose at least one file to download, or just Open CS2 if you already have them.`);return}let t=pt(E,e),n=b.querySelector(`[data-try-game-status]`);n&&(n.textContent=t.length?`Downloaded ${t.join(` + `)}. Copy into your CS2 folders, then Open CS2.`:`Nothing selected to download.`)}),b.querySelector(`[data-try-game-open]`)?.addEventListener(`click`,Tn),b.querySelector(`[data-try-game-copy-cmd]`)?.addEventListener(`click`,En),b.querySelectorAll(`[data-add-media]`).forEach(e=>e.addEventListener(`click`,()=>Dn(e.dataset.addMedia))),b.querySelectorAll(`[data-try-import]`).forEach(e=>e.addEventListener(`click`,()=>vn(e.dataset.tryImport))),b.querySelectorAll(`[data-delete-nade]`).forEach(e=>e.addEventListener(`click`,()=>On(e.dataset.deleteNade))),b.querySelectorAll(`[data-delete-media]`).forEach(e=>e.addEventListener(`click`,()=>kn(e.dataset.deleteMedia))),b.querySelectorAll(`[data-approve-nade]`).forEach(e=>e.addEventListener(`click`,()=>An(e.dataset.approveNade,`approved`))),b.querySelectorAll(`[data-reject-nade]`).forEach(e=>e.addEventListener(`click`,()=>An(e.dataset.rejectNade,`rejected`))),b.querySelectorAll(`[data-approve-media]`).forEach(e=>e.addEventListener(`click`,()=>Mn(e.dataset.approveMedia,`approved`))),b.querySelectorAll(`[data-reject-media]`).forEach(e=>e.addEventListener(`click`,()=>Mn(e.dataset.rejectMedia,`rejected`)));let t=b.querySelector(`#review-select-all`),n=b.querySelector(`#review-bulk-approve`),r=b.querySelector(`#review-bulk-reject`),i=()=>{let e=b.querySelectorAll(`.review-nade-check:checked`).length;n&&(n.disabled=e===0),r&&(r.disabled=e===0)};t?.addEventListener(`change`,()=>{b.querySelectorAll(`.review-nade-check`).forEach(e=>{e.checked=t.checked}),i()}),b.querySelectorAll(`.review-nade-check`).forEach(e=>e.addEventListener(`change`,i)),n?.addEventListener(`click`,()=>jn(`approved`)),r?.addEventListener(`click`,()=>jn(`rejected`)),b.querySelectorAll(`[data-role-user]`).forEach(e=>e.addEventListener(`click`,()=>Nn(e.dataset.roleUser,e.dataset.role))),b.querySelectorAll(`[data-ban]`).forEach(e=>e.addEventListener(`click`,()=>{let t=b.querySelector(`[data-ban-dur="${e.dataset.ban}"]`);Pn(e.dataset.ban,t?t.value:`24`)})),b.querySelectorAll(`[data-unban]`).forEach(e=>e.addEventListener(`click`,()=>Fn(e.dataset.unban)))}async function pn(e){if(e.preventDefault(),w.title=b.querySelector(`#add-title`)?.value||``,w.map=b.querySelector(`#add-map`)?.value||w.map,w.type=b.querySelector(`#add-type`)?.value||w.type,w.side=b.querySelector(`#add-side`)?.value||w.side,w.technique=b.querySelector(`#add-technique`)?.value||w.technique,w.description=b.querySelector(`#add-description`)?.value||``,!w.start||!w.end){O(`Click the map to set both the throw position and the landing spot.`,`error`);return}let t=[],n=(b.querySelector(`#add-video`)?.value||``).trim(),r=(b.querySelector(`#add-image`)?.value||``).trim();n&&t.push({url:n,kind:`video`}),r&&t.push({url:r,kind:nt(r)});let i=b.querySelector(`#add-upload`);try{if(i?.files?.[0]){O(`Uploading image…`,``);let e=await _.uploads.image(i.files[0]);t.push({url:e.url,kind:`image`})}await _.nades.create({...w,media:t}),w=zt(),await k(`mine`),O(`Nade submitted! It will appear publicly once an admin approves it.`,`ok`)}catch(e){O(e.message,`error`)}}async function mn(e){let t=e.target.files?.[0];if(t)try{T.fileName=t.name,T.text=await t.text(),T.parsed=null,T.selected=null,A(),O(`Loaded ${t.name}. Click Preview lineups.`,`ok`)}catch{O(`Could not read that file.`,`error`)}}async function hn(){let e=(b.querySelector(`#guide-text`)?.value||T.text||``).trim();if(T.text=e,T.side=b.querySelector(`#guide-side`)?.value||T.side,!e){O(`Upload or paste a CS2 map guide .txt first.`,`error`);return}try{O(`Parsing map guide…`,``);let t=await _.nades.parseMapGuide(e);T.parsed=t,T.selected=0,A(),O(`Found ${t.nades.length} lineup${t.nades.length===1?``:`s`} on ${Qe(t.map)}.`,`ok`)}catch(e){T.parsed=null,A(),O(e.message,`error`)}}async function gn(){if(!T.parsed?.nades?.length){O(`Preview the guide first so you can confirm the lineups.`,`error`);return}T.side=b.querySelector(`#guide-side`)?.value||T.side;let e=(b.querySelector(`#guide-text`)?.value||T.text||``).trim();try{O(`Importing lineups…`,``);let t=await _.nades.importMapGuide({nades:T.parsed.nades,side:T.side,guideText:e,fileName:T.fileName});T=Bt(),await k(`mine`),O(`Imported ${t.count} nade${t.count===1?``:`s`} — pending admin review.`,`ok`)}catch(e){O(e.message,`error`)}}async function _n(){let e=(b.querySelector(`#guide-text`)?.value||T.text||``).trim(),t=T.parsed?.map;if(!e||!t){O(`Preview the map guide first.`,`error`);return}try{O(`Preparing CS2 practice pack…`,``),E=(await _.nades.practicePackFromText({text:e,map:t})).pack,Rt=T.parsed?.nades?.length||1,A(),O(`Choose what to download (or skip if you already have the files), then Open CS2.`,`ok`)}catch(e){O(e.message,`error`)}}async function vn(e){try{O(`Preparing CS2 practice pack…`,``),E=(await _.nades.practicePackFromImport(e)).pack,Rt=1,A(),O(`Choose what to download (or skip if you already have the files), then Open CS2.`,`ok`)}catch(e){O(e.message,`error`)}}function yn(e,t,n){if(!Number.isFinite(e)||e<=0)return!1;if(!n)return C.delete(e),Sn(),!0;if(C.size>=Dt&&!C.has(e))return O(`You can select at most ${Dt} lineups at once.`,`error`,{title:`Too many lineups`}),!1;for(let[,e]of C)if(e!==t)return O(`You can only select lineups from one map. Clear your selection or pick more from ${Qe(e)}.`,`error`,{title:`One map only`}),!1;return C.set(e,t),Sn(),!0}function bn(e){if(!e)return;let t=Number(e.dataset.browseNade),n=C.has(t);e.classList.toggle(`selected`,n),e.setAttribute(`aria-checked`,n?`true`:`false`);let r=e.querySelector(`.browse-select`);r&&(r.checked=n)}function xn(e){let t=Number(e.dataset.browseNade),n=e.dataset.map;yn(t,n,!C.has(t)),bn(e)}function Sn(){let e=b.querySelector(`#browse-try-selected`),t=b.querySelector(`#browse-select-clear`),n=C.size;e&&(e.disabled=n===0,e.textContent=`Try selected in game (${n}/${Dt})`),t&&(t.disabled=n===0)}async function Cn(e){let t=[...new Set((e||[]).map(Number).filter(e=>Number.isFinite(e)&&e>0))];if(!t.length){O(`Select at least one lineup (max ${Dt}, same map).`,`error`,{title:`Nothing selected`});return}if(t.length>Dt){O(`You can open at most ${Dt} lineups at once.`,`error`,{title:`Too many lineups`});return}try{O(`Preparing CS2 practice pack…`,``),E=(await _.nades.practicePackFromNades(t)).pack,Rt=t.length,A(),O(t.length>1?`Merged ${t.length} lineups into one annotation file. Download what you need, then Open CS2.`:`Choose what to download (or skip if you already have the files), then Open CS2.`,`ok`)}catch(e){O(e.message,`error`)}}async function wn(e){if(!x){y(`login`);return}if(!(!Number.isFinite(e)||e<=0))try{let t=await _.nades.favorite(e);Nt.counts[e]=t.count,Nt.mine=t.favorited?[...Nt.mine.filter(t=>t!==e),e]:Nt.mine.filter(t=>t!==e),S===`favorites`&&!t.favorited&&(Pt=Pt.filter(t=>t.id!==e)),A(),O(t.favorited?`Added to favorites.`:`Removed from favorites.`,`ok`)}catch(e){O(e.message,`error`)}}function Tn(){if(!E)return;let e=b.querySelector(`[data-try-game-status]`);try{mt(E);let t=`Opening CS2 private ${E.deMap}… Quit CS2 first if it was already running, otherwise paste in console: ${E.consoleCommand||`map ${E.deMap}; exec ${E.cfgBaseName}`}`;e&&(e.textContent=t),O(t,`ok`)}catch(t){e&&(e.textContent=t.message),O(t.message,`error`)}}async function En(){if(!E)return;let e=b.querySelector(`[data-try-game-status]`);try{let t=`Copied: ${await ht(E)}`;e&&(e.textContent=t),O(t,`ok`)}catch(t){e&&(e.textContent=t.message),O(t.message,`error`)}}async function Dn(e){let t=(b.querySelector(`.add-media-url[data-nade="${e}"]`)?.value||``).trim();if(!t){O(`Enter a media URL first.`,`error`);return}try{await _.nades.addMedia(e,{url:t,kind:nt(t)}),await k(`mine`),O(`Media added — pending admin review.`,`ok`)}catch(e){O(e.message,`error`)}}async function On(e){if(confirm(`Permanently delete this nade and its media?`))try{await _.nades.remove(e),C.delete(Number(e)),await k(S),O(`Nade deleted.`,`ok`)}catch(e){O(e.message,`error`)}}async function kn(e){if(confirm(`Permanently remove this media?`))try{await _.admin.removeMedia(e),await k(S),O(`Media removed.`,`ok`)}catch(e){O(e.message,`error`)}}async function An(e,t){let n=b.querySelector(`.review-note[data-nade="${e}"]`)?.value||``;try{await _.admin.reviewNade(e,t,n),await k(`review`),O(`Nade ${t}.`,`ok`)}catch(e){O(e.message,`error`)}}async function jn(e){let t=[...b.querySelectorAll(`.review-nade-check:checked`)].map(e=>Number(e.value));if(!t.length){O(`Select at least one pending nade.`,`error`);return}let n=b.querySelector(`#review-bulk-note`)?.value||``;try{let r=await _.admin.reviewNadesBulk(t,e,n);await k(`review`),O(`${e===`approved`?`Approved`:`Rejected`} ${r.updated} nade${r.updated===1?``:`s`}.`,`ok`)}catch(e){O(e.message,`error`)}}async function Mn(e,t){try{await _.admin.reviewMedia(e,t),await k(`review`),O(`Media ${t}.`,`ok`)}catch(e){O(e.message,`error`)}}async function Nn(e,t){try{await _.admin.setRole(e,t),await k(`users`),O(`Role updated.`,`ok`)}catch(e){O(e.message,`error`)}}async function Pn(e,t){try{t===`perma`?await _.admin.banUser(e,{permanent:!0}):await _.admin.banUser(e,{hours:Number(t)}),await k(`users`),O(`User banned.`,`ok`)}catch(e){O(e.message,`error`)}}async function Fn(e){try{await _.admin.unbanUser(e),await k(`users`),O(`User unbanned.`,`ok`)}catch(e){O(e.message,`error`)}}async function In(){b=document.querySelector(`#nades-tool`),b&&(x=ke(),Ae(async e=>{x=e,await Kt(),!x&&[`add`,`import`,`mine`,`favorites`,`review`,`users`].includes(S)&&(S=`browse`),x&&!g(x)&&[`review`,`users`].includes(S)&&(S=`browse`),await k(S)}),await Kt(),A(),await k(`browse`))}function Ln(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Rn(e){let t=document.createElement(`div`);t.className=`modal`,t.innerHTML=`
    <div class="modal-backdrop" data-close></div>
    <div class="modal-card import-card" role="dialog" aria-modal="true" aria-label="${Ln(e.title)}">
      <button class="modal-close" data-close aria-label="Close">&times;</button>
      <h2 class="modal-title">${Ln(e.title)}</h2>
      <p class="hint">${Ln(e.description)}</p>
      <ol class="import-steps">
        <li>Open the source and complete the verification: <a class="btn btn-sm" href="${Ln(e.sourceUrl)}" target="_blank" rel="noopener noreferrer">${Ln(e.sourceLabel)} ↗</a></li>
        <li>Copy the page content.</li>
        <li>Paste it below and import.</li>
      </ol>
      <textarea id="import-content" rows="9" spellcheck="false" placeholder="${Ln(e.placeholder||`Paste the page content here…`)}"></textarea>
      <div class="actions">
        <button class="btn primary" id="import-run">Import</button>
        <button class="btn ghost" data-close>Cancel</button>
      </div>
      <p class="status" id="import-status"></p>
    </div>`,document.body.appendChild(t);let n=()=>t.remove();t.querySelectorAll(`[data-close]`).forEach(e=>e.addEventListener(`click`,n));let r=e=>{e.key===`Escape`&&(n(),document.removeEventListener(`keydown`,r))};document.addEventListener(`keydown`,r);let i=t.querySelector(`#import-status`),a=t.querySelector(`#import-run`);a.addEventListener(`click`,async()=>{let r=t.querySelector(`#import-content`).value;if(!r.trim()){i.textContent=`Paste the page content first.`,i.className=`status error`;return}a.disabled=!0,i.textContent=`Importing…`,i.className=`status`;try{let t=await e.onImport(r);i.textContent=t||`Imported.`,i.className=`status ok`,setTimeout(n,900)}catch(e){i.textContent=e.message,i.className=`status error`,a.disabled=!1}}),t.querySelector(`#import-content`)?.focus()}var j,zn=null,M={commands:[],categories:[],recommendedLaunchOptions:``,source:`seed`,lastSync:0,cs2Build:``,cs2Version:``,remoteConfigured:!1},Bn={counts:{},mine:[],comments:{}},Vn=[],Hn={text:``,kind:``},Un=new Set;function N(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function P(e,t=``){Hn={text:e,kind:t};let n=j?.querySelector(`#commands-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function Wn(e){if(!e)return`—`;try{return new Date(e).toLocaleString()}catch{return`—`}}async function Gn(){try{M=await _.commands.catalog()}catch(e){P(`Could not load command catalog: ${e.message}`,`error`)}try{Bn=await _.commands.social()}catch{}if(g(zn))try{Vn=await _.admin.pendingComments()}catch{Vn=[]}else Vn=[]}function Kn(e){let t=Bn.comments[e.key]||[];return`<div class="cmd-comments">${t.length?t.map(e=>`<div class="cmd-comment">
            <div class="cmd-comment-body"><strong>${N(e.username)}</strong><span>${N(e.body)}</span></div>
            ${g(zn)?`<button class="btn btn-sm ghost danger" type="button" data-remove-comment="${e.id}">Remove</button>`:``}
          </div>`).join(``):`<p class="hint">No comments yet.</p>`}${zn?`<form class="cmd-comment-form" data-comment-key="${N(e.key)}">
       ...
       <p class="hint">Comments are reviewed by an admin before appearing.</p>`:`<button class="btn btn-sm" data-open-auth="login">Log in to comment</button>`}</div>`}function qn(e){let t=Bn.counts[e.key]||0,n=Bn.mine.includes(e.key),r=(Bn.comments[e.key]||[]).length,i=Un.has(e.key);return`
    <article class="cmd-card" data-search="${N(`${e.command} ${e.title} ${e.description}`.toLowerCase())}">
      ...
      ${i?Kn(e):``}
    </article>`}function Jn(e){let t=M.commands.filter(t=>t.category===e.id);return t.length?`
    <section class="cmd-category" data-category="${N(e.id)}">
      <h3 class="cmd-cat-title">${N(e.name)} <span class="cmd-count">${t.length}</span></h3>
      <div class="cmd-grid">${t.map(qn).join(``)}</div>
    </section>`:``}function Yn(){let e=M.commands.filter(e=>e.isNew).length,t=g(zn)?`<div class="actions">
    ...
    <section class="cmd-status-bar">
      <div>
        ...
        <strong>Last synced:</strong> ${Wn(M.lastSync)}
        ${e?` · <span class="nade-badge new">${e} new</span>`:``}
      </div>
      ${t}
    </section>`}function Xn(){return!g(zn)||!Vn.length?``:`
    <section class="cmd-review panel-review">
      <h3>Comments awaiting review (${Vn.length})</h3>
      ${Vn.map(e=>`<div class="review-comment">
    ...
    </section>`}function Zn(){j.innerHTML=`
    <div class="commands-shell">
      ...
      ${M.categories.map(Jn).join(``)}
      <div id="commands-status" class="status ${Hn.kind}">${N(Hn.text)}</div>
    </div>`,$n()}function Qn(e){let t=e.trim().toLowerCase();j.querySelectorAll(`.cmd-category`).forEach(e=>{let n=0;e.querySelectorAll(`.cmd-card`).forEach(e=>{let r=!t||e.dataset.search.includes(t);e.classList.toggle(`hidden`,!r),r&&(n+=1)}),e.classList.toggle(`hidden`,n===0)})}function $n(){j.querySelectorAll(`[data-copy]`).forEach(e=>e.addEventListener(`click`,async()=>{try{await navigator.clipboard.writeText(e.dataset.copy),P(`Copied to clipboard.`,`ok`)}catch{P(`Clipboard blocked — select and copy manually.`,`error`)}})),j.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>y(e.dataset.openAuth))),j.querySelectorAll(`[data-recommend]`).forEach(e=>e.addEventListener(`click`,()=>er(e.dataset.recommend))),j.querySelectorAll(`[data-toggle-comments]`).forEach(e=>e.addEventListener(`click`,()=>{let t=e.dataset.toggleComments;Un.has(t)?Un.delete(t):Un.add(t),Zn()})),j.querySelectorAll(`.cmd-comment-form`).forEach(e=>e.addEventListener(`submit`,t=>{t.preventDefault(),tr(e.dataset.commentKey,e.querySelector(`input`))})),j.querySelectorAll(`[data-approve-comment]`).forEach(e=>e.addEventListener(`click`,()=>nr(e.dataset.approveComment,`approved`))),j.querySelectorAll(`[data-reject-comment]`).forEach(e=>e.addEventListener(`click`,()=>nr(e.dataset.rejectComment,`rejected`))),j.querySelectorAll(`[data-remove-comment]`).forEach(e=>e.addEventListener(`click`,()=>rr(e.dataset.removeComment))),j.querySelector(`#cmd-search`)?.addEventListener(`input`,e=>Qn(e.target.value)),j.querySelector(`#cmd-sync`)?.addEventListener(`click`,ir),j.querySelector(`#cmd-check-cs2`)?.addEventListener(`click`,ar)}async function er(e){if(!zn){y(`login`);return}try{let t=await _.commands.recommend(e);Bn.counts[e]=t.count,Bn.mine=t.recommended?[...Bn.mine.filter(t=>t!==e),e]:Bn.mine.filter(t=>t!==e),Zn()}catch(e){P(e.message,`error`)}}async function tr(e,t){let n=(t?.value||``).trim();if(!n){P(`Write something first.`,`error`);return}try{await _.commands.addComment(e,n),P(`Comment submitted — an admin will review it before it appears.`,`ok`),t&&(t.value=``)}catch(e){P(e.message,`error`)}}async function nr(e,t){try{await _.admin.reviewComment(e,t),await Gn(),Zn(),P(`Comment ${t}.`,`ok`)}catch(e){P(e.message,`error`)}}async function rr(e){if(confirm(`Permanently delete this comment?`))try{await _.admin.removeComment(e),await Gn(),Zn(),P(`Comment deleted.`,`ok`)}catch(e){P(e.message,`error`)}}function ir(){Rn({title:`Sync commands from the CS2 wiki`,description:`The Valve wiki has a bot check that blocks servers. Open it in your browser, complete the verification, then copy the page source (wikitext) and paste it here — the server will parse it.`,sourceUrl:`https://developer.valvesoftware.com/w/index.php?title=List_of_Counter-Strike_2_console_command_variables&action=raw`,sourceLabel:`Open CS2 wiki source`,placeholder:`Paste the wiki page source (wikitext), or a JSON list of commands…`,onImport:async e=>{let t=await _.admin.importCommands(e);return await Gn(),Zn(),`Imported ${t.count} commands.`}})}async function ar(){P(`Checking the current CS2 build…`,``);try{let e=await _.admin.checkCommandsCs2();await Gn(),Zn(),P(e.ok?`CS2 build ${e.build}${e.changed?` — changed, catalog re-synced`:` — no change`}.`:`Check failed: ${e.reason}`,e.ok?`ok`:`error`)}catch(e){P(e.message,`error`)}}async function or(){j=document.querySelector(`#commands-tool`),j&&(zn=ke(),Ae(async e=>{zn=e,await Gn(),Zn()}),Zn(),await Gn(),Zn())}var F,I=null,sr=null,cr={paypalUrl:``,steamTradeUrl:``},lr={text:``,kind:``};function L(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function R(e,t=``){lr={text:e,kind:t};let n=F?.querySelector(`#profile-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function ur(e){try{return new Date(e).toLocaleDateString()}catch{return`—`}}async function dr(){if(I){try{sr=(await _.auth.profile()).stats}catch(e){R(e.message,`error`)}if(we(I))try{cr=await _.settings.get()}catch{}}}function fr(e,t){return`<div class="profile-stat"><dt>${L(e)}</dt><dd>${L(t)}</dd></div>`}function pr(){return we(I)?`
    <section class="panel profile-settings">
      ...
      <div class="profile-settings-body">
        ...
        <label class="field">
          ...
          <input id="set-paypal" type="url" placeholder="https://www.paypal.com/paypalme/yourname" value="${L(cr.paypalUrl)}" />
        </label>
        <label class="field">
          <span>Steam trade link</span>
          <input id="set-steam" type="url" placeholder="https://steamcommunity.com/tradeoffer/new/?partner=...&token=..." value="${L(cr.steamTradeUrl)}" />
        </label>
        <div class="actions">
          <button class="btn primary" id="set-save">Save donate links</button>
        </div>
      </div>
    </section>`:``}function mr(){if(!I){F.innerHTML=`<div class="profile-shell"><div class="login-prompt">
    ...
    </div></div>`,F.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>y(e.dataset.openAuth)));return}let e=(I.username||`?`).charAt(0).toUpperCase(),t=sr||{nadesTotal:0,nadesApproved:0,nadesPending:0,recommendations:0,comments:0,nadeFavorites:0};F.innerHTML=`
    <div class="profile-shell">
      <section class="panel profile-card">
        <div class="profile-head">
          ...
          <div>
            ...
            <p class="hint">${I.email?L(I.email):`No email set`} · member since ${ur(I.createdAt)}</p>
        ...
        <dl class="profile-stats">
          ${fr(`Nades submitted`,t.nadesTotal)}
          ${fr(`Approved`,t.nadesApproved)}
          ${fr(`Pending`,t.nadesPending)}
          ${fr(`Favorite nades`,t.nadeFavorites)}
          ${fr(`Commands recommended`,t.recommendations)}
          ${fr(`Comments`,t.comments)}
        </dl>
      </section>
      ...
      ${pr()}
      <div id="profile-status" class="status ${lr.kind}">${L(lr.text)}</div>
    </div>`,F.querySelector(`#set-save`)?.addEventListener(`click`,Sr),F.querySelector(`#pw-save`)?.addEventListener(`click`,gr),F.querySelector(`#username-save`)?.addEventListener(`click`,vr),F.querySelector(`#cred-save`)?.addEventListener(`click`,yr),F.querySelector(`#steam-link`)?.addEventListener(`click`,br),F.querySelector(`#steam-unlink`)?.addEventListener(`click`,xr);let n=F.querySelector(`#avatar-file`);F.querySelector(`#avatar-upload`)?.addEventListener(`click`,()=>n?.click()),n?.addEventListener(`change`,e=>hr(e.target.files?.[0])),F.querySelector(`#avatar-remove`)?.addEventListener(`click`,_r)}async function hr(e){if(e){R(`Uploading image…`,``);try{await _.auth.uploadAvatar(e),await je(),R(`Profile image updated.`,`ok`)}catch(e){R(e.message,`error`)}}}async function gr(){let e=F.querySelector(`#pw-current`)?.value||``,t=F.querySelector(`#pw-new`)?.value||``;try{await _.auth.changePassword({currentPassword:e,newPassword:t}),F.querySelector(`#pw-current`).value=``,F.querySelector(`#pw-new`).value=``,R(`Password updated.`,`ok`)}catch(e){R(e.message,`error`)}}async function _r(){try{await _.auth.setAvatar(``),await je(),R(`Profile image removed.`,`ok`)}catch(e){R(e.message,`error`)}}async function vr(){let e=F.querySelector(`#acc-username`)?.value||``;try{await _.auth.changeUsername(e),await je(),R(`Username updated.`,`ok`)}catch(e){R(e.message,`error`)}}async function yr(){let e=F.querySelector(`#cred-email`)?.value||``,t=F.querySelector(`#cred-password`)?.value||``;try{await _.auth.setCredentials({email:e,password:t}),await je(),R(`Email & password saved — you can now log in without Steam.`,`ok`)}catch(e){R(e.message,`error`)}}async function br(){try{let e=await _.auth.steamLinkUrl();window.location.href=e}catch(e){R(e.message,`error`)}}async function xr(){try{await _.auth.steamUnlink(),await je(),R(`Steam unlinked.`,`ok`)}catch(e){R(e.message,`error`)}}async function Sr(){let e=F.querySelector(`#set-paypal`)?.value||``,t=F.querySelector(`#set-steam`)?.value||``;try{cr=await _.admin.saveSettings({paypalUrl:e,steamTradeUrl:t}),R(`Donate links saved.`,`ok`),document.dispatchEvent(new CustomEvent(`aimkit:settings-updated`))}catch(e){R(e.message,`error`)}}async function Cr(){F=document.querySelector(`#profile-tool`),F&&(I=ke(),Ae(async e=>{I=e,await dr(),mr()}),mr(),await dr(),mr())}var z,wr=null,Tr=[],Er=`top`,Dr=!1,Or={text:``,kind:``},kr=new Set;function Ar(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function jr(e,t=``){Or={text:e,kind:t};let n=z?.querySelector(`#configs-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function Mr(e){try{return new Date(e).toLocaleDateString()}catch{return``}}function Nr(e,t){let n=new Blob([t],{type:`text/plain`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=e,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r)}async function Pr(){try{Tr=await _.configs.list({sort:Er})}catch(e){jr(e.message,`error`)}zr()}function Fr(e){let t=Math.round(e),n=``;for(let e=1;e<=5;e+=1)n+=e<=t?`★`:`☆`;return n}function Ir(e){if(!wr)return`<button class="btn btn-sm" data-open-auth="login">Log in to rate</button>`;if(e.authorId===wr.id)return`<span class="hint">Your upload</span>`;let t=``;for(let n=1;n<=5;n+=1)t+=`<button class="star-btn ${n<=e.myRating?`on`:``}" data-rate="${e.id}" data-star="${n}" title="${n} star${n>1?`s`:``}">${n<=e.myRating?`★`:`☆`}</button>`;return`<span class="rate-label">Your rating:</span><span class="star-picker">${t}</span>`}function Lr(e){let t=kr.has(e.id),n=wr&&(e.authorId===wr.id||g(wr));return`
    <article class="config-card" data-search="${Ar(`${e.title} ${e.description} ${e.authorName}`.toLowerCase())}">
      <div class="config-head">
        <h3>${Ar(e.title)}</h3>
        <div class="config-rating" title="${e.avgRating} from ${e.ratingCount} rating(s)">
          <span class="stars">${Fr(e.avgRating)}</span>
          <span class="rating-num">${e.avgRating||`—`} (${e.ratingCount})</span>
        </div>
      </div>
      ${e.description?`<p class="config-desc">${Ar(e.description)}</p>`:``}
      ...
      ${t?`<div class="config-view">
               ${e.hasConfig?`<div><strong>Config</strong><pre>${Ar(e.configText)}</pre></div>`:``}
               ${e.hasVideo?`<div><strong>Video settings</strong><pre>${Ar(e.videoText)}</pre></div>`:``}
             </div>`:``}
      <div class="config-foot">
        <span>by ${Ar(e.authorName)} · ${Mr(e.createdAt)}</span>
        <span class="config-rate">${Ir(e)}</span>
      </div>
    </article>`}function Rr(){return!wr||!Dr?``:`
    ...
    </section>`}function zr(){z.innerHTML=`
    <div class="configs-shell">
      <div class="configs-controls">
        <div class="sort-tabs">
          <button class="tool-tab ${Er===`top`?`active`:``}" data-sort="top">Most rated</button>
          <button class="tool-tab ${Er===`new`?`active`:``}" data-sort="new">Last uploaded</button>
        </div>
        <input id="cfg-search" type="search" class="cfg-search" placeholder="Search configs by title, author…" />
        ${wr?`<button class="btn primary" id="cfg-new">Upload config</button>`:`<button class="btn primary" data-open-auth="login">Log in to upload</button>`}
      </div>
      ${Rr()}
      <div class="config-grid">
        ${Tr.length?Tr.map(Lr).join(``):`<p class="hint">No configs yet — be the first to upload one!</p>`}
      </div>
      <div id="configs-status" class="status ${Or.kind}">${Ar(Or.text)}</div>
    </div>`,Vr()}function Br(e){let t=e.trim().toLowerCase();z.querySelectorAll(`.config-card`).forEach(e=>{e.classList.toggle(`hidden`,t&&!e.dataset.search.includes(t))})}function Vr(){z.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>y(e.dataset.openAuth))),z.querySelectorAll(`[data-sort]`).forEach(e=>e.addEventListener(`click`,()=>{Er=e.dataset.sort,Pr()})),z.querySelector(`#cfg-search`)?.addEventListener(`input`,e=>Br(e.target.value)),z.querySelector(`#cfg-new`)?.addEventListener(`click`,()=>{Dr=!0,zr()}),z.querySelector(`#cfg-cancel`)?.addEventListener(`click`,()=>{Dr=!1,zr()}),z.querySelector(`#cfg-submit`)?.addEventListener(`click`,Wr),z.querySelector(`#cfg-config-file`)?.addEventListener(`change`,e=>Ur(e.target,`#cfg-config`)),z.querySelector(`#cfg-video-file`)?.addEventListener(`change`,e=>Ur(e.target,`#cfg-video`)),z.querySelectorAll(`[data-dl]`).forEach(e=>e.addEventListener(`click`,()=>{let t=Tr.find(t=>String(t.id)===e.dataset.dl);t&&(e.dataset.kind===`config`?Nr(`${Hr(t.title)}.cfg`,t.configText):Nr(`cs2_video.txt`,t.videoText))})),z.querySelectorAll(`[data-view]`).forEach(e=>e.addEventListener(`click`,()=>{let t=Number(e.dataset.view);kr.has(t)?kr.delete(t):kr.add(t),zr()})),z.querySelectorAll(`[data-del]`).forEach(e=>e.addEventListener(`click`,()=>Kr(Number(e.dataset.del)))),z.querySelectorAll(`[data-rate]`).forEach(e=>e.addEventListener(`click`,()=>Gr(Number(e.dataset.rate),Number(e.dataset.star))))}function Hr(e){return(e||`config`).toLowerCase().replace(/[^a-z0-9]+/g,`_`).replace(/^_|_$/g,``).slice(0,40)||`config`}function Ur(e,t){let n=e.files?.[0];if(!n)return;let r=new FileReader;r.onload=()=>{let e=z.querySelector(t);e&&(e.value=String(r.result||``))},r.readAsText(n)}async function Wr(){let e=z.querySelector(`#cfg-title`)?.value||``,t=z.querySelector(`#cfg-desc`)?.value||``,n=z.querySelector(`#cfg-config`)?.value||``,r=z.querySelector(`#cfg-video`)?.value||``;try{await _.configs.create({title:e,description:t,configText:n,videoText:r}),Dr=!1,Er=`new`,await Pr(),jr(`Config published!`,`ok`)}catch(e){jr(e.message,`error`)}}async function Gr(e,t){try{let n=await _.configs.rate(e,t),r=Tr.find(t=>t.id===e);r&&(r.avgRating=n.avgRating,r.ratingCount=n.ratingCount,r.myRating=n.myRating),zr(),jr(`Thanks for rating!`,`ok`)}catch(e){jr(e.message,`error`)}}async function Kr(e){try{await _.configs.remove(e),await Pr(),jr(`Config deleted.`,`ok`)}catch(e){jr(e.message,`error`)}}async function qr(){z=document.querySelector(`#configs-tool`),z&&(wr=ke(),Ae(async e=>{wr=e,await Pr()}),zr(),await Pr())}var B,Jr=null,Yr=[],Xr=[],Zr={text:``,kind:``},Qr=!1,$r=null;function V(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function ei(e,t=``){Zr={text:e,kind:t};let n=B?.querySelector(`#highlights-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function ti(e){try{return new Date(e).toLocaleDateString()}catch{return``}}function ni(e){let t=/(?:youtube\.com\/(?:watch\?v=|embed\/|shorts\/)|youtu\.be\/)([\w-]{6,})/.exec(e||``);return t?t[1]:null}function ri(e){return/^https?:\/\//.test(e||``)?e:``}function ii(e){let t=ri(e);if(!t)return``;let n=ni(e);return n?`<iframe class="hl-embed" src="https://www.youtube.com/embed/${V(n)}" title="highlight" allowfullscreen loading="lazy"></iframe>`:/\.(mp4|webm|mov)(\?|$)/i.test(e)?`<video class="hl-embed" src="${V(t)}" controls preload="none"></video>`:`<a class="btn ghost" href="${V(t)}" target="_blank" rel="noopener noreferrer">Open highlight ↗</a>`}async function ai(){try{Yr=await _.highlights.list({}),Xr=g(Jr)?await _.admin.highlightReports():[]}catch(e){ei(e.message,`error`)}li()}function oi(){return!g(Jr)||!Xr.length?``:`
    <section class="panel panel-review">
      <h3>Reported highlights (${Xr.length})</h3>
      ${Xr.map(e=>`<div class="report-item">
            <div class="report-media">${ii(e.url)}</div>
    ...
    </section>`}function si(e){let t=Jr&&(e.authorId===Jr.id||g(Jr));return`
    <article class="hl-card" data-search="${V(`${e.title} ${e.description} ${e.authorName}`.toLowerCase())}">
      <div class="hl-media">${ii(e.url)}</div>
      <h3 class="hl-title">${V(e.title)}</h3>
      ${e.description?`<p class="hl-desc">${V(e.description)}</p>`:``}
      <div class="hl-foot">
        <span>by ${V(e.authorName)} · ${ti(e.createdAt)}</span>
        <span class="hl-actions">
          ${Jr?e.reportedByMe?`<span class="hint">Reported</span>`:`<button class="btn btn-sm ghost" data-report="${e.id}">Report</button>`:``}
          ${t?`<button class="btn btn-sm ghost" data-del="${e.id}">Delete</button>`:``}
        </span>
      </div>
      ${$r===e.id?`<form class="hl-report-form" data-report-form="${e.id}">
    ...
    </article>`}function ci(){return!Jr||!Qr?``:`
    <section class="panel config-upload">
    ...
    </section>`}function li(){B.innerHTML=`
    <div class="highlights-shell">
      <div class="configs-controls">
        <input id="hl-search" type="search" class="cfg-search" placeholder="Search highlights by title, author…" />
        ${Jr?`<button class="btn primary" id="hl-new">Share highlight</button>`:`<button class="btn primary" data-open-auth="login">Log in to share</button>`}
      </div>
      ${oi()}
      ${ci()}
      <div class="hl-grid">
        ${Yr.length?Yr.map(si).join(``):`<p class="hint">No highlights yet — share the first one!</p>`}
      </div>
      <div id="highlights-status" class="status ${Zr.kind}">${V(Zr.text)}</div>
    </div>`,di()}function ui(e){let t=e.trim().toLowerCase();B.querySelectorAll(`.hl-card`).forEach(e=>{e.classList.toggle(`hidden`,t&&!e.dataset.search.includes(t))})}function di(){B.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>y(e.dataset.openAuth))),B.querySelector(`#hl-search`)?.addEventListener(`input`,e=>ui(e.target.value)),B.querySelector(`#hl-new`)?.addEventListener(`click`,()=>{Qr=!0,li()}),B.querySelector(`#hl-cancel`)?.addEventListener(`click`,()=>{Qr=!1,li()}),B.querySelector(`#hl-submit`)?.addEventListener(`click`,fi),B.querySelectorAll(`[data-report]`).forEach(e=>e.addEventListener(`click`,()=>{$r=Number(e.dataset.report),li()})),B.querySelector(`[data-cancel-report]`)?.addEventListener(`click`,()=>{$r=null,li()}),B.querySelector(`[data-report-form]`)?.addEventListener(`submit`,e=>{e.preventDefault(),pi(Number(e.currentTarget.dataset.reportForm),e.currentTarget.querySelector(`input`).value)}),B.querySelectorAll(`[data-del]`).forEach(e=>e.addEventListener(`click`,()=>mi(Number(e.dataset.del)))),B.querySelectorAll(`[data-keep]`).forEach(e=>e.addEventListener(`click`,()=>hi(Number(e.dataset.keep),`keep`))),B.querySelectorAll(`[data-remove-hl]`).forEach(e=>e.addEventListener(`click`,()=>hi(Number(e.dataset.removeHl),`delete`)))}async function fi(){let e=B.querySelector(`#hl-title`)?.value||``,t=B.querySelector(`#hl-desc`)?.value||``,n=B.querySelector(`#hl-url`)?.value||``;try{await _.highlights.create({title:e,description:t,url:n}),Qr=!1,await ai(),ei(`Highlight shared!`,`ok`)}catch(e){ei(e.message,`error`)}}async function pi(e,t){try{await _.highlights.report(e,t),$r=null,await ai(),ei(`Thanks — an admin will review your report.`,`ok`)}catch(e){ei(e.message,`error`)}}async function mi(e){try{await _.highlights.remove(e),await ai(),ei(`Highlight deleted.`,`ok`)}catch(e){ei(e.message,`error`)}}async function hi(e,t){try{await _.admin.reviewHighlight(e,t),await ai(),ei(t===`delete`?`Highlight removed.`:`Reports cleared — highlight kept.`,`ok`)}catch(e){ei(e.message,`error`)}}async function gi(){B=document.querySelector(`#highlights-tool`),B&&(Jr=ke(),Ae(async e=>{Jr=e,await ai()}),li(),await ai())}var H,_i=null,vi={pros:[],source:`seed`,lastSync:0},yi=`featured`,bi=``,xi=null,Si={text:``,kind:``};function U(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Ci(e,t=``){Si={text:e,kind:t};let n=H?.querySelector(`#pros-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}async function wi(){try{vi=await _.pros.list({sort:yi,q:bi})}catch(e){Ci(e.message,`error`)}ji()}var Ti={"natus vincere":`#f4d000`,vitality:`#f5d20a`,falcons:`#0aa14f`,"team spirit":`#c8102e`,astralis:`#e4002b`,faze:`#e43b26`,g2:`#c8102e`};function Ei(e){return Ti[(e||``).toLowerCase()]||`#33415a`}function Di(e){let t=(e.team||e.player||`?`).trim(),n=t.split(/\s+/);return(n.length>1?n.slice(0,3).map(e=>e[0]).join(``):t.slice(0,2)).toUpperCase()}function Oi(e){let t=e.photo||e.teamLogo||``,n=e.photo&&e.teamLogo?e.teamLogo:``,r=t?`<img class="pro-img" alt="${U(e.player)}" loading="lazy" src="${U(t)}"${n?` data-logo="${U(n)}"`:``} onerror="if(this.dataset.logo){this.src=this.dataset.logo;this.removeAttribute('data-logo');}else{this.remove();}" />`:``;return`<div class="pro-photo" style="--team:${Ei(e.team)}"><span class="pro-monogram">${U(Di(e))}</span>${r}</div>`}function ki(e,t){return`<div class="pro-stat"><dt>${U(e)}</dt><dd>${t!=null&&t!==``?U(t):`—`}</dd></div>`}function Ai(e){return`
    <article class="pro-card" data-search="${U(`${e.player} ${e.team||``}`.toLowerCase())}">
      ...
      <dl class="pro-stats">
        ...
        ${ki(`Zoom`,e.zoomSens)}
        ${ki(`Hz`,e.hz)}
        ${ki(`Resolution`,e.resolution)}
        ${ki(`Aspect`,e.aspectRatio)}
      </dl>
    </article>`}function ji(){let e=g(_i)&&be()?`<div class="pros-admin-actions">
    ...
    <div class="pros-shell">
      <div class="cmd-status-bar">
        <div><strong>Source:</strong> ${U(vi.source)} · <strong>${vi.pros.length}</strong> players${vi.lastSync?` · synced ${U(new Date(vi.lastSync).toLocaleDateString())}`:``}</div>
        ${e}
      </div>
      <div class="configs-controls">
        <div class="sort-tabs">
          <button class="tool-tab ${yi===`featured`?`active`:``}" data-sort="featured">Featured</button>
          <button class="tool-tab ${yi===`name`?`active`:``}" data-sort="name">Name</button>
          <button class="tool-tab ${yi===`edpi`?`active`:``}" data-sort="edpi">Lowest eDPI</button>
          <button class="tool-tab ${yi===`edpi-desc`?`active`:``}" data-sort="edpi-desc">Highest eDPI</button>
        </div>
        <input id="pros-search" type="search" class="cfg-search" placeholder="Search player or team…" value="${U(bi)}" />
      </div>
      <p class="hint">${vi.source===`prosettings`?`Live from prosettings.net.`:vi.source===`seed`?`Built-in list. Admins can sync live data from prosettings.net.`:`Source: ${U(vi.source)}.`}</p>
      <div class="pro-grid">
        ${vi.pros.length?vi.pros.map(Ai).join(``):`<p class="hint">No pro settings yet.</p>`}
      </div>
      <div id="pros-status" class="status ${Si.kind}">${U(Si.text)}</div>
    </div>`,Mi()}function Mi(){H.querySelectorAll(`[data-sort]`).forEach(e=>e.addEventListener(`click`,()=>{yi=e.dataset.sort,wi()}));let e=H.querySelector(`#pros-search`);e&&e.addEventListener(`input`,e=>{bi=e.target.value,clearTimeout(xi),xi=setTimeout(async()=>{await wi();let e=H.querySelector(`#pros-search`);e&&(e.focus(),e.setSelectionRange(e.value.length,e.value.length))},300)}),H.querySelector(`#pros-sync`)?.addEventListener(`click`,Ni),H.querySelector(`#pros-import`)?.addEventListener(`click`,Pi)}async function Ni(){let e=H.querySelector(`#pros-sync`);if(e&&(e.disabled=!0),!be()){Ci(`Please log in as an admin to sync.`,`error`),y(`login`),e&&(e.disabled=!1);return}Ci(`Syncing from prosettings.net…`,``);try{let e=await _.admin.syncPros();await wi(),e.synced?Ci(`Synced ${e.count} players from ${e.source}.`,`ok`):Ci(`Sync failed: ${e.reason||`unknown error`}. Kept the current list.`,`error`)}catch(e){e.status===401?(Ci(`Please log in as an admin to sync.`,`error`),y(`login`)):Ci(e.message,`error`)}finally{let e=H.querySelector(`#pros-sync`);e&&(e.disabled=!1)}}function Pi(){Rn({title:`Import pro settings from HLTV`,description:`HLTV has a Cloudflare check that blocks servers. Open HLTV in your browser, complete the verification, then paste a JSON list of players here. Each item: {"player","team","dpi","sens","zoomSens","hz","resolution","aspectRatio","photo","teamLogo"}.`,sourceUrl:`https://www.hltv.org/stats/players`,sourceLabel:`Open HLTV`,placeholder:`[{"player":"s1mple","team":"Natus Vincere","dpi":400,"sens":3.09,"hz":1000,"resolution":"1280x960","aspectRatio":"4:3"}]`,onImport:async e=>{let t=await _.admin.importPros(e);return await wi(),`Imported ${t.count} players.`}})}async function Fi(){H=document.querySelector(`#pros-tool`),H&&(_i=ke(),Ae(e=>{_i=e,ji()}),ji(),await wi())}var W,G=null,Ii=`overview`,Li={text:``,kind:``},Ri={nades:0,comments:0,reports:0},K={},zi=[{id:`overview`,label:`Overview`},{id:`nades`,label:`Nades`},{id:`comments`,label:`Comments`},{id:`reports`,label:`Reports`},{id:`users`,label:`Users`},{id:`sync`,label:`Data sync`},{id:`contact`,label:`Contact`},{id:`logs`,label:`Logs`,ownerOnly:!0},{id:`settings`,label:`Site settings`,ownerOnly:!0}];function q(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Bi(e,t=``){Li={text:e,kind:t};let n=W?.querySelector(`#admin-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function Vi(e){try{return new Date(e).toLocaleString()}catch{return`—`}}async function Hi(){try{let[e,t,n]=await Promise.all([_.admin.pendingCount().catch(()=>0),_.admin.pendingCommentsCount().catch(()=>0),_.admin.highlightReportsCount().catch(()=>0)]);Ri={nades:e,comments:t,reports:n}}catch{}}function Ui(){let e=(e,t,n)=>`<button class="admin-stat" data-goto="${n}">
       <span class="admin-stat-num">${t}</span>
       <span class="admin-stat-label">${q(e)}</span>
     </button>`;return`
    <div class="admin-stats">
      ${e(`Nades to review`,Ri.nades,`nades`)}
      ${e(`Comments to review`,Ri.comments,`comments`)}
      ${e(`Highlight reports`,Ri.reports,`reports`)}
    </div>
    <p class="hint">Use the tabs above to moderate content, manage users, sync data sources, and read contact messages.</p>`}function Wi(){let e=K.nades||[];return e.length?`
    <div class="review-bulk-bar">
      <label class="review-select-all">
    ...
    ${e.map(e=>{let t=(e.media||[]).map(e=>`
        ...
        </article>`}).join(``)}`:`<p class="hint">Nothing pending. All nades are reviewed.</p>`}function Gi(){let e=K.comments||[];return e.length?e.map(e=>`
      <article class="panel admin-item">
        <p>${q(e.body)}</p>
        <p class="hint">by ${q(e.username)} on <code>${q(e.commandKey)}</code> · ${Vi(e.createdAt)}</p>
        <div class="actions">
      ...
      </article>`).join(``):`<p class="hint">No comments pending review.</p>`}function Ki(){let e=K.reports||[];return e.length?e.map(e=>{let t=(e.reports||[]).map(e=>`<li>${q(e.reason||`No reason`)} — <span class="hint">${q(e.reporterName||`?`)}</span></li>`).join(``);return`
        <article class="panel admin-item">
          <div class="admin-item-head">
    ...
    <div class="admin-users">${r}</div>`}function Ji(){return`
    <div class="admin-sync">
    ...
    </div>`}function Yi(){let e=K.contact||[];return e.length?e.map(e=>`
      <article class="panel admin-item">
        <div class="admin-item-head">
          <strong>${q(e.subject||`(no subject)`)}</strong>
          <span class="hint">${Vi(e.created_at)}</span>
        </div>
      ...
      </article>`).join(``):`<p class="hint">No contact messages.</p>`}function Xi(){let e=K.settings||{paypalUrl:``,steamTradeUrl:``};return`
    <div class="panel admin-item">
    ...
    <div class="admin-logs">${i}</div>`}var Qi={overview:Ui,nades:Wi,comments:Gi,reports:Ki,users:qi,sync:Ji,contact:Yi,logs:Zi,settings:Xi};async function $i(e){try{e===`overview`?await Hi():e===`nades`?K.nades=await _.admin.pending():e===`comments`?K.comments=await _.admin.pendingComments():e===`reports`?K.reports=await _.admin.highlightReports():e===`users`?K.users=await _.admin.users():e===`contact`?K.contact=await _.admin.contactMessages():e===`logs`?K.logs=await _.admin.ownerLogs({action:K.logsFilter||``}):e===`settings`&&(K.settings=await _.settings.get())}catch(e){Bi(e.message,`error`)}}function ea(){if(!W)return;if(!g(G)){W.innerHTML=`<div class="admin-shell"><div class="login-prompt">
    ...
    </div></div>`,W.querySelector(`[data-open-auth]`)?.addEventListener(`click`,()=>y(`login`));return}(Ii===`logs`||Ii===`settings`)&&!we(G)&&(Ii=`overview`);let e=zi.filter(e=>!e.ownerOnly||we(G)).map(e=>`<button class="tool-tab ${Ii===e.id?`active`:``}" data-section="${e.id}">${q(e.label)}${e.id===`nades`&&Ri.nades?` (${Ri.nades})`:``}${e.id===`comments`&&Ri.comments?` (${Ri.comments})`:``}${e.id===`reports`&&Ri.reports?` (${Ri.reports})`:``}</button>`).join(``),t=(Qi[Ii]||Ui)();W.innerHTML=`
    <div class="admin-shell">
      <h2 class="admin-title">Admin</h2>
      <div class="admin-nav sort-tabs">${e}</div>
      <div class="admin-body">${t}</div>
      <div id="admin-status" class="status ${Li.kind}">${q(Li.text)}</div>
    </div>`,na()}async function ta(e){(e===`logs`||e===`settings`)&&(we(G)||(e=`overview`)),Ii=e,ea(),await $i(e),ea()}function na(){W.querySelectorAll(`[data-section]`).forEach(e=>e.addEventListener(`click`,()=>ta(e.dataset.section))),W.querySelectorAll(`[data-goto]`).forEach(e=>e.addEventListener(`click`,()=>ta(e.dataset.goto)));let e=async(e,t)=>{try{await e(),t&&Bi(t,`ok`)}catch(e){e.status===401?(Bi(`Please log in as an admin and try again.`,`error`),y(`login`)):Bi(e.message,`error`)}},t=async()=>{await $i(Ii),await Hi(),ea()};W.querySelectorAll(`[data-nade-approve]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await _.admin.reviewNade(n.dataset.nadeApprove,`approved`),await t()},`Nade approved.`))),W.querySelectorAll(`[data-nade-reject]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await _.admin.reviewNade(n.dataset.nadeReject,`rejected`),await t()},`Nade rejected.`))),W.querySelectorAll(`[data-nade-delete]`).forEach(n=>n.addEventListener(`click`,()=>{confirm(`Permanently delete this nade and its media?`)&&e(async()=>{await _.nades.remove(n.dataset.nadeDelete),await t()},`Nade deleted.`)})),W.querySelectorAll(`[data-media-approve]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await _.admin.reviewMedia(n.dataset.mediaApprove,`approved`),await t()},`Media approved.`))),W.querySelectorAll(`[data-media-reject]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await _.admin.reviewMedia(n.dataset.mediaReject,`rejected`),await t()},`Media rejected.`))),W.querySelectorAll(`[data-media-delete]`).forEach(n=>n.addEventListener(`click`,()=>{confirm(`Permanently remove this media?`)&&e(async()=>{await _.admin.removeMedia(n.dataset.mediaDelete),await t()},`Media removed.`)}));let n=W.querySelector(`#admin-nade-select-all`),r=W.querySelector(`#admin-nade-bulk-approve`),i=W.querySelector(`#admin-nade-bulk-reject`),a=()=>{let e=W.querySelectorAll(`.admin-nade-check:checked`).length;r&&(r.disabled=e===0),i&&(i.disabled=e===0)};n?.addEventListener(`change`,()=>{W.querySelectorAll(`.admin-nade-check`).forEach(e=>{e.checked=n.checked}),a()}),W.querySelectorAll(`.admin-nade-check`).forEach(e=>e.addEventListener(`change`,a));let o=async n=>{let r=[...W.querySelectorAll(`.admin-nade-check:checked`)].map(e=>Number(e.value));r.length&&await e(async()=>{let e=await _.admin.reviewNadesBulk(r,n);await t(),Bi(`${n===`approved`?`Approved`:`Rejected`} ${e.updated} nade${e.updated===1?``:`s`}.`,`ok`)})};r?.addEventListener(`click`,()=>o(`approved`)),i?.addEventListener(`click`,()=>o(`rejected`)),W.querySelectorAll(`[data-comment-approve]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await _.admin.reviewComment(n.dataset.commentApprove,`approved`),await t()},`Comment approved.`))),W.querySelectorAll(`[data-comment-reject]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await _.admin.reviewComment(n.dataset.commentReject,`rejected`),await t()},`Comment rejected.`))),W.querySelectorAll(`[data-comment-delete]`).forEach(n=>n.addEventListener(`click`,()=>{confirm(`Permanently delete this comment?`)&&e(async()=>{await _.admin.removeComment(n.dataset.commentDelete),await t()},`Comment deleted.`)})),W.querySelectorAll(`[data-report-keep]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await _.admin.reviewHighlight(n.dataset.reportKeep,`keep`),await t()},`Kept highlight.`))),W.querySelectorAll(`[data-report-delete]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await _.admin.reviewHighlight(n.dataset.reportDelete,`delete`),await t()},`Highlight deleted.`))),W.querySelectorAll(`[data-role-set]`).forEach(n=>n.addEventListener(`click`,()=>{let r=n.dataset.role;e(async()=>{await _.admin.setRole(n.dataset.roleSet,r),await t()},r===`admin`?`Promoted to admin.`:`Admin access removed.`)})),W.querySelectorAll(`[data-unban]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await _.admin.unbanUser(n.dataset.unban),await t()},`User unbanned.`))),W.querySelectorAll(`[data-ban]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{let e=Number(W.querySelector(`[data-ban-hrs="${n.dataset.ban}"]`)?.value);if(!Number.isFinite(e)||e<=0)return Bi(`Enter a positive number of hours.`,`error`);await _.admin.banUser(n.dataset.ban,{hours:e}),await t(),Bi(`User banned.`,`ok`)}))),W.querySelectorAll(`[data-ban-perma]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await _.admin.banUser(n.dataset.banPerma,{permanent:!0}),await t()},`User banned permanently.`))),W.querySelector(`#sync-commands`)?.addEventListener(`click`,()=>e(async()=>{let e=await _.admin.syncCommands();Bi(e.synced?`Commands synced (${e.count}).`:`No sync: ${e.reason||`no source`}.`,e.synced?`ok`:`error`)})),W.querySelector(`#check-cs2`)?.addEventListener(`click`,()=>e(async()=>{let e=await _.admin.checkCommandsCs2();Bi(`CS2 build: ${e.build||`unknown`}${e.changed?` (changed → re-synced)`:``}.`,`ok`)})),W.querySelector(`#sync-pros`)?.addEventListener(`click`,()=>e(async()=>{let e=await _.admin.syncPros();Bi(e.synced?`Synced ${e.count} pros from ${e.source}.`:`Sync failed: ${e.reason}.`,e.synced?`ok`:`error`)})),W.querySelector(`#import-commands`)?.addEventListener(`click`,()=>Rn({title:`Import commands`,description:`Paste the CS2 console-commands wiki page (wikitext) or a JSON array of commands.`,sourceUrl:`https://developer.valvesoftware.com/wiki/List_of_Counter-Strike_2_console_command_variables`,sourceLabel:`Open wiki`,onImport:async e=>`Imported ${(await _.admin.importCommands(e)).count} commands.`})),W.querySelector(`#import-pros`)?.addEventListener(`click`,()=>Rn({title:`Import pro settings from HLTV`,description:`Open HLTV, complete the check, then paste a JSON list of players.`,sourceUrl:`https://www.hltv.org/stats/players`,sourceLabel:`Open HLTV`,onImport:async e=>{let t=await _.admin.importPros(e);return await $i(`sync`),`Imported ${t.count} players.`}})),W.querySelectorAll(`[data-contact-delete]`).forEach(n=>n.addEventListener(`click`,()=>{confirm(`Delete this contact message?`)&&e(async()=>{await _.admin.removeContact(n.dataset.contactDelete),await t()},`Message deleted.`)})),W.querySelector(`#save-settings`)?.addEventListener(`click`,()=>e(async()=>{let e=W.querySelector(`#set-paypal`)?.value||``,t=W.querySelector(`#set-steam`)?.value||``;K.settings=await _.admin.saveSettings({paypalUrl:e,steamTradeUrl:t}),document.dispatchEvent(new CustomEvent(`aimkit:settings-updated`))},`Donate links saved.`)),W.querySelector(`#owner-logs-filter`)?.addEventListener(`change`,t=>{K.logsFilter=t.target.value||``,e(async()=>{await $i(`logs`),ea()})}),W.querySelector(`#owner-logs-refresh`)?.addEventListener(`click`,()=>e(async()=>{await $i(`logs`),ea()},`Logs refreshed.`))}function ra(e){document.querySelectorAll(`.admin-only`).forEach(t=>t.classList.toggle(`hidden`,!g(e)))}async function ia(){W=document.querySelector(`#admin-tool`),W&&(G=ke(),ra(G),Ae(async e=>{let t=g(G);G=e,ra(e),g(e)&&!t&&await Hi(),ea()}),ea(),g(G)&&(await Hi(),ea()))}function aa(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function oa(){let e=ke(),t=document.createElement(`div`);t.className=`modal`,t.innerHTML=`
    <div class="modal-backdrop" data-close></div>
    <div class="modal-card" role="dialog" aria-modal="true" aria-label="Contact us">
      ...
      <form id="contact-form" class="auth-form-modal">
        <label class="field"><span>Your name</span><input id="contact-name" type="text" value="${aa(e?.username||``)}" /></label>
        <label class="field"><span>Your email</span><input id="contact-email" type="email" value="${aa(e?.email||``)}" /></label>
...
`;var Da=document.querySelector(`#preview-canvas`),Oa=document.querySelector(`#preview-stats`),ka=document.querySelector(`#preview-res`),Aa=document.querySelector(`#preview-res-scale`);Da.width=280,Da.height=280,Da.style.imageRendering=`pixelated`;var ja=[{id:`1920x1080`,h:1080,label:`1920 × 1080 (16:9)`},{id:`2560x1440`,h:1440,label:`2560 × 1440 (16:9)`},{id:`3840x2160`,h:2160,label:`3840 × 2160 (4K)`},{id:`1600x900`,h:900,label:`1600 × 900 (16:9)`},{id:`1366x768`,h:768,label:`1366 × 768 (16:9)`},{id:`1280x960`,h:960,label:`1280 × 960 (4:3)`},{id:`1024x768`,h:768,label:`1024 × 768 (4:3)`},{id:`1280x1024`,h:1024,label:`1280 × 1024 (5:4)`}],Ma=null;function Na(){return(ja.find(e=>e.id===ka?.value)||ja[0]).h}var Pa=ha({source:Da,stage:document.querySelector(`.preview-stage`),toggleBtn:document.querySelector(`#magnifier-toggle`),zoomSelect:document.querySelector(`#magnifier-zoom`)});function Fa(e){if(Ma=e,ma(Da,e,{resHeight:Na()}),Aa)if(e){let t=ja.find(e=>e.id===ka?.value)||ja[0],n=pa(e,t.h);Aa.textContent=`≈ ${n.length}px arms · ${n.thickness}px thick @ ${t.h}p`}else Aa.textContent=``;Pa.refresh()}var X=document.querySelector(`#crosshair-status`),Ia=document.querySelector(`#sensitivity-status`),La=document.querySelector(`#sharecode-input`),Ra=document.querySelector(`#commands-output`),za=document.querySelector(`#commands-input`),Ba=document.querySelector(`#sharecode-output`),Va=document.querySelector(`#sens-from-game`),Ha=document.querySelector(`#sens-to-game`),Ua=document.querySelector(`#sens-source`),Wa=document.querySelector(`#sens-target`),Ga=document.querySelector(`#sens-source-dpi`),Ka=document.querySelector(`#sens-target-dpi`),qa=document.querySelector(`#sens-source-myaw`),Ja=document.querySelector(`#sens-target-myaw`),Ya=document.querySelector(`#sens-source-yaw`),Xa=document.querySelector(`#sens-target-yaw`),Za=document.querySelector(`#source-yaw-field`),Qa=document.querySelector(`#target-yaw-field`),$a=document.querySelector(`#m-yaw-fields`),eo=document.querySelector(`#sens-cm360`),to=document.querySelector(`#sens-stats`),no=document.querySelector(`#sens-formula`),ro=`CSGO-UseJt-3oTvn-47wPX-hEyER-WZfiK`,io=`cl_crosshairstyle 4
cl_crosshairsize 3
cl_crosshairgap -2
...
cl_crosshair_recoil 0`;function Z(e,t,n=``){e&&(e.textContent=t,e.className=`status${n?` ${n}`:``}`)}function ao(e){Fa(e),Oa.innerHTML=`
  ...
  `}function oo(e){return e.trim().replace(/\s+/g,``).replace(/^csgo/i,`CSGO`)}function so(){let e=La.value.trim();if(!e){Z(X,`Paste a crosshair share code first.`,`error`);return}let t=oo(e);if(!Ca.test(t)){Z(X,`Invalid format. Expected CSGO-xxxxx-xxxxx-xxxxx-xxxxx-xxxxx`,`error`);return}try{let e=d(t);La.value=t,Ra.value=se(p(e)),ao(e),Z(X,`Converted share code to console commands.`,`ok`)}catch(e){e instanceof i||e instanceof r?Z(X,`That share code is not a valid crosshair code.`,`error`):Z(X,e instanceof Error?e.message:`Failed to decode share code.`,`error`)}}function co(){let e=za.value.trim();if(!e){Z(X,`Paste crosshair console commands first.`,`error`);return}try{let t=oe(e);Ba.value=f(t),ao(t),Z(X,`Converted commands to share code.`,`ok`)}catch(e){Z(X,e instanceof Error?e.message:`Failed to encode share code.`,`error`)}}async function lo(e,t,n){if(!t){Z(e,`Nothing to copy for ${n}.`,`error`);return}try{await navigator.clipboard.writeText(t),Z(e,`Copied ${n} to clipboard.`,`ok`)}catch{Z(e,`Clipboard access failed. Select and copy manually.`,`error`)}}function uo(){let e=ga[Va.value]?.supportsMYaw||ga[Ha.value]?.supportsMYaw;$a?.classList.toggle(`hidden`,!e),Za?.classList.toggle(`hidden`,!ga[Va.value]?.custom),Qa?.classList.toggle(`hidden`,!ga[Ha.value]?.custom)}function fo(){let e=Number(Ua.value),t=Number(Ga.value),n=Number(Ka.value),r=Number(qa.value)||.022,i=Number(Ja.value)||.022,a=Number(Ya.value),o=Number(Xa.value);if(uo(),ga[Va.value]?.custom&&!(a>0)){Z(Ia,`Enter a valid source custom yaw (° per count).`,`error`);return}if(ga[Ha.value]?.custom&&!(o>0)){Z(Ia,`Enter a valid target custom yaw (° per count).`,`error`);return}if(!Number.isFinite(e)||e<=0){Wa.value=``,eo.textContent=`—`,to.innerHTML=``,no.textContent=``;return}if(!Number.isFinite(t)||t<=0||!Number.isFinite(n)||n<=0){Z(Ia,`Enter valid DPI values.`,`error`);return}let s=ba({sourceGame:Va.value,targetGame:Ha.value,sourceSens:e,sourceDpi:t,targetDpi:n,sourceMYaw:r,targetMYaw:i,sourceCustomYaw:a,targetCustomYaw:o}),c=ga[Va.value].name,l=ga[Ha.value].name,u=Y(s.targetSensitivity);Wa.value=u,eo.textContent=xa(s.cm360),to.innerHTML=`
    <div><dt>Inches / 360°</dt><dd>${xa(s.inches360)} in</dd></div>
    <div><dt>Source eDPI</dt><dd>${xa(s.sourceEdpi,0)}</dd></div>
    <div><dt>Target eDPI</dt><dd>${xa(s.targetEdpi,0)}</dd></div>
  ...
  `,e)_s?.classList.add(`hidden`),Z(As,`Done — set your sensitivity to ${Y(t,3)} and play a few sessions before changing again.`,`ok`);else{let{lower:e,higher:t}=ue($);_s?.classList.remove(`hidden`),vs.textContent=String($.round),ys.style.width=`${($.round-1)/7*100}%`,Ss.textContent=Y(e,3),Cs.textContent=Y(t,3),Z(As,`Round ${$.round} of 7: test both values, then pick the side that feels better.`,``)}$.choices.length>0?(ks?.classList.remove(`hidden`),ks.innerHTML=`<strong>History:</strong><br />${$.choices.map(e=>`Round ${e.round}: chose <strong>${e.side}</strong> (${Y(e.lower,3)} vs ${Y(e.higher,3)})`).join(`<br />`)}`):(ks?.classList.add(`hidden`),ks.innerHTML=``)}function Ms(){let e=Number(hs.value);if(!Number.isFinite(e)||e<=0){Z(As,`Enter a valid pad 360° sensitivity greater than 0.`,`error`);return}$=le(e),js()}function Ns(e){!$||de($)||($=me($,e),js())}gs?.addEventListener(`click`,Ms),bs?.addEventListener(`click`,()=>Ns(`lower`)),xs?.addEventListener(`click`,()=>Ns(`higher`)),ws?.addEventListener(`click`,()=>{$&&($=he($),js())}),Ts?.addEventListener(`click`,()=>{$=null,js(),Z(As,`Enter your pad 360° sensitivity and press Start PSA.`,``)}),ka.innerHTML=ja.map(e=>`<option value="${e.id}">${e.label}</option>`).join(``),ka.addEventListener(`change`,()=>Fa(Ma)),Fa(null),so(),mo();function Ps(e){return String(e||``).replaceAll(`&`,`&amp;`).replaceAll(`"`,`&quot;`)}function Fs(e){let t=document.querySelector(`#donate-section`),n=document.querySelector(`#donate-actions`);if(!t||!n)return;let r=[];e.paypalUrl&&r.push(`<a class="btn donate-btn paypal" href="${Ps(e.paypalUrl)}" target="_blank" rel="noopener noreferrer">${wa}<span>Donate via PayPal</span></a>`),e.steamTradeUrl&&r.push(`<a class="btn donate-btn steam" href="${Ps(e.steamTradeUrl)}" target="_blank" rel="noopener noreferrer">${Ta}<span>Donate Steam skins</span></a>`),n.innerHTML=r.join(``),t.classList.toggle(`hidden`,r.length===0);let i=document.querySelector(`#donate-fab`);if(i){let t=[];e.paypalUrl&&t.push(`<a class="donate-fab-btn paypal" href="${Ps(e.paypalUrl)}" target="_blank" rel="noopener noreferrer" title="Donate via PayPal">${wa}<span>PayPal</span></a>`),e.steamTradeUrl&&t.push(`<a class="donate-fab-btn steam" href="${Ps(e.steamTradeUrl)}" target="_blank" rel="noopener noreferrer" title="Donate Steam skins">${Ta}<span>Steam</span></a>`),i.innerHTML=t.length?`<span class="donate-fab-label">Support AimKit</span>${t.join(``)}`:``,i.classList.toggle(`hidden`,t.length===0)}}async function Is(){try{Fs(await _.settings.get())}catch{Fs({paypalUrl:``,steamTradeUrl:``})}}document.addEventListener(`aimkit:settings-updated`,Is),document.querySelector(`#contact-open`)?.addEventListener(`click`,oa),qe();var Ls=new URLSearchParams(window.location.search).get(`reset`);if(Ls){We(Ls);let e=new URL(window.location.href);e.searchParams.delete(`reset`),window.history.replaceState({},``,e)}var Rs=new URLSearchParams(window.location.search);if(Rs.get(`token`)){Ce(Rs.get(`token`)),je();let e=new URL(window.location.href);e.searchParams.delete(`token`),window.history.replaceState({},``,e)}else if(Rs.get(`steam`)===`linked`){je();let e=new URL(window.location.href);e.searchParams.delete(`steam`),window.history.replaceState({},``,e)}else if(Rs.get(`steam_error`)){let e=new URL(window.location.href);e.searchParams.delete(`steam_error`),window.history.replaceState({},``,e)}In(),or(),qr(),gi(),Fi(),Cr(),ia(),Is();