...
`)}var le=.5;function ue(e){return{base:e,lo:e*(1-le),hi:e*1.5,round:1,choices:[]}}function de(e){return{lower:e.lo,higher:e.hi,mid:(e.lo+e.hi)/2}}function fe(e){return e.round>7}function pe(e){return(e.lo+e.hi)/2}function me(e){let t=pe(e);return t<=0?0:(e.hi-e.lo)/t}function he(e,t){if(fe(e))return e;let n=(e.lo+e.hi)/2,r={round:e.round,side:t,lo:e.lo,hi:e.hi,lower:e.lo,higher:e.hi},i={...e,choices:[...e.choices,r],round:e.round+1};return t===`lower`?i.hi=n:i.lo=n,i}function ge(e){if(e.choices.length===0)return e;let t=e.choices.slice(0,-1),n=e.choices[e.choices.length-1];return{...e,lo:n.lo,hi:n.hi,round:n.round,choices:t}}function _e(e){return pe(e)}var ve=`/api`,ye=`cs2utils.token`,be=/^https?:\/\//.test(ve)?new URL(ve).origin:``;function xe(){try{return localStorage.getItem(ye)}catch{return null}}function Se(e){try{e?localStorage.setItem(ye,e):localStorage.removeItem(ye)}catch{}}async function m(e,t,n,{auth:r=!1}={}){let i={};if(n!==void 0&&!(n instanceof FormData)&&(i[`Content-Type`]=`application/json`),r){let e=xe();e&&(i.Authorization=`Bearer ${e}`)}let a;try{a=await fetch(`${ve}${t}`,{method:e,headers:i,body:n instanceof FormData?n:n===void 0?void 0:JSON.stringify(n)})}catch{throw Error(`Cannot reach the server. Is the API running?`)}let o=null,s=await a.text();if(s)try{o=JSON.parse(s)}catch{o=null}if(!a.ok){let e=Error(o&&o.error||`Request failed (${a.status}).`);throw e.status=a.status,e.data=o,e}return o}var Ce=`${ve}/auth/steam`;function we(e){Se(e)}function h(e){return!!e&&(e.role===`admin`||e.role===`owner`)}function Te(e){return!!e&&e.role===`owner`}function Ee(e){return e?/^https?:\/\//.test(e)||e.startsWith(`data:`)?e:be+e:``}var g={auth:{async register(e){let t=await m(`POST`,`/auth/register`,e);return Se(t.token),t.user},async login(e){let t=await m(`POST`,`/auth/login`,e);return Se(t.token),t.user},logout(){Se(null)},async captcha(){return m(`GET`,`/auth/captcha`)},async changePassword(e){return m(`POST`,`/auth/password`,e,{auth:!0})},async forgot(e){return m(`POST`,`/auth/forgot`,{email:e})},async reset(e,t){return m(`POST`,`/auth/reset`,{token:e,password:t})},async me(){if(!xe())return null;try{return(await m(`GET`,`/auth/me`,void 0,{auth:!0})).user}catch{return Se(null),null}},async profile(){return m(`GET`,`/auth/profile`,void 0,{auth:!0})},async setAvatar(e){return(await m(`POST`,`/auth/avatar`,{url:e},{auth:!0})).user},async uploadAvatar(e){let t=new FormData;return t.append(`file`,e),(await m(`POST`,`/auth/avatar/upload`,t,{auth:!0})).user},async changePassword(e){return m(`POST`,`/auth/password`,e,{auth:!0})},async changeUsername(e){let t=await m(`POST`,`/auth/username`,{username:e},{auth:!0});return t.token&&Se(t.token),t.user},async setCredentials(e){let t=await m(`POST`,`/auth/credentials`,e,{auth:!0});return t.token&&Se(t.token),t.user},async forgot(e){return m(`POST`,`/auth/forgot`,{email:e})},async reset(e,t){return m(`POST`,`/auth/reset`,{token:e,password:t})},steamLoginUrl(){return`${ve}/auth/steam`},async steamLinkUrl(){return(await m(`GET`,`/auth/steam/link-url`,void 0,{auth:!0})).url},async steamUnlink(){return(await m(`POST`,`/auth/steam/unlink`,{},{auth:!0})).user}},settings:{async get(){return m(`GET`,`/settings`)}},contact:{async send(e){return m(`POST`,`/contact`,e)}},pros:{async list({q:e=``,sort:t=`name`}={}){let n=new URLSearchParams;e&&n.set(`q`,e),t&&n.set(`sort`,t);let r=n.toString();return m(`GET`,`/pros${r?`?${r}`:``}`)}},configs:{async list({sort:e=`top`,q:t=``}={}){let n=new URLSearchParams;e&&n.set(`sort`,e),t&&n.set(`q`,t);let r=n.toString();return(await m(`GET`,`/configs${r?`?${r}`:``}`,void 0,{auth:!0})).configs},async create(e){return(await m(`POST`,`/configs`,e,{auth:!0})).config},async rate(e,t){return m(`POST`,`/configs/${e}/rate`,{rating:t},{auth:!0})},async remove(e){return m(`DELETE`,`/configs/${e}`,void 0,{auth:!0})}},highlights:{async list({q:e=``}={}){return(await m(`GET`,`/highlights${e?`?q=${encodeURIComponent(e)}`:``}`,void 0,{auth:!0})).highlights},async create(e){return(await m(`POST`,`/highlights`,e,{auth:!0})).highlight},async report(e,t){return m(`POST`,`/highlights/${e}/report`,{reason:t},{auth:!0})},async remove(e){return m(`DELETE`,`/highlights/${e}`,void 0,{auth:!0})}},nades:{async list({map:e=``,type:t=``}={}){let n=new URLSearchParams;e&&n.set(`map`,e),t&&n.set(`type`,t);let r=n.toString();return(await m(`GET`,`/nades${r?`?${r}`:``}`)).nades},async mine(){return(await m(`GET`,`/nades/mine`,void 0,{auth:!0})).nades},async create(e){return(await m(`POST`,`/nades`,e,{auth:!0})).nade},async addMedia(e,t){return(await m(`POST`,`/nades/${e}/media`,t,{auth:!0})).media},async remove(e){return m(`DELETE`,`/nades/${e}`,void 0,{auth:!0})},async parseMapGuide(e){return m(`POST`,`/nades/map-guide/parse`,{text:e},{auth:!0})},async importMapGuide({text:e,nades:t,side:n,guideText:r,fileName:i}={}){return m(`POST`,`/nades/map-guide/import`,{text:e,nades:t,side:n,guideText:r,fileName:i},{auth:!0})},async practicePackFromText({text:e,map:t,importId:n}={}){return m(`POST`,`/nades/map-guide/practice-pack`,{text:e,map:t,importId:n},{auth:!0})},async practicePackFromImport(e){return m(`GET`,`/nades/map-guide/imports/${e}/practice-pack`,void 0,{auth:!!xe()})},async practicePackFromNades(e){return m(`POST`,`/nades/map-guide/practice-pack-from-nades`,{nadeIds:e},{auth:!!xe()})}},commands:{async catalog(){return m(`GET`,`/commands/catalog`)},async social(){return m(`GET`,`/commands/social`,void 0,{auth:!0})},async recommend(e){return m(`POST`,`/commands/${e}/recommend`,{},{auth:!0})},async addComment(e,t){return m(`POST`,`/commands/${e}/comments`,{body:t},{auth:!0})}},admin:{async pending(){return(await m(`GET`,`/admin/nades/pending`,void 0,{auth:!0})).nades},async pendingComments(){return(await m(`GET`,`/admin/comments/pending`,void 0,{auth:!0})).comments},async pendingCommentsCount(){return(await m(`GET`,`/admin/comments/pending/count`,void 0,{auth:!0})).count},async reviewComment(e,t){return m(`POST`,`/admin/comments/${e}/review`,{decision:t},{auth:!0})},async syncCommands(){return m(`POST`,`/admin/commands/sync`,{},{auth:!0})},async checkCommandsCs2(){return m(`POST`,`/admin/commands/check-cs2`,{},{auth:!0})},async saveSettings(e){return m(`POST`,`/admin/settings`,e,{auth:!0})},async highlightReports(){return(await m(`GET`,`/admin/highlights/reports`,void 0,{auth:!0})).highlights},async highlightReportsCount(){return(await m(`GET`,`/admin/highlights/reports/count`,void 0,{auth:!0})).count},async reviewHighlight(e,t){return m(`POST`,`/admin/highlights/${e}/review`,{decision:t},{auth:!0})},async syncPros(){return m(`POST`,`/admin/pros/sync`,{},{auth:!0})},async importCommands(e){return m(`POST`,`/admin/commands/import`,{content:e},{auth:!0})},async importPros(e){return m(`POST`,`/admin/pros/import`,{content:e},{auth:!0})},async banUser(e,{hours:t,permanent:n}){return(await m(`POST`,`/admin/users/${e}/ban`,{hours:t,permanent:n},{auth:!0})).user},async unbanUser(e){return(await m(`POST`,`/admin/users/${e}/unban`,{},{auth:!0})).user},async pendingCount(){return(await m(`GET`,`/admin/nades/pending/count`,void 0,{auth:!0})).count},async reviewNade(e,t,n=``){return m(`POST`,`/admin/nades/${e}/review`,{decision:t,note:n},{auth:!0})},async reviewNadesBulk(e,t,n=``){return m(`POST`,`/admin/nades/review-bulk`,{ids:e,decision:t,note:n},{auth:!0})},async reviewMedia(e,t){return m(`POST`,`/admin/media/${e}/review`,{decision:t},{auth:!0})},async reviewMediaBulk(e,t){return m(`POST`,`/admin/media/review-bulk`,{ids:e,decision:t},{auth:!0})},async users(){return(await m(`GET`,`/admin/users`,void 0,{auth:!0})).users},async setRole(e,t){return(await m(`POST`,`/admin/users/${e}/role`,{role:t},{auth:!0})).user},async contactMessages(){return(await m(`GET`,`/admin/contact`,void 0,{auth:!0})).messages}},uploads:{async image(e){let t=new FormData;return t.append(`file`,e),await m(`POST`,`/uploads`,t,{auth:!0})}}},De=null,Oe=new Set;function ke(){for(let e of Oe)e(De)}function Ae(){return De}function je(e){return Oe.add(e),()=>Oe.delete(e)}async function Me(){return De=await g.auth.me(),ke(),De}async function Ne(e){return De=await g.auth.login(e),ke(),De}async function Pe(e){return De=await g.auth.register(e),ke(),De}function Fe(){g.auth.logout(),De=null,ke()}var Ie,_,Le=`login`,Re={required:!1,token:null,svg:``};function ze(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Be(){let e=Ae();e?(Ie.innerHTML=`
    ...
    <div class="modal-card import-card" role="dialog" aria-modal="true" aria-label="${Cn(e.title)}">
      ...
      <p class="status" id="import-status"></p>
       ...
       <p class="hint">Comments are reviewed by an admin before appearing.</p>`:`<button class="btn btn-sm" data-open-auth="login">Log in to comment</button>`}</div>`}function Nn(e){let t=En.counts[e.key]||0,n=En.mine.includes(e.key),r=(En.comments[e.key]||[]).length,i=kn.has(e.key);return`
    <article class="cmd-card" data-search="${j(`${e.command} ${e.title} ${e.description}`.toLowerCase())}">
      ...
      ${i?Mn(e):``}
    </article>`}function Pn(e){let t=A.commands.filter(t=>t.category===e.id);return t.length?`
    ...
    </section>`:``}function Fn(){let e=A.commands.filter(e=>e.isNew).length,t=h(Tn)?`<div class="actions">
    ...
    <section class="cmd-status-bar">
      <div>
        ...
        <strong>Last synced:</strong> ${An(A.lastSync)}
        ${e?` · <span class="nade-badge new">${e} new</span>`:``}
      </div>
      ${t}
    </section>`}function In(){return!h(Tn)||!Dn.length?``:`
    <section class="cmd-review panel-review">
      <h3>Comments awaiting review (${Dn.length})</h3>
      ${Dn.map(e=>`<div class="review-comment">
    ...
    </section>`}function Ln(){k.innerHTML=`
    <div class="commands-shell">
      ...
      ${A.categories.map(Pn).join(``)}
      <div id="commands-status" class="status ${On.kind}">${j(On.text)}</div>
    </div>`,zn()}function Rn(e){let t=e.trim().toLowerCase();k.querySelectorAll(`.cmd-category`).forEach(e=>{let n=0;e.querySelectorAll(`.cmd-card`).forEach(e=>{let r=!t||e.dataset.search.includes(t);e.classList.toggle(`hidden`,!r),r&&(n+=1)}),e.classList.toggle(`hidden`,n===0)})}function zn(){k.querySelectorAll(`[data-copy]`).forEach(e=>e.addEventListener(`click`,async()=>{try{await navigator.clipboard.writeText(e.dataset.copy),M(`Copied to clipboard.`,`ok`)}catch{M(`Clipboard blocked — select and copy manually.`,`error`)}})),k.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>Je(e.dataset.openAuth))),k.querySelectorAll(`[data-recommend]`).forEach(e=>e.addEventListener(`click`,()=>Bn(e.dataset.recommend))),k.querySelectorAll(`[data-toggle-comments]`).forEach(e=>e.addEventListener(`click`,()=>{let t=e.dataset.toggleComments;kn.has(t)?kn.delete(t):kn.add(t),Ln()})),k.querySelectorAll(`.cmd-comment-form`).forEach(e=>e.addEventListener(`submit`,t=>{t.preventDefault(),Vn(e.dataset.commentKey,e.querySelector(`input`))})),k.querySelectorAll(`[data-approve-comment]`).forEach(e=>e.addEventListener(`click`,()=>Hn(e.dataset.approveComment,`approved`))),k.querySelectorAll(`[data-reject-comment]`).forEach(e=>e.addEventListener(`click`,()=>Hn(e.dataset.rejectComment,`rejected`))),k.querySelector(`#cmd-search`)?.addEventListener(`input`,e=>Rn(e.target.value)),k.querySelector(`#cmd-sync`)?.addEventListener(`click`,Un),k.querySelector(`#cmd-check-cs2`)?.addEventListener(`click`,Wn)}async function Bn(e){if(!Tn){Je(`login`);return}try{let t=await g.commands.recommend(e);En.counts[e]=t.count,En.mine=t.recommended?[...En.mine.filter(t=>t!==e),e]:En.mine.filter(t=>t!==e),Ln()}catch(e){M(e.message,`error`)}}async function Vn(e,t){let n=(t?.value||``).trim();if(!n){M(`Write something first.`,`error`);return}try{await g.commands.addComment(e,n),M(`Comment submitted — an admin will review it before it appears.`,`ok`),t&&(t.value=``)}catch(e){M(e.message,`error`)}}async function Hn(e,t){try{await g.admin.reviewComment(e,t),await jn(),Ln(),M(`Comment ${t}.`,`ok`)}catch(e){M(e.message,`error`)}}function Un(){wn({title:`Sync commands from the CS2 wiki`,description:`The Valve wiki has a bot check that blocks servers. Open it in your browser, complete the verification, then copy the page source (wikitext) and paste it here — the server will parse it.`,sourceUrl:`https://developer.valvesoftware.com/w/index.php?title=List_of_Counter-Strike_2_console_command_variables&action=raw`,sourceLabel:`Open CS2 wiki source`,placeholder:`Paste the wiki page source (wikitext), or a JSON list of commands…`,onImport:async e=>{let t=await g.admin.importCommands(e);return await jn(),Ln(),`Imported ${t.count} commands.`}})}async function Wn(){M(`Checking the current CS2 build…`,``);try{let e=await g.admin.checkCommandsCs2();await jn(),Ln(),M(e.ok?`CS2 build ${e.build}${e.changed?` — changed, catalog re-synced`:` — no change`}.`:`Check failed: ${e.reason}`,e.ok?`ok`:`error`)}catch(e){M(e.message,`error`)}}async function Gn(){k=document.querySelector(`#commands-tool`),k&&(Tn=Ae(),je(async e=>{Tn=e,await jn(),Ln()}),Ln(),await jn(),Ln())}var N,P=null,Kn=null,qn={paypalUrl:``,steamTradeUrl:``},Jn={text:``,kind:``};function F(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function I(e,t=``){Jn={text:e,kind:t};let n=N?.querySelector(`#profile-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function Yn(e){try{return new Date(e).toLocaleDateString()}catch{return`—`}}async function Xn(){if(P){try{Kn=(await g.auth.profile()).stats}catch(e){I(e.message,`error`)}if(Te(P))try{qn=await g.settings.get()}catch{}}}function Zn(e,t){return`<div class="profile-stat"><dt>${F(e)}</dt><dd>${F(t)}</dd></div>`}function Qn(){return Te(P)?`
    <section class="panel profile-settings">
      ...
      <div class="profile-settings-body">
        ...
        <label class="field">
          ...
          <input id="set-paypal" type="url" placeholder="https://www.paypal.com/paypalme/yourname" value="${F(qn.paypalUrl)}" />
        </label>
        <label class="field">
          <span>Steam trade link</span>
          <input id="set-steam" type="url" placeholder="https://steamcommunity.com/tradeoffer/new/?partner=...&token=..." value="${F(qn.steamTradeUrl)}" />
        </label>
        <div class="actions">
          <button class="btn primary" id="set-save">Save donate links</button>
        </div>
      </div>
    </section>`:``}function $n(){if(!P){N.innerHTML=`<div class="profile-shell"><div class="login-prompt">
    ...
    </div></div>`,N.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>Je(e.dataset.openAuth)));return}let e=(P.username||`?`).charAt(0).toUpperCase(),t=Kn||{nadesTotal:0,nadesApproved:0,nadesPending:0,recommendations:0,comments:0};N.innerHTML=`
    <div class="profile-shell">
      <section class="panel profile-card">
        ...
        <dl class="profile-stats">
          ${Zn(`Nades submitted`,t.nadesTotal)}
          ${Zn(`Approved`,t.nadesApproved)}
          ${Zn(`Pending`,t.nadesPending)}
          ${Zn(`Commands recommended`,t.recommendations)}
          ${Zn(`Comments`,t.comments)}
        </dl>
      </section>
      ...
      ${Qn()}
      <div id="profile-status" class="status ${Jn.kind}">${F(Jn.text)}</div>
    </div>`,N.querySelector(`#set-save`)?.addEventListener(`click`,sr),N.querySelector(`#pw-save`)?.addEventListener(`click`,tr),N.querySelector(`#username-save`)?.addEventListener(`click`,rr),N.querySelector(`#cred-save`)?.addEventListener(`click`,ir),N.querySelector(`#steam-link`)?.addEventListener(`click`,ar),N.querySelector(`#steam-unlink`)?.addEventListener(`click`,or);let n=N.querySelector(`#avatar-file`);N.querySelector(`#avatar-upload`)?.addEventListener(`click`,()=>n?.click()),n?.addEventListener(`change`,e=>er(e.target.files?.[0])),N.querySelector(`#avatar-remove`)?.addEventListener(`click`,nr)}async function er(e){if(e){I(`Uploading image…`,``);try{await g.auth.uploadAvatar(e),await Me(),I(`Profile image updated.`,`ok`)}catch(e){I(e.message,`error`)}}}async function tr(){let e=N.querySelector(`#pw-current`)?.value||``,t=N.querySelector(`#pw-new`)?.value||``;try{await g.auth.changePassword({currentPassword:e,newPassword:t}),N.querySelector(`#pw-current`).value=``,N.querySelector(`#pw-new`).value=``,I(`Password updated.`,`ok`)}catch(e){I(e.message,`error`)}}async function nr(){try{await g.auth.setAvatar(``),await Me(),I(`Profile image removed.`,`ok`)}catch(e){I(e.message,`error`)}}async function rr(){let e=N.querySelector(`#acc-username`)?.value||``;try{await g.auth.changeUsername(e),await Me(),I(`Username updated.`,`ok`)}catch(e){I(e.message,`error`)}}async function ir(){let e=N.querySelector(`#cred-email`)?.value||``,t=N.querySelector(`#cred-password`)?.value||``;try{await g.auth.setCredentials({email:e,password:t}),await Me(),I(`Email & password saved — you can now log in without Steam.`,`ok`)}catch(e){I(e.message,`error`)}}async function ar(){try{let e=await g.auth.steamLinkUrl();window.location.href=e}catch(e){I(e.message,`error`)}}async function or(){try{await g.auth.steamUnlink(),await Me(),I(`Steam unlinked.`,`ok`)}catch(e){I(e.message,`error`)}}async function sr(){let e=N.querySelector(`#set-paypal`)?.value||``,t=N.querySelector(`#set-steam`)?.value||``;try{qn=await g.admin.saveSettings({paypalUrl:e,steamTradeUrl:t}),I(`Donate links saved.`,`ok`),document.dispatchEvent(new CustomEvent(`aimkit:settings-updated`))}catch(e){I(e.message,`error`)}}async function cr(){N=document.querySelector(`#profile-tool`),N&&(P=Ae(),je(async e=>{P=e,await Xn(),$n()}),$n(),await Xn(),$n())}var L,lr=null,ur=[],dr=`top`,fr=!1,pr={text:``,kind:``},mr=new Set;function hr(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function gr(e,t=``){pr={text:e,kind:t};let n=L?.querySelector(`#configs-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function _r(e){try{return new Date(e).toLocaleDateString()}catch{return``}}function vr(e,t){let n=new Blob([t],{type:`text/plain`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=e,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r)}async function yr(){try{ur=await g.configs.list({sort:dr})}catch(e){gr(e.message,`error`)}wr()}function br(e){let t=Math.round(e),n=``;for(let e=1;e<=5;e+=1)n+=e<=t?`★`:`☆`;return n}function xr(e){if(!lr)return`<button class="btn btn-sm" data-open-auth="login">Log in to rate</button>`;if(e.authorId===lr.id)return`<span class="hint">Your upload</span>`;let t=``;for(let n=1;n<=5;n+=1)t+=`<button class="star-btn ${n<=e.myRating?`on`:``}" data-rate="${e.id}" data-star="${n}" title="${n} star${n>1?`s`:``}">${n<=e.myRating?`★`:`☆`}</button>`;return`<span class="rate-label">Your rating:</span><span class="star-picker">${t}</span>`}function Sr(e){let t=mr.has(e.id),n=lr&&(e.authorId===lr.id||h(lr));return`
    <article class="config-card" data-search="${hr(`${e.title} ${e.description} ${e.authorName}`.toLowerCase())}">
      <div class="config-head">
        <h3>${hr(e.title)}</h3>
        <div class="config-rating" title="${e.avgRating} from ${e.ratingCount} rating(s)">
          <span class="stars">${br(e.avgRating)}</span>
          <span class="rating-num">${e.avgRating||`—`} (${e.ratingCount})</span>
        </div>
      </div>
      ${e.description?`<p class="config-desc">${hr(e.description)}</p>`:``}
      ...
      ${t?`<div class="config-view">
               ${e.hasConfig?`<div><strong>Config</strong><pre>${hr(e.configText)}</pre></div>`:``}
               ${e.hasVideo?`<div><strong>Video settings</strong><pre>${hr(e.videoText)}</pre></div>`:``}
             </div>`:``}
      <div class="config-foot">
        <span>by ${hr(e.authorName)} · ${_r(e.createdAt)}</span>
        <span class="config-rate">${xr(e)}</span>
      </div>
    </article>`}function Cr(){return!lr||!fr?``:`
    ...
    </section>`}function wr(){L.innerHTML=`
    <div class="configs-shell">
      <div class="configs-controls">
        ...
        ${lr?`<button class="btn primary" id="cfg-new">Upload config</button>`:`<button class="btn primary" data-open-auth="login">Log in to upload</button>`}
      </div>
      ${Cr()}
      <div class="config-grid">
        ${ur.length?ur.map(Sr).join(``):`<p class="hint">No configs yet — be the first to upload one!</p>`}
      </div>
      <div id="configs-status" class="status ${pr.kind}">${hr(pr.text)}</div>
    </div>`,Er()}function Tr(e){let t=e.trim().toLowerCase();L.querySelectorAll(`.config-card`).forEach(e=>{e.classList.toggle(`hidden`,t&&!e.dataset.search.includes(t))})}function Er(){L.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>Je(e.dataset.openAuth))),L.querySelectorAll(`[data-sort]`).forEach(e=>e.addEventListener(`click`,()=>{dr=e.dataset.sort,yr()})),L.querySelector(`#cfg-search`)?.addEventListener(`input`,e=>Tr(e.target.value)),L.querySelector(`#cfg-new`)?.addEventListener(`click`,()=>{fr=!0,wr()}),L.querySelector(`#cfg-cancel`)?.addEventListener(`click`,()=>{fr=!1,wr()}),L.querySelector(`#cfg-submit`)?.addEventListener(`click`,kr),L.querySelector(`#cfg-config-file`)?.addEventListener(`change`,e=>Or(e.target,`#cfg-config`)),L.querySelector(`#cfg-video-file`)?.addEventListener(`change`,e=>Or(e.target,`#cfg-video`)),L.querySelectorAll(`[data-dl]`).forEach(e=>e.addEventListener(`click`,()=>{let t=ur.find(t=>String(t.id)===e.dataset.dl);t&&(e.dataset.kind===`config`?vr(`${Dr(t.title)}.cfg`,t.configText):vr(`cs2_video.txt`,t.videoText))})),L.querySelectorAll(`[data-view]`).forEach(e=>e.addEventListener(`click`,()=>{let t=Number(e.dataset.view);mr.has(t)?mr.delete(t):mr.add(t),wr()})),L.querySelectorAll(`[data-del]`).forEach(e=>e.addEventListener(`click`,()=>jr(Number(e.dataset.del)))),L.querySelectorAll(`[data-rate]`).forEach(e=>e.addEventListener(`click`,()=>Ar(Number(e.dataset.rate),Number(e.dataset.star))))}function Dr(e){return(e||`config`).toLowerCase().replace(/[^a-z0-9]+/g,`_`).replace(/^_|_$/g,``).slice(0,40)||`config`}function Or(e,t){let n=e.files?.[0];if(!n)return;let r=new FileReader;r.onload=()=>{let e=L.querySelector(t);e&&(e.value=String(r.result||``))},r.readAsText(n)}async function kr(){let e=L.querySelector(`#cfg-title`)?.value||``,t=L.querySelector(`#cfg-desc`)?.value||``,n=L.querySelector(`#cfg-config`)?.value||``,r=L.querySelector(`#cfg-video`)?.value||``;try{await g.configs.create({title:e,description:t,configText:n,videoText:r}),fr=!1,dr=`new`,await yr(),gr(`Config published!`,`ok`)}catch(e){gr(e.message,`error`)}}async function Ar(e,t){try{let n=await g.configs.rate(e,t),r=ur.find(t=>t.id===e);r&&(r.avgRating=n.avgRating,r.ratingCount=n.ratingCount,r.myRating=n.myRating),wr(),gr(`Thanks for rating!`,`ok`)}catch(e){gr(e.message,`error`)}}async function jr(e){try{await g.configs.remove(e),await yr(),gr(`Config deleted.`,`ok`)}catch(e){gr(e.message,`error`)}}async function Mr(){L=document.querySelector(`#configs-tool`),L&&(lr=Ae(),je(async e=>{lr=e,await yr()}),wr(),await yr())}var R,z=null,Nr=[],Pr=[],Fr={text:``,kind:``},Ir=!1,Lr=null;function B(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Rr(e,t=``){Fr={text:e,kind:t};let n=R?.querySelector(`#highlights-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function zr(e){try{return new Date(e).toLocaleDateString()}catch{return``}}function Br(e){let t=/(?:youtube\.com\/(?:watch\?v=|embed\/|shorts\/)|youtu\.be\/)([\w-]{6,})/.exec(e||``);return t?t[1]:null}function Vr(e){return/^https?:\/\//.test(e||``)?e:``}function Hr(e){let t=Vr(e);if(!t)return``;let n=Br(e);return n?`<iframe class="hl-embed" src="https://www.youtube.com/embed/${B(n)}" title="highlight" allowfullscreen loading="lazy"></iframe>`:/\.(mp4|webm|mov)(\?|$)/i.test(e)?`<video class="hl-embed" src="${B(t)}" controls preload="none"></video>`:`<a class="btn ghost" href="${B(t)}" target="_blank" rel="noopener noreferrer">Open highlight ↗</a>`}async function Ur(){try{Nr=await g.highlights.list({}),Pr=h(z)?await g.admin.highlightReports():[]}catch(e){Rr(e.message,`error`)}qr()}function Wr(){return!h(z)||!Pr.length?``:`
    <section class="panel panel-review">
      <h3>Reported highlights (${Pr.length})</h3>
      ${Pr.map(e=>`<div class="report-item">
    ...
    </section>`}function Gr(e){let t=z&&(e.authorId===z.id||h(z));return`
    <article class="hl-card" data-search="${B(`${e.title} ${e.description} ${e.authorName}`.toLowerCase())}">
      ...
      <div class="hl-foot">
        <span>by ${B(e.authorName)} · ${zr(e.createdAt)}</span>
      ...
      ${Lr===e.id?`<form class="hl-report-form" data-report-form="${e.id}">
    ...
    </article>`}function Kr(){return!z||!Ir?``:`
    <section class="panel config-upload">
    ...
    </section>`}function qr(){R.innerHTML=`
    <div class="highlights-shell">
      ...
      ${Kr()}
      <div class="hl-grid">
        ${Nr.length?Nr.map(Gr).join(``):`<p class="hint">No highlights yet — share the first one!</p>`}
      </div>
      <div id="highlights-status" class="status ${Fr.kind}">${B(Fr.text)}</div>
    </div>`,Yr()}function Jr(e){let t=e.trim().toLowerCase();R.querySelectorAll(`.hl-card`).forEach(e=>{e.classList.toggle(`hidden`,t&&!e.dataset.search.includes(t))})}function Yr(){R.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>Je(e.dataset.openAuth))),R.querySelector(`#hl-search`)?.addEventListener(`input`,e=>Jr(e.target.value)),R.querySelector(`#hl-new`)?.addEventListener(`click`,()=>{Ir=!0,qr()}),R.querySelector(`#hl-cancel`)?.addEventListener(`click`,()=>{Ir=!1,qr()}),R.querySelector(`#hl-submit`)?.addEventListener(`click`,Xr),R.querySelectorAll(`[data-report]`).forEach(e=>e.addEventListener(`click`,()=>{Lr=Number(e.dataset.report),qr()})),R.querySelector(`[data-cancel-report]`)?.addEventListener(`click`,()=>{Lr=null,qr()}),R.querySelector(`[data-report-form]`)?.addEventListener(`submit`,e=>{e.preventDefault(),Zr(Number(e.currentTarget.dataset.reportForm),e.currentTarget.querySelector(`input`).value)}),R.querySelectorAll(`[data-del]`).forEach(e=>e.addEventListener(`click`,()=>Qr(Number(e.dataset.del)))),R.querySelectorAll(`[data-keep]`).forEach(e=>e.addEventListener(`click`,()=>$r(Number(e.dataset.keep),`keep`))),R.querySelectorAll(`[data-remove-hl]`).forEach(e=>e.addEventListener(`click`,()=>$r(Number(e.dataset.removeHl),`delete`)))}async function Xr(){let e=R.querySelector(`#hl-title`)?.value||``,t=R.querySelector(`#hl-desc`)?.value||``,n=R.querySelector(`#hl-url`)?.value||``;try{await g.highlights.create({title:e,description:t,url:n}),Ir=!1,await Ur(),Rr(`Highlight shared!`,`ok`)}catch(e){Rr(e.message,`error`)}}async function Zr(e,t){try{await g.highlights.report(e,t),Lr=null,await Ur(),Rr(`Thanks — an admin will review your report.`,`ok`)}catch(e){Rr(e.message,`error`)}}async function Qr(e){try{await g.highlights.remove(e),await Ur(),Rr(`Highlight deleted.`,`ok`)}catch(e){Rr(e.message,`error`)}}async function $r(e,t){try{await g.admin.reviewHighlight(e,t),await Ur(),Rr(t===`delete`?`Highlight removed.`:`Reports cleared — highlight kept.`,`ok`)}catch(e){Rr(e.message,`error`)}}async function ei(){R=document.querySelector(`#highlights-tool`),R&&(z=Ae(),je(async e=>{z=e,await Ur()}),qr(),await Ur())}var V,ti=null,H={pros:[],source:`seed`,lastSync:0},ni=`featured`,ri=``,ii=null,ai={text:``,kind:``};function U(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function oi(e,t=``){ai={text:e,kind:t};let n=V?.querySelector(`#pros-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}async function si(){try{H=await g.pros.list({sort:ni,q:ri})}catch(e){oi(e.message,`error`)}mi()}var ci={"natus vincere":`#f4d000`,vitality:`#f5d20a`,falcons:`#0aa14f`,"team spirit":`#c8102e`,astralis:`#e4002b`,faze:`#e43b26`,g2:`#c8102e`};function li(e){return ci[(e||``).toLowerCase()]||`#33415a`}function ui(e){let t=(e.team||e.player||`?`).trim(),n=t.split(/\s+/);return(n.length>1?n.slice(0,3).map(e=>e[0]).join(``):t.slice(0,2)).toUpperCase()}function di(e){let t=e.photo||e.teamLogo||``,n=e.photo&&e.teamLogo?e.teamLogo:``,r=t?`<img class="pro-img" alt="${U(e.player)}" loading="lazy" src="${U(t)}"${n?` data-logo="${U(n)}"`:``} onerror="if(this.dataset.logo){this.src=this.dataset.logo;this.removeAttribute('data-logo');}else{this.remove();}" />`:``;return`<div class="pro-photo" style="--team:${li(e.team)}"><span class="pro-monogram">${U(ui(e))}</span>${r}</div>`}function fi(e,t){return`<div class="pro-stat"><dt>${U(e)}</dt><dd>${t!=null&&t!==``?U(t):`—`}</dd></div>`}function pi(e){return`
    <article class="pro-card" data-search="${U(`${e.player} ${e.team||``}`.toLowerCase())}">
      ...
      <dl class="pro-stats">
        ...
        ${fi(`Zoom`,e.zoomSens)}
        ${fi(`Hz`,e.hz)}
        ${fi(`Resolution`,e.resolution)}
        ${fi(`Aspect`,e.aspectRatio)}
      </dl>
    </article>`}function mi(){let e=h(ti)?`<div class="pros-admin-actions">
    ...
    <div class="pros-shell">
      ...
      <div class="configs-controls">
        <div class="sort-tabs">
          <button class="tool-tab ${ni===`featured`?`active`:``}" data-sort="featured">Featured</button>
          <button class="tool-tab ${ni===`name`?`active`:``}" data-sort="name">Name</button>
          <button class="tool-tab ${ni===`edpi`?`active`:``}" data-sort="edpi">Lowest eDPI</button>
          <button class="tool-tab ${ni===`edpi-desc`?`active`:``}" data-sort="edpi-desc">Highest eDPI</button>
        </div>
        <input id="pros-search" type="search" class="cfg-search" placeholder="Search player or team…" value="${U(ri)}" />
      </div>
      ...
      <div class="pro-grid">
        ${H.pros.length?H.pros.map(pi).join(``):`<p class="hint">No pro settings yet.</p>`}
      </div>
      <div id="pros-status" class="status ${ai.kind}">${U(ai.text)}</div>
    </div>`,hi()}function hi(){V.querySelectorAll(`[data-sort]`).forEach(e=>e.addEventListener(`click`,()=>{ni=e.dataset.sort,si()}));let e=V.querySelector(`#pros-search`);e&&e.addEventListener(`input`,e=>{ri=e.target.value,clearTimeout(ii),ii=setTimeout(async()=>{await si();let e=V.querySelector(`#pros-search`);e&&(e.focus(),e.setSelectionRange(e.value.length,e.value.length))},300)}),V.querySelector(`#pros-sync`)?.addEventListener(`click`,gi),V.querySelector(`#pros-import`)?.addEventListener(`click`,_i)}async function gi(){let e=V.querySelector(`#pros-sync`);e&&(e.disabled=!0),oi(`Syncing from prosettings.net…`,``);try{let e=await g.admin.syncPros();await si(),e.synced?oi(`Synced ${e.count} players from ${e.source}.`,`ok`):oi(`Sync failed: ${e.reason||`unknown error`}. Kept the current list.`,`error`)}catch(e){oi(e.message,`error`)}finally{let e=V.querySelector(`#pros-sync`);e&&(e.disabled=!1)}}function _i(){wn({title:`Import pro settings from HLTV`,description:`HLTV has a Cloudflare check that blocks servers. Open HLTV in your browser, complete the verification, then paste a JSON list of players here. Each item: {"player","team","dpi","sens","zoomSens","hz","resolution","aspectRatio","photo","teamLogo"}.`,sourceUrl:`https://www.hltv.org/stats/players`,sourceLabel:`Open HLTV`,placeholder:`[{"player":"s1mple","team":"Natus Vincere","dpi":400,"sens":3.09,"hz":1000,"resolution":"1280x960","aspectRatio":"4:3"}]`,onImport:async e=>{let t=await g.admin.importPros(e);return await si(),`Imported ${t.count} players.`}})}async function vi(){V=document.querySelector(`#pros-tool`),V&&(ti=Ae(),je(e=>{ti=e,mi()}),mi(),await si())}var W,yi=null,bi=`overview`,xi={text:``,kind:``},Si={nades:0,comments:0,reports:0},G={},Ci=[{id:`overview`,label:`Overview`},{id:`nades`,label:`Nades`},{id:`comments`,label:`Comments`},{id:`reports`,label:`Reports`},{id:`users`,label:`Users`},{id:`sync`,label:`Data sync`},{id:`contact`,label:`Contact`},{id:`settings`,label:`Site settings`,ownerOnly:!0}];function K(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function wi(e,t=``){xi={text:e,kind:t};let n=W?.querySelector(`#admin-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function Ti(e){try{return new Date(e).toLocaleString()}catch{return`—`}}async function Ei(){try{let[e,t,n]=await Promise.all([g.admin.pendingCount().catch(()=>0),g.admin.pendingCommentsCount().catch(()=>0),g.admin.highlightReportsCount().catch(()=>0)]);Si={nades:e,comments:t,reports:n}}catch{}}function Di(){let e=(e,t,n)=>`<button class="admin-stat" data-goto="${n}">
       <span class="admin-stat-num">${t}</span>
       <span class="admin-stat-label">${K(e)}</span>
     </button>`;return`
    <div class="admin-stats">
      ${e(`Nades to review`,Si.nades,`nades`)}
      ${e(`Comments to review`,Si.comments,`comments`)}
      ${e(`Highlight reports`,Si.reports,`reports`)}
    </div>
    <p class="hint">Use the tabs above to moderate content, manage users, sync data sources, and read contact messages.</p>`}function Oi(){let e=G.nades||[];return e.length?`
    <div class="review-bulk-bar">
      <label class="review-select-all">
    ...
    ${e.map(e=>{let t=(e.media||[]).map(e=>`
      ...
      <article class="panel admin-item">
        <p>${K(e.body)}</p>
        <p class="hint">by ${K(e.username)} on <code>${K(e.commandKey)}</code> · ${Ti(e.createdAt)}</p>
        <div class="actions">
      ...
      </article>`).join(``):`<p class="hint">No comments pending review.</p>`}function Ai(){let e=G.reports||[];return e.length?e.map(e=>{let t=(e.reports||[]).map(e=>`<li>${K(e.reason||`No reason`)} — <span class="hint">${K(e.reporterName||`?`)}</span></li>`).join(``);return`
        <article class="panel admin-item">
          <div class="admin-item-head">
        ...
        </article>`}).join(``):`<p class="hint">No open highlight reports.</p>`}function ji(){let e=G.users||[];if(!e.length)return`<p class="hint">No users.</p>`;let t=Date.now();return`<div class="admin-users">${e.map(e=>{let n=e.bannedUntil&&new Date(e.bannedUntil).getTime()>t,r=e.role===`owner`;return`
    ...
    <div class="admin-sync">
    ...
    </div>`}function Ni(){let e=G.contact||[];return e.length?e.map(e=>`
      <article class="panel admin-item">
        <div class="admin-item-head">
      ...
      </article>`).join(``):`<p class="hint">No contact messages.</p>`}function Pi(){let e=G.settings||{paypalUrl:``,steamTradeUrl:``};return`
    <div class="panel admin-item">
    ...
    </div>`}var Fi={overview:Di,nades:Oi,comments:ki,reports:Ai,users:ji,sync:Mi,contact:Ni,settings:Pi};async function Ii(e){try{e===`overview`?await Ei():e===`nades`?G.nades=await g.admin.pending():e===`comments`?G.comments=await g.admin.pendingComments():e===`reports`?G.reports=await g.admin.highlightReports():e===`users`?G.users=await g.admin.users():e===`contact`?G.contact=await g.admin.contactMessages():e===`settings`&&(G.settings=await g.settings.get())}catch(e){wi(e.message,`error`)}}function Li(){if(!W)return;if(!h(yi)){W.innerHTML=`<div class="admin-shell"><div class="login-prompt">
      <p class="hint">This area is for admins only.</p>
      ${yi?``:`<div class="actions"><button class="btn primary" data-open-auth="login">Log in</button></div>`}
    </div></div>`,W.querySelector(`[data-open-auth]`)?.addEventListener(`click`,()=>Je(`login`));return}let e=Ci.filter(e=>!e.ownerOnly||Te(yi)).map(e=>`<button class="tool-tab ${bi===e.id?`active`:``}" data-section="${e.id}">${K(e.label)}${e.id===`nades`&&Si.nades?` (${Si.nades})`:``}${e.id===`comments`&&Si.comments?` (${Si.comments})`:``}${e.id===`reports`&&Si.reports?` (${Si.reports})`:``}</button>`).join(``),t=(Fi[bi]||Di)();W.innerHTML=`
    <div class="admin-shell">
      <h2 class="admin-title">Admin</h2>
      <div class="admin-nav sort-tabs">${e}</div>
      <div class="admin-body">${t}</div>
      <div id="admin-status" class="status ${xi.kind}">${K(xi.text)}</div>
    </div>`,zi()}async function Ri(e){bi=e,Li(),await Ii(e),Li()}function zi(){W.querySelectorAll(`[data-section]`).forEach(e=>e.addEventListener(`click`,()=>Ri(e.dataset.section))),W.querySelectorAll(`[data-goto]`).forEach(e=>e.addEventListener(`click`,()=>Ri(e.dataset.goto)));let e=async(e,t)=>{try{await e(),t&&wi(t,`ok`)}catch(e){wi(e.message,`error`)}},t=async()=>{await Ii(bi),await Ei(),Li()};W.querySelectorAll(`[data-nade-approve]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewNade(n.dataset.nadeApprove,`approved`),await t()},`Nade approved.`))),W.querySelectorAll(`[data-nade-reject]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewNade(n.dataset.nadeReject,`rejected`),await t()},`Nade rejected.`))),W.querySelectorAll(`[data-media-approve]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewMedia(n.dataset.mediaApprove,`approved`),await t()},`Media approved.`))),W.querySelectorAll(`[data-media-reject]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewMedia(n.dataset.mediaReject,`rejected`),await t()},`Media rejected.`)));let n=W.querySelector(`#admin-nade-select-all`),r=W.querySelector(`#admin-nade-bulk-approve`),i=W.querySelector(`#admin-nade-bulk-reject`),a=()=>{let e=W.querySelectorAll(`.admin-nade-check:checked`).length;r&&(r.disabled=e===0),i&&(i.disabled=e===0)};n?.addEventListener(`change`,()=>{W.querySelectorAll(`.admin-nade-check`).forEach(e=>{e.checked=n.checked}),a()}),W.querySelectorAll(`.admin-nade-check`).forEach(e=>e.addEventListener(`change`,a));let o=async n=>{let r=[...W.querySelectorAll(`.admin-nade-check:checked`)].map(e=>Number(e.value));r.length&&await e(async()=>{let e=await g.admin.reviewNadesBulk(r,n);await t(),wi(`${n===`approved`?`Approved`:`Rejected`} ${e.updated} nade${e.updated===1?``:`s`}.`,`ok`)})};r?.addEventListener(`click`,()=>o(`approved`)),i?.addEventListener(`click`,()=>o(`rejected`)),W.querySelectorAll(`[data-comment-approve]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewComment(n.dataset.commentApprove,`approved`),await t()},`Comment approved.`))),W.querySelectorAll(`[data-comment-reject]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewComment(n.dataset.commentReject,`rejected`),await t()},`Comment rejected.`))),W.querySelectorAll(`[data-report-keep]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewHighlight(n.dataset.reportKeep,`keep`),await t()},`Kept highlight.`))),W.querySelectorAll(`[data-report-delete]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewHighlight(n.dataset.reportDelete,`delete`),await t()},`Highlight deleted.`))),W.querySelectorAll(`[data-role]`).forEach(n=>n.addEventListener(`change`,()=>e(async()=>{await g.admin.setRole(n.dataset.role,n.value),await t()},`Role updated.`))),W.querySelectorAll(`[data-unban]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.unbanUser(n.dataset.unban),await t()},`User unbanned.`))),W.querySelectorAll(`[data-ban]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{let e=Number(W.querySelector(`[data-ban-hrs="${n.dataset.ban}"]`)?.value);if(!Number.isFinite(e)||e<=0)return wi(`Enter a positive number of hours.`,`error`);await g.admin.banUser(n.dataset.ban,{hours:e}),await t(),wi(`User banned.`,`ok`)}))),W.querySelectorAll(`[data-ban-perma]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.banUser(n.dataset.banPerma,{permanent:!0}),await t()},`User banned permanently.`))),W.querySelector(`#sync-commands`)?.addEventListener(`click`,()=>e(async()=>{let e=await g.admin.syncCommands();wi(e.synced?`Commands synced (${e.count}).`:`No sync: ${e.reason||`no source`}.`,e.synced?`ok`:`error`)})),W.querySelector(`#check-cs2`)?.addEventListener(`click`,()=>e(async()=>{let e=await g.admin.checkCommandsCs2();wi(`CS2 build: ${e.build||`unknown`}${e.changed?` (changed → re-synced)`:``}.`,`ok`)})),W.querySelector(`#sync-pros`)?.addEventListener(`click`,()=>e(async()=>{let e=await g.admin.syncPros();wi(e.synced?`Synced ${e.count} pros from ${e.source}.`:`Sync failed: ${e.reason}.`,e.synced?`ok`:`error`)})),W.querySelector(`#import-commands`)?.addEventListener(`click`,()=>wn({title:`Import commands`,description:`Paste the CS2 console-commands wiki page (wikitext) or a JSON array of commands.`,sourceUrl:`https://developer.valvesoftware.com/wiki/List_of_Counter-Strike_2_console_command_variables`,sourceLabel:`Open wiki`,onImport:async e=>`Imported ${(await g.admin.importCommands(e)).count} commands.`})),W.querySelector(`#import-pros`)?.addEventListener(`click`,()=>wn({title:`Import pro settings from HLTV`,description:`Open HLTV, complete the check, then paste a JSON list of players.`,sourceUrl:`https://www.hltv.org/stats/players`,sourceLabel:`Open HLTV`,onImport:async e=>{let t=await g.admin.importPros(e);return await Ii(`sync`),`Imported ${t.count} players.`}})),W.querySelector(`#save-settings`)?.addEventListener(`click`,()=>e(async()=>{let e=W.querySelector(`#set-paypal`)?.value||``,t=W.querySelector(`#set-steam`)?.value||``;G.settings=await g.admin.saveSettings({paypalUrl:e,steamTradeUrl:t}),document.dispatchEvent(new CustomEvent(`aimkit:settings-updated`))},`Donate links saved.`))}function Bi(e){document.querySelectorAll(`.admin-only`).forEach(t=>t.classList.toggle(`hidden`,!h(e)))}async function Vi(){W=document.querySelector(`#admin-tool`),W&&(yi=Ae(),Bi(yi),je(async e=>{let t=h(yi);yi=e,Bi(e),h(e)&&!t&&await Ei(),Li()}),Li(),h(yi)&&(await Ei(),Li()))}function Hi(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Ui(){let e=Ae(),t=document.createElement(`div`);t.className=`modal`,t.innerHTML=`
    <div class="modal-backdrop" data-close></div>
    <div class="modal-card" role="dialog" aria-modal="true" aria-label="Contact us">
      ...
      <form id="contact-form" class="auth-form-modal">
        <label class="field"><span>Your name</span><input id="contact-name" type="text" value="${Hi(e?.username||``)}" /></label>
        <label class="field"><span>Your email</span><input id="contact-email" type="email" value="${Hi(e?.email||``)}" /></label>
...
`;var oa=document.querySelector(`#preview-canvas`),sa=document.querySelector(`#preview-stats`),ca=document.querySelector(`#preview-res`),la=document.querySelector(`#preview-res-scale`),ua=`ingame`;function da(){let e=ua===`fullscreen`?1080:280;oa.width!==e&&(oa.width=e,oa.height=e),oa.style.imageRendering=ua===`fullscreen`?`auto`:`pixelated`}da();var fa=[{id:`1920x1080`,h:1080,label:`1920 × 1080 (16:9)`},{id:`2560x1440`,h:1440,label:`2560 × 1440 (16:9)`},{id:`3840x2160`,h:2160,label:`3840 × 2160 (4K)`},{id:`1600x900`,h:900,label:`1600 × 900 (16:9)`},{id:`1366x768`,h:768,label:`1366 × 768 (16:9)`},{id:`1280x960`,h:960,label:`1280 × 960 (4:3)`},{id:`1024x768`,h:768,label:`1024 × 768 (4:3)`},{id:`1280x1024`,h:1024,label:`1280 × 1024 (5:4)`}],pa=null;function ma(){return ua===`fullscreen`?oa.height/1080:(fa.find(e=>e.id===ca?.value)||fa[0]).h/1080}var ha=Ji({source:oa,stage:document.querySelector(`.preview-stage`),toggleBtn:document.querySelector(`#magnifier-toggle`),zoomSelect:document.querySelector(`#magnifier-zoom`)});function ga(e){if(pa=e,qi(oa,e,ma()),la)if(e){let t=fa.find(e=>e.id===ca?.value)||fa[0],n=t.h/1080;la.textContent=`≈ ${Math.max(0,Math.round(e.length*n))}px arms · ${Math.max(1,Math.round(e.thickness*n))}px thick @ ${t.h}p`}else la.textContent=``;ha.refresh()}function _a(e){ua=e===`fullscreen`?`fullscreen`:`ingame`,da(),document.querySelectorAll(`.pmode`).forEach(e=>{let t=e.dataset.pmode===ua;e.classList.toggle(`active`,t),e.setAttribute(`aria-selected`,String(t))});let t=document.querySelector(`#preview-mode-tag`);t&&(t.textContent=ua===`fullscreen`?`Relative to full screen`:`Actual in-game size`),ga(pa)}document.querySelectorAll(`.pmode`).forEach(e=>e.addEventListener(`click`,()=>_a(e.dataset.pmode)));var Y=document.querySelector(`#crosshair-status`),va=document.querySelector(`#sensitivity-status`),ya=document.querySelector(`#sharecode-input`),ba=document.querySelector(`#commands-output`),xa=document.querySelector(`#commands-input`),Sa=document.querySelector(`#sharecode-output`),Ca=document.querySelector(`#sens-from-game`),X=document.querySelector(`#sens-to-game`),wa=document.querySelector(`#sens-source`),Ta=document.querySelector(`#sens-target`),Ea=document.querySelector(`#sens-source-dpi`),Da=document.querySelector(`#sens-target-dpi`),Oa=document.querySelector(`#sens-source-myaw`),ka=document.querySelector(`#sens-target-myaw`),Aa=document.querySelector(`#sens-source-yaw`),ja=document.querySelector(`#sens-target-yaw`),Ma=document.querySelector(`#source-yaw-field`),Na=document.querySelector(`#target-yaw-field`),Pa=document.querySelector(`#m-yaw-fields`),Fa=document.querySelector(`#sens-cm360`),Ia=document.querySelector(`#sens-stats`),La=document.querySelector(`#sens-formula`),Ra=`CSGO-UseJt-3oTvn-47wPX-hEyER-WZfiK`,za=`cl_crosshairstyle 4
cl_crosshairsize 3
cl_crosshairgap -2
...
cl_crosshair_recoil 0`;function Z(e,t,n=``){e&&(e.textContent=t,e.className=`status${n?` ${n}`:``}`)}function Ba(e){ga(e),sa.innerHTML=`
  ...
  `}function Va(e){return e.trim().replace(/\s+/g,``).replace(/^csgo/i,`CSGO`)}function Ha(){let e=ya.value.trim();if(!e){Z(Y,`Paste a crosshair share code first.`,`error`);return}let t=Va(e);if(!na.test(t)){Z(Y,`Invalid format. Expected CSGO-xxxxx-xxxxx-xxxxx-xxxxx-xxxxx`,`error`);return}try{let e=d(t);ya.value=t,ba.value=ce(ee(e)),Ba(e),Z(Y,`Converted share code to console commands.`,`ok`)}catch(e){e instanceof i||e instanceof r?Z(Y,`That share code is not a valid crosshair code.`,`error`):Z(Y,e instanceof Error?e.message:`Failed to decode share code.`,`error`)}}function Ua(){let e=xa.value.trim();if(!e){Z(Y,`Paste crosshair console commands first.`,`error`);return}try{let t=se(e);Sa.value=f(t),Ba(t),Z(Y,`Converted commands to share code.`,`ok`)}catch(e){Z(Y,e instanceof Error?e.message:`Failed to encode share code.`,`error`)}}async function Wa(e,t,n){if(!t){Z(e,`Nothing to copy for ${n}.`,`error`);return}try{await navigator.clipboard.writeText(t),Z(e,`Copied ${n} to clipboard.`,`ok`)}catch{Z(e,`Clipboard access failed. Select and copy manually.`,`error`)}}function Ga(){let e=Yi[Ca.value]?.supportsMYaw||Yi[X.value]?.supportsMYaw;Pa?.classList.toggle(`hidden`,!e),Ma?.classList.toggle(`hidden`,!Yi[Ca.value]?.custom),Na?.classList.toggle(`hidden`,!Yi[X.value]?.custom)}function Ka(){let e=Number(wa.value),t=Number(Ea.value),n=Number(Da.value),r=Number(Oa.value)||.022,i=Number(ka.value)||.022,a=Number(Aa.value),o=Number(ja.value);if(Ga(),Yi[Ca.value]?.custom&&!(a>0)){Z(va,`Enter a valid source custom yaw (° per count).`,`error`);return}if(Yi[X.value]?.custom&&!(o>0)){Z(va,`Enter a valid target custom yaw (° per count).`,`error`);return}if(!Number.isFinite(e)||e<=0){Ta.value=``,Fa.textContent=`—`,Ia.innerHTML=``,La.textContent=``;return}if(!Number.isFinite(t)||t<=0||!Number.isFinite(n)||n<=0){Z(va,`Enter valid DPI values.`,`error`);return}let s=$i({sourceGame:Ca.value,targetGame:X.value,sourceSens:e,sourceDpi:t,targetDpi:n,sourceMYaw:r,targetMYaw:i,sourceCustomYaw:a,targetCustomYaw:o}),c=Yi[Ca.value].name,l=Yi[X.value].name,u=J(s.targetSensitivity);Ta.value=u,Fa.textContent=ea(s.cm360),Ia.innerHTML=`
    <div><dt>Inches / 360°</dt><dd>${ea(s.inches360)} in</dd></div>
    <div><dt>Source eDPI</dt><dd>${ea(s.sourceEdpi,0)}</dd></div>
    <div><dt>Target eDPI</dt><dd>${ea(s.targetEdpi,0)}</dd></div>
  ...
  `,Z(va,`${c} → ${l}: ${u}`,`ok`)}function qa(){let e=Ca.value;Ca.value=X.value,X.value=e,Ta.value&&(wa.value=Ta.value),Ka()}function Ja(){Ca.value=`cs2`,X.value=`valorant`,wa.value=`1.25`,Ea.value=`800`,Da.value=`800`,Ka()}var Ya={crosshair:`Convert a crosshair share code into console commands, build a code from commands, or design one visually with a live preview.`,sensitivity:`Keep the same cm/360 aim feel across games — with custom yaw values and DPI changes handled for you.`,psa:`Dial in your ideal sensitivity with a guided 7-round A/B test (Perfect Sensitivity Approximation).`,nades:`Browse community grenade line-ups, or sign in to submit your own with a 2D throw guide, videos and photos.`,commands:`Copy up-to-date CS2 launch options and console commands, recommend the ones that help, and share tips in the comments.`,configs:`Share your CS2 configs and video settings, download other players’ setups, and rate the best ones.`,highlights:`Share your best CS2 clips, watch the community’s highlights, and report anything that breaks the rules.`,pros:`Browse pro players’ sensitivity, DPI, resolution and crosshair settings.`,profile:`Your account, contributions, and settings.`,admin:`Moderate content, manage users, sync data sources, and read contact messages.`},Xa=document.querySelector(`#tool-desc`);function Za(e){Xa&&(Xa.textContent=Ya[e]||``)}function Qa(e){document.querySelectorAll(`.tool-nav .tool-tab`).forEach(t=>{let n=t.getAttribute(`data-tool`)===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,String(n))}),document.querySelectorAll(`.tool-view`).forEach(t=>{t.classList.toggle(`active`,t.id===`${e}-tool`)}),Za(e),window.scrollTo({top:0,behavior:`smooth`})}document.querySelectorAll(`.tool-nav .tool-tab`).forEach(e=>{e.addEventListener(`click`,()=>Qa(e.getAttribute(`data-tool`)))}),document.addEventListener(`aimkit:navigate`,e=>Qa(e.detail)),Za(`crosshair`),document.querySelectorAll(`.converter-panel .tab`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-tab`);document.querySelectorAll(`.converter-panel .tab`).forEach(e=>{let n=e.getAttribute(`data-tab`)===t;e.classList.toggle(`active`,n),e.setAttribute(`aria-selected`,String(n))}),document.querySelectorAll(`.converter-panel .tab-panel`).forEach(e=>{e.classList.toggle(`active`,e.getAttribute(`data-panel`)===t)})})}),document.querySelector(`#decode-btn`)?.addEventListener(`click`,Ha),document.querySelector(`#encode-btn`)?.addEventListener(`click`,Ua),ya.addEventListener(`keydown`,e=>{e.key===`Enter`&&Ha()}),xa.addEventListener(`input`,()=>{let e=xa.value.trim();if(!e){ga(null),sa.innerHTML=``;return}try{Ba(se(e))}catch{}}),ya.addEventListener(`input`,()=>{let e=Va(ya.value);if(na.test(e))try{Ba(d(e))}catch{}}),document.querySelector(`#copy-commands`)?.addEventListener(`click`,()=>{Wa(Y,ba.value,`commands`)}),document.querySelector(`#copy-code`)?.addEventListener(`click`,()=>{Wa(Y,Sa.value,`share code`)}),document.querySelector(`#copy-sharecode-cmd`)?.addEventListener(`click`,()=>{let e=Va(ya.value);if(!e){Z(Y,`Enter a share code first.`,`error`);return}Wa(Y,`cl_crosshair_sharecode "${e}"`,`import command`)}),document.querySelector(`#load-example-code`)?.addEventListener(`click`,()=>{ya.value=Ra,Ha()}),document.querySelector(`#load-example-cmd`)?.addEventListener(`click`,()=>{xa.value=za,Ua()});var $a={0:[255,255,255],1:[50,250,50],2:[255,255,0],3:[50,50,250],4:[50,250,250]},Q={...ne},eo=document.querySelector(`#ed-style`),to=document.querySelector(`#ed-color`),no=document.querySelector(`#ed-custom-color`),ro=document.querySelector(`#ed-custom-color-field`),io=document.querySelector(`#ed-r`),ao=document.querySelector(`#ed-g`),oo=document.querySelector(`#ed-b`),so=document.querySelector(`#ed-rgb-val`),co=document.querySelector(`#ed-color-swatch`);function lo(e,t){e&&document.activeElement!==e&&(e.value=String(t))}var uo=document.querySelector(`#ed-length`),fo=document.querySelector(`#ed-thickness`),po=document.querySelector(`#ed-gap`),mo=document.querySelector(`#ed-outline`),ho=document.querySelector(`#ed-alpha`),go=document.querySelector(`#ed-dot`),_o=document.querySelector(`#ed-tstyle`),vo=document.querySelector(`#ed-outline-on`),yo=document.querySelector(`#ed-alpha-on`),bo=document.querySelector(`#ed-sharecode`),xo=document.querySelector(`#ed-commands`),So=document.querySelector(`#ed-length-num`),Co=document.querySelector(`#ed-thickness-num`),wo=document.querySelector(`#ed-gap-num`),To=document.querySelector(`#ed-outline-num`),Eo=document.querySelector(`#ed-alpha-num`),Do=document.querySelector(`#ed-r-num`),Oo=document.querySelector(`#ed-g-num`),ko=document.querySelector(`#ed-b-num`),Ao=(e,t,n)=>Math.max(t,Math.min(n,e)),jo=[{key:`length`,slider:uo,num:So,min:0,max:15},{key:`thickness`,slider:fo,num:Co,min:0,max:6},{key:`gap`,slider:po,num:wo,min:-10,max:10},{key:`outline`,slider:mo,num:To,min:0,max:3},{key:`alpha`,slider:ho,num:Eo,min:0,max:255}],Mo=[{key:`red`,slider:io,num:Do},{key:`green`,slider:ao,num:Oo},{key:`blue`,slider:oo,num:ko}];function No(e,t,n){let r=e=>Math.max(0,Math.min(255,Math.round(e))).toString(16).padStart(2,`0`);return`#${r(e)}${r(t)}${r(n)}`}function Po(e){let t=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(e.trim());return t?{r:parseInt(t[1],16),g:parseInt(t[2],16),b:parseInt(t[3],16)}:{r:Q.red,g:Q.green,b:Q.blue}}function Fo(){let e=No(Q.red,Q.green,Q.blue);to.value=String(Q.color),lo(no,e);for(let e of Mo)lo(e.slider,Q[e.key]),lo(e.num,Q[e.key]);so&&(so.textContent=`${Q.red}, ${Q.green}, ${Q.blue}`),co&&(co.style.background=e),ro?.classList.toggle(`hidden`,Q.color!==5)}function Io(){for(let e of jo)lo(e.slider,Ao(Q[e.key],e.min,e.max)),lo(e.num,Q[e.key])}function Lo(){eo.value=String(Q.style),go.checked=Q.centerDotEnabled,_o.checked=Q.tStyleEnabled,vo.checked=Q.outlineEnabled,yo.checked=Q.alphaEnabled,Io(),Fo()}function Ro(){Io();let e=!Q.outlineEnabled;mo.disabled=e,To.disabled=e;let t=!Q.alphaEnabled;ho.disabled=t,Eo.disabled=t;try{bo.value=f(Q)}catch{bo.value=``}xo.value=ce(ee(Q))}function zo(){Ba(Q),Ro()}function Bo(){Q.style=Number(eo.value),Q.centerDotEnabled=go.checked,Q.tStyleEnabled=_o.checked,Q.outlineEnabled=vo.checked,Q.alphaEnabled=yo.checked,zo()}function Vo(e){Q[e.key]=Number(e.slider.value),zo()}function Ho(e,t){let n=Number(e.num.value);if(e.num.value===``||!Number.isFinite(n)){t&&(e.num.value=String(Q[e.key]));return}Q[e.key]=Ao(n,e.min,e.max),t&&(e.num.value=String(Q[e.key])),zo()}function Uo(){Q.color=5,Q.red=Ao(Number(Do.value)||0,0,255),Q.green=Ao(Number(Oo.value)||0,0,255),Q.blue=Ao(Number(ko.value)||0,0,255),Fo(),zo()}function Wo(){if(Q.color=Number(to.value),Q.color!==5){let[e,t,n]=$a[Q.color]??$a[1];Q.red=e,Q.green=t,Q.blue=n}Fo(),zo()}function Go(){Q.color=5,Q.red=Number(io.value),Q.green=Number(ao.value),Q.blue=Number(oo.value),Fo(),zo()}function Ko(){Q.color=5;let{r:e,g:t,b:n}=Po(no.value);Q.red=e,Q.green=t,Q.blue=n,Fo(),zo()}jo.forEach(e=>{e.slider.addEventListener(`input`,()=>Vo(e)),e.num.addEventListener(`input`,()=>Ho(e,!1)),e.num.addEventListener(`change`,()=>Ho(e,!0))}),[eo,go,_o,vo,yo].forEach(e=>e.addEventListener(`change`,Bo)),to.addEventListener(`change`,Wo),no.addEventListener(`input`,Ko),no.addEventListener(`change`,Ko),Mo.forEach(e=>{e.slider.addEventListener(`input`,Go),e.num.addEventListener(`input`,Uo),e.num.addEventListener(`change`,Uo)}),document.querySelector(`#ed-copy-code`)?.addEventListener(`click`,()=>{Wa(Y,bo.value,`share code`)}),document.querySelector(`#ed-copy-commands`)?.addEventListener(`click`,()=>{Wa(Y,xo.value,`commands`)}),document.querySelector(`#ed-reset`)?.addEventListener(`click`,()=>{Object.assign(Q,ne),Lo(),zo(),Z(Y,`Crosshair reset to defaults.`,`ok`)}),document.querySelector(`.converter-panel .tab[data-tab="visual"]`)?.addEventListener(`click`,zo),Lo(),Ro(),Ca.innerHTML=ta(`cs2`),X.innerHTML=ta(`valorant`),[Ca,X,wa,Ea,Da,Oa,ka,Aa,ja].forEach(e=>{e.addEventListener(`input`,Ka),e.addEventListener(`change`,Ka)}),document.querySelector(`#sens-swap`)?.addEventListener(`click`,qa),document.querySelector(`#copy-sens`)?.addEventListener(`click`,()=>{Wa(va,Ta.value,`converted sensitivity`)}),document.querySelector(`#sens-cs2-val`)?.addEventListener(`click`,Ja);var qo=document.querySelector(`#psa-start`),Jo=document.querySelector(`#psa-begin`),Yo=document.querySelector(`#psa-round`),Xo=document.querySelector(`#psa-round-num`),Zo=document.querySelector(`#psa-bar-fill`),Qo=document.querySelector(`#psa-lower`),$o=document.querySelector(`#psa-higher`),es=document.querySelector(`#psa-lower-val`),ts=document.querySelector(`#psa-higher-val`),ns=document.querySelector(`#psa-undo`),rs=document.querySelector(`#psa-reset`),is=document.querySelector(`#psa-result`),as=document.querySelector(`#psa-result-label`),os=document.querySelector(`#psa-stats`),ss=document.querySelector(`#psa-history`),cs=document.querySelector(`#psa-status`),$=null;function ls(){if(!$){Yo?.classList.add(`hidden`),ss?.classList.add(`hidden`),is.textContent=`—`,as.textContent=`recommended sensitivity`,os.innerHTML=``;return}let e=fe($),t=e?_e($):pe($);if(is.textContent=J(t,3),as.textContent=e?`final recommended sensitivity`:`current estimate`,os.innerHTML=`
  ...
  `,e)Yo?.classList.add(`hidden`),Z(cs,`Done — set your sensitivity to ${J(t,3)} and play a few sessions before changing again.`,`ok`);else{let{lower:e,higher:t}=de($);Yo?.classList.remove(`hidden`),Xo.textContent=String($.round),Zo.style.width=`${($.round-1)/7*100}%`,es.textContent=J(e,3),ts.textContent=J(t,3),Z(cs,`Round ${$.round} of 7: test both values, then pick the side that feels better.`,``)}$.choices.length>0?(ss?.classList.remove(`hidden`),ss.innerHTML=`<strong>History:</strong><br />${$.choices.map(e=>`Round ${e.round}: chose <strong>${e.side}</strong> (${J(e.lower,3)} vs ${J(e.higher,3)})`).join(`<br />`)}`):(ss?.classList.add(`hidden`),ss.innerHTML=``)}function us(){let e=Number(qo.value);if(!Number.isFinite(e)||e<=0){Z(cs,`Enter a valid starting sensitivity greater than 0.`,`error`);return}$=ue(e),ls()}function ds(e){!$||fe($)||($=he($,e),ls())}Jo?.addEventListener(`click`,us),Qo?.addEventListener(`click`,()=>ds(`lower`)),$o?.addEventListener(`click`,()=>ds(`higher`)),ns?.addEventListener(`click`,()=>{$&&($=ge($),ls())}),rs?.addEventListener(`click`,()=>{$=null,ls(),Z(cs,`Enter a starting sensitivity and press Start PSA.`,``)}),ca.innerHTML=fa.map(e=>`<option value="${e.id}">${e.label}</option>`).join(``),ca.addEventListener(`change`,()=>ga(pa)),ga(null),Ha(),Ja();function fs(e){return String(e||``).replaceAll(`&`,`&amp;`).replaceAll(`"`,`&quot;`)}function ps(e){let t=document.querySelector(`#donate-section`),n=document.querySelector(`#donate-actions`);if(!t||!n)return;let r=[];e.paypalUrl&&r.push(`<a class="btn donate-btn paypal" href="${fs(e.paypalUrl)}" target="_blank" rel="noopener noreferrer">${ra}<span>Donate via PayPal</span></a>`),e.steamTradeUrl&&r.push(`<a class="btn donate-btn steam" href="${fs(e.steamTradeUrl)}" target="_blank" rel="noopener noreferrer">${ia}<span>Donate Steam skins</span></a>`),n.innerHTML=r.join(``),t.classList.toggle(`hidden`,r.length===0);let i=document.querySelector(`#donate-fab`);if(i){let t=[];e.paypalUrl&&t.push(`<a class="donate-fab-btn paypal" href="${fs(e.paypalUrl)}" target="_blank" rel="noopener noreferrer" title="Donate via PayPal">${ra}<span>PayPal</span></a>`),e.steamTradeUrl&&t.push(`<a class="donate-fab-btn steam" href="${fs(e.steamTradeUrl)}" target="_blank" rel="noopener noreferrer" title="Donate Steam skins">${ia}<span>Steam</span></a>`),i.innerHTML=t.length?`<span class="donate-fab-label">Support AimKit</span>${t.join(``)}`:``,i.classList.toggle(`hidden`,t.length===0)}}async function ms(){try{ps(await g.settings.get())}catch{ps({paypalUrl:``,steamTradeUrl:``})}}document.addEventListener(`aimkit:settings-updated`,ms),document.querySelector(`#contact-open`)?.addEventListener(`click`,Ui),Ye();var hs=new URLSearchParams(window.location.search).get(`reset`);if(hs){Ge(hs);let e=new URL(window.location.href);e.searchParams.delete(`reset`),window.history.replaceState({},``,e)}var gs=new URLSearchParams(window.location.search);if(gs.get(`token`)){we(gs.get(`token`)),Me();let e=new URL(window.location.href);e.searchParams.delete(`token`),window.history.replaceState({},``,e)}else if(gs.get(`steam`)===`linked`){Me();let e=new URL(window.location.href);e.searchParams.delete(`steam`),window.history.replaceState({},``,e)}else if(gs.get(`steam_error`)){let e=new URL(window.location.href);e.searchParams.delete(`steam_error`),window.history.replaceState({},``,e)}Sn(),Gn(),Mr(),ei(),vi(),cr(),Vi(),ms();