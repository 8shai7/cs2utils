...
`)}var le=.5;function ue(e){return{base:e,lo:e*(1-le),hi:e*1.5,round:1,choices:[]}}function de(e){return{lower:e.lo,higher:e.hi,mid:(e.lo+e.hi)/2}}function fe(e){return e.round>7}function pe(e){return(e.lo+e.hi)/2}function me(e){let t=pe(e);return t<=0?0:(e.hi-e.lo)/t}function he(e,t){if(fe(e))return e;let n=(e.lo+e.hi)/2,r={round:e.round,side:t,lo:e.lo,hi:e.hi,lower:e.lo,higher:e.hi},i={...e,choices:[...e.choices,r],round:e.round+1};return t===`lower`?i.hi=n:i.lo=n,i}function ge(e){if(e.choices.length===0)return e;let t=e.choices.slice(0,-1),n=e.choices[e.choices.length-1];return{...e,lo:n.lo,hi:n.hi,round:n.round,choices:t}}function _e(e){return pe(e)}var ve=`/api`,ye=`cs2utils.token`,be=/^https?:\/\//.test(ve)?new URL(ve).origin:``;function xe(){try{return localStorage.getItem(ye)}catch{return null}}function Se(e){try{e?localStorage.setItem(ye,e):localStorage.removeItem(ye)}catch{}}async function m(e,t,n,{auth:r=!1}={}){let i={};if(n!==void 0&&!(n instanceof FormData)&&(i[`Content-Type`]=`application/json`),r){let e=xe();e&&(i.Authorization=`Bearer ${e}`)}let a;try{a=await fetch(`${ve}${t}`,{method:e,headers:i,body:n instanceof FormData?n:n===void 0?void 0:JSON.stringify(n)})}catch{throw Error(`Cannot reach the server. Is the API running?`)}let o=null,s=await a.text();if(s)try{o=JSON.parse(s)}catch{o=null}if(!a.ok){let e=Error(o&&o.error||`Request failed (${a.status}).`);throw e.status=a.status,e.data=o,e}return o}var Ce=`${ve}/auth/steam`;function we(e){Se(e)}function h(e){return!!e&&(e.role===`admin`||e.role===`owner`)}function Te(e){return!!e&&e.role===`owner`}function Ee(e){return e?/^https?:\/\//.test(e)||e.startsWith(`data:`)?e:be+e:``}var g={auth:{async register(e){let t=await m(`POST`,`/auth/register`,e);return Se(t.token),t.user},async login(e){let t=await m(`POST`,`/auth/login`,e);return Se(t.token),t.user},logout(){Se(null)},async captcha(){return m(`GET`,`/auth/captcha`)},async changePassword(e){return m(`POST`,`/auth/password`,e,{auth:!0})},async forgot(e){return m(`POST`,`/auth/forgot`,{email:e})},async reset(e,t){return m(`POST`,`/auth/reset`,{token:e,password:t})},async me(){if(!xe())return null;try{return(await m(`GET`,`/auth/me`,void 0,{auth:!0})).user}catch{return Se(null),null}},async profile(){return m(`GET`,`/auth/profile`,void 0,{auth:!0})},async setAvatar(e){return(await m(`POST`,`/auth/avatar`,{url:e},{auth:!0})).user},async uploadAvatar(e){let t=new FormData;return t.append(`file`,e),(await m(`POST`,`/auth/avatar/upload`,t,{auth:!0})).user},async changePassword(e){return m(`POST`,`/auth/password`,e,{auth:!0})},async changeUsername(e){let t=await m(`POST`,`/auth/username`,{username:e},{auth:!0});return t.token&&Se(t.token),t.user},async setCredentials(e){let t=await m(`POST`,`/auth/credentials`,e,{auth:!0});return t.token&&Se(t.token),t.user},async forgot(e){return m(`POST`,`/auth/forgot`,{email:e})},async reset(e,t){return m(`POST`,`/auth/reset`,{token:e,password:t})},steamLoginUrl(){return`${ve}/auth/steam`},async steamLinkUrl(){return(await m(`GET`,`/auth/steam/link-url`,void 0,{auth:!0})).url},async steamUnlink(){return(await m(`POST`,`/auth/steam/unlink`,{},{auth:!0})).user}},settings:{async get(){return m(`GET`,`/settings`)}},contact:{async send(e){return m(`POST`,`/contact`,e)}},pros:{async list({q:e=``,sort:t=`name`}={}){let n=new URLSearchParams;e&&n.set(`q`,e),t&&n.set(`sort`,t);let r=n.toString();return m(`GET`,`/pros${r?`?${r}`:``}`)}},configs:{async list({sort:e=`top`,q:t=``}={}){let n=new URLSearchParams;e&&n.set(`sort`,e),t&&n.set(`q`,t);let r=n.toString();return(await m(`GET`,`/configs${r?`?${r}`:``}`,void 0,{auth:!0})).configs},async create(e){return(await m(`POST`,`/configs`,e,{auth:!0})).config},async rate(e,t){return m(`POST`,`/configs/${e}/rate`,{rating:t},{auth:!0})},async remove(e){return m(`DELETE`,`/configs/${e}`,void 0,{auth:!0})}},highlights:{async list({q:e=``}={}){return(await m(`GET`,`/highlights${e?`?q=${encodeURIComponent(e)}`:``}`,void 0,{auth:!0})).highlights},async create(e){return(await m(`POST`,`/highlights`,e,{auth:!0})).highlight},async report(e,t){return m(`POST`,`/highlights/${e}/report`,{reason:t},{auth:!0})},async remove(e){return m(`DELETE`,`/highlights/${e}`,void 0,{auth:!0})}},nades:{async list({map:e=``,type:t=``}={}){let n=new URLSearchParams;e&&n.set(`map`,e),t&&n.set(`type`,t);let r=n.toString();return(await m(`GET`,`/nades${r?`?${r}`:``}`)).nades},async mine(){return(await m(`GET`,`/nades/mine`,void 0,{auth:!0})).nades},async create(e){return(await m(`POST`,`/nades`,e,{auth:!0})).nade},async addMedia(e,t){return(await m(`POST`,`/nades/${e}/media`,t,{auth:!0})).media},async remove(e){return m(`DELETE`,`/nades/${e}`,void 0,{auth:!0})},async parseMapGuide(e){return m(`POST`,`/nades/map-guide/parse`,{text:e},{auth:!0})},async importMapGuide({text:e,nades:t,side:n,guideText:r,fileName:i}={}){return m(`POST`,`/nades/map-guide/import`,{text:e,nades:t,side:n,guideText:r,fileName:i},{auth:!0})},async practicePackFromText({text:e,map:t,importId:n}={}){return m(`POST`,`/nades/map-guide/practice-pack`,{text:e,map:t,importId:n},{auth:!0})},async practicePackFromImport(e){return m(`GET`,`/nades/map-guide/imports/${e}/practice-pack`,void 0,{auth:!!xe()})},async practicePackFromNades(e){return m(`POST`,`/nades/map-guide/practice-pack-from-nades`,{nadeIds:e},{auth:!!xe()})}},commands:{async catalog(){return m(`GET`,`/commands/catalog`)},async social(){return m(`GET`,`/commands/social`,void 0,{auth:!0})},async recommend(e){return m(`POST`,`/commands/${e}/recommend`,{},{auth:!0})},async addComment(e,t){return m(`POST`,`/commands/${e}/comments`,{body:t},{auth:!0})}},admin:{async pending(){return(await m(`GET`,`/admin/nades/pending`,void 0,{auth:!0})).nades},async pendingComments(){return(await m(`GET`,`/admin/comments/pending`,void 0,{auth:!0})).comments},async pendingCommentsCount(){return(await m(`GET`,`/admin/comments/pending/count`,void 0,{auth:!0})).count},async reviewComment(e,t){return m(`POST`,`/admin/comments/${e}/review`,{decision:t},{auth:!0})},async removeComment(e){return m(`DELETE`,`/admin/comments/${e}`,void 0,{auth:!0})},async syncCommands(){return m(`POST`,`/admin/commands/sync`,{},{auth:!0})},async checkCommandsCs2(){return m(`POST`,`/admin/commands/check-cs2`,{},{auth:!0})},async saveSettings(e){return m(`POST`,`/admin/settings`,e,{auth:!0})},async highlightReports(){return(await m(`GET`,`/admin/highlights/reports`,void 0,{auth:!0})).highlights},async highlightReportsCount(){return(await m(`GET`,`/admin/highlights/reports/count`,void 0,{auth:!0})).count},async reviewHighlight(e,t){return m(`POST`,`/admin/highlights/${e}/review`,{decision:t},{auth:!0})},async syncPros(){return m(`POST`,`/admin/pros/sync`,{},{auth:!0})},async importCommands(e){return m(`POST`,`/admin/commands/import`,{content:e},{auth:!0})},async importPros(e){return m(`POST`,`/admin/pros/import`,{content:e},{auth:!0})},async banUser(e,{hours:t,permanent:n}){return(await m(`POST`,`/admin/users/${e}/ban`,{hours:t,permanent:n},{auth:!0})).user},async unbanUser(e){return(await m(`POST`,`/admin/users/${e}/unban`,{},{auth:!0})).user},async pendingCount(){return(await m(`GET`,`/admin/nades/pending/count`,void 0,{auth:!0})).count},async reviewNade(e,t,n=``){return m(`POST`,`/admin/nades/${e}/review`,{decision:t,note:n},{auth:!0})},async reviewNadesBulk(e,t,n=``){return m(`POST`,`/admin/nades/review-bulk`,{ids:e,decision:t,note:n},{auth:!0})},async reviewMedia(e,t){return m(`POST`,`/admin/media/${e}/review`,{decision:t},{auth:!0})},async reviewMediaBulk(e,t){return m(`POST`,`/admin/media/review-bulk`,{ids:e,decision:t},{auth:!0})},async removeMedia(e){return m(`DELETE`,`/admin/media/${e}`,void 0,{auth:!0})},async users(){return(await m(`GET`,`/admin/users`,void 0,{auth:!0})).users},async setRole(e,t){return(await m(`POST`,`/admin/users/${e}/role`,{role:t},{auth:!0})).user},async contactMessages(){return(await m(`GET`,`/admin/contact`,void 0,{auth:!0})).messages},async removeContact(e){return m(`DELETE`,`/admin/contact/${e}`,void 0,{auth:!0})},async ownerLogs({limit:e=100,offset:t=0,action:n=``}={}){let r=new URLSearchParams;e&&r.set(`limit`,String(e)),t&&r.set(`offset`,String(t)),n&&r.set(`action`,n);let i=r.toString();return m(`GET`,`/admin/owner-logs${i?`?${i}`:``}`,void 0,{auth:!0})}},uploads:{async image(e){let t=new FormData;return t.append(`file`,e),await m(`POST`,`/uploads`,t,{auth:!0})}}},De=null,Oe=new Set;function ke(){for(let e of Oe)e(De)}function Ae(){return De}function je(e){return Oe.add(e),()=>Oe.delete(e)}async function Me(){return De=await g.auth.me(),ke(),De}async function Ne(e){return De=await g.auth.login(e),ke(),De}async function Pe(e){return De=await g.auth.register(e),ke(),De}function Fe(){g.auth.logout(),De=null,ke()}var Ie,_,Le=`login`,Re={required:!1,token:null,svg:``};function ze(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Be(){let e=Ae();e?(Ie.innerHTML=`
    ...
    <div class="try-game-modal" role="dialog" aria-modal="true" aria-label="Try in game">
      <div class="try-game-card">
       ...
       </div>`:r&&h(y)?`<div class="nade-card-actions">
           <button class="btn ghost danger" type="button" data-delete-nade="${e.id}">Remove</button>
         </div>`:``;return`
    <article class="nade-card${n?` browse-nade-card`:``}${s?` selected`:``}"${n?` data-browse-nade="${e.id}" data-map="${T(e.map)}" tabindex="0" role="checkbox" aria-checked="${s?`true`:`false`}"`:``}>
      <div class="nade-card-head">
        <div>
          <h3>${T(e.title)}</h3>
          <p class="nade-sub">
            <span class="nade-chip" style="--chip:${i.color}">${T(i.name)}</span>
      ...
      ${c}
    </article>`}function Bt(){return[...x.keys()]}function Vt(){let e=Tt.length?Tt.map(e=>zt(e,{showTryInGame:!0,adminRemove:!0})).join(``):`<p class="hint">No approved nades yet${y?` — be the first to add one!`:` — log in and add the nades you found.`}</p>`,t=x.size;return`
    ...
    <div class="nade-grid">${Dt.map(e=>{let t=e.media||[],n=t.length?`<div class="review-media">${t.map(e=>`<div class="review-media-item">${Rt(e)}
                  <div class="nade-media-meta">${Ft(e.status)} <span>by ${T(e.addedByName||``)}</span></div>
                  <div class="actions">
                 ...
                 <input type="text" class="review-note" data-nade="${e.id}" placeholder="Optional note to the author" />
               </div>`;return`<div class="nade-mine">${zt(e,{showStatus:!0})}${n}${r}</div>`}).join(``)}</div>`:`<p class="hint">Nothing pending review. Nice and clean.</p>`:`<p class="hint">Admins only.</p>`}function qt(e){if(!e.bannedUntil)return null;let t=new Date(e.bannedUntil);return t.getTime()<=Date.now()?null:t.getFullYear()>=9999?`permanently`:`until ${t.toLocaleString()}`}function Jt(){if(!h(y))return`<p class="hint">Admins only.</p>`;let e=Te(y);return`<div class="users-table">
    ...
    </div>`,en(),Zt()}function Zt(){v.querySelectorAll(`canvas.nade-canvas:not(.interactive):not(#guide-preview-canvas)`).forEach(e=>{ut(e,{mapId:e.dataset.map,type:e.dataset.type,start:{x:Number(e.dataset.sx),y:Number(e.dataset.sy)},end:{x:Number(e.dataset.ex),y:Number(e.dataset.ey)}})}),Qt(),$t()}function Qt(){let e=v.querySelector(`#nade-add-canvas`);e&&ut(e,{mapId:S.map,type:S.type,start:S.start,end:S.end})}function $t(){let e=v.querySelector(`#guide-preview-canvas`);if(!e)return;let t=C.parsed?.nades?.[C.selected??0];if(!t){ut(e,{mapId:`mirage`,type:`smoke`,start:null,end:null});return}ut(e,{mapId:t.map,type:t.type,start:t.start,end:t.end})}function en(){v.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>Je(e.dataset.openAuth))),v.querySelectorAll(`[data-view]`).forEach(e=>e.addEventListener(`click`,()=>D(e.dataset.view))),v.querySelector(`#filter-map`)?.addEventListener(`change`,e=>{wt.map=e.target.value,x=new Map,D(`browse`)}),v.querySelector(`#filter-type`)?.addEventListener(`change`,e=>{wt.type=e.target.value,D(`browse`)}),v.querySelectorAll(`.browse-select`).forEach(e=>e.addEventListener(`change`,()=>{cn(Number(e.value),e.dataset.map,e.checked),ln(e.closest(`.browse-nade-card`))})),v.querySelectorAll(`.browse-nade-card`).forEach(e=>{e.addEventListener(`click`,t=>{t.target.closest(`a, button, input, label`)||un(e)}),e.addEventListener(`keydown`,t=>{t.key!==` `&&t.key!==`Enter`||t.target.closest(`a, button, input, label`)||(t.preventDefault(),un(e))})}),v.querySelector(`#browse-select-clear`)?.addEventListener(`click`,()=>{x=new Map,O()}),v.querySelector(`#browse-try-selected`)?.addEventListener(`click`,()=>{fn(Bt())}),v.querySelectorAll(`[data-try-nades]`).forEach(e=>e.addEventListener(`click`,t=>{t.stopPropagation(),fn([Number(e.dataset.tryNades)])}));let e=v.querySelector(`#nade-add-canvas`);e&&e.addEventListener(`click`,t=>{let n=pt(e,t);!S.start||S.start&&S.end?(S.start=n,S.end=null):S.end=n;let r=v.querySelector(`#nade-add-coords`);r&&(r.textContent=S.end?`Throw + landing set. Adjust by clicking again to start over.`:`Now click the landing spot for the grenade.`),Qt()}),v.querySelector(`#add-map`)?.addEventListener(`change`,e=>{S.map=e.target.value,Qt()}),v.querySelector(`#add-type`)?.addEventListener(`change`,e=>{S.type=e.target.value,Qt()}),v.querySelector(`#add-clear`)?.addEventListener(`click`,()=>{S.start=null,S.end=null,Qt();let e=v.querySelector(`#nade-add-coords`);e&&(e.textContent=`Click the map to set the throw position, then click again for the landing spot.`)}),v.querySelector(`#nade-add-form`)?.addEventListener(`submit`,tn),v.querySelector(`#guide-file`)?.addEventListener(`change`,nn),v.querySelector(`#guide-text`)?.addEventListener(`input`,e=>{C.text=e.target.value}),v.querySelector(`#guide-side`)?.addEventListener(`change`,e=>{C.side=e.target.value}),v.querySelector(`#guide-parse`)?.addEventListener(`click`,rn),v.querySelector(`#guide-import`)?.addEventListener(`click`,an),v.querySelector(`#guide-try-game`)?.addEventListener(`click`,on),v.querySelector(`#guide-clear`)?.addEventListener(`click`,()=>{C=jt(),w=null,O(),E(`Cleared map guide.`,``)}),v.querySelectorAll(`[data-guide-idx]`).forEach(e=>e.addEventListener(`click`,()=>{C.selected=Number(e.dataset.guideIdx),O()})),v.querySelector(`[data-try-game-close]`)?.addEventListener(`click`,()=>{w=null,kt=1,O()}),v.querySelector(`[data-try-game-download]`)?.addEventListener(`click`,()=>{if(!w)return;let e=_t(v);if(!e.guide&&!e.cfg){let e=v.querySelector(`[data-try-game-status]`);e&&(e.textContent=`Choose at least one file to download, or just Open CS2 if you already have them.`);return}let t=ht(w,e),n=v.querySelector(`[data-try-game-status]`);n&&(n.textContent=t.length?`Downloaded ${t.join(` + `)}. Copy into your CS2 folders, then Open CS2.`:`Nothing selected to download.`)}),v.querySelector(`[data-try-game-open]`)?.addEventListener(`click`,pn),v.querySelectorAll(`[data-add-media]`).forEach(e=>e.addEventListener(`click`,()=>mn(e.dataset.addMedia))),v.querySelectorAll(`[data-try-import]`).forEach(e=>e.addEventListener(`click`,()=>sn(e.dataset.tryImport))),v.querySelectorAll(`[data-delete-nade]`).forEach(e=>e.addEventListener(`click`,()=>hn(e.dataset.deleteNade))),v.querySelectorAll(`[data-delete-media]`).forEach(e=>e.addEventListener(`click`,()=>gn(e.dataset.deleteMedia))),v.querySelectorAll(`[data-approve-nade]`).forEach(e=>e.addEventListener(`click`,()=>_n(e.dataset.approveNade,`approved`))),v.querySelectorAll(`[data-reject-nade]`).forEach(e=>e.addEventListener(`click`,()=>_n(e.dataset.rejectNade,`rejected`))),v.querySelectorAll(`[data-approve-media]`).forEach(e=>e.addEventListener(`click`,()=>yn(e.dataset.approveMedia,`approved`))),v.querySelectorAll(`[data-reject-media]`).forEach(e=>e.addEventListener(`click`,()=>yn(e.dataset.rejectMedia,`rejected`)));let t=v.querySelector(`#review-select-all`),n=v.querySelector(`#review-bulk-approve`),r=v.querySelector(`#review-bulk-reject`),i=()=>{let e=v.querySelectorAll(`.review-nade-check:checked`).length;n&&(n.disabled=e===0),r&&(r.disabled=e===0)};t?.addEventListener(`change`,()=>{v.querySelectorAll(`.review-nade-check`).forEach(e=>{e.checked=t.checked}),i()}),v.querySelectorAll(`.review-nade-check`).forEach(e=>e.addEventListener(`change`,i)),n?.addEventListener(`click`,()=>vn(`approved`)),r?.addEventListener(`click`,()=>vn(`rejected`)),v.querySelectorAll(`[data-role-user]`).forEach(e=>e.addEventListener(`click`,()=>bn(e.dataset.roleUser,e.dataset.role))),v.querySelectorAll(`[data-ban]`).forEach(e=>e.addEventListener(`click`,()=>{let t=v.querySelector(`[data-ban-dur="${e.dataset.ban}"]`);xn(e.dataset.ban,t?t.value:`24`)})),v.querySelectorAll(`[data-unban]`).forEach(e=>e.addEventListener(`click`,()=>Sn(e.dataset.unban)))}async function tn(e){if(e.preventDefault(),S.title=v.querySelector(`#add-title`)?.value||``,S.map=v.querySelector(`#add-map`)?.value||S.map,S.type=v.querySelector(`#add-type`)?.value||S.type,S.side=v.querySelector(`#add-side`)?.value||S.side,S.technique=v.querySelector(`#add-technique`)?.value||S.technique,S.description=v.querySelector(`#add-description`)?.value||``,!S.start||!S.end){E(`Click the map to set both the throw position and the landing spot.`,`error`);return}let t=[],n=(v.querySelector(`#add-video`)?.value||``).trim(),r=(v.querySelector(`#add-image`)?.value||``).trim();n&&t.push({url:n,kind:`video`}),r&&t.push({url:r,kind:it(r)});let i=v.querySelector(`#add-upload`);try{if(i?.files?.[0]){E(`Uploading image…`,``);let e=await g.uploads.image(i.files[0]);t.push({url:e.url,kind:`image`})}await g.nades.create({...S,media:t}),S=At(),await D(`mine`),E(`Nade submitted! It will appear publicly once an admin approves it.`,`ok`)}catch(e){E(e.message,`error`)}}async function nn(e){let t=e.target.files?.[0];if(t)try{C.fileName=t.name,C.text=await t.text(),C.parsed=null,C.selected=null,O(),E(`Loaded ${t.name}. Click Preview lineups.`,`ok`)}catch{E(`Could not read that file.`,`error`)}}async function rn(){let e=(v.querySelector(`#guide-text`)?.value||C.text||``).trim();if(C.text=e,C.side=v.querySelector(`#guide-side`)?.value||C.side,!e){E(`Upload or paste a CS2 map guide .txt first.`,`error`);return}try{E(`Parsing map guide…`,``);let t=await g.nades.parseMapGuide(e);C.parsed=t,C.selected=0,O(),E(`Found ${t.nades.length} lineup${t.nades.length===1?``:`s`} on ${et(t.map)}.`,`ok`)}catch(e){C.parsed=null,O(),E(e.message,`error`)}}async function an(){if(!C.parsed?.nades?.length){E(`Preview the guide first so you can confirm the lineups.`,`error`);return}C.side=v.querySelector(`#guide-side`)?.value||C.side;let e=(v.querySelector(`#guide-text`)?.value||C.text||``).trim();try{E(`Importing lineups…`,``);let t=await g.nades.importMapGuide({nades:C.parsed.nades,side:C.side,guideText:e,fileName:C.fileName});C=jt(),await D(`mine`),E(`Imported ${t.count} nade${t.count===1?``:`s`} — pending admin review.`,`ok`)}catch(e){E(e.message,`error`)}}async function on(){let e=(v.querySelector(`#guide-text`)?.value||C.text||``).trim(),t=C.parsed?.map;if(!e||!t){E(`Preview the map guide first.`,`error`);return}try{E(`Preparing CS2 practice pack…`,``),w=(await g.nades.practicePackFromText({text:e,map:t})).pack,kt=C.parsed?.nades?.length||1,O(),E(`Choose what to download (or skip if you already have the files), then Open CS2.`,`ok`)}catch(e){E(e.message,`error`)}}async function sn(e){try{E(`Preparing CS2 practice pack…`,``),w=(await g.nades.practicePackFromImport(e)).pack,kt=1,O(),E(`Choose what to download (or skip if you already have the files), then Open CS2.`,`ok`)}catch(e){E(e.message,`error`)}}function cn(e,t,n){if(!Number.isFinite(e)||e<=0)return!1;if(!n)return x.delete(e),dn(),!0;if(x.size>=bt&&!x.has(e))return E(`You can select at most ${bt} lineups.`,`error`),!1;for(let[,e]of x)if(e!==t)return E(`Selected lineups must be on the same map.`,`error`),!1;return x.set(e,t),dn(),!0}function ln(e){if(!e)return;let t=Number(e.dataset.browseNade),n=x.has(t);e.classList.toggle(`selected`,n),e.setAttribute(`aria-checked`,n?`true`:`false`);let r=e.querySelector(`.browse-select`);r&&(r.checked=n)}function un(e){let t=Number(e.dataset.browseNade),n=e.dataset.map;cn(t,n,!x.has(t)),ln(e)}function dn(){let e=v.querySelector(`#browse-try-selected`),t=v.querySelector(`#browse-select-clear`),n=x.size;e&&(e.disabled=n===0,e.textContent=`Try selected in game (${n}/${bt})`),t&&(t.disabled=n===0)}async function fn(e){let t=[...new Set((e||[]).map(Number).filter(e=>Number.isFinite(e)&&e>0))];if(!t.length){E(`Select at least one lineup (max ${bt}, same map).`,`error`);return}if(t.length>bt){E(`You can open at most ${bt} lineups at once.`,`error`);return}try{E(`Preparing CS2 practice pack…`,``),w=(await g.nades.practicePackFromNades(t)).pack,kt=t.length,O(),E(t.length>1?`Merged ${t.length} lineups into one annotation file. Download what you need, then Open CS2.`:`Choose what to download (or skip if you already have the files), then Open CS2.`,`ok`)}catch(e){E(e.message,`error`)}}function pn(){if(!w)return;let e=v.querySelector(`[data-try-game-status]`);try{gt(w);let t=`Opening CS2 private ${w.deMap}… (make sure annotation_load ${w.loadName} is installed).`;e&&(e.textContent=t),E(t,`ok`)}catch(t){e&&(e.textContent=t.message),E(t.message,`error`)}}async function mn(e){let t=(v.querySelector(`.add-media-url[data-nade="${e}"]`)?.value||``).trim();if(!t){E(`Enter a media URL first.`,`error`);return}try{await g.nades.addMedia(e,{url:t,kind:it(t)}),await D(`mine`),E(`Media added — pending admin review.`,`ok`)}catch(e){E(e.message,`error`)}}async function hn(e){if(confirm(`Permanently delete this nade and its media?`))try{await g.nades.remove(e),x.delete(Number(e)),await D(b),E(`Nade deleted.`,`ok`)}catch(e){E(e.message,`error`)}}async function gn(e){if(confirm(`Permanently remove this media?`))try{await g.admin.removeMedia(e),await D(b),E(`Media removed.`,`ok`)}catch(e){E(e.message,`error`)}}async function _n(e,t){let n=v.querySelector(`.review-note[data-nade="${e}"]`)?.value||``;try{await g.admin.reviewNade(e,t,n),await D(`review`),E(`Nade ${t}.`,`ok`)}catch(e){E(e.message,`error`)}}async function vn(e){let t=[...v.querySelectorAll(`.review-nade-check:checked`)].map(e=>Number(e.value));if(!t.length){E(`Select at least one pending nade.`,`error`);return}let n=v.querySelector(`#review-bulk-note`)?.value||``;try{let r=await g.admin.reviewNadesBulk(t,e,n);await D(`review`),E(`${e===`approved`?`Approved`:`Rejected`} ${r.updated} nade${r.updated===1?``:`s`}.`,`ok`)}catch(e){E(e.message,`error`)}}async function yn(e,t){try{await g.admin.reviewMedia(e,t),await D(`review`),E(`Media ${t}.`,`ok`)}catch(e){E(e.message,`error`)}}async function bn(e,t){try{await g.admin.setRole(e,t),await D(`users`),E(`Role updated.`,`ok`)}catch(e){E(e.message,`error`)}}async function xn(e,t){try{t===`perma`?await g.admin.banUser(e,{permanent:!0}):await g.admin.banUser(e,{hours:Number(t)}),await D(`users`),E(`User banned.`,`ok`)}catch(e){E(e.message,`error`)}}async function Sn(e){try{await g.admin.unbanUser(e),await D(`users`),E(`User unbanned.`,`ok`)}catch(e){E(e.message,`error`)}}async function Cn(){v=document.querySelector(`#nades-tool`),v&&(y=Ae(),je(async e=>{y=e,await Lt(),!y&&[`add`,`import`,`mine`,`review`,`users`].includes(b)&&(b=`browse`),y&&!h(y)&&[`review`,`users`].includes(b)&&(b=`browse`),await D(b)}),await Lt(),O(),await D(`browse`))}function wn(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Tn(e){let t=document.createElement(`div`);t.className=`modal`,t.innerHTML=`
    <div class="modal-backdrop" data-close></div>
    <div class="modal-card import-card" role="dialog" aria-modal="true" aria-label="${wn(e.title)}">
      ...
      <p class="status" id="import-status"></p>
    </div>`,document.body.appendChild(t);let n=()=>t.remove();t.querySelectorAll(`[data-close]`).forEach(e=>e.addEventListener(`click`,n));let r=e=>{e.key===`Escape`&&(n(),document.removeEventListener(`keydown`,r))};document.addEventListener(`keydown`,r);let i=t.querySelector(`#import-status`),a=t.querySelector(`#import-run`);a.addEventListener(`click`,async()=>{let r=t.querySelector(`#import-content`).value;if(!r.trim()){i.textContent=`Paste the page content first.`,i.className=`status error`;return}a.disabled=!0,i.textContent=`Importing…`,i.className=`status`;try{let t=await e.onImport(r);i.textContent=t||`Imported.`,i.className=`status ok`,setTimeout(n,900)}catch(e){i.textContent=e.message,i.className=`status error`,a.disabled=!1}}),t.querySelector(`#import-content`)?.focus()}var k,En=null,A={commands:[],categories:[],recommendedLaunchOptions:``,source:`seed`,lastSync:0,cs2Build:``,cs2Version:``,remoteConfigured:!1},Dn={counts:{},mine:[],comments:{}},On=[],kn={text:``,kind:``},An=new Set;function j(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function M(e,t=``){kn={text:e,kind:t};let n=k?.querySelector(`#commands-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function jn(e){if(!e)return`—`;try{return new Date(e).toLocaleString()}catch{return`—`}}async function Mn(){try{A=await g.commands.catalog()}catch(e){M(`Could not load command catalog: ${e.message}`,`error`)}try{Dn=await g.commands.social()}catch{}if(h(En))try{On=await g.admin.pendingComments()}catch{On=[]}else On=[]}function Nn(e){let t=Dn.comments[e.key]||[];return`<div class="cmd-comments">${t.length?t.map(e=>`<div class="cmd-comment">
            <div class="cmd-comment-body"><strong>${j(e.username)}</strong><span>${j(e.body)}</span></div>
            ${h(En)?`<button class="btn btn-sm ghost danger" type="button" data-remove-comment="${e.id}">Remove</button>`:``}
          </div>`).join(``):`<p class="hint">No comments yet.</p>`}${En?`<form class="cmd-comment-form" data-comment-key="${j(e.key)}">
       ...
       <p class="hint">Comments are reviewed by an admin before appearing.</p>`:`<button class="btn btn-sm" data-open-auth="login">Log in to comment</button>`}</div>`}function Pn(e){let t=Dn.counts[e.key]||0,n=Dn.mine.includes(e.key),r=(Dn.comments[e.key]||[]).length,i=An.has(e.key);return`
    <article class="cmd-card" data-search="${j(`${e.command} ${e.title} ${e.description}`.toLowerCase())}">
      ...
      ${i?Nn(e):``}
    </article>`}function Fn(e){let t=A.commands.filter(t=>t.category===e.id);return t.length?`
    <section class="cmd-category" data-category="${j(e.id)}">
      <h3 class="cmd-cat-title">${j(e.name)} <span class="cmd-count">${t.length}</span></h3>
      <div class="cmd-grid">${t.map(Pn).join(``)}</div>
    </section>`:``}function In(){let e=A.commands.filter(e=>e.isNew).length,t=h(En)?`<div class="actions">
    ...
    <section class="cmd-status-bar">
      <div>
        ...
        <strong>Last synced:</strong> ${jn(A.lastSync)}
        ${e?` · <span class="nade-badge new">${e} new</span>`:``}
      </div>
      ${t}
    </section>`}function Ln(){return!h(En)||!On.length?``:`
    <section class="cmd-review panel-review">
      <h3>Comments awaiting review (${On.length})</h3>
      ${On.map(e=>`<div class="review-comment">
    ...
    </section>`}function Rn(){k.innerHTML=`
    <div class="commands-shell">
      ...
      ${A.categories.map(Fn).join(``)}
      <div id="commands-status" class="status ${kn.kind}">${j(kn.text)}</div>
    </div>`,Bn()}function zn(e){let t=e.trim().toLowerCase();k.querySelectorAll(`.cmd-category`).forEach(e=>{let n=0;e.querySelectorAll(`.cmd-card`).forEach(e=>{let r=!t||e.dataset.search.includes(t);e.classList.toggle(`hidden`,!r),r&&(n+=1)}),e.classList.toggle(`hidden`,n===0)})}function Bn(){k.querySelectorAll(`[data-copy]`).forEach(e=>e.addEventListener(`click`,async()=>{try{await navigator.clipboard.writeText(e.dataset.copy),M(`Copied to clipboard.`,`ok`)}catch{M(`Clipboard blocked — select and copy manually.`,`error`)}})),k.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>Je(e.dataset.openAuth))),k.querySelectorAll(`[data-recommend]`).forEach(e=>e.addEventListener(`click`,()=>Vn(e.dataset.recommend))),k.querySelectorAll(`[data-toggle-comments]`).forEach(e=>e.addEventListener(`click`,()=>{let t=e.dataset.toggleComments;An.has(t)?An.delete(t):An.add(t),Rn()})),k.querySelectorAll(`.cmd-comment-form`).forEach(e=>e.addEventListener(`submit`,t=>{t.preventDefault(),Hn(e.dataset.commentKey,e.querySelector(`input`))})),k.querySelectorAll(`[data-approve-comment]`).forEach(e=>e.addEventListener(`click`,()=>Un(e.dataset.approveComment,`approved`))),k.querySelectorAll(`[data-reject-comment]`).forEach(e=>e.addEventListener(`click`,()=>Un(e.dataset.rejectComment,`rejected`))),k.querySelectorAll(`[data-remove-comment]`).forEach(e=>e.addEventListener(`click`,()=>Wn(e.dataset.removeComment))),k.querySelector(`#cmd-search`)?.addEventListener(`input`,e=>zn(e.target.value)),k.querySelector(`#cmd-sync`)?.addEventListener(`click`,Gn),k.querySelector(`#cmd-check-cs2`)?.addEventListener(`click`,Kn)}async function Vn(e){if(!En){Je(`login`);return}try{let t=await g.commands.recommend(e);Dn.counts[e]=t.count,Dn.mine=t.recommended?[...Dn.mine.filter(t=>t!==e),e]:Dn.mine.filter(t=>t!==e),Rn()}catch(e){M(e.message,`error`)}}async function Hn(e,t){let n=(t?.value||``).trim();if(!n){M(`Write something first.`,`error`);return}try{await g.commands.addComment(e,n),M(`Comment submitted — an admin will review it before it appears.`,`ok`),t&&(t.value=``)}catch(e){M(e.message,`error`)}}async function Un(e,t){try{await g.admin.reviewComment(e,t),await Mn(),Rn(),M(`Comment ${t}.`,`ok`)}catch(e){M(e.message,`error`)}}async function Wn(e){if(confirm(`Permanently delete this comment?`))try{await g.admin.removeComment(e),await Mn(),Rn(),M(`Comment deleted.`,`ok`)}catch(e){M(e.message,`error`)}}function Gn(){Tn({title:`Sync commands from the CS2 wiki`,description:`The Valve wiki has a bot check that blocks servers. Open it in your browser, complete the verification, then copy the page source (wikitext) and paste it here — the server will parse it.`,sourceUrl:`https://developer.valvesoftware.com/w/index.php?title=List_of_Counter-Strike_2_console_command_variables&action=raw`,sourceLabel:`Open CS2 wiki source`,placeholder:`Paste the wiki page source (wikitext), or a JSON list of commands…`,onImport:async e=>{let t=await g.admin.importCommands(e);return await Mn(),Rn(),`Imported ${t.count} commands.`}})}async function Kn(){M(`Checking the current CS2 build…`,``);try{let e=await g.admin.checkCommandsCs2();await Mn(),Rn(),M(e.ok?`CS2 build ${e.build}${e.changed?` — changed, catalog re-synced`:` — no change`}.`:`Check failed: ${e.reason}`,e.ok?`ok`:`error`)}catch(e){M(e.message,`error`)}}async function qn(){k=document.querySelector(`#commands-tool`),k&&(En=Ae(),je(async e=>{En=e,await Mn(),Rn()}),Rn(),await Mn(),Rn())}var N,P=null,Jn=null,Yn={paypalUrl:``,steamTradeUrl:``},Xn={text:``,kind:``};function F(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function I(e,t=``){Xn={text:e,kind:t};let n=N?.querySelector(`#profile-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function Zn(e){try{return new Date(e).toLocaleDateString()}catch{return`—`}}async function Qn(){if(P){try{Jn=(await g.auth.profile()).stats}catch(e){I(e.message,`error`)}if(Te(P))try{Yn=await g.settings.get()}catch{}}}function $n(e,t){return`<div class="profile-stat"><dt>${F(e)}</dt><dd>${F(t)}</dd></div>`}function er(){return Te(P)?`
    <section class="panel profile-settings">
      ...
      <div class="profile-settings-body">
        ...
        <label class="field">
          ...
          <input id="set-paypal" type="url" placeholder="https://www.paypal.com/paypalme/yourname" value="${F(Yn.paypalUrl)}" />
        </label>
        <label class="field">
          <span>Steam trade link</span>
          <input id="set-steam" type="url" placeholder="https://steamcommunity.com/tradeoffer/new/?partner=...&token=..." value="${F(Yn.steamTradeUrl)}" />
        </label>
        <div class="actions">
          <button class="btn primary" id="set-save">Save donate links</button>
        </div>
      </div>
    </section>`:``}function tr(){if(!P){N.innerHTML=`<div class="profile-shell"><div class="login-prompt">
    ...
    </div></div>`,N.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>Je(e.dataset.openAuth)));return}let e=(P.username||`?`).charAt(0).toUpperCase(),t=Jn||{nadesTotal:0,nadesApproved:0,nadesPending:0,recommendations:0,comments:0};N.innerHTML=`
    <div class="profile-shell">
      <section class="panel profile-card">
        <div class="profile-head">
          ...
          <div>
            ...
            <p class="hint">${P.email?F(P.email):`No email set`} · member since ${Zn(P.createdAt)}</p>
        ...
        <dl class="profile-stats">
          ${$n(`Nades submitted`,t.nadesTotal)}
          ${$n(`Approved`,t.nadesApproved)}
          ${$n(`Pending`,t.nadesPending)}
          ${$n(`Commands recommended`,t.recommendations)}
      ...
      ${er()}
      <div id="profile-status" class="status ${Xn.kind}">${F(Xn.text)}</div>
    </div>`,N.querySelector(`#set-save`)?.addEventListener(`click`,lr),N.querySelector(`#pw-save`)?.addEventListener(`click`,rr),N.querySelector(`#username-save`)?.addEventListener(`click`,ar),N.querySelector(`#cred-save`)?.addEventListener(`click`,or),N.querySelector(`#steam-link`)?.addEventListener(`click`,sr),N.querySelector(`#steam-unlink`)?.addEventListener(`click`,cr);let n=N.querySelector(`#avatar-file`);N.querySelector(`#avatar-upload`)?.addEventListener(`click`,()=>n?.click()),n?.addEventListener(`change`,e=>nr(e.target.files?.[0])),N.querySelector(`#avatar-remove`)?.addEventListener(`click`,ir)}async function nr(e){if(e){I(`Uploading image…`,``);try{await g.auth.uploadAvatar(e),await Me(),I(`Profile image updated.`,`ok`)}catch(e){I(e.message,`error`)}}}async function rr(){let e=N.querySelector(`#pw-current`)?.value||``,t=N.querySelector(`#pw-new`)?.value||``;try{await g.auth.changePassword({currentPassword:e,newPassword:t}),N.querySelector(`#pw-current`).value=``,N.querySelector(`#pw-new`).value=``,I(`Password updated.`,`ok`)}catch(e){I(e.message,`error`)}}async function ir(){try{await g.auth.setAvatar(``),await Me(),I(`Profile image removed.`,`ok`)}catch(e){I(e.message,`error`)}}async function ar(){let e=N.querySelector(`#acc-username`)?.value||``;try{await g.auth.changeUsername(e),await Me(),I(`Username updated.`,`ok`)}catch(e){I(e.message,`error`)}}async function or(){let e=N.querySelector(`#cred-email`)?.value||``,t=N.querySelector(`#cred-password`)?.value||``;try{await g.auth.setCredentials({email:e,password:t}),await Me(),I(`Email & password saved — you can now log in without Steam.`,`ok`)}catch(e){I(e.message,`error`)}}async function sr(){try{let e=await g.auth.steamLinkUrl();window.location.href=e}catch(e){I(e.message,`error`)}}async function cr(){try{await g.auth.steamUnlink(),await Me(),I(`Steam unlinked.`,`ok`)}catch(e){I(e.message,`error`)}}async function lr(){let e=N.querySelector(`#set-paypal`)?.value||``,t=N.querySelector(`#set-steam`)?.value||``;try{Yn=await g.admin.saveSettings({paypalUrl:e,steamTradeUrl:t}),I(`Donate links saved.`,`ok`),document.dispatchEvent(new CustomEvent(`aimkit:settings-updated`))}catch(e){I(e.message,`error`)}}async function ur(){N=document.querySelector(`#profile-tool`),N&&(P=Ae(),je(async e=>{P=e,await Qn(),tr()}),tr(),await Qn(),tr())}var L,dr=null,fr=[],pr=`top`,mr=!1,hr={text:``,kind:``},gr=new Set;function _r(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function vr(e,t=``){hr={text:e,kind:t};let n=L?.querySelector(`#configs-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function yr(e){try{return new Date(e).toLocaleDateString()}catch{return``}}function br(e,t){let n=new Blob([t],{type:`text/plain`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=e,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r)}async function xr(){try{fr=await g.configs.list({sort:pr})}catch(e){vr(e.message,`error`)}Er()}function Sr(e){let t=Math.round(e),n=``;for(let e=1;e<=5;e+=1)n+=e<=t?`★`:`☆`;return n}function Cr(e){if(!dr)return`<button class="btn btn-sm" data-open-auth="login">Log in to rate</button>`;if(e.authorId===dr.id)return`<span class="hint">Your upload</span>`;let t=``;for(let n=1;n<=5;n+=1)t+=`<button class="star-btn ${n<=e.myRating?`on`:``}" data-rate="${e.id}" data-star="${n}" title="${n} star${n>1?`s`:``}">${n<=e.myRating?`★`:`☆`}</button>`;return`<span class="rate-label">Your rating:</span><span class="star-picker">${t}</span>`}function wr(e){let t=gr.has(e.id),n=dr&&(e.authorId===dr.id||h(dr));return`
    <article class="config-card" data-search="${_r(`${e.title} ${e.description} ${e.authorName}`.toLowerCase())}">
      <div class="config-head">
        <h3>${_r(e.title)}</h3>
        <div class="config-rating" title="${e.avgRating} from ${e.ratingCount} rating(s)">
          <span class="stars">${Sr(e.avgRating)}</span>
          <span class="rating-num">${e.avgRating||`—`} (${e.ratingCount})</span>
        </div>
      </div>
      ${e.description?`<p class="config-desc">${_r(e.description)}</p>`:``}
      ...
      ${t?`<div class="config-view">
               ${e.hasConfig?`<div><strong>Config</strong><pre>${_r(e.configText)}</pre></div>`:``}
               ${e.hasVideo?`<div><strong>Video settings</strong><pre>${_r(e.videoText)}</pre></div>`:``}
             </div>`:``}
      <div class="config-foot">
        <span>by ${_r(e.authorName)} · ${yr(e.createdAt)}</span>
        <span class="config-rate">${Cr(e)}</span>
      </div>
    </article>`}function Tr(){return!dr||!mr?``:`
    ...
    </section>`}function Er(){L.innerHTML=`
    <div class="configs-shell">
      <div class="configs-controls">
        <div class="sort-tabs">
          <button class="tool-tab ${pr===`top`?`active`:``}" data-sort="top">Most rated</button>
          <button class="tool-tab ${pr===`new`?`active`:``}" data-sort="new">Last uploaded</button>
        </div>
        <input id="cfg-search" type="search" class="cfg-search" placeholder="Search configs by title, author…" />
        ${dr?`<button class="btn primary" id="cfg-new">Upload config</button>`:`<button class="btn primary" data-open-auth="login">Log in to upload</button>`}
      </div>
      ${Tr()}
      <div class="config-grid">
        ${fr.length?fr.map(wr).join(``):`<p class="hint">No configs yet — be the first to upload one!</p>`}
      </div>
      <div id="configs-status" class="status ${hr.kind}">${_r(hr.text)}</div>
    </div>`,Or()}function Dr(e){let t=e.trim().toLowerCase();L.querySelectorAll(`.config-card`).forEach(e=>{e.classList.toggle(`hidden`,t&&!e.dataset.search.includes(t))})}function Or(){L.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>Je(e.dataset.openAuth))),L.querySelectorAll(`[data-sort]`).forEach(e=>e.addEventListener(`click`,()=>{pr=e.dataset.sort,xr()})),L.querySelector(`#cfg-search`)?.addEventListener(`input`,e=>Dr(e.target.value)),L.querySelector(`#cfg-new`)?.addEventListener(`click`,()=>{mr=!0,Er()}),L.querySelector(`#cfg-cancel`)?.addEventListener(`click`,()=>{mr=!1,Er()}),L.querySelector(`#cfg-submit`)?.addEventListener(`click`,jr),L.querySelector(`#cfg-config-file`)?.addEventListener(`change`,e=>Ar(e.target,`#cfg-config`)),L.querySelector(`#cfg-video-file`)?.addEventListener(`change`,e=>Ar(e.target,`#cfg-video`)),L.querySelectorAll(`[data-dl]`).forEach(e=>e.addEventListener(`click`,()=>{let t=fr.find(t=>String(t.id)===e.dataset.dl);t&&(e.dataset.kind===`config`?br(`${kr(t.title)}.cfg`,t.configText):br(`cs2_video.txt`,t.videoText))})),L.querySelectorAll(`[data-view]`).forEach(e=>e.addEventListener(`click`,()=>{let t=Number(e.dataset.view);gr.has(t)?gr.delete(t):gr.add(t),Er()})),L.querySelectorAll(`[data-del]`).forEach(e=>e.addEventListener(`click`,()=>Nr(Number(e.dataset.del)))),L.querySelectorAll(`[data-rate]`).forEach(e=>e.addEventListener(`click`,()=>Mr(Number(e.dataset.rate),Number(e.dataset.star))))}function kr(e){return(e||`config`).toLowerCase().replace(/[^a-z0-9]+/g,`_`).replace(/^_|_$/g,``).slice(0,40)||`config`}function Ar(e,t){let n=e.files?.[0];if(!n)return;let r=new FileReader;r.onload=()=>{let e=L.querySelector(t);e&&(e.value=String(r.result||``))},r.readAsText(n)}async function jr(){let e=L.querySelector(`#cfg-title`)?.value||``,t=L.querySelector(`#cfg-desc`)?.value||``,n=L.querySelector(`#cfg-config`)?.value||``,r=L.querySelector(`#cfg-video`)?.value||``;try{await g.configs.create({title:e,description:t,configText:n,videoText:r}),mr=!1,pr=`new`,await xr(),vr(`Config published!`,`ok`)}catch(e){vr(e.message,`error`)}}async function Mr(e,t){try{let n=await g.configs.rate(e,t),r=fr.find(t=>t.id===e);r&&(r.avgRating=n.avgRating,r.ratingCount=n.ratingCount,r.myRating=n.myRating),Er(),vr(`Thanks for rating!`,`ok`)}catch(e){vr(e.message,`error`)}}async function Nr(e){try{await g.configs.remove(e),await xr(),vr(`Config deleted.`,`ok`)}catch(e){vr(e.message,`error`)}}async function Pr(){L=document.querySelector(`#configs-tool`),L&&(dr=Ae(),je(async e=>{dr=e,await xr()}),Er(),await xr())}var R,z=null,Fr=[],Ir=[],Lr={text:``,kind:``},Rr=!1,zr=null;function B(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Br(e,t=``){Lr={text:e,kind:t};let n=R?.querySelector(`#highlights-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function Vr(e){try{return new Date(e).toLocaleDateString()}catch{return``}}function Hr(e){let t=/(?:youtube\.com\/(?:watch\?v=|embed\/|shorts\/)|youtu\.be\/)([\w-]{6,})/.exec(e||``);return t?t[1]:null}function Ur(e){return/^https?:\/\//.test(e||``)?e:``}function Wr(e){let t=Ur(e);if(!t)return``;let n=Hr(e);return n?`<iframe class="hl-embed" src="https://www.youtube.com/embed/${B(n)}" title="highlight" allowfullscreen loading="lazy"></iframe>`:/\.(mp4|webm|mov)(\?|$)/i.test(e)?`<video class="hl-embed" src="${B(t)}" controls preload="none"></video>`:`<a class="btn ghost" href="${B(t)}" target="_blank" rel="noopener noreferrer">Open highlight ↗</a>`}async function Gr(){try{Fr=await g.highlights.list({}),Ir=h(z)?await g.admin.highlightReports():[]}catch(e){Br(e.message,`error`)}Yr()}function Kr(){return!h(z)||!Ir.length?``:`
    <section class="panel panel-review">
      <h3>Reported highlights (${Ir.length})</h3>
      ${Ir.map(e=>`<div class="report-item">
            <div class="report-media">${Wr(e.url)}</div>
    ...
    <article class="hl-card" data-search="${B(`${e.title} ${e.description} ${e.authorName}`.toLowerCase())}">
      ...
      ${zr===e.id?`<form class="hl-report-form" data-report-form="${e.id}">
    ...
    </article>`}function Jr(){return!z||!Rr?``:`
    <section class="panel config-upload">
    ...
    </section>`}function Yr(){R.innerHTML=`
    <div class="highlights-shell">
      ...
      ${Jr()}
      <div class="hl-grid">
        ${Fr.length?Fr.map(qr).join(``):`<p class="hint">No highlights yet — share the first one!</p>`}
      </div>
      <div id="highlights-status" class="status ${Lr.kind}">${B(Lr.text)}</div>
    </div>`,Zr()}function Xr(e){let t=e.trim().toLowerCase();R.querySelectorAll(`.hl-card`).forEach(e=>{e.classList.toggle(`hidden`,t&&!e.dataset.search.includes(t))})}function Zr(){R.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>Je(e.dataset.openAuth))),R.querySelector(`#hl-search`)?.addEventListener(`input`,e=>Xr(e.target.value)),R.querySelector(`#hl-new`)?.addEventListener(`click`,()=>{Rr=!0,Yr()}),R.querySelector(`#hl-cancel`)?.addEventListener(`click`,()=>{Rr=!1,Yr()}),R.querySelector(`#hl-submit`)?.addEventListener(`click`,Qr),R.querySelectorAll(`[data-report]`).forEach(e=>e.addEventListener(`click`,()=>{zr=Number(e.dataset.report),Yr()})),R.querySelector(`[data-cancel-report]`)?.addEventListener(`click`,()=>{zr=null,Yr()}),R.querySelector(`[data-report-form]`)?.addEventListener(`submit`,e=>{e.preventDefault(),$r(Number(e.currentTarget.dataset.reportForm),e.currentTarget.querySelector(`input`).value)}),R.querySelectorAll(`[data-del]`).forEach(e=>e.addEventListener(`click`,()=>ei(Number(e.dataset.del)))),R.querySelectorAll(`[data-keep]`).forEach(e=>e.addEventListener(`click`,()=>ti(Number(e.dataset.keep),`keep`))),R.querySelectorAll(`[data-remove-hl]`).forEach(e=>e.addEventListener(`click`,()=>ti(Number(e.dataset.removeHl),`delete`)))}async function Qr(){let e=R.querySelector(`#hl-title`)?.value||``,t=R.querySelector(`#hl-desc`)?.value||``,n=R.querySelector(`#hl-url`)?.value||``;try{await g.highlights.create({title:e,description:t,url:n}),Rr=!1,await Gr(),Br(`Highlight shared!`,`ok`)}catch(e){Br(e.message,`error`)}}async function $r(e,t){try{await g.highlights.report(e,t),zr=null,await Gr(),Br(`Thanks — an admin will review your report.`,`ok`)}catch(e){Br(e.message,`error`)}}async function ei(e){try{await g.highlights.remove(e),await Gr(),Br(`Highlight deleted.`,`ok`)}catch(e){Br(e.message,`error`)}}async function ti(e,t){try{await g.admin.reviewHighlight(e,t),await Gr(),Br(t===`delete`?`Highlight removed.`:`Reports cleared — highlight kept.`,`ok`)}catch(e){Br(e.message,`error`)}}async function ni(){R=document.querySelector(`#highlights-tool`),R&&(z=Ae(),je(async e=>{z=e,await Gr()}),Yr(),await Gr())}var V,ri=null,ii={pros:[],source:`seed`,lastSync:0},ai=`featured`,oi=``,si=null,ci={text:``,kind:``};function H(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function li(e,t=``){ci={text:e,kind:t};let n=V?.querySelector(`#pros-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}async function ui(){try{ii=await g.pros.list({sort:ai,q:oi})}catch(e){li(e.message,`error`)}_i()}var di={"natus vincere":`#f4d000`,vitality:`#f5d20a`,falcons:`#0aa14f`,"team spirit":`#c8102e`,astralis:`#e4002b`,faze:`#e43b26`,g2:`#c8102e`};function fi(e){return di[(e||``).toLowerCase()]||`#33415a`}function pi(e){let t=(e.team||e.player||`?`).trim(),n=t.split(/\s+/);return(n.length>1?n.slice(0,3).map(e=>e[0]).join(``):t.slice(0,2)).toUpperCase()}function mi(e){let t=e.photo||e.teamLogo||``,n=e.photo&&e.teamLogo?e.teamLogo:``,r=t?`<img class="pro-img" alt="${H(e.player)}" loading="lazy" src="${H(t)}"${n?` data-logo="${H(n)}"`:``} onerror="if(this.dataset.logo){this.src=this.dataset.logo;this.removeAttribute('data-logo');}else{this.remove();}" />`:``;return`<div class="pro-photo" style="--team:${fi(e.team)}"><span class="pro-monogram">${H(pi(e))}</span>${r}</div>`}function hi(e,t){return`<div class="pro-stat"><dt>${H(e)}</dt><dd>${t!=null&&t!==``?H(t):`—`}</dd></div>`}function gi(e){return`
    <article class="pro-card" data-search="${H(`${e.player} ${e.team||``}`.toLowerCase())}">
      ...
      <dl class="pro-stats">
        ...
        ${hi(`Zoom`,e.zoomSens)}
        ${hi(`Hz`,e.hz)}
        ${hi(`Resolution`,e.resolution)}
        ${hi(`Aspect`,e.aspectRatio)}
      </dl>
    </article>`}function _i(){let e=h(ri)?`<div class="pros-admin-actions">
    ...
    <div class="pros-shell">
      <div class="cmd-status-bar">
        <div><strong>Source:</strong> ${H(ii.source)} · <strong>${ii.pros.length}</strong> players${ii.lastSync?` · synced ${H(new Date(ii.lastSync).toLocaleDateString())}`:``}</div>
        ${e}
      </div>
      <div class="configs-controls">
        <div class="sort-tabs">
          <button class="tool-tab ${ai===`featured`?`active`:``}" data-sort="featured">Featured</button>
          <button class="tool-tab ${ai===`name`?`active`:``}" data-sort="name">Name</button>
          <button class="tool-tab ${ai===`edpi`?`active`:``}" data-sort="edpi">Lowest eDPI</button>
          <button class="tool-tab ${ai===`edpi-desc`?`active`:``}" data-sort="edpi-desc">Highest eDPI</button>
        </div>
        <input id="pros-search" type="search" class="cfg-search" placeholder="Search player or team…" value="${H(oi)}" />
      </div>
      <p class="hint">${ii.source===`prosettings`?`Live from prosettings.net.`:ii.source===`seed`?`Built-in list. Admins can sync live data from prosettings.net.`:`Source: ${H(ii.source)}.`}</p>
      <div class="pro-grid">
        ${ii.pros.length?ii.pros.map(gi).join(``):`<p class="hint">No pro settings yet.</p>`}
      </div>
      <div id="pros-status" class="status ${ci.kind}">${H(ci.text)}</div>
    </div>`,vi()}function vi(){V.querySelectorAll(`[data-sort]`).forEach(e=>e.addEventListener(`click`,()=>{ai=e.dataset.sort,ui()}));let e=V.querySelector(`#pros-search`);e&&e.addEventListener(`input`,e=>{oi=e.target.value,clearTimeout(si),si=setTimeout(async()=>{await ui();let e=V.querySelector(`#pros-search`);e&&(e.focus(),e.setSelectionRange(e.value.length,e.value.length))},300)}),V.querySelector(`#pros-sync`)?.addEventListener(`click`,yi),V.querySelector(`#pros-import`)?.addEventListener(`click`,bi)}async function yi(){let e=V.querySelector(`#pros-sync`);e&&(e.disabled=!0),li(`Syncing from prosettings.net…`,``);try{let e=await g.admin.syncPros();await ui(),e.synced?li(`Synced ${e.count} players from ${e.source}.`,`ok`):li(`Sync failed: ${e.reason||`unknown error`}. Kept the current list.`,`error`)}catch(e){li(e.message,`error`)}finally{let e=V.querySelector(`#pros-sync`);e&&(e.disabled=!1)}}function bi(){Tn({title:`Import pro settings from HLTV`,description:`HLTV has a Cloudflare check that blocks servers. Open HLTV in your browser, complete the verification, then paste a JSON list of players here. Each item: {"player","team","dpi","sens","zoomSens","hz","resolution","aspectRatio","photo","teamLogo"}.`,sourceUrl:`https://www.hltv.org/stats/players`,sourceLabel:`Open HLTV`,placeholder:`[{"player":"s1mple","team":"Natus Vincere","dpi":400,"sens":3.09,"hz":1000,"resolution":"1280x960","aspectRatio":"4:3"}]`,onImport:async e=>{let t=await g.admin.importPros(e);return await ui(),`Imported ${t.count} players.`}})}async function xi(){V=document.querySelector(`#pros-tool`),V&&(ri=Ae(),je(e=>{ri=e,_i()}),_i(),await ui())}var U,W=null,Si=`overview`,Ci={text:``,kind:``},wi={nades:0,comments:0,reports:0},G={},Ti=[{id:`overview`,label:`Overview`},{id:`nades`,label:`Nades`},{id:`comments`,label:`Comments`},{id:`reports`,label:`Reports`},{id:`users`,label:`Users`},{id:`sync`,label:`Data sync`},{id:`contact`,label:`Contact`},{id:`logs`,label:`Logs`,ownerOnly:!0},{id:`settings`,label:`Site settings`,ownerOnly:!0}];function K(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Ei(e,t=``){Ci={text:e,kind:t};let n=U?.querySelector(`#admin-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function Di(e){try{return new Date(e).toLocaleString()}catch{return`—`}}async function Oi(){try{let[e,t,n]=await Promise.all([g.admin.pendingCount().catch(()=>0),g.admin.pendingCommentsCount().catch(()=>0),g.admin.highlightReportsCount().catch(()=>0)]);wi={nades:e,comments:t,reports:n}}catch{}}function ki(){let e=(e,t,n)=>`<button class="admin-stat" data-goto="${n}">
       <span class="admin-stat-num">${t}</span>
       <span class="admin-stat-label">${K(e)}</span>
     </button>`;return`
    <div class="admin-stats">
      ${e(`Nades to review`,wi.nades,`nades`)}
      ${e(`Comments to review`,wi.comments,`comments`)}
      ${e(`Highlight reports`,wi.reports,`reports`)}
    </div>
    <p class="hint">Use the tabs above to moderate content, manage users, sync data sources, and read contact messages.</p>`}function Ai(){let e=G.nades||[];return e.length?`
    <div class="review-bulk-bar">
      <label class="review-select-all">
    ...
    ${e.map(e=>{let t=(e.media||[]).map(e=>`
        ...
        </article>`}).join(``)}`:`<p class="hint">Nothing pending. All nades are reviewed.</p>`}function ji(){let e=G.comments||[];return e.length?e.map(e=>`
      <article class="panel admin-item">
        <p>${K(e.body)}</p>
        <p class="hint">by ${K(e.username)} on <code>${K(e.commandKey)}</code> · ${Di(e.createdAt)}</p>
        <div class="actions">
      ...
      </article>`).join(``):`<p class="hint">No comments pending review.</p>`}function Mi(){let e=G.reports||[];return e.length?e.map(e=>{let t=(e.reports||[]).map(e=>`<li>${K(e.reason||`No reason`)} — <span class="hint">${K(e.reporterName||`?`)}</span></li>`).join(``);return`
        <article class="panel admin-item">
          <div class="admin-item-head">
    ...
    <div class="admin-users">${r}</div>`}function Pi(){return`
    <div class="admin-sync">
    ...
    </div>`}function Fi(){let e=G.contact||[];return e.length?e.map(e=>`
      <article class="panel admin-item">
        <div class="admin-item-head">
          <strong>${K(e.subject||`(no subject)`)}</strong>
          <span class="hint">${Di(e.created_at)}</span>
        </div>
      ...
      </article>`).join(``):`<p class="hint">No contact messages.</p>`}function Ii(){let e=G.settings||{paypalUrl:``,steamTradeUrl:``};return`
    <div class="panel admin-item">
    ...
    <div class="admin-logs">${i}</div>`}var Ri={overview:ki,nades:Ai,comments:ji,reports:Mi,users:Ni,sync:Pi,contact:Fi,logs:Li,settings:Ii};async function zi(e){try{e===`overview`?await Oi():e===`nades`?G.nades=await g.admin.pending():e===`comments`?G.comments=await g.admin.pendingComments():e===`reports`?G.reports=await g.admin.highlightReports():e===`users`?G.users=await g.admin.users():e===`contact`?G.contact=await g.admin.contactMessages():e===`logs`?G.logs=await g.admin.ownerLogs({action:G.logsFilter||``}):e===`settings`&&(G.settings=await g.settings.get())}catch(e){Ei(e.message,`error`)}}function Bi(){if(!U)return;if(!h(W)){U.innerHTML=`<div class="admin-shell"><div class="login-prompt">
    ...
    </div></div>`,U.querySelector(`[data-open-auth]`)?.addEventListener(`click`,()=>Je(`login`));return}(Si===`logs`||Si===`settings`)&&!Te(W)&&(Si=`overview`);let e=Ti.filter(e=>!e.ownerOnly||Te(W)).map(e=>`<button class="tool-tab ${Si===e.id?`active`:``}" data-section="${e.id}">${K(e.label)}${e.id===`nades`&&wi.nades?` (${wi.nades})`:``}${e.id===`comments`&&wi.comments?` (${wi.comments})`:``}${e.id===`reports`&&wi.reports?` (${wi.reports})`:``}</button>`).join(``),t=(Ri[Si]||ki)();U.innerHTML=`
    <div class="admin-shell">
      <h2 class="admin-title">Admin</h2>
      <div class="admin-nav sort-tabs">${e}</div>
      <div class="admin-body">${t}</div>
      <div id="admin-status" class="status ${Ci.kind}">${K(Ci.text)}</div>
    </div>`,Hi()}async function Vi(e){(e===`logs`||e===`settings`)&&(Te(W)||(e=`overview`)),Si=e,Bi(),await zi(e),Bi()}function Hi(){U.querySelectorAll(`[data-section]`).forEach(e=>e.addEventListener(`click`,()=>Vi(e.dataset.section))),U.querySelectorAll(`[data-goto]`).forEach(e=>e.addEventListener(`click`,()=>Vi(e.dataset.goto)));let e=async(e,t)=>{try{await e(),t&&Ei(t,`ok`)}catch(e){Ei(e.message,`error`)}},t=async()=>{await zi(Si),await Oi(),Bi()};U.querySelectorAll(`[data-nade-approve]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewNade(n.dataset.nadeApprove,`approved`),await t()},`Nade approved.`))),U.querySelectorAll(`[data-nade-reject]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewNade(n.dataset.nadeReject,`rejected`),await t()},`Nade rejected.`))),U.querySelectorAll(`[data-nade-delete]`).forEach(n=>n.addEventListener(`click`,()=>{confirm(`Permanently delete this nade and its media?`)&&e(async()=>{await g.nades.remove(n.dataset.nadeDelete),await t()},`Nade deleted.`)})),U.querySelectorAll(`[data-media-approve]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewMedia(n.dataset.mediaApprove,`approved`),await t()},`Media approved.`))),U.querySelectorAll(`[data-media-reject]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewMedia(n.dataset.mediaReject,`rejected`),await t()},`Media rejected.`))),U.querySelectorAll(`[data-media-delete]`).forEach(n=>n.addEventListener(`click`,()=>{confirm(`Permanently remove this media?`)&&e(async()=>{await g.admin.removeMedia(n.dataset.mediaDelete),await t()},`Media removed.`)}));let n=U.querySelector(`#admin-nade-select-all`),r=U.querySelector(`#admin-nade-bulk-approve`),i=U.querySelector(`#admin-nade-bulk-reject`),a=()=>{let e=U.querySelectorAll(`.admin-nade-check:checked`).length;r&&(r.disabled=e===0),i&&(i.disabled=e===0)};n?.addEventListener(`change`,()=>{U.querySelectorAll(`.admin-nade-check`).forEach(e=>{e.checked=n.checked}),a()}),U.querySelectorAll(`.admin-nade-check`).forEach(e=>e.addEventListener(`change`,a));let o=async n=>{let r=[...U.querySelectorAll(`.admin-nade-check:checked`)].map(e=>Number(e.value));r.length&&await e(async()=>{let e=await g.admin.reviewNadesBulk(r,n);await t(),Ei(`${n===`approved`?`Approved`:`Rejected`} ${e.updated} nade${e.updated===1?``:`s`}.`,`ok`)})};r?.addEventListener(`click`,()=>o(`approved`)),i?.addEventListener(`click`,()=>o(`rejected`)),U.querySelectorAll(`[data-comment-approve]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewComment(n.dataset.commentApprove,`approved`),await t()},`Comment approved.`))),U.querySelectorAll(`[data-comment-reject]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewComment(n.dataset.commentReject,`rejected`),await t()},`Comment rejected.`))),U.querySelectorAll(`[data-comment-delete]`).forEach(n=>n.addEventListener(`click`,()=>{confirm(`Permanently delete this comment?`)&&e(async()=>{await g.admin.removeComment(n.dataset.commentDelete),await t()},`Comment deleted.`)})),U.querySelectorAll(`[data-report-keep]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewHighlight(n.dataset.reportKeep,`keep`),await t()},`Kept highlight.`))),U.querySelectorAll(`[data-report-delete]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.reviewHighlight(n.dataset.reportDelete,`delete`),await t()},`Highlight deleted.`))),U.querySelectorAll(`[data-role-set]`).forEach(n=>n.addEventListener(`click`,()=>{let r=n.dataset.role;e(async()=>{await g.admin.setRole(n.dataset.roleSet,r),await t()},r===`admin`?`Promoted to admin.`:`Admin access removed.`)})),U.querySelectorAll(`[data-unban]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.unbanUser(n.dataset.unban),await t()},`User unbanned.`))),U.querySelectorAll(`[data-ban]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{let e=Number(U.querySelector(`[data-ban-hrs="${n.dataset.ban}"]`)?.value);if(!Number.isFinite(e)||e<=0)return Ei(`Enter a positive number of hours.`,`error`);await g.admin.banUser(n.dataset.ban,{hours:e}),await t(),Ei(`User banned.`,`ok`)}))),U.querySelectorAll(`[data-ban-perma]`).forEach(n=>n.addEventListener(`click`,()=>e(async()=>{await g.admin.banUser(n.dataset.banPerma,{permanent:!0}),await t()},`User banned permanently.`))),U.querySelector(`#sync-commands`)?.addEventListener(`click`,()=>e(async()=>{let e=await g.admin.syncCommands();Ei(e.synced?`Commands synced (${e.count}).`:`No sync: ${e.reason||`no source`}.`,e.synced?`ok`:`error`)})),U.querySelector(`#check-cs2`)?.addEventListener(`click`,()=>e(async()=>{let e=await g.admin.checkCommandsCs2();Ei(`CS2 build: ${e.build||`unknown`}${e.changed?` (changed → re-synced)`:``}.`,`ok`)})),U.querySelector(`#sync-pros`)?.addEventListener(`click`,()=>e(async()=>{let e=await g.admin.syncPros();Ei(e.synced?`Synced ${e.count} pros from ${e.source}.`:`Sync failed: ${e.reason}.`,e.synced?`ok`:`error`)})),U.querySelector(`#import-commands`)?.addEventListener(`click`,()=>Tn({title:`Import commands`,description:`Paste the CS2 console-commands wiki page (wikitext) or a JSON array of commands.`,sourceUrl:`https://developer.valvesoftware.com/wiki/List_of_Counter-Strike_2_console_command_variables`,sourceLabel:`Open wiki`,onImport:async e=>`Imported ${(await g.admin.importCommands(e)).count} commands.`})),U.querySelector(`#import-pros`)?.addEventListener(`click`,()=>Tn({title:`Import pro settings from HLTV`,description:`Open HLTV, complete the check, then paste a JSON list of players.`,sourceUrl:`https://www.hltv.org/stats/players`,sourceLabel:`Open HLTV`,onImport:async e=>{let t=await g.admin.importPros(e);return await zi(`sync`),`Imported ${t.count} players.`}})),U.querySelectorAll(`[data-contact-delete]`).forEach(n=>n.addEventListener(`click`,()=>{confirm(`Delete this contact message?`)&&e(async()=>{await g.admin.removeContact(n.dataset.contactDelete),await t()},`Message deleted.`)})),U.querySelector(`#save-settings`)?.addEventListener(`click`,()=>e(async()=>{let e=U.querySelector(`#set-paypal`)?.value||``,t=U.querySelector(`#set-steam`)?.value||``;G.settings=await g.admin.saveSettings({paypalUrl:e,steamTradeUrl:t}),document.dispatchEvent(new CustomEvent(`aimkit:settings-updated`))},`Donate links saved.`)),U.querySelector(`#owner-logs-filter`)?.addEventListener(`change`,t=>{G.logsFilter=t.target.value||``,e(async()=>{await zi(`logs`),Bi()})}),U.querySelector(`#owner-logs-refresh`)?.addEventListener(`click`,()=>e(async()=>{await zi(`logs`),Bi()},`Logs refreshed.`))}function Ui(e){document.querySelectorAll(`.admin-only`).forEach(t=>t.classList.toggle(`hidden`,!h(e)))}async function Wi(){U=document.querySelector(`#admin-tool`),U&&(W=Ae(),Ui(W),je(async e=>{let t=h(W);W=e,Ui(e),h(e)&&!t&&await Oi(),Bi()}),Bi(),h(W)&&(await Oi(),Bi()))}function Gi(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Ki(){let e=Ae(),t=document.createElement(`div`);t.className=`modal`,t.innerHTML=`
    <div class="modal-backdrop" data-close></div>
    <div class="modal-card" role="dialog" aria-modal="true" aria-label="Contact us">
      ...
      <form id="contact-form" class="auth-form-modal">
        <label class="field"><span>Your name</span><input id="contact-name" type="text" value="${Gi(e?.username||``)}" /></label>
        <label class="field"><span>Your email</span><input id="contact-email" type="email" value="${Gi(e?.email||``)}" /></label>
...
`;var la=document.querySelector(`#preview-canvas`),ua=document.querySelector(`#preview-stats`),da=document.querySelector(`#preview-res`),fa=document.querySelector(`#preview-res-scale`),pa=`ingame`;function ma(){let e=pa===`fullscreen`?1080:280;la.width!==e&&(la.width=e,la.height=e),la.style.imageRendering=pa===`fullscreen`?`auto`:`pixelated`}ma();var ha=[{id:`1920x1080`,h:1080,label:`1920 × 1080 (16:9)`},{id:`2560x1440`,h:1440,label:`2560 × 1440 (16:9)`},{id:`3840x2160`,h:2160,label:`3840 × 2160 (4K)`},{id:`1600x900`,h:900,label:`1600 × 900 (16:9)`},{id:`1366x768`,h:768,label:`1366 × 768 (16:9)`},{id:`1280x960`,h:960,label:`1280 × 960 (4:3)`},{id:`1024x768`,h:768,label:`1024 × 768 (4:3)`},{id:`1280x1024`,h:1024,label:`1280 × 1024 (5:4)`}],ga=null;function _a(){return pa===`fullscreen`?la.height/1080:(ha.find(e=>e.id===da?.value)||ha[0]).h/1080}var va=Zi({source:la,stage:document.querySelector(`.preview-stage`),toggleBtn:document.querySelector(`#magnifier-toggle`),zoomSelect:document.querySelector(`#magnifier-zoom`)});function ya(e){if(ga=e,Xi(la,e,_a()),fa)if(e){let t=ha.find(e=>e.id===da?.value)||ha[0],n=t.h/1080;fa.textContent=`≈ ${Math.max(0,Math.round(e.length*n))}px arms · ${Math.max(1,Math.round(e.thickness*n))}px thick @ ${t.h}p`}else fa.textContent=``;va.refresh()}function ba(e){pa=e===`fullscreen`?`fullscreen`:`ingame`,ma(),document.querySelectorAll(`.pmode`).forEach(e=>{let t=e.dataset.pmode===pa;e.classList.toggle(`active`,t),e.setAttribute(`aria-selected`,String(t))});let t=document.querySelector(`#preview-mode-tag`);t&&(t.textContent=pa===`fullscreen`?`Relative to full screen`:`Actual in-game size`),ya(ga)}document.querySelectorAll(`.pmode`).forEach(e=>e.addEventListener(`click`,()=>ba(e.dataset.pmode)));var Y=document.querySelector(`#crosshair-status`),xa=document.querySelector(`#sensitivity-status`),Sa=document.querySelector(`#sharecode-input`),Ca=document.querySelector(`#commands-output`),wa=document.querySelector(`#commands-input`),Ta=document.querySelector(`#sharecode-output`),Ea=document.querySelector(`#sens-from-game`),X=document.querySelector(`#sens-to-game`),Da=document.querySelector(`#sens-source`),Oa=document.querySelector(`#sens-target`),ka=document.querySelector(`#sens-source-dpi`),Aa=document.querySelector(`#sens-target-dpi`),ja=document.querySelector(`#sens-source-myaw`),Ma=document.querySelector(`#sens-target-myaw`),Na=document.querySelector(`#sens-source-yaw`),Pa=document.querySelector(`#sens-target-yaw`),Fa=document.querySelector(`#source-yaw-field`),Ia=document.querySelector(`#target-yaw-field`),La=document.querySelector(`#m-yaw-fields`),Ra=document.querySelector(`#sens-cm360`),za=document.querySelector(`#sens-stats`),Ba=document.querySelector(`#sens-formula`),Va=`CSGO-UseJt-3oTvn-47wPX-hEyER-WZfiK`,Ha=`cl_crosshairstyle 4
cl_crosshairsize 3
cl_crosshairgap -2
...
cl_crosshair_recoil 0`;function Z(e,t,n=``){e&&(e.textContent=t,e.className=`status${n?` ${n}`:``}`)}function Ua(e){ya(e),ua.innerHTML=`
  ...
  `}function Wa(e){return e.trim().replace(/\s+/g,``).replace(/^csgo/i,`CSGO`)}function Ga(){let e=Sa.value.trim();if(!e){Z(Y,`Paste a crosshair share code first.`,`error`);return}let t=Wa(e);if(!aa.test(t)){Z(Y,`Invalid format. Expected CSGO-xxxxx-xxxxx-xxxxx-xxxxx-xxxxx`,`error`);return}try{let e=d(t);Sa.value=t,Ca.value=ce(ee(e)),Ua(e),Z(Y,`Converted share code to console commands.`,`ok`)}catch(e){e instanceof i||e instanceof r?Z(Y,`That share code is not a valid crosshair code.`,`error`):Z(Y,e instanceof Error?e.message:`Failed to decode share code.`,`error`)}}function Ka(){let e=wa.value.trim();if(!e){Z(Y,`Paste crosshair console commands first.`,`error`);return}try{let t=se(e);Ta.value=f(t),Ua(t),Z(Y,`Converted commands to share code.`,`ok`)}catch(e){Z(Y,e instanceof Error?e.message:`Failed to encode share code.`,`error`)}}async function qa(e,t,n){if(!t){Z(e,`Nothing to copy for ${n}.`,`error`);return}try{await navigator.clipboard.writeText(t),Z(e,`Copied ${n} to clipboard.`,`ok`)}catch{Z(e,`Clipboard access failed. Select and copy manually.`,`error`)}}function Ja(){let e=Qi[Ea.value]?.supportsMYaw||Qi[X.value]?.supportsMYaw;La?.classList.toggle(`hidden`,!e),Fa?.classList.toggle(`hidden`,!Qi[Ea.value]?.custom),Ia?.classList.toggle(`hidden`,!Qi[X.value]?.custom)}function Ya(){let e=Number(Da.value),t=Number(ka.value),n=Number(Aa.value),r=Number(ja.value)||.022,i=Number(Ma.value)||.022,a=Number(Na.value),o=Number(Pa.value);if(Ja(),Qi[Ea.value]?.custom&&!(a>0)){Z(xa,`Enter a valid source custom yaw (° per count).`,`error`);return}if(Qi[X.value]?.custom&&!(o>0)){Z(xa,`Enter a valid target custom yaw (° per count).`,`error`);return}if(!Number.isFinite(e)||e<=0){Oa.value=``,Ra.textContent=`—`,za.innerHTML=``,Ba.textContent=``;return}if(!Number.isFinite(t)||t<=0||!Number.isFinite(n)||n<=0){Z(xa,`Enter valid DPI values.`,`error`);return}let s=na({sourceGame:Ea.value,targetGame:X.value,sourceSens:e,sourceDpi:t,targetDpi:n,sourceMYaw:r,targetMYaw:i,sourceCustomYaw:a,targetCustomYaw:o}),c=Qi[Ea.value].name,l=Qi[X.value].name,u=J(s.targetSensitivity);Oa.value=u,Ra.textContent=ra(s.cm360),za.innerHTML=`
    <div><dt>Inches / 360°</dt><dd>${ra(s.inches360)} in</dd></div>
    <div><dt>Source eDPI</dt><dd>${ra(s.sourceEdpi,0)}</dd></div>
    <div><dt>Target eDPI</dt><dd>${ra(s.targetEdpi,0)}</dd></div>
  ...
  `,Z(xa,`${c} → ${l}: ${u}`,`ok`)}function Xa(){let e=Ea.value;Ea.value=X.value,X.value=e,Oa.value&&(Da.value=Oa.value),Ya()}function Za(){Ea.value=`cs2`,X.value=`valorant`,Da.value=`1.25`,ka.value=`800`,Aa.value=`800`,Ya()}var Qa={crosshair:`Convert a crosshair share code into console commands, build a code from commands, or design one visually with a live preview.`,sensitivity:`Keep the same cm/360 aim feel across games — with custom yaw values and DPI changes handled for you.`,psa:`Dial in your ideal sensitivity with a guided 7-round A/B test (Perfect Sensitivity Approximation).`,nades:`Browse community grenade line-ups, or sign in to submit your own with a 2D throw guide, videos and photos.`,commands:`Copy up-to-date CS2 launch options and console commands, recommend the ones that help, and share tips in the comments.`,configs:`Share your CS2 configs and video settings, download other players’ setups, and rate the best ones.`,highlights:`Share your best CS2 clips, watch the community’s highlights, and report anything that breaks the rules.`,pros:`Browse pro players’ sensitivity, DPI, resolution and crosshair settings.`,profile:`Your account, contributions, and settings.`,admin:`Moderate content, manage users, sync data sources, and read contact messages.`},$a=document.querySelector(`#tool-desc`);function eo(e){$a&&($a.textContent=Qa[e]||``)}function to(e){document.querySelectorAll(`.tool-nav .tool-tab`).forEach(t=>{let n=t.getAttribute(`data-tool`)===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,String(n))}),document.querySelectorAll(`.tool-view`).forEach(t=>{t.classList.toggle(`active`,t.id===`${e}-tool`)}),eo(e),window.scrollTo({top:0,behavior:`smooth`})}document.querySelectorAll(`.tool-nav .tool-tab`).forEach(e=>{e.addEventListener(`click`,()=>to(e.getAttribute(`data-tool`)))}),document.addEventListener(`aimkit:navigate`,e=>to(e.detail)),eo(`crosshair`),document.querySelectorAll(`.converter-panel .tab`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-tab`);document.querySelectorAll(`.converter-panel .tab`).forEach(e=>{let n=e.getAttribute(`data-tab`)===t;e.classList.toggle(`active`,n),e.setAttribute(`aria-selected`,String(n))}),document.querySelectorAll(`.converter-panel .tab-panel`).forEach(e=>{e.classList.toggle(`active`,e.getAttribute(`data-panel`)===t)})})}),document.querySelector(`#decode-btn`)?.addEventListener(`click`,Ga),document.querySelector(`#encode-btn`)?.addEventListener(`click`,Ka),Sa.addEventListener(`keydown`,e=>{e.key===`Enter`&&Ga()}),wa.addEventListener(`input`,()=>{let e=wa.value.trim();if(!e){ya(null),ua.innerHTML=``;return}try{Ua(se(e))}catch{}}),Sa.addEventListener(`input`,()=>{let e=Wa(Sa.value);if(aa.test(e))try{Ua(d(e))}catch{}}),document.querySelector(`#copy-commands`)?.addEventListener(`click`,()=>{qa(Y,Ca.value,`commands`)}),document.querySelector(`#copy-code`)?.addEventListener(`click`,()=>{qa(Y,Ta.value,`share code`)}),document.querySelector(`#copy-sharecode-cmd`)?.addEventListener(`click`,()=>{let e=Wa(Sa.value);if(!e){Z(Y,`Enter a share code first.`,`error`);return}qa(Y,`cl_crosshair_sharecode "${e}"`,`import command`)}),document.querySelector(`#load-example-code`)?.addEventListener(`click`,()=>{Sa.value=Va,Ga()}),document.querySelector(`#load-example-cmd`)?.addEventListener(`click`,()=>{wa.value=Ha,Ka()});var no={0:[255,255,255],1:[50,250,50],2:[255,255,0],3:[50,50,250],4:[50,250,250]},Q={...ne},ro=document.querySelector(`#ed-style`),io=document.querySelector(`#ed-color`),ao=document.querySelector(`#ed-custom-color`),oo=document.querySelector(`#ed-custom-color-field`),so=document.querySelector(`#ed-r`),co=document.querySelector(`#ed-g`),lo=document.querySelector(`#ed-b`),uo=document.querySelector(`#ed-rgb-val`),fo=document.querySelector(`#ed-color-swatch`);function po(e,t){e&&document.activeElement!==e&&(e.value=String(t))}var mo=document.querySelector(`#ed-length`),ho=document.querySelector(`#ed-thickness`),go=document.querySelector(`#ed-gap`),_o=document.querySelector(`#ed-outline`),vo=document.querySelector(`#ed-alpha`),yo=document.querySelector(`#ed-dot`),bo=document.querySelector(`#ed-tstyle`),xo=document.querySelector(`#ed-outline-on`),So=document.querySelector(`#ed-alpha-on`),Co=document.querySelector(`#ed-sharecode`),wo=document.querySelector(`#ed-commands`),To=document.querySelector(`#ed-length-num`),Eo=document.querySelector(`#ed-thickness-num`),Do=document.querySelector(`#ed-gap-num`),Oo=document.querySelector(`#ed-outline-num`),ko=document.querySelector(`#ed-alpha-num`),Ao=document.querySelector(`#ed-r-num`),jo=document.querySelector(`#ed-g-num`),Mo=document.querySelector(`#ed-b-num`),No=(e,t,n)=>Math.max(t,Math.min(n,e)),Po=[{key:`length`,slider:mo,num:To,min:0,max:15},{key:`thickness`,slider:ho,num:Eo,min:0,max:6},{key:`gap`,slider:go,num:Do,min:-10,max:10},{key:`outline`,slider:_o,num:Oo,min:0,max:3},{key:`alpha`,slider:vo,num:ko,min:0,max:255}],Fo=[{key:`red`,slider:so,num:Ao},{key:`green`,slider:co,num:jo},{key:`blue`,slider:lo,num:Mo}];function Io(e,t,n){let r=e=>Math.max(0,Math.min(255,Math.round(e))).toString(16).padStart(2,`0`);return`#${r(e)}${r(t)}${r(n)}`}function Lo(e){let t=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(e.trim());return t?{r:parseInt(t[1],16),g:parseInt(t[2],16),b:parseInt(t[3],16)}:{r:Q.red,g:Q.green,b:Q.blue}}function Ro(){let e=Io(Q.red,Q.green,Q.blue);io.value=String(Q.color),po(ao,e);for(let e of Fo)po(e.slider,Q[e.key]),po(e.num,Q[e.key]);uo&&(uo.textContent=`${Q.red}, ${Q.green}, ${Q.blue}`),fo&&(fo.style.background=e),oo?.classList.toggle(`hidden`,Q.color!==5)}function zo(){for(let e of Po)po(e.slider,No(Q[e.key],e.min,e.max)),po(e.num,Q[e.key])}function Bo(){ro.value=String(Q.style),yo.checked=Q.centerDotEnabled,bo.checked=Q.tStyleEnabled,xo.checked=Q.outlineEnabled,So.checked=Q.alphaEnabled,zo(),Ro()}function Vo(){zo();let e=!Q.outlineEnabled;_o.disabled=e,Oo.disabled=e;let t=!Q.alphaEnabled;vo.disabled=t,ko.disabled=t;try{Co.value=f(Q)}catch{Co.value=``}wo.value=ce(ee(Q))}function Ho(){Ua(Q),Vo()}function Uo(){Q.style=Number(ro.value),Q.centerDotEnabled=yo.checked,Q.tStyleEnabled=bo.checked,Q.outlineEnabled=xo.checked,Q.alphaEnabled=So.checked,Ho()}function Wo(e){Q[e.key]=Number(e.slider.value),Ho()}function Go(e,t){let n=Number(e.num.value);if(e.num.value===``||!Number.isFinite(n)){t&&(e.num.value=String(Q[e.key]));return}Q[e.key]=No(n,e.min,e.max),t&&(e.num.value=String(Q[e.key])),Ho()}function Ko(){Q.color=5,Q.red=No(Number(Ao.value)||0,0,255),Q.green=No(Number(jo.value)||0,0,255),Q.blue=No(Number(Mo.value)||0,0,255),Ro(),Ho()}function qo(){if(Q.color=Number(io.value),Q.color!==5){let[e,t,n]=no[Q.color]??no[1];Q.red=e,Q.green=t,Q.blue=n}Ro(),Ho()}function Jo(){Q.color=5,Q.red=Number(so.value),Q.green=Number(co.value),Q.blue=Number(lo.value),Ro(),Ho()}function Yo(){Q.color=5;let{r:e,g:t,b:n}=Lo(ao.value);Q.red=e,Q.green=t,Q.blue=n,Ro(),Ho()}Po.forEach(e=>{e.slider.addEventListener(`input`,()=>Wo(e)),e.num.addEventListener(`input`,()=>Go(e,!1)),e.num.addEventListener(`change`,()=>Go(e,!0))}),[ro,yo,bo,xo,So].forEach(e=>e.addEventListener(`change`,Uo)),io.addEventListener(`change`,qo),ao.addEventListener(`input`,Yo),ao.addEventListener(`change`,Yo),Fo.forEach(e=>{e.slider.addEventListener(`input`,Jo),e.num.addEventListener(`input`,Ko),e.num.addEventListener(`change`,Ko)}),document.querySelector(`#ed-copy-code`)?.addEventListener(`click`,()=>{qa(Y,Co.value,`share code`)}),document.querySelector(`#ed-copy-commands`)?.addEventListener(`click`,()=>{qa(Y,wo.value,`commands`)}),document.querySelector(`#ed-reset`)?.addEventListener(`click`,()=>{Object.assign(Q,ne),Bo(),Ho(),Z(Y,`Crosshair reset to defaults.`,`ok`)}),document.querySelector(`.converter-panel .tab[data-tab="visual"]`)?.addEventListener(`click`,Ho),Bo(),Vo(),Ea.innerHTML=ia(`cs2`),X.innerHTML=ia(`valorant`),[Ea,X,Da,ka,Aa,ja,Ma,Na,Pa].forEach(e=>{e.addEventListener(`input`,Ya),e.addEventListener(`change`,Ya)}),document.querySelector(`#sens-swap`)?.addEventListener(`click`,Xa),document.querySelector(`#copy-sens`)?.addEventListener(`click`,()=>{qa(xa,Oa.value,`converted sensitivity`)}),document.querySelector(`#sens-cs2-val`)?.addEventListener(`click`,Za);var Xo=document.querySelector(`#psa-start`),Zo=document.querySelector(`#psa-begin`),Qo=document.querySelector(`#psa-round`),$o=document.querySelector(`#psa-round-num`),es=document.querySelector(`#psa-bar-fill`),ts=document.querySelector(`#psa-lower`),ns=document.querySelector(`#psa-higher`),rs=document.querySelector(`#psa-lower-val`),is=document.querySelector(`#psa-higher-val`),as=document.querySelector(`#psa-undo`),os=document.querySelector(`#psa-reset`),ss=document.querySelector(`#psa-result`),cs=document.querySelector(`#psa-result-label`),ls=document.querySelector(`#psa-stats`),us=document.querySelector(`#psa-history`),ds=document.querySelector(`#psa-status`),$=null;function fs(){if(!$){Qo?.classList.add(`hidden`),us?.classList.add(`hidden`),ss.textContent=`—`,cs.textContent=`recommended sensitivity`,ls.innerHTML=``;return}let e=fe($),t=e?_e($):pe($);if(ss.textContent=J(t,3),cs.textContent=e?`final recommended sensitivity`:`current estimate`,ls.innerHTML=`
  ...
  `,e)Qo?.classList.add(`hidden`),Z(ds,`Done — set your sensitivity to ${J(t,3)} and play a few sessions before changing again.`,`ok`);else{let{lower:e,higher:t}=de($);Qo?.classList.remove(`hidden`),$o.textContent=String($.round),es.style.width=`${($.round-1)/7*100}%`,rs.textContent=J(e,3),is.textContent=J(t,3),Z(ds,`Round ${$.round} of 7: test both values, then pick the side that feels better.`,``)}$.choices.length>0?(us?.classList.remove(`hidden`),us.innerHTML=`<strong>History:</strong><br />${$.choices.map(e=>`Round ${e.round}: chose <strong>${e.side}</strong> (${J(e.lower,3)} vs ${J(e.higher,3)})`).join(`<br />`)}`):(us?.classList.add(`hidden`),us.innerHTML=``)}function ps(){let e=Number(Xo.value);if(!Number.isFinite(e)||e<=0){Z(ds,`Enter a valid starting sensitivity greater than 0.`,`error`);return}$=ue(e),fs()}function ms(e){!$||fe($)||($=he($,e),fs())}Zo?.addEventListener(`click`,ps),ts?.addEventListener(`click`,()=>ms(`lower`)),ns?.addEventListener(`click`,()=>ms(`higher`)),as?.addEventListener(`click`,()=>{$&&($=ge($),fs())}),os?.addEventListener(`click`,()=>{$=null,fs(),Z(ds,`Enter a starting sensitivity and press Start PSA.`,``)}),da.innerHTML=ha.map(e=>`<option value="${e.id}">${e.label}</option>`).join(``),da.addEventListener(`change`,()=>ya(ga)),ya(null),Ga(),Za();function hs(e){return String(e||``).replaceAll(`&`,`&amp;`).replaceAll(`"`,`&quot;`)}function gs(e){let t=document.querySelector(`#donate-section`),n=document.querySelector(`#donate-actions`);if(!t||!n)return;let r=[];e.paypalUrl&&r.push(`<a class="btn donate-btn paypal" href="${hs(e.paypalUrl)}" target="_blank" rel="noopener noreferrer">${oa}<span>Donate via PayPal</span></a>`),e.steamTradeUrl&&r.push(`<a class="btn donate-btn steam" href="${hs(e.steamTradeUrl)}" target="_blank" rel="noopener noreferrer">${sa}<span>Donate Steam skins</span></a>`),n.innerHTML=r.join(``),t.classList.toggle(`hidden`,r.length===0);let i=document.querySelector(`#donate-fab`);if(i){let t=[];e.paypalUrl&&t.push(`<a class="donate-fab-btn paypal" href="${hs(e.paypalUrl)}" target="_blank" rel="noopener noreferrer" title="Donate via PayPal">${oa}<span>PayPal</span></a>`),e.steamTradeUrl&&t.push(`<a class="donate-fab-btn steam" href="${hs(e.steamTradeUrl)}" target="_blank" rel="noopener noreferrer" title="Donate Steam skins">${sa}<span>Steam</span></a>`),i.innerHTML=t.length?`<span class="donate-fab-label">Support AimKit</span>${t.join(``)}`:``,i.classList.toggle(`hidden`,t.length===0)}}async function _s(){try{gs(await g.settings.get())}catch{gs({paypalUrl:``,steamTradeUrl:``})}}document.addEventListener(`aimkit:settings-updated`,_s),document.querySelector(`#contact-open`)?.addEventListener(`click`,Ki),Ye();var vs=new URLSearchParams(window.location.search).get(`reset`);if(vs){Ge(vs);let e=new URL(window.location.href);e.searchParams.delete(`reset`),window.history.replaceState({},``,e)}var ys=new URLSearchParams(window.location.search);if(ys.get(`token`)){we(ys.get(`token`)),Me();let e=new URL(window.location.href);e.searchParams.delete(`token`),window.history.replaceState({},``,e)}else if(ys.get(`steam`)===`linked`){Me();let e=new URL(window.location.href);e.searchParams.delete(`steam`),window.history.replaceState({},``,e)}else if(ys.get(`steam_error`)){let e=new URL(window.location.href);e.searchParams.delete(`steam_error`),window.history.replaceState({},``,e)}Cn(),qn(),Pr(),ni(),xi(),ur(),Wi(),_s();