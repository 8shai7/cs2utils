...
`)}var le=.5;function ue(e){return{base:e,lo:e*(1-le),hi:e*1.5,round:1,choices:[]}}function de(e){let t=(e.lo+e.hi)/2;return{lower:(e.lo+t)/2,higher:(t+e.hi)/2,mid:t}}function fe(e){return e.round>7}function pe(e){return(e.lo+e.hi)/2}function me(e){let t=pe(e);return t<=0?0:(e.hi-e.lo)/t}function he(e,t){if(fe(e))return e;let n=(e.lo+e.hi)/2,{lower:r,higher:i}=de(e),a={round:e.round,side:t,lo:e.lo,hi:e.hi,lower:r,higher:i},o={...e,choices:[...e.choices,a],round:e.round+1};return t===`lower`?o.hi=n:o.lo=n,o}function ge(e){if(e.choices.length===0)return e;let t=e.choices.slice(0,-1),n=e.choices[e.choices.length-1];return{...e,lo:n.lo,hi:n.hi,round:n.round,choices:t}}function _e(e){return pe(e)}var ve=`https://cs2utils.vercel.app/api`,ye=`cs2utils.token`,be=/^https?:\/\//.test(ve)?new URL(ve).origin:``;function xe(){try{return localStorage.getItem(ye)}catch{return null}}function Se(e){try{e?localStorage.setItem(ye,e):localStorage.removeItem(ye)}catch{}}async function m(e,t,n,{auth:r=!1}={}){let i={};if(n!==void 0&&!(n instanceof FormData)&&(i[`Content-Type`]=`application/json`),r){let e=xe();if(!e)throw Error(`Please log in first.`);i.Authorization=`Bearer ${e}`,i[`X-AimKit-Token`]=`Bearer ${e}`}let a;try{a=await fetch(`${ve}${t}`,{method:e,headers:i,body:n instanceof FormData?n:n===void 0?void 0:JSON.stringify(n)})}catch{throw Error(`Cannot reach the server. Is the API running?`)}let o=null,s=await a.text();if(s)try{o=JSON.parse(s)}catch{o=null}if(!a.ok){let e=o&&o.error||`Request failed (${a.status}).`,t=o&&typeof o.detail==`string`?o.detail.trim():``,n=t&&t!==e?`${e} ${t}`:e,r=Error(n);throw r.status=a.status,r.data=o,r}return o}var Ce=`${ve}/auth/steam`;function we(e){Se(e)}function h(e){return!!e&&(e.role===`admin`||e.role===`owner`)}function Te(e){return!!e&&e.role===`owner`}function Ee(e){return e?/^https?:\/\//.test(e)||e.startsWith(`data:`)?e:be+e:``}var g={auth:{async register(e){let t=await m(`POST`,`/auth/register`,e);return Se(t.token),t.user},async login(e){let t=await m(`POST`,`/auth/login`,e);return Se(t.token),t.user},logout(){Se(null)},async captcha(){return m(`GET`,`/auth/captcha`)},async changePassword(e){return m(`POST`,`/auth/password`,e,{auth:!0})},async forgot(e){return m(`POST`,`/auth/forgot`,{email:e})},async reset(e,t){return m(`POST`,`/auth/reset`,{token:e,password:t})},async me(){if(!xe())return null;try{return(await m(`GET`,`/auth/me`,void 0,{auth:!0})).user}catch{return Se(null),null}},async profile(){return m(`GET`,`/auth/profile`,void 0,{auth:!0})},async setAvatar(e){return(await m(`POST`,`/auth/avatar`,{url:e},{auth:!0})).user},async uploadAvatar(e){let t=new FormData;return t.append(`file`,e),(await m(`POST`,`/auth/avatar/upload`,t,{auth:!0})).user},async changePassword(e){return m(`POST`,`/auth/password`,e,{auth:!0})},async changeUsername(e){let t=await m(`POST`,`/auth/username`,{username:e},{auth:!0});return t.token&&Se(t.token),t.user},async setCredentials(e){let t=await m(`POST`,`/auth/credentials`,e,{auth:!0});return t.token&&Se(t.token),t.user},async forgot(e){return m(`POST`,`/auth/forgot`,{email:e})},async reset(e,t){return m(`POST`,`/auth/reset`,{token:e,password:t})},steamLoginUrl(){return`${ve}/auth/steam`},async steamLinkUrl(){return(await m(`GET`,`/auth/steam/link-url`,void 0,{auth:!0})).url},async steamUnlink(){return(await m(`POST`,`/auth/steam/unlink`,{},{auth:!0})).user}},settings:{async get(){return m(`GET`,`/settings`)}},contact:{async send(e){return m(`POST`,`/contact`,e)}},pros:{async list({q:e=``,sort:t=`name`}={}){let n=new URLSearchParams;e&&n.set(`q`,e),t&&n.set(`sort`,t);let r=n.toString();return m(`GET`,`/pros${r?`?${r}`:``}`)}},configs:{async list({sort:e=`top`,q:t=``}={}){let n=new URLSearchParams;e&&n.set(`sort`,e),t&&n.set(`q`,t);let r=n.toString();return(await m(`GET`,`/configs${r?`?${r}`:``}`,void 0,{auth:!0})).configs},async create(e){return(await m(`POST`,`/configs`,e,{auth:!0})).config},async rate(e,t){return m(`POST`,`/configs/${e}/rate`,{rating:t},{auth:!0})},async remove(e){return m(`DELETE`,`/configs/${e}`,void 0,{auth:!0})}},highlights:{async list({q:e=``}={}){return(await m(`GET`,`/highlights${e?`?q=${encodeURIComponent(e)}`:``}`,void 0,{auth:!0})).highlights},async create(e){return(await m(`POST`,`/highlights`,e,{auth:!0})).highlight},async report(e,t){return m(`POST`,`/highlights/${e}/report`,{reason:t},{auth:!0})},async remove(e){return m(`DELETE`,`/highlights/${e}`,void 0,{auth:!0})}},nades:{async list({map:e=``,type:t=``}={}){let n=new URLSearchParams;e&&n.set(`map`,e),t&&n.set(`type`,t);let r=n.toString();return(await m(`GET`,`/nades${r?`?${r}`:``}`)).nades},async mine(){return(await m(`GET`,`/nades/mine`,void 0,{auth:!0})).nades},async favorites({map:e=``,type:t=``}={}){let n=new URLSearchParams;e&&n.set(`map`,e),t&&n.set(`type`,t);let r=n.toString();return(await m(`GET`,`/nades/favorites${r?`?${r}`:``}`,void 0,{auth:!0})).nades},async social(){return m(`GET`,`/nades/social`,void 0,{auth:!!xe()})},async favorite(e){return m(`POST`,`/nades/${e}/favorite`,{},{auth:!0})},async create(e){return(await m(`POST`,`/nades`,e,{auth:!0})).nade},async addMedia(e,t){return(await m(`POST`,`/nades/${e}/media`,t,{auth:!0})).media},async remove(e){return m(`DELETE`,`/nades/${e}`,void 0,{auth:!0})},async parseMapGuide(e){return m(`POST`,`/nades/map-guide/parse`,{text:e},{auth:!0})},async importMapGuide({text:e,nades:t,side:n,guideText:r,fileName:i}={}){return m(`POST`,`/nades/map-guide/import`,{text:e,nades:t,side:n,guideText:r,fileName:i},{auth:!0})},async practicePackFromText({text:e,map:t,importId:n}={}){return m(`POST`,`/nades/map-guide/practice-pack`,{text:e,map:t,importId:n},{auth:!0})},async practicePackFromImport(e){return m(`GET`,`/nades/map-guide/imports/${e}/practice-pack`,void 0,{auth:!!xe()})},async practicePackFromNades(e){return m(`POST`,`/nades/map-guide/practice-pack-from-nades`,{nadeIds:e},{auth:!!xe()})}},commands:{async catalog(){return m(`GET`,`/commands/catalog`)},async social(){return m(`GET`,`/commands/social`,void 0,{auth:!0})},async recommend(e){return m(`POST`,`/commands/${e}/recommend`,{},{auth:!0})},async addComment(e,t){return m(`POST`,`/commands/${e}/comments`,{body:t},{auth:!0})}},admin:{async pending(){return(await m(`GET`,`/admin/nades/pending`,void 0,{auth:!0})).nades},async pendingComments(){return(await m(`GET`,`/admin/comments/pending`,void 0,{auth:!0})).comments},async pendingCommentsCount(){return(await m(`GET`,`/admin/comments/pending/count`,void 0,{auth:!0})).count},async reviewComment(e,t){return m(`POST`,`/admin/comments/${e}/review`,{decision:t},{auth:!0})},async removeComment(e){return m(`DELETE`,`/admin/comments/${e}`,void 0,{auth:!0})},async syncCommands(){return m(`POST`,`/admin/commands/sync`,{},{auth:!0})},async checkCommandsCs2(){return m(`POST`,`/admin/commands/check-cs2`,{},{auth:!0})},async saveSettings(e){return m(`POST`,`/admin/settings`,e,{auth:!0})},async highlightReports(){return(await m(`GET`,`/admin/highlights/reports`,void 0,{auth:!0})).highlights},async highlightReportsCount(){return(await m(`GET`,`/admin/highlights/reports/count`,void 0,{auth:!0})).count},async reviewHighlight(e,t){return m(`POST`,`/admin/highlights/${e}/review`,{decision:t},{auth:!0})},async syncPros(){return m(`POST`,`/admin/pros/sync`,{},{auth:!0})},async importCommands(e){return m(`POST`,`/admin/commands/import`,{content:e},{auth:!0})},async importPros(e){return m(`POST`,`/admin/pros/import`,{content:e},{auth:!0})},async banUser(e,{hours:t,permanent:n}){return(await m(`POST`,`/admin/users/${e}/ban`,{hours:t,permanent:n},{auth:!0})).user},async unbanUser(e){return(await m(`POST`,`/admin/users/${e}/unban`,{},{auth:!0})).user},async pendingCount(){return(await m(`GET`,`/admin/nades/pending/count`,void 0,{auth:!0})).count},async reviewNade(e,t,n=``){return m(`POST`,`/admin/nades/${e}/review`,{decision:t,note:n},{auth:!0})},async reviewNadesBulk(e,t,n=``){return m(`POST`,`/admin/nades/review-bulk`,{ids:e,decision:t,note:n},{auth:!0})},async reviewMedia(e,t){return m(`POST`,`/admin/media/${e}/review`,{decision:t},{auth:!0})},async reviewMediaBulk(e,t){return m(`POST`,`/admin/media/review-bulk`,{ids:e,decision:t},{auth:!0})},async removeMedia(e){return m(`DELETE`,`/admin/media/${e}`,void 0,{auth:!0})},async users(){return(await m(`GET`,`/admin/users`,void 0,{auth:!0})).users},async setRole(e,t){return(await m(`POST`,`/admin/users/${e}/role`,{role:t},{auth:!0})).user},async contactMessages(){return(await m(`GET`,`/admin/contact`,void 0,{auth:!0})).messages},async removeContact(e){return m(`DELETE`,`/admin/contact/${e}`,void 0,{auth:!0})},async ownerLogs({limit:e=100,offset:t=0,action:n=``}={}){let r=new URLSearchParams;e&&r.set(`limit`,String(e)),t&&r.set(`offset`,String(t)),n&&r.set(`action`,n);let i=r.toString();return m(`GET`,`/admin/owner-logs${i?`?${i}`:``}`,void 0,{auth:!0})}},uploads:{async image(e){let t=new FormData;return t.append(`file`,e),await m(`POST`,`/uploads`,t,{auth:!0})}}},De=null,Oe=new Set;function ke(){for(let e of Oe)e(De)}function Ae(){return De}function je(e){return Oe.add(e),()=>Oe.delete(e)}async function Me(){return De=await g.auth.me(),ke(),De}async function Ne(e){return De=await g.auth.login(e),ke(),De}async function Pe(e){return De=await g.auth.register(e),ke(),De}function Fe(){g.auth.logout(),De=null,ke()}var Ie,_,Le=`login`,Re={required:!1,token:null,svg:``};function ze(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Be(){let e=Ae();e?(Ie.innerHTML=`
    ...
    <button type="button" class="app-toast-close" aria-label="Dismiss">&times;</button>`;let c=()=>{Tt(),s.classList.remove(`app-toast-in`),s.classList.add(`app-toast-out`),Ct=setTimeout(()=>{s.parentNode===o&&s.remove()},220)};s.querySelector(`.app-toast-close`)?.addEventListener(`click`,c),o.appendChild(s),requestAnimationFrame(()=>{requestAnimationFrame(()=>s.classList.add(`app-toast-in`))}),St=setTimeout(c,i)}var Dt=360,Ot=100,y,b=null,x=`browse`,kt={text:``,kind:``},At=0,jt=!1,Mt={map:``,type:``},Nt=[],S=new Map,Pt={counts:{},mine:[]},Ft=[],It=[],Lt=[],Rt=[],C=Bt(),w=Vt(),T=null,zt=1;function Bt(){return{map:`mirage`,type:`smoke`,side:`t`,technique:`stand`,title:``,description:``,start:null,end:null}}function Vt(){return{text:``,fileName:``,side:`t`,parsed:null,selected:null}}function E(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Ht(e){let t=Ee(e);return/^https?:\/\//.test(t)||t.startsWith(`data:image/`)?t:``}function Ut(e){let t=/(?:youtube\.com\/(?:watch\?v=|embed\/|shorts\/)|youtu\.be\/)([\w-]{6,})/.exec(e||``);return t?t[1]:null}function Wt(e,t){return e.map(e=>`<option value="${e.id}"${e.id===t?` selected`:``}>${E(e.name)}</option>`).join(``)}function D(e,t=``,n={}){kt={text:e,kind:t};let r=y?.querySelector(`#nades-status`);r&&(r.textContent=e,r.className=`status${t?` ${t}`:``}`),(t===`error`||t===`warn`)&&e&&Et(e,{kind:t,title:n.title})}function Gt(e){return`<span class="nade-badge ${e}">${e}</span>`}function Kt(e){try{return new Date(e).toLocaleDateString()}catch{return``}}async function qt(){if(h(b))try{At=await g.admin.pendingCount()}catch{At=0}else At=0}async function Jt(){try{Pt=await g.nades.social()}catch{Pt={counts:{},mine:[]}}}async function O(e){x=e,jt=![`add`,`import`].includes(e),jt&&k();try{x===`browse`&&(Nt=await g.nades.list(Mt),await Jt()),x===`favorites`&&(b?(Ft=await g.nades.favorites(Mt),await Jt()):Ft=[]),x===`mine`&&b&&(It=await g.nades.mine()),x===`review`&&h(b)&&(Lt=await g.admin.pending(),At=await g.admin.pendingCount()),x===`users`&&h(b)&&(Rt=await g.admin.users())}catch(e){D(e.message,`error`)}jt=!1,k()}function Yt(e){let t=Ht(e.url);if(!t)return``;if(e.kind===`video`){let n=Ut(e.url);return n?`<iframe class="nade-media-embed" src="https://www.youtube.com/embed/${E(n)}" title="nade video" allowfullscreen loading="lazy"></iframe>`:/\.(mp4|webm|mov)(\?|$)/i.test(e.url)?`<video class="nade-media-embed" src="${E(t)}" controls preload="none"></video>`:`<a class="btn ghost" href="${E(t)}" target="_blank" rel="noopener noreferrer">Open video ↗</a>`}return`<a href="${E(t)}" target="_blank" rel="noopener noreferrer"><img class="nade-media-img" src="${E(t)}" alt="${E(e.addedByName||`nade media`)}" loading="lazy" /></a>`}function Xt(e,{showStatus:t=!1,showTryInGame:n=!1,adminRemove:r=!1,showFavorite:i=!1}={}){let a=et(e.type),o=(e.media||[]).filter(e=>t?!0:e.status===`approved`),s=o.length?`<div class="nade-media">${o.map(e=>`<div class="nade-media-item">${Yt(e)}${t?`<div class="nade-media-meta">${Gt(e.status)} <span>by ${E(e.addedByName||``)}</span></div>`:``}</div>`).join(``)}</div>`:`<p class="hint">No approved media yet — a 2D throw preview is shown above.</p>`,c=n&&S.has(e.id),l=Pt.mine.includes(e.id),u=Pt.counts[e.id]||0,d=i?`<button class="btn btn-sm favorite ${l?`active`:``}" type="button" data-favorite-nade="${e.id}" title="${l?`Remove from favorites`:`Add to favorites`}">${l?`★ Favorited`:`☆ Favorite`}${u?` <span class="fav-count">${u}</span>`:``}</button>`:``,f=n?`<div class="nade-card-actions">
         ...
         ${r&&h(b)?`<button class="btn ghost danger" type="button" data-delete-nade="${e.id}">Remove</button>`:``}
       </div>`:d||r&&h(b)?`<div class="nade-card-actions">
           ${d}
           ${r&&h(b)?`<button class="btn ghost danger" type="button" data-delete-nade="${e.id}">Remove</button>`:``}
         </div>`:``;return`
    ...
    <div class="nade-import">
      ...
      </div>`).join(``)}</div>`:`<p class="hint">You haven't added any nades yet.</p>`:en(`see and manage your nades`)}function an(){return h(b)?Lt.length?`
    ...
    <div class="nade-grid">${Lt.map(e=>{let t=e.media||[],n=t.length?`<div class="review-media">${t.map(e=>`<div class="review-media-item">${Yt(e)}
                 ...
                 <input type="text" class="review-note" data-nade="${e.id}" placeholder="Optional note to the author" />
               </div>`;return`<div class="nade-mine">${Xt(e,{showStatus:!0})}${n}${r}</div>`}).join(``)}</div>`:`<p class="hint">Nothing pending review. Nice and clean.</p>`:`<p class="hint">Admins only.</p>`}function on(e){if(!e.bannedUntil)return null;let t=new Date(e.bannedUntil);return t.getTime()<=Date.now()?null:t.getFullYear()>=9999?`permanently`:`until ${t.toLocaleString()}`}function sn(){if(!h(b))return`<p class="hint">Admins only.</p>`;let e=Te(b);return`<div class="users-table">
  ...
  </div>`}function cn(){let e=Pt.mine?.length||0,t=[[`browse`,`Browse`]];return b&&(t.push([`favorites`,`Favorites${e?` (${e})`:``}`]),t.push([`add`,`Add nade`],[`import`,`Import guide`],[`mine`,`My nades`])),h(b)&&t.push([`review`,`Review${At?` (${At})`:``}`],[`users`,`Users`]),`<nav class="nades-subnav">${t.map(([e,t])=>`<button class="tool-tab ${x===e?`active`:``}" data-view="${e}">${E(t)}</button>`).join(``)}</nav>`}function ln(){if(jt)return`<div class="nades-loading"><span class="spinner"></span> Loading…</div>`;switch(x){case`add`:return tn();case`import`:return nn();case`favorites`:return $t();case`mine`:return rn();case`review`:return an();case`users`:return sn();default:return Qt()}}function k(){y.innerHTML=`
    ...
    </section>`:``}function Xn(){let e=j.commands.filter(e=>e.isNew).length,t=h(Bn)?`<div class="actions">
    ...
    <section class="cmd-status-bar">
      ...
      ${t}
    </section>`}function Zn(){return!h(Bn)||!Hn.length?``:`
    ...
    </div>`,er()}function $n(e){let t=e.trim().toLowerCase();A.querySelectorAll(`.cmd-category`).forEach(e=>{let n=0;e.querySelectorAll(`.cmd-card`).forEach(e=>{let r=!t||e.dataset.search.includes(t);e.classList.toggle(`hidden`,!r),r&&(n+=1)}),e.classList.toggle(`hidden`,n===0)})}function er(){A.querySelectorAll(`[data-copy]`).forEach(e=>e.addEventListener(`click`,async()=>{try{await navigator.clipboard.writeText(e.dataset.copy),N(`Copied to clipboard.`,`ok`)}catch{N(`Clipboard blocked — select and copy manually.`,`error`)}})),A.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>v(e.dataset.openAuth))),A.querySelectorAll(`[data-recommend]`).forEach(e=>e.addEventListener(`click`,()=>tr(e.dataset.recommend))),A.querySelectorAll(`[data-toggle-comments]`).forEach(e=>e.addEventListener(`click`,()=>{let t=e.dataset.toggleComments;Wn.has(t)?Wn.delete(t):Wn.add(t),Qn()})),A.querySelectorAll(`.cmd-comment-form`).forEach(e=>e.addEventListener(`submit`,t=>{t.preventDefault(),nr(e.dataset.commentKey,e.querySelector(`input`))})),A.querySelectorAll(`[data-approve-comment]`).forEach(e=>e.addEventListener(`click`,()=>rr(e.dataset.approveComment,`approved`))),A.querySelectorAll(`[data-reject-comment]`).forEach(e=>e.addEventListener(`click`,()=>rr(e.dataset.rejectComment,`rejected`))),A.querySelectorAll(`[data-remove-comment]`).forEach(e=>e.addEventListener(`click`,()=>ir(e.dataset.removeComment))),A.querySelector(`#cmd-search`)?.addEventListener(`input`,e=>$n(e.target.value)),A.querySelector(`#cmd-sync`)?.addEventListener(`click`,ar),A.querySelector(`#cmd-check-cs2`)?.addEventListener(`click`,or)}async function tr(e){if(!Bn){v(`login`);return}try{let t=await g.commands.recommend(e);Vn.counts[e]=t.count,Vn.mine=t.recommended?[...Vn.mine.filter(t=>t!==e),e]:Vn.mine.filter(t=>t!==e),Qn()}catch(e){N(e.message,`error`)}}async function nr(e,t){let n=(t?.value||``).trim();if(!n){N(`Write something first.`,`error`);return}try{await g.commands.addComment(e,n),N(`Comment submitted — an admin will review it before it appears.`,`ok`),t&&(t.value=``)}catch(e){N(e.message,`error`)}}async function rr(e,t){try{await g.admin.reviewComment(e,t),await Kn(),Qn(),N(`Comment ${t}.`,`ok`)}catch(e){N(e.message,`error`)}}async function ir(e){if(confirm(`Permanently delete this comment?`))try{await g.admin.removeComment(e),await Kn(),Qn(),N(`Comment deleted.`,`ok`)}catch(e){N(e.message,`error`)}}function ar(){zn({title:`Sync commands from the CS2 wiki`,description:`The Valve wiki has a bot check that blocks servers. Open it in your browser, complete the verification, then copy the page source (wikitext) and paste it here — the server will parse it.`,sourceUrl:`https://developer.valvesoftware.com/w/index.php?title=List_of_Counter-Strike_2_console_command_variables&action=raw`,sourceLabel:`Open CS2 wiki source`,placeholder:`Paste the wiki page source (wikitext), or a JSON list of commands…`,onImport:async e=>{let t=await g.admin.importCommands(e);return await Kn(),Qn(),`Imported ${t.count} commands.`}})}async function or(){N(`Checking the current CS2 build…`,``);try{let e=await g.admin.checkCommandsCs2();await Kn(),Qn(),N(e.ok?`CS2 build ${e.build}${e.changed?` — changed, catalog re-synced`:` — no change`}.`:`Check failed: ${e.reason}`,e.ok?`ok`:`error`)}catch(e){N(e.message,`error`)}}async function sr(){A=document.querySelector(`#commands-tool`),A&&(Bn=Ae(),je(async e=>{Bn=e,await Kn(),Qn()}),Qn(),await Kn(),Qn())}var P,F=null,cr=null,lr={paypalUrl:``,steamTradeUrl:``},ur={text:``,kind:``};function I(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function L(e,t=``){ur={text:e,kind:t};let n=P?.querySelector(`#profile-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function dr(e){try{return new Date(e).toLocaleDateString()}catch{return`—`}}async function fr(){if(F){try{cr=(await g.auth.profile()).stats}catch(e){L(e.message,`error`)}if(Te(F))try{lr=await g.settings.get()}catch{}}}function pr(e,t){return`<div class="profile-stat"><dt>${I(e)}</dt><dd>${I(t)}</dd></div>`}function mr(){return Te(F)?`
    ...
    </div></div>`,P.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>v(e.dataset.openAuth)));return}let e=(F.username||`?`).charAt(0).toUpperCase(),t=cr||{nadesTotal:0,nadesApproved:0,nadesPending:0,recommendations:0,comments:0,nadeFavorites:0};P.innerHTML=`
    <div class="profile-shell">
      <section class="panel profile-card">
        <div class="profile-head">
          <div class="profile-avatar">${F.avatarUrl?`<img src="${I(Ee(F.avatarUrl))}" alt="${I(F.username)}" />`:I(e)}</div>
          <div>
    ...
    </div>`,P.querySelector(`#set-save`)?.addEventListener(`click`,Cr),P.querySelector(`#pw-save`)?.addEventListener(`click`,_r),P.querySelector(`#username-save`)?.addEventListener(`click`,yr),P.querySelector(`#cred-save`)?.addEventListener(`click`,br),P.querySelector(`#steam-link`)?.addEventListener(`click`,xr),P.querySelector(`#steam-unlink`)?.addEventListener(`click`,Sr);let n=P.querySelector(`#avatar-file`);P.querySelector(`#avatar-upload`)?.addEventListener(`click`,()=>n?.click()),n?.addEventListener(`change`,e=>gr(e.target.files?.[0])),P.querySelector(`#avatar-remove`)?.addEventListener(`click`,vr)}async function gr(e){if(e){L(`Uploading image…`,``);try{await g.auth.uploadAvatar(e),await Me(),L(`Profile image updated.`,`ok`)}catch(e){L(e.message,`error`)}}}async function _r(){let e=P.querySelector(`#pw-current`)?.value||``,t=P.querySelector(`#pw-new`)?.value||``;try{await g.auth.changePassword({currentPassword:e,newPassword:t}),P.querySelector(`#pw-current`).value=``,P.querySelector(`#pw-new`).value=``,L(`Password updated.`,`ok`)}catch(e){L(e.message,`error`)}}async function vr(){try{await g.auth.setAvatar(``),await Me(),L(`Profile image removed.`,`ok`)}catch(e){L(e.message,`error`)}}async function yr(){let e=P.querySelector(`#acc-username`)?.value||``;try{await g.auth.changeUsername(e),await Me(),L(`Username updated.`,`ok`)}catch(e){L(e.message,`error`)}}async function br(){let e=P.querySelector(`#cred-email`)?.value||``,t=P.querySelector(`#cred-password`)?.value||``;try{await g.auth.setCredentials({email:e,password:t}),await Me(),L(`Email & password saved — you can now log in without Steam.`,`ok`)}catch(e){L(e.message,`error`)}}async function xr(){try{let e=await g.auth.steamLinkUrl();window.location.href=e}catch(e){L(e.message,`error`)}}async function Sr(){try{await g.auth.steamUnlink(),await Me(),L(`Steam unlinked.`,`ok`)}catch(e){L(e.message,`error`)}}async function Cr(){let e=P.querySelector(`#set-paypal`)?.value||``,t=P.querySelector(`#set-steam`)?.value||``;try{lr=await g.admin.saveSettings({paypalUrl:e,steamTradeUrl:t}),L(`Donate links saved.`,`ok`),document.dispatchEvent(new CustomEvent(`aimkit:settings-updated`))}catch(e){L(e.message,`error`)}}async function wr(){P=document.querySelector(`#profile-tool`),P&&(F=Ae(),je(async e=>{F=e,await fr(),hr()}),hr(),await fr(),hr())}var R,Tr=null,Er=[],Dr=`top`,Or=!1,kr={text:``,kind:``},Ar=new Set;function jr(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Mr(e,t=``){kr={text:e,kind:t};let n=R?.querySelector(`#configs-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function Nr(e){try{return new Date(e).toLocaleDateString()}catch{return``}}function Pr(e,t){let n=new Blob([t],{type:`text/plain`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=e,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r)}async function Fr(){try{Er=await g.configs.list({sort:Dr})}catch(e){Mr(e.message,`error`)}Br()}function Ir(e){let t=Math.round(e),n=``;for(let e=1;e<=5;e+=1)n+=e<=t?`★`:`☆`;return n}function Lr(e){if(!Tr)return`<button class="btn btn-sm" data-open-auth="login">Log in to rate</button>`;if(e.authorId===Tr.id)return`<span class="hint">Your upload</span>`;let t=``;for(let n=1;n<=5;n+=1)t+=`<button class="star-btn ${n<=e.myRating?`on`:``}" data-rate="${e.id}" data-star="${n}" title="${n} star${n>1?`s`:``}">${n<=e.myRating?`★`:`☆`}</button>`;return`<span class="rate-label">Your rating:</span><span class="star-picker">${t}</span>`}function Rr(e){let t=Ar.has(e.id),n=Tr&&(e.authorId===Tr.id||h(Tr));return`
    ...
    </section>`}function ci(e){let t=Yr&&(e.authorId===Yr.id||h(Yr));return`
    ...
    </article>`}function ji(){let e=h(vi)&&xe()?`<div class="pros-admin-actions">
    ...
    </div>`,Mi()}function Mi(){V.querySelectorAll(`[data-sort]`).forEach(e=>e.addEventListener(`click`,()=>{yi=e.dataset.sort,wi()}));let e=V.querySelector(`#pros-search`);e&&e.addEventListener(`input`,e=>{bi=e.target.value,clearTimeout(xi),xi=setTimeout(async()=>{await wi();let e=V.querySelector(`#pros-search`);e&&(e.focus(),e.setSelectionRange(e.value.length,e.value.length))},300)}),V.querySelector(`#pros-sync`)?.addEventListener(`click`,Ni),V.querySelector(`#pros-import`)?.addEventListener(`click`,Pi)}async function Ni(){let e=V.querySelector(`#pros-sync`);if(e&&(e.disabled=!0),!xe()){Ci(`Please log in as an admin to sync.`,`error`),v(`login`),e&&(e.disabled=!1);return}Ci(`Syncing from prosettings.net…`,``);try{let e=await g.admin.syncPros();await wi(),e.synced?Ci(`Synced ${e.count} players from ${e.source}.`,`ok`):Ci(`Sync failed: ${e.reason||`unknown error`}. Kept the current list.`,`error`)}catch(e){e.status===401?(Ci(`Please log in as an admin to sync.`,`error`),v(`login`)):Ci(e.message,`error`)}finally{let e=V.querySelector(`#pros-sync`);e&&(e.disabled=!1)}}function Pi(){zn({title:`Import pro settings from HLTV`,description:`HLTV has a Cloudflare check that blocks servers. Open HLTV in your browser, complete the verification, then paste a JSON list of players here. Each item: {"player","team","dpi","sens","zoomSens","hz","resolution","aspectRatio","photo","teamLogo"}.`,sourceUrl:`https://www.hltv.org/stats/players`,sourceLabel:`Open HLTV`,placeholder:`[{"player":"s1mple","team":"Natus Vincere","dpi":400,"sens":3.09,"hz":1000,"resolution":"1280x960","aspectRatio":"4:3"}]`,onImport:async e=>{let t=await g.admin.importPros(e);return await wi(),`Imported ${t.count} players.`}})}async function Fi(){V=document.querySelector(`#pros-tool`),V&&(vi=Ae(),je(e=>{vi=e,ji()}),ji(),await wi())}var W,G=null,Ii=`overview`,Li={text:``,kind:``},Ri={nades:0,comments:0,reports:0},K={},zi=[{id:`overview`,label:`Overview`},{id:`nades`,label:`Nades`},{id:`comments`,label:`Comments`},{id:`reports`,label:`Reports`},{id:`users`,label:`Users`},{id:`sync`,label:`Data sync`},{id:`contact`,label:`Contact`},{id:`logs`,label:`Logs`,ownerOnly:!0},{id:`settings`,label:`Site settings`,ownerOnly:!0}];function q(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Bi(e,t=``){Li={text:e,kind:t};let n=W?.querySelector(`#admin-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function Vi(e){try{return new Date(e).toLocaleString()}catch{return`—`}}async function Hi(){try{let[e,t,n]=await Promise.all([g.admin.pendingCount().catch(()=>0),g.admin.pendingCommentsCount().catch(()=>0),g.admin.highlightReportsCount().catch(()=>0)]);Ri={nades:e,comments:t,reports:n}}catch{}}function Ui(){let e=(e,t,n)=>`<button class="admin-stat" data-goto="${n}">
    ...
    <div class="admin-logs">${i}</div>`}var Qi={overview:Ui,nades:Wi,comments:Gi,reports:Ki,users:qi,sync:Ji,contact:Yi,logs:Zi,settings:Xi};async function $i(e){try{e===`overview`?await Hi():e===`nades`?K.nades=await g.admin.pending():e===`comments`?K.comments=await g.admin.pendingComments():e===`reports`?K.reports=await g.admin.highlightReports():e===`users`?K.users=await g.admin.users():e===`contact`?K.contact=await g.admin.contactMessages():e===`logs`?K.logs=await g.admin.ownerLogs({action:K.logsFilter||``}):e===`settings`&&(K.settings=await g.settings.get())}catch(e){Bi(e.message,`error`)}}function ea(){if(!W)return;if(!h(G)){W.innerHTML=`<div class="admin-shell"><div class="login-prompt">
    ...
    </div></div>`,W.querySelector(`[data-open-auth]`)?.addEventListener(`click`,()=>v(`login`));return}(Ii===`logs`||Ii===`settings`)&&!Te(G)&&(Ii=`overview`);let e=zi.filter(e=>!e.ownerOnly||Te(G)).map(e=>`<button class="tool-tab ${Ii===e.id?`active`:``}" data-section="${e.id}">${q(e.label)}${e.id===`nades`&&Ri.nades?` (${Ri.nades})`:``}${e.id===`comments`&&Ri.comments?` (${Ri.comments})`:``}${e.id===`reports`&&Ri.reports?` (${Ri.reports})`:``}</button>`).join(``),t=(Qi[Ii]||Ui)();W.innerHTML=`
