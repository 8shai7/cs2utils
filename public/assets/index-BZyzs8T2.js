...
`)}var ce=.5;function le(e){return{base:e,lo:e*(1-ce),hi:e*1.5,round:1,choices:[]}}function ue(e){return{lower:e.lo,higher:e.hi,mid:(e.lo+e.hi)/2}}function de(e){return e.round>7}function fe(e){return(e.lo+e.hi)/2}function pe(e){let t=fe(e);return t<=0?0:(e.hi-e.lo)/t}function me(e,t){if(de(e))return e;let n=(e.lo+e.hi)/2,r={round:e.round,side:t,lo:e.lo,hi:e.hi,lower:e.lo,higher:e.hi},i={...e,choices:[...e.choices,r],round:e.round+1};return t===`lower`?i.hi=n:i.lo=n,i}function he(e){if(e.choices.length===0)return e;let t=e.choices.slice(0,-1),n=e.choices[e.choices.length-1];return{...e,lo:n.lo,hi:n.hi,round:n.round,choices:t}}function ge(e){return fe(e)}var _e=`/api`,ve=`cs2utils.token`,ye=/^https?:\/\//.test(_e)?new URL(_e).origin:``;function be(){try{return localStorage.getItem(ve)}catch{return null}}function xe(e){try{e?localStorage.setItem(ve,e):localStorage.removeItem(ve)}catch{}}async function h(e,t,n,{auth:r=!1}={}){let i={};if(n!==void 0&&!(n instanceof FormData)&&(i[`Content-Type`]=`application/json`),r){let e=be();e&&(i.Authorization=`Bearer ${e}`)}let a;try{a=await fetch(`${_e}${t}`,{method:e,headers:i,body:n instanceof FormData?n:n===void 0?void 0:JSON.stringify(n)})}catch{throw Error(`Cannot reach the server. Is the API running?`)}let o=null,s=await a.text();if(s)try{o=JSON.parse(s)}catch{o=null}if(!a.ok){let e=Error(o&&o.error||`Request failed (${a.status}).`);throw e.status=a.status,e.data=o,e}return o}var Se=`${_e}/auth/steam`;function Ce(e){xe(e)}function g(e){return!!e&&(e.role===`admin`||e.role===`owner`)}function we(e){return!!e&&e.role===`owner`}function Te(e){return e?/^https?:\/\//.test(e)||e.startsWith(`data:`)?e:ye+e:``}var _={auth:{async register(e){let t=await h(`POST`,`/auth/register`,e);return xe(t.token),t.user},async login(e){let t=await h(`POST`,`/auth/login`,e);return xe(t.token),t.user},logout(){xe(null)},async captcha(){return h(`GET`,`/auth/captcha`)},async changePassword(e){return h(`POST`,`/auth/password`,e,{auth:!0})},async forgot(e){return h(`POST`,`/auth/forgot`,{email:e})},async reset(e,t){return h(`POST`,`/auth/reset`,{token:e,password:t})},async me(){if(!be())return null;try{return(await h(`GET`,`/auth/me`,void 0,{auth:!0})).user}catch{return xe(null),null}},async profile(){return h(`GET`,`/auth/profile`,void 0,{auth:!0})},async setAvatar(e){return(await h(`POST`,`/auth/avatar`,{url:e},{auth:!0})).user},async uploadAvatar(e){let t=new FormData;return t.append(`file`,e),(await h(`POST`,`/auth/avatar/upload`,t,{auth:!0})).user},async changePassword(e){return h(`POST`,`/auth/password`,e,{auth:!0})},async changeUsername(e){let t=await h(`POST`,`/auth/username`,{username:e},{auth:!0});return t.token&&xe(t.token),t.user},async setCredentials(e){let t=await h(`POST`,`/auth/credentials`,e,{auth:!0});return t.token&&xe(t.token),t.user},async forgot(e){return h(`POST`,`/auth/forgot`,{email:e})},async reset(e,t){return h(`POST`,`/auth/reset`,{token:e,password:t})},steamLoginUrl(){return`${_e}/auth/steam`},async steamLinkUrl(){return(await h(`GET`,`/auth/steam/link-url`,void 0,{auth:!0})).url},async steamUnlink(){return(await h(`POST`,`/auth/steam/unlink`,{},{auth:!0})).user}},settings:{async get(){return h(`GET`,`/settings`)}},contact:{async send(e){return h(`POST`,`/contact`,e)}},pros:{async list({q:e=``,sort:t=`name`}={}){let n=new URLSearchParams;e&&n.set(`q`,e),t&&n.set(`sort`,t);let r=n.toString();return h(`GET`,`/pros${r?`?${r}`:``}`)}},configs:{async list({sort:e=`top`,q:t=``}={}){let n=new URLSearchParams;e&&n.set(`sort`,e),t&&n.set(`q`,t);let r=n.toString();return(await h(`GET`,`/configs${r?`?${r}`:``}`,void 0,{auth:!0})).configs},async create(e){return(await h(`POST`,`/configs`,e,{auth:!0})).config},async rate(e,t){return h(`POST`,`/configs/${e}/rate`,{rating:t},{auth:!0})},async remove(e){return h(`DELETE`,`/configs/${e}`,void 0,{auth:!0})}},highlights:{async list({q:e=``}={}){return(await h(`GET`,`/highlights${e?`?q=${encodeURIComponent(e)}`:``}`,void 0,{auth:!0})).highlights},async create(e){return(await h(`POST`,`/highlights`,e,{auth:!0})).highlight},async report(e,t){return h(`POST`,`/highlights/${e}/report`,{reason:t},{auth:!0})},async remove(e){return h(`DELETE`,`/highlights/${e}`,void 0,{auth:!0})}},nades:{async list({map:e=``,type:t=``}={}){let n=new URLSearchParams;e&&n.set(`map`,e),t&&n.set(`type`,t);let r=n.toString();return(await h(`GET`,`/nades${r?`?${r}`:``}`)).nades},async mine(){return(await h(`GET`,`/nades/mine`,void 0,{auth:!0})).nades},async create(e){return(await h(`POST`,`/nades`,e,{auth:!0})).nade},async addMedia(e,t){return(await h(`POST`,`/nades/${e}/media`,t,{auth:!0})).media},async remove(e){return h(`DELETE`,`/nades/${e}`,void 0,{auth:!0})},async parseMapGuide(e){return h(`POST`,`/nades/map-guide/parse`,{text:e},{auth:!0})},async importMapGuide({text:e,nades:t,side:n,guideText:r,fileName:i}={}){return h(`POST`,`/nades/map-guide/import`,{text:e,nades:t,side:n,guideText:r,fileName:i},{auth:!0})},async practicePackFromText({text:e,map:t,importId:n}={}){return h(`POST`,`/nades/map-guide/practice-pack`,{text:e,map:t,importId:n},{auth:!0})},async practicePackFromImport(e){return h(`GET`,`/nades/map-guide/imports/${e}/practice-pack`,void 0,{auth:!!be()})},async practicePackFromNades(e){return h(`POST`,`/nades/map-guide/practice-pack-from-nades`,{nadeIds:e},{auth:!!be()})}},commands:{async catalog(){return h(`GET`,`/commands/catalog`)},async social(){return h(`GET`,`/commands/social`,void 0,{auth:!0})},async recommend(e){return h(`POST`,`/commands/${e}/recommend`,{},{auth:!0})},async addComment(e,t){return h(`POST`,`/commands/${e}/comments`,{body:t},{auth:!0})}},admin:{async pending(){return(await h(`GET`,`/admin/nades/pending`,void 0,{auth:!0})).nades},async pendingComments(){return(await h(`GET`,`/admin/comments/pending`,void 0,{auth:!0})).comments},async pendingCommentsCount(){return(await h(`GET`,`/admin/comments/pending/count`,void 0,{auth:!0})).count},async reviewComment(e,t){return h(`POST`,`/admin/comments/${e}/review`,{decision:t},{auth:!0})},async syncCommands(){return h(`POST`,`/admin/commands/sync`,{},{auth:!0})},async checkCommandsCs2(){return h(`POST`,`/admin/commands/check-cs2`,{},{auth:!0})},async saveSettings(e){return h(`POST`,`/admin/settings`,e,{auth:!0})},async highlightReports(){return(await h(`GET`,`/admin/highlights/reports`,void 0,{auth:!0})).highlights},async highlightReportsCount(){return(await h(`GET`,`/admin/highlights/reports/count`,void 0,{auth:!0})).count},async reviewHighlight(e,t){return h(`POST`,`/admin/highlights/${e}/review`,{decision:t},{auth:!0})},async syncPros(){return h(`POST`,`/admin/pros/sync`,{},{auth:!0})},async importCommands(e){return h(`POST`,`/admin/commands/import`,{content:e},{auth:!0})},async importPros(e){return h(`POST`,`/admin/pros/import`,{content:e},{auth:!0})},async banUser(e,{hours:t,permanent:n}){return(await h(`POST`,`/admin/users/${e}/ban`,{hours:t,permanent:n},{auth:!0})).user},async unbanUser(e){return(await h(`POST`,`/admin/users/${e}/unban`,{},{auth:!0})).user},async pendingCount(){return(await h(`GET`,`/admin/nades/pending/count`,void 0,{auth:!0})).count},async reviewNade(e,t,n=``){return h(`POST`,`/admin/nades/${e}/review`,{decision:t,note:n},{auth:!0})},async reviewNadesBulk(e,t,n=``){return h(`POST`,`/admin/nades/review-bulk`,{ids:e,decision:t,note:n},{auth:!0})},async reviewMedia(e,t){return h(`POST`,`/admin/media/${e}/review`,{decision:t},{auth:!0})},async reviewMediaBulk(e,t){return h(`POST`,`/admin/media/review-bulk`,{ids:e,decision:t},{auth:!0})},async users(){return(await h(`GET`,`/admin/users`,void 0,{auth:!0})).users},async setRole(e,t){return(await h(`POST`,`/admin/users/${e}/role`,{role:t},{auth:!0})).user},async contactMessages(){return(await h(`GET`,`/admin/contact`,void 0,{auth:!0})).messages}},uploads:{async image(e){let t=new FormData;return t.append(`file`,e),await h(`POST`,`/uploads`,t,{auth:!0})}}},Ee=null,De=new Set;function Oe(){for(let e of De)e(Ee)}function ke(){return Ee}function Ae(e){return De.add(e),()=>De.delete(e)}async function je(){return Ee=await _.auth.me(),Oe(),Ee}async function Me(e){return Ee=await _.auth.login(e),Oe(),Ee}async function Ne(e){return Ee=await _.auth.register(e),Oe(),Ee}function Pe(){_.auth.logout(),Ee=null,Oe()}var Fe,v,Ie=`login`,Le={required:!1,token:null,svg:``};function Re(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function ze(){let e=ke();e?(Fe.innerHTML=`
    ...
    <div class="try-game-modal" role="dialog" aria-modal="true" aria-label="Try in game">
      <div class="try-game-card">
        ...
        <ol class="nade-steps try-game-steps">
          <li>Move <code>${t(e.loadName)}.txt</code> to<br />
            <code>…/Counter-Strike Global Offensive/game/csgo/annotations/local/${t(e.loadName)}/${t(e.loadName)}.txt</code>
            <br /><span class="hint">(create the <code>${t(e.loadName)}</code> folder if needed)</span>
          </li>
          <li>Move <code>${t(e.cfgBaseName)}.cfg</code> to<br />
            <code>…/game/csgo/cfg/${t(e.cfgBaseName)}.cfg</code>
          </li>
          <li>Click <strong>Download &amp; open CS2</strong> — Steam loads a private <code>${t(e.deMap)}</code> server and runs <code>annotation_load ${t(e.loadName)}</code>.</li>
        </ol>
        <div class="actions">
    ...
    </div>`:``}var vt=360,y,b=null,x=`browse`,yt={text:``,kind:``},bt=0,xt=!1,St={map:``,type:``},Ct=[],wt=[],Tt=[],Et=[],S=Dt(),C=Ot(),w=null;function Dt(){return{map:`mirage`,type:`smoke`,side:`t`,technique:`stand`,title:``,description:``,start:null,end:null}}function Ot(){return{text:``,fileName:``,side:`t`,parsed:null,selected:null}}function T(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function kt(e){let t=Te(e);return/^https?:\/\//.test(t)||t.startsWith(`data:image/`)?t:``}function At(e){let t=/(?:youtube\.com\/(?:watch\?v=|embed\/|shorts\/)|youtu\.be\/)([\w-]{6,})/.exec(e||``);return t?t[1]:null}function jt(e,t){return e.map(e=>`<option value="${e.id}"${e.id===t?` selected`:``}>${T(e.name)}</option>`).join(``)}function E(e,t=``){yt={text:e,kind:t};let n=y?.querySelector(`#nades-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function Mt(e){return`<span class="nade-badge ${e}">${e}</span>`}function Nt(e){try{return new Date(e).toLocaleDateString()}catch{return``}}async function Pt(){if(g(b))try{bt=await _.admin.pendingCount()}catch{bt=0}else bt=0}async function D(e){x=e,xt=![`add`,`import`].includes(e),xt&&O();try{x===`browse`&&(Ct=await _.nades.list(St)),x===`mine`&&b&&(wt=await _.nades.mine()),x===`review`&&g(b)&&(Tt=await _.admin.pending(),bt=await _.admin.pendingCount()),x===`users`&&g(b)&&(Et=await _.admin.users())}catch(e){E(e.message,`error`)}xt=!1,O()}function Ft(e){let t=kt(e.url);if(!t)return``;if(e.kind===`video`){let n=At(e.url);return n?`<iframe class="nade-media-embed" src="https://www.youtube.com/embed/${T(n)}" title="nade video" allowfullscreen loading="lazy"></iframe>`:/\.(mp4|webm|mov)(\?|$)/i.test(e.url)?`<video class="nade-media-embed" src="${T(t)}" controls preload="none"></video>`:`<a class="btn ghost" href="${T(t)}" target="_blank" rel="noopener noreferrer">Open video ↗</a>`}return`<a href="${T(t)}" target="_blank" rel="noopener noreferrer"><img class="nade-media-img" src="${T(t)}" alt="${T(e.addedByName||`nade media`)}" loading="lazy" /></a>`}function It(e,{showStatus:t=!1,showTryInGame:n=!1}={}){let r=et(e.type),i=(e.media||[]).filter(e=>t?!0:e.status===`approved`),a=i.length?`<div class="nade-media">${i.map(e=>`<div class="nade-media-item">${Ft(e)}${t?`<div class="nade-media-meta">${Mt(e.status)} <span>by ${T(e.addedByName||``)}</span></div>`:``}</div>`).join(``)}</div>`:`<p class="hint">No approved media yet — a 2D throw preview is shown above.</p>`,o=n?`<div class="nade-card-actions">
    ...
    <article class="nade-card">
      ...
      ${a}
      <p class="nade-foot">by ${T(e.authorName)} · ${Nt(e.createdAt)}</p>
      ${o}
    </article>`}function Lt(){let e=Ct.length?Ct.map(e=>It(e,{showTryInGame:!0})).join(``):`<p class="hint">No approved nades yet${b?` — be the first to add one!`:` — log in and add the nades you found.`}</p>`,t=St.map&&Ct.length>0;return`
    <div class="nades-filters">
      <label class="field">
        <span>Map</span>
        <select id="filter-map"><option value="">All maps</option>${jt(Ye,St.map)}</select>
      </label>
      <label class="field">
        <span>Type</span>
        <select id="filter-type"><option value="">All types</option>${jt(Xe,St.type)}</select>
      </label>
      ${t?`<div class="field browse-try-field">
               <span>&nbsp;</span>
               <button class="btn primary" type="button" id="browse-try-map">Try ${T($e(St.map))} in game (${Ct.length})</button>
             </div>`:``}
    </div>
    <div class="nade-grid">${e}</div>`}function Rt(e){return`<div class="login-prompt">
    ...
    <div class="nade-add">
      ...
      <form class="nade-add-form" id="nade-add-form">
        ...
        <div class="sens-grid">
          <label class="field"><span>Map</span><select id="add-map">${jt(Ye,S.map)}</select></label>
          <label class="field"><span>Type</span><select id="add-type">${jt(Xe,S.type)}</select></label>
        </div>
        <div class="sens-grid">
          <label class="field"><span>Side</span><select id="add-side">${jt(Qe,S.side)}</select></label>
          <label class="field"><span>Technique</span><select id="add-technique">${jt(Ze,S.technique)}</select></label>
        </div>
    ...
    </div>`:Rt(`add nades`)}function Bt(){if(!b)return Rt(`import a CS2 map guide`);let e=C.parsed,t=e&&C.selected!=null?e.nades[C.selected]:e?.nades?.[0]||null,n=e?`<div class="guide-preview-list">
    ...
    <div class="nade-import">
      ...
      <div class="nade-add-form">
        ...
        <label class="field">
          ...
          <select id="guide-side">${jt(Qe,C.side)}</select>
        </label>
        <div class="actions">
    ...
    </div>`}function Vt(){return b?wt.length?`<div class="nade-grid">${wt.map(e=>`
      <div class="nade-mine">
        ${It(e,{showStatus:!0})}
      ...
      </div>`).join(``)}</div>`:`<p class="hint">You haven't added any nades yet.</p>`:Rt(`see and manage your nades`)}function Ht(){return g(b)?Tt.length?`
    <div class="review-bulk-bar">
      <label class="review-select-all">
        <input type="checkbox" id="review-select-all" />
        <span>Select all pending nades (${Tt.filter(e=>e.status===`pending`).length})</span>
      </label>
    ...
    <div class="nade-grid">${Tt.map(e=>{let t=(e.media||[]).filter(e=>e.status===`pending`),n=t.length?`<div class="review-media">${t.map(e=>`<div class="review-media-item">${Ft(e)}
                  <div class="actions">
               ...
               </div>`:`<p class="hint">Nade already ${T(e.status)} — reviewing added media only.</p>`;return`<div class="nade-mine">${It(e,{showStatus:!0})}${n}${r}</div>`}).join(``)}</div>`:`<p class="hint">Nothing pending review. Nice and clean.</p>`:`<p class="hint">Admins only.</p>`}function Ut(e){if(!e.bannedUntil)return null;let t=new Date(e.bannedUntil);return t.getTime()<=Date.now()?null:t.getFullYear()>=9999?`permanently`:`until ${t.toLocaleString()}`}function Wt(){return g(b)?`<div class="users-table">
    ${Et.map(e=>{let t=Ut(e),n=e.role===`owner`?`<span class="hint">owner</span>`:e.role===`admin`?`<button class="btn btn-sm ghost" data-role-user="${e.id}" data-role="user">Revoke admin</button>`:`<button class="btn btn-sm" data-role-user="${e.id}" data-role="admin">Make admin</button>`,r=e.role===`owner`?``:t?`<span class="nade-badge rejected">banned ${T(t)}</span> <button class="btn btn-sm ghost" data-unban="${e.id}">Unban</button>`:`<select class="ban-duration" data-ban-dur="${e.id}">
  ...
  </div>`:`<p class="hint">Admins only.</p>`}function Gt(){let e=[[`browse`,`Browse`]];return b&&e.push([`add`,`Add nade`],[`import`,`Import guide`],[`mine`,`My nades`]),g(b)&&e.push([`review`,`Review${bt?` (${bt})`:``}`],[`users`,`Users`]),`<nav class="nades-subnav">${e.map(([e,t])=>`<button class="tool-tab ${x===e?`active`:``}" data-view="${e}">${T(t)}</button>`).join(``)}</nav>`}function Kt(){if(xt)return`<div class="nades-loading"><span class="spinner"></span> Loading…</div>`;switch(x){case`add`:return zt();case`import`:return Bt();case`mine`:return Vt();case`review`:return Ht();case`users`:return Wt();default:return Lt()}}function O(){y.innerHTML=`
    <div class="nades-shell">
      ${Gt()}
      <div class="nades-body">${Kt()}</div>
      <div id="nades-status" class="status ${yt.kind}">${T(yt.text)}</div>
      ${w?_t(w,{esc:T}):``}
    </div>`,Xt(),qt()}function qt(){y.querySelectorAll(`canvas.nade-canvas:not(.interactive):not(#guide-preview-canvas)`).forEach(e=>{lt(e,{mapId:e.dataset.map,type:e.dataset.type,start:{x:Number(e.dataset.sx),y:Number(e.dataset.sy)},end:{x:Number(e.dataset.ex),y:Number(e.dataset.ey)}})}),Jt(),Yt()}function Jt(){let e=y.querySelector(`#nade-add-canvas`);e&&lt(e,{mapId:S.map,type:S.type,start:S.start,end:S.end})}function Yt(){let e=y.querySelector(`#guide-preview-canvas`);if(!e)return;let t=C.parsed?.nades?.[C.selected??0];if(!t){lt(e,{mapId:`mirage`,type:`smoke`,start:null,end:null});return}lt(e,{mapId:t.map,type:t.type,start:t.start,end:t.end})}function Xt(){y.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>qe(e.dataset.openAuth))),y.querySelectorAll(`[data-view]`).forEach(e=>e.addEventListener(`click`,()=>D(e.dataset.view))),y.querySelector(`#filter-map`)?.addEventListener(`change`,e=>{St.map=e.target.value,D(`browse`)}),y.querySelector(`#filter-type`)?.addEventListener(`change`,e=>{St.type=e.target.value,D(`browse`)}),y.querySelector(`#browse-try-map`)?.addEventListener(`click`,()=>{rn(Ct.map(e=>e.id))}),y.querySelectorAll(`[data-try-nades]`).forEach(e=>e.addEventListener(`click`,()=>rn([Number(e.dataset.tryNades)])));let e=y.querySelector(`#nade-add-canvas`);e&&e.addEventListener(`click`,t=>{let n=ft(e,t);!S.start||S.start&&S.end?(S.start=n,S.end=null):S.end=n;let r=y.querySelector(`#nade-add-coords`);r&&(r.textContent=S.end?`Throw + landing set. Adjust by clicking again to start over.`:`Now click the landing spot for the grenade.`),Jt()}),y.querySelector(`#add-map`)?.addEventListener(`change`,e=>{S.map=e.target.value,Jt()}),y.querySelector(`#add-type`)?.addEventListener(`change`,e=>{S.type=e.target.value,Jt()}),y.querySelector(`#add-clear`)?.addEventListener(`click`,()=>{S.start=null,S.end=null,Jt();let e=y.querySelector(`#nade-add-coords`);e&&(e.textContent=`Click the map to set the throw position, then click again for the landing spot.`)}),y.querySelector(`#nade-add-form`)?.addEventListener(`submit`,Zt),y.querySelector(`#guide-file`)?.addEventListener(`change`,Qt),y.querySelector(`#guide-text`)?.addEventListener(`input`,e=>{C.text=e.target.value}),y.querySelector(`#guide-side`)?.addEventListener(`change`,e=>{C.side=e.target.value}),y.querySelector(`#guide-parse`)?.addEventListener(`click`,$t),y.querySelector(`#guide-import`)?.addEventListener(`click`,en),y.querySelector(`#guide-try-game`)?.addEventListener(`click`,tn),y.querySelector(`#guide-clear`)?.addEventListener(`click`,()=>{C=Ot(),w=null,O(),E(`Cleared map guide.`,``)}),y.querySelectorAll(`[data-guide-idx]`).forEach(e=>e.addEventListener(`click`,()=>{C.selected=Number(e.dataset.guideIdx),O()})),y.querySelector(`[data-try-game-close]`)?.addEventListener(`click`,()=>{w=null,O()}),y.querySelector(`[data-try-game-download]`)?.addEventListener(`click`,()=>{if(!w)return;mt(w);let e=y.querySelector(`[data-try-game-status]`);e&&(e.textContent=`Downloaded guide + CFG. Copy them into game/csgo (see steps), then click Download & open CS2.`)}),y.querySelector(`[data-try-game-go]`)?.addEventListener(`click`,an),y.querySelectorAll(`[data-add-media]`).forEach(e=>e.addEventListener(`click`,()=>on(e.dataset.addMedia))),y.querySelectorAll(`[data-try-import]`).forEach(e=>e.addEventListener(`click`,()=>nn(e.dataset.tryImport))),y.querySelectorAll(`[data-delete-nade]`).forEach(e=>e.addEventListener(`click`,()=>sn(e.dataset.deleteNade))),y.querySelectorAll(`[data-approve-nade]`).forEach(e=>e.addEventListener(`click`,()=>cn(e.dataset.approveNade,`approved`))),y.querySelectorAll(`[data-reject-nade]`).forEach(e=>e.addEventListener(`click`,()=>cn(e.dataset.rejectNade,`rejected`))),y.querySelectorAll(`[data-approve-media]`).forEach(e=>e.addEventListener(`click`,()=>un(e.dataset.approveMedia,`approved`))),y.querySelectorAll(`[data-reject-media]`).forEach(e=>e.addEventListener(`click`,()=>un(e.dataset.rejectMedia,`rejected`)));let t=y.querySelector(`#review-select-all`),n=y.querySelector(`#review-bulk-approve`),r=y.querySelector(`#review-bulk-reject`),i=()=>{let e=y.querySelectorAll(`.review-nade-check:checked`).length;n&&(n.disabled=e===0),r&&(r.disabled=e===0)};t?.addEventListener(`change`,()=>{y.querySelectorAll(`.review-nade-check`).forEach(e=>{e.checked=t.checked}),i()}),y.querySelectorAll(`.review-nade-check`).forEach(e=>e.addEventListener(`change`,i)),n?.addEventListener(`click`,()=>ln(`approved`)),r?.addEventListener(`click`,()=>ln(`rejected`)),y.querySelectorAll(`[data-role-user]`).forEach(e=>e.addEventListener(`click`,()=>dn(e.dataset.roleUser,e.dataset.role))),y.querySelectorAll(`[data-ban]`).forEach(e=>e.addEventListener(`click`,()=>{let t=y.querySelector(`[data-ban-dur="${e.dataset.ban}"]`);fn(e.dataset.ban,t?t.value:`24`)})),y.querySelectorAll(`[data-unban]`).forEach(e=>e.addEventListener(`click`,()=>pn(e.dataset.unban)))}async function Zt(e){if(e.preventDefault(),S.title=y.querySelector(`#add-title`)?.value||``,S.map=y.querySelector(`#add-map`)?.value||S.map,S.type=y.querySelector(`#add-type`)?.value||S.type,S.side=y.querySelector(`#add-side`)?.value||S.side,S.technique=y.querySelector(`#add-technique`)?.value||S.technique,S.description=y.querySelector(`#add-description`)?.value||``,!S.start||!S.end){E(`Click the map to set both the throw position and the landing spot.`,`error`);return}let t=[],n=(y.querySelector(`#add-video`)?.value||``).trim(),r=(y.querySelector(`#add-image`)?.value||``).trim();n&&t.push({url:n,kind:`video`}),r&&t.push({url:r,kind:rt(r)});let i=y.querySelector(`#add-upload`);try{if(i?.files?.[0]){E(`Uploading image…`,``);let e=await _.uploads.image(i.files[0]);t.push({url:e.url,kind:`image`})}await _.nades.create({...S,media:t}),S=Dt(),await D(`mine`),E(`Nade submitted! It will appear publicly once an admin approves it.`,`ok`)}catch(e){E(e.message,`error`)}}async function Qt(e){let t=e.target.files?.[0];if(t)try{C.fileName=t.name,C.text=await t.text(),C.parsed=null,C.selected=null,O(),E(`Loaded ${t.name}. Click Preview lineups.`,`ok`)}catch{E(`Could not read that file.`,`error`)}}async function $t(){let e=(y.querySelector(`#guide-text`)?.value||C.text||``).trim();if(C.text=e,C.side=y.querySelector(`#guide-side`)?.value||C.side,!e){E(`Upload or paste a CS2 map guide .txt first.`,`error`);return}try{E(`Parsing map guide…`,``);let t=await _.nades.parseMapGuide(e);C.parsed=t,C.selected=0,O(),E(`Found ${t.nades.length} lineup${t.nades.length===1?``:`s`} on ${$e(t.map)}.`,`ok`)}catch(e){C.parsed=null,O(),E(e.message,`error`)}}async function en(){if(!C.parsed?.nades?.length){E(`Preview the guide first so you can confirm the lineups.`,`error`);return}C.side=y.querySelector(`#guide-side`)?.value||C.side;let e=(y.querySelector(`#guide-text`)?.value||C.text||``).trim();try{E(`Importing lineups…`,``);let t=await _.nades.importMapGuide({nades:C.parsed.nades,side:C.side,guideText:e,fileName:C.fileName});C=Ot(),await D(`mine`),E(`Imported ${t.count} nade${t.count===1?``:`s`} — pending admin review.`,`ok`)}catch(e){E(e.message,`error`)}}async function tn(){let e=(y.querySelector(`#guide-text`)?.value||C.text||``).trim(),t=C.parsed?.map;if(!e||!t){E(`Preview the map guide first.`,`error`);return}try{E(`Preparing CS2 practice pack…`,``),w=(await _.nades.practicePackFromText({text:e,map:t})).pack,O(),E(`Ready — install into CS2 and open a private practice server.`,`ok`)}catch(e){E(e.message,`error`)}}async function nn(e){try{E(`Preparing CS2 practice pack…`,``),w=(await _.nades.practicePackFromImport(e)).pack,O(),E(`Ready — install into CS2 and open a private practice server.`,`ok`)}catch(e){E(e.message,`error`)}}async function rn(e){let t=(e||[]).map(Number).filter(e=>Number.isFinite(e)&&e>0);if(!t.length){E(`No nades to open in CS2.`,`error`);return}try{E(`Preparing CS2 practice pack…`,``),w=(await _.nades.practicePackFromNades(t)).pack,O(),E(`Ready — install into CS2 and open a private practice server.`,`ok`)}catch(e){E(e.message,`error`)}}async function an(){if(!w)return;let e=y.querySelector(`[data-try-game-status]`);e&&(e.textContent=`Working…`);try{let t=await gt(w);e&&(e.textContent=t.message),E(t.message,`ok`)}catch(t){e&&(e.textContent=t.message),E(t.message,`error`)}}async function on(e){let t=(y.querySelector(`.add-media-url[data-nade="${e}"]`)?.value||``).trim();if(!t){E(`Enter a media URL first.`,`error`);return}try{await _.nades.addMedia(e,{url:t,kind:rt(t)}),await D(`mine`),E(`Media added — pending admin review.`,`ok`)}catch(e){E(e.message,`error`)}}async function sn(e){try{await _.nades.remove(e),await D(`mine`),E(`Nade deleted.`,`ok`)}catch(e){E(e.message,`error`)}}async function cn(e,t){let n=y.querySelector(`.review-note[data-nade="${e}"]`)?.value||``;try{await _.admin.reviewNade(e,t,n),await D(`review`),E(`Nade ${t}.`,`ok`)}catch(e){E(e.message,`error`)}}async function ln(e){let t=[...y.querySelectorAll(`.review-nade-check:checked`)].map(e=>Number(e.value));if(!t.length){E(`Select at least one pending nade.`,`error`);return}let n=y.querySelector(`#review-bulk-note`)?.value||``;try{let r=await _.admin.reviewNadesBulk(t,e,n);await D(`review`),E(`${e===`approved`?`Approved`:`Rejected`} ${r.updated} nade${r.updated===1?``:`s`}.`,`ok`)}catch(e){E(e.message,`error`)}}async function un(e,t){try{await _.admin.reviewMedia(e,t),await D(`review`),E(`Media ${t}.`,`ok`)}catch(e){E(e.message,`error`)}}async function dn(e,t){try{await _.admin.setRole(e,t),await D(`users`),E(`Role updated.`,`ok`)}catch(e){E(e.message,`error`)}}async function fn(e,t){try{t===`perma`?await _.admin.banUser(e,{permanent:!0}):await _.admin.banUser(e,{hours:Number(t)}),await D(`users`),E(`User banned.`,`ok`)}catch(e){E(e.message,`error`)}}async function pn(e){try{await _.admin.unbanUser(e),await D(`users`),E(`User unbanned.`,`ok`)}catch(e){E(e.message,`error`)}}async function mn(){y=document.querySelector(`#nades-tool`),y&&(b=ke(),Ae(async e=>{b=e,await Pt(),!b&&[`add`,`import`,`mine`,`review`,`users`].includes(x)&&(x=`browse`),b&&!g(b)&&[`review`,`users`].includes(x)&&(x=`browse`),await D(x)}),await Pt(),O(),await D(`browse`))}function hn(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function gn(e){let t=document.createElement(`div`);t.className=`modal`,t.innerHTML=`
    <div class="modal-backdrop" data-close></div>
    <div class="modal-card import-card" role="dialog" aria-modal="true" aria-label="${hn(e.title)}">
      <button class="modal-close" data-close aria-label="Close">&times;</button>
      <h2 class="modal-title">${hn(e.title)}</h2>
      <p class="hint">${hn(e.description)}</p>
      <ol class="import-steps">
        <li>Open the source and complete the verification: <a class="btn btn-sm" href="${hn(e.sourceUrl)}" target="_blank" rel="noopener noreferrer">${hn(e.sourceLabel)} ↗</a></li>
        <li>Copy the page content.</li>
        <li>Paste it below and import.</li>
      </ol>
      <textarea id="import-content" rows="9" spellcheck="false" placeholder="${hn(e.placeholder||`Paste the page content here…`)}"></textarea>
      <div class="actions">
        <button class="btn primary" id="import-run">Import</button>
        <button class="btn ghost" data-close>Cancel</button>
      </div>
      <p class="status" id="import-status"></p>
    </div>`,document.body.appendChild(t);let n=()=>t.remove();t.querySelectorAll(`[data-close]`).forEach(e=>e.addEventListener(`click`,n));let r=e=>{e.key===`Escape`&&(n(),document.removeEventListener(`keydown`,r))};document.addEventListener(`keydown`,r);let i=t.querySelector(`#import-status`),a=t.querySelector(`#import-run`);a.addEventListener(`click`,async()=>{let r=t.querySelector(`#import-content`).value;if(!r.trim()){i.textContent=`Paste the page content first.`,i.className=`status error`;return}a.disabled=!0,i.textContent=`Importing…`,i.className=`status`;try{let t=await e.onImport(r);i.textContent=t||`Imported.`,i.className=`status ok`,setTimeout(n,900)}catch(e){i.textContent=e.message,i.className=`status error`,a.disabled=!1}}),t.querySelector(`#import-content`)?.focus()}var k,_n=null,A={commands:[],categories:[],recommendedLaunchOptions:``,source:`seed`,lastSync:0,cs2Build:``,cs2Version:``,remoteConfigured:!1},vn={counts:{},mine:[],comments:{}},yn=[],bn={text:``,kind:``},xn=new Set;function j(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function M(e,t=``){bn={text:e,kind:t};let n=k?.querySelector(`#commands-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function Sn(e){if(!e)return`—`;try{return new Date(e).toLocaleString()}catch{return`—`}}async function Cn(){try{A=await _.commands.catalog()}catch(e){M(`Could not load command catalog: ${e.message}`,`error`)}try{vn=await _.commands.social()}catch{}if(g(_n))try{yn=await _.admin.pendingComments()}catch{yn=[]}else yn=[]}function wn(e){let t=vn.comments[e.key]||[];return`<div class="cmd-comments">${t.length?t.map(e=>`<div class="cmd-comment"><strong>${j(e.username)}</strong><span>${j(e.body)}</span></div>`).join(``):`<p class="hint">No comments yet.</p>`}${_n?`<form class="cmd-comment-form" data-comment-key="${j(e.key)}">
       ...
       <p class="hint">Comments are reviewed by an admin before appearing.</p>`:`<button class="btn btn-sm" data-open-auth="login">Log in to comment</button>`}</div>`}function Tn(e){let t=vn.counts[e.key]||0,n=vn.mine.includes(e.key),r=(vn.comments[e.key]||[]).length,i=xn.has(e.key);return`
    <article class="cmd-card" data-search="${j(`${e.command} ${e.title} ${e.description}`.toLowerCase())}">
      ...
      ${i?wn(e):``}
    </article>`}function En(e){let t=A.commands.filter(t=>t.category===e.id);return t.length?`
    ...
    </section>`:``}function Dn(){let e=A.commands.filter(e=>e.isNew).length,t=g(_n)?`<div class="actions">
    ...
    <section class="cmd-status-bar">
      <div>
        ...
        <strong>Last synced:</strong> ${Sn(A.lastSync)}
        ${e?` · <span class="nade-badge new">${e} new</span>`:``}
      </div>
      ${t}
    </section>`}function On(){return!g(_n)||!yn.length?``:`
    <section class="cmd-review panel-review">
      <h3>Comments awaiting review (${yn.length})</h3>
      ${yn.map(e=>`<div class="review-comment">
    ...
    </section>`}function kn(){k.innerHTML=`
    <div class="commands-shell">
      ...
      ${A.categories.map(En).join(``)}
      <div id="commands-status" class="status ${bn.kind}">${j(bn.text)}</div>
    </div>`,jn()}function An(e){let t=e.trim().toLowerCase();k.querySelectorAll(`.cmd-category`).forEach(e=>{let n=0;e.querySelectorAll(`.cmd-card`).forEach(e=>{let r=!t||e.dataset.search.includes(t);e.classList.toggle(`hidden`,!r),r&&(n+=1)}),e.classList.toggle(`hidden`,n===0)})}function jn(){k.querySelectorAll(`[data-copy]`).forEach(e=>e.addEventListener(`click`,async()=>{try{await navigator.clipboard.writeText(e.dataset.copy),M(`Copied to clipboard.`,`ok`)}catch{M(`Clipboard blocked — select and copy manually.`,`error`)}})),k.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>qe(e.dataset.openAuth))),k.querySelectorAll(`[data-recommend]`).forEach(e=>e.addEventListener(`click`,()=>Mn(e.dataset.recommend))),k.querySelectorAll(`[data-toggle-comments]`).forEach(e=>e.addEventListener(`click`,()=>{let t=e.dataset.toggleComments;xn.has(t)?xn.delete(t):xn.add(t),kn()})),k.querySelectorAll(`.cmd-comment-form`).forEach(e=>e.addEventListener(`submit`,t=>{t.preventDefault(),Nn(e.dataset.commentKey,e.querySelector(`input`))})),k.querySelectorAll(`[data-approve-comment]`).forEach(e=>e.addEventListener(`click`,()=>Pn(e.dataset.approveComment,`approved`))),k.querySelectorAll(`[data-reject-comment]`).forEach(e=>e.addEventListener(`click`,()=>Pn(e.dataset.rejectComment,`rejected`))),k.querySelector(`#cmd-search`)?.addEventListener(`input`,e=>An(e.target.value)),k.querySelector(`#cmd-sync`)?.addEventListener(`click`,Fn),k.querySelector(`#cmd-check-cs2`)?.addEventListener(`click`,In)}async function Mn(e){if(!_n){qe(`login`);return}try{let t=await _.commands.recommend(e);vn.counts[e]=t.count,vn.mine=t.recommended?[...vn.mine.filter(t=>t!==e),e]:vn.mine.filter(t=>t!==e),kn()}catch(e){M(e.message,`error`)}}async function Nn(e,t){let n=(t?.value||``).trim();if(!n){M(`Write something first.`,`error`);return}try{await _.commands.addComment(e,n),M(`Comment submitted — an admin will review it before it appears.`,`ok`),t&&(t.value=``)}catch(e){M(e.message,`error`)}}async function Pn(e,t){try{await _.admin.reviewComment(e,t),await Cn(),kn(),M(`Comment ${t}.`,`ok`)}catch(e){M(e.message,`error`)}}function Fn(){gn({title:`Sync commands from the CS2 wiki`,description:`The Valve wiki has a bot check that blocks servers. Open it in your browser, complete the verification, then copy the page source (wikitext) and paste it here — the server will parse it.`,sourceUrl:`https://developer.valvesoftware.com/w/index.php?title=List_of_Counter-Strike_2_console_command_variables&action=raw`,sourceLabel:`Open CS2 wiki source`,placeholder:`Paste the wiki page source (wikitext), or a JSON list of commands…`,onImport:async e=>{let t=await _.admin.importCommands(e);return await Cn(),kn(),`Imported ${t.count} commands.`}})}async function In(){M(`Checking the current CS2 build…`,``);try{let e=await _.admin.checkCommandsCs2();await Cn(),kn(),M(e.ok?`CS2 build ${e.build}${e.changed?` — changed, catalog re-synced`:` — no change`}.`:`Check failed: ${e.reason}`,e.ok?`ok`:`error`)}catch(e){M(e.message,`error`)}}async function Ln(){k=document.querySelector(`#commands-tool`),k&&(_n=ke(),Ae(async e=>{_n=e,await Cn(),kn()}),kn(),await Cn(),kn())}var N,P=null,Rn=null,zn={paypalUrl:``,steamTradeUrl:``},Bn={text:``,kind:``};function F(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function I(e,t=``){Bn={text:e,kind:t};let n=N?.querySelector(`#profile-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function Vn(e){try{return new Date(e).toLocaleDateString()}catch{return`—`}}async function Hn(){if(P){try{Rn=(await _.auth.profile()).stats}catch(e){I(e.message,`error`)}if(we(P))try{zn=await _.settings.get()}catch{}}}function Un(e,t){return`<div class="profile-stat"><dt>${F(e)}</dt><dd>${F(t)}</dd></div>`}function Wn(){return we(P)?`
    <section class="panel profile-settings">
      ...
      <div class="profile-settings-body">
        ...
        <label class="field">
          ...
          <input id="set-paypal" type="url" placeholder="https://www.paypal.com/paypalme/yourname" value="${F(zn.paypalUrl)}" />
        </label>
        <label class="field">
          <span>Steam trade link</span>
          <input id="set-steam" type="url" placeholder="https://steamcommunity.com/tradeoffer/new/?partner=...&token=..." value="${F(zn.steamTradeUrl)}" />
        </label>
        <div class="actions">
          <button class="btn primary" id="set-save">Save donate links</button>
        </div>
      </div>
    </section>`:``}function Gn(){if(!P){N.innerHTML=`<div class="profile-shell"><div class="login-prompt">
    ...
    </div></div>`,N.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>qe(e.dataset.openAuth)));return}let e=(P.username||`?`).charAt(0).toUpperCase(),t=Rn||{nadesTotal:0,nadesApproved:0,nadesPending:0,recommendations:0,comments:0};N.innerHTML=`
    <div class="profile-shell">
      <section class="panel profile-card">
        <div class="profile-head">
          ...
          <div>
            ...
            <p class="hint">${P.email?F(P.email):`No email set`} · member since ${Vn(P.createdAt)}</p>
        ...
        <dl class="profile-stats">
          ${Un(`Nades submitted`,t.nadesTotal)}
          ${Un(`Approved`,t.nadesApproved)}
          ${Un(`Pending`,t.nadesPending)}
          ${Un(`Commands recommended`,t.recommendations)}
          ${Un(`Comments`,t.comments)}
        </dl>
      </section>
      ...
      ${Wn()}
      <div id="profile-status" class="status ${Bn.kind}">${F(Bn.text)}</div>
    </div>`,N.querySelector(`#set-save`)?.addEventListener(`click`,$n),N.querySelector(`#pw-save`)?.addEventListener(`click`,qn),N.querySelector(`#username-save`)?.addEventListener(`click`,Yn),N.querySelector(`#cred-save`)?.addEventListener(`click`,Xn),N.querySelector(`#steam-link`)?.addEventListener(`click`,Zn),N.querySelector(`#steam-unlink`)?.addEventListener(`click`,Qn);let n=N.querySelector(`#avatar-file`);N.querySelector(`#avatar-upload`)?.addEventListener(`click`,()=>n?.click()),n?.addEventListener(`change`,e=>Kn(e.target.files?.[0])),N.querySelector(`#avatar-remove`)?.addEventListener(`click`,Jn)}async function Kn(e){if(e){I(`Uploading image…`,``);try{await _.auth.uploadAvatar(e),await je(),I(`Profile image updated.`,`ok`)}catch(e){I(e.message,`error`)}}}async function qn(){let e=N.querySelector(`#pw-current`)?.value||``,t=N.querySelector(`#pw-new`)?.value||``;try{await _.auth.changePassword({currentPassword:e,newPassword:t}),N.querySelector(`#pw-current`).value=``,N.querySelector(`#pw-new`).value=``,I(`Password updated.`,`ok`)}catch(e){I(e.message,`error`)}}async function Jn(){try{await _.auth.setAvatar(``),await je(),I(`Profile image removed.`,`ok`)}catch(e){I(e.message,`error`)}}async function Yn(){let e=N.querySelector(`#acc-username`)?.value||``;try{await _.auth.changeUsername(e),await je(),I(`Username updated.`,`ok`)}catch(e){I(e.message,`error`)}}async function Xn(){let e=N.querySelector(`#cred-email`)?.value||``,t=N.querySelector(`#cred-password`)?.value||``;try{await _.auth.setCredentials({email:e,password:t}),await je(),I(`Email & password saved — you can now log in without Steam.`,`ok`)}catch(e){I(e.message,`error`)}}async function Zn(){try{let e=await _.auth.steamLinkUrl();window.location.href=e}catch(e){I(e.message,`error`)}}async function Qn(){try{await _.auth.steamUnlink(),await je(),I(`Steam unlinked.`,`ok`)}catch(e){I(e.message,`error`)}}async function $n(){let e=N.querySelector(`#set-paypal`)?.value||``,t=N.querySelector(`#set-steam`)?.value||``;try{zn=await _.admin.saveSettings({paypalUrl:e,steamTradeUrl:t}),I(`Donate links saved.`,`ok`),document.dispatchEvent(new CustomEvent(`aimkit:settings-updated`))}catch(e){I(e.message,`error`)}}async function er(){N=document.querySelector(`#profile-tool`),N&&(P=ke(),Ae(async e=>{P=e,await Hn(),Gn()}),Gn(),await Hn(),Gn())}var L,tr=null,nr=[],rr=`top`,ir=!1,ar={text:``,kind:``},or=new Set;function sr(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function cr(e,t=``){ar={text:e,kind:t};let n=L?.querySelector(`#configs-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function lr(e){try{return new Date(e).toLocaleDateString()}catch{return``}}function ur(e,t){let n=new Blob([t],{type:`text/plain`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=e,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r)}async function dr(){try{nr=await _.configs.list({sort:rr})}catch(e){cr(e.message,`error`)}gr()}function fr(e){let t=Math.round(e),n=``;for(let e=1;e<=5;e+=1)n+=e<=t?`★`:`☆`;return n}function pr(e){if(!tr)return`<button class="btn btn-sm" data-open-auth="login">Log in to rate</button>`;if(e.authorId===tr.id)return`<span class="hint">Your upload</span>`;let t=``;for(let n=1;n<=5;n+=1)t+=`<button class="star-btn ${n<=e.myRating?`on`:``}" data-rate="${e.id}" data-star="${n}" title="${n} star${n>1?`s`:``}">${n<=e.myRating?`★`:`☆`}</button>`;return`<span class="rate-label">Your rating:</span><span class="star-picker">${t}</span>`}function mr(e){let t=or.has(e.id),n=tr&&(e.authorId===tr.id||g(tr));return`
    <article class="config-card" data-search="${sr(`${e.title} ${e.description} ${e.authorName}`.toLowerCase())}">
      ...
      <div class="config-foot">
        <span>by ${sr(e.authorName)} · ${lr(e.createdAt)}</span>
        <span class="config-rate">${pr(e)}</span>
      </div>
    </article>`}function hr(){return!tr||!ir?``:`
    ...
    </section>`}function gr(){L.innerHTML=`
    <div class="configs-shell">
      <div class="configs-controls">
        <div class="sort-tabs">
          <button class="tool-tab ${rr===`top`?`active`:``}" data-sort="top">Most rated</button>
          <button class="tool-tab ${rr===`new`?`active`:``}" data-sort="new">Last uploaded</button>
        </div>
      ...
      <div class="config-grid">
        ${nr.length?nr.map(mr).join(``):`<p class="hint">No configs yet — be the first to upload one!</p>`}
      </div>
      <div id="configs-status" class="status ${ar.kind}">${sr(ar.text)}</div>
    </div>`,vr()}function _r(e){let t=e.trim().toLowerCase();L.querySelectorAll(`.config-card`).forEach(e=>{e.classList.toggle(`hidden`,t&&!e.dataset.search.includes(t))})}function vr(){L.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>qe(e.dataset.openAuth))),L.querySelectorAll(`[data-sort]`).forEach(e=>e.addEventListener(`click`,()=>{rr=e.dataset.sort,dr()})),L.querySelector(`#cfg-search`)?.addEventListener(`input`,e=>_r(e.target.value)),L.querySelector(`#cfg-new`)?.addEventListener(`click`,()=>{ir=!0,gr()}),L.querySelector(`#cfg-cancel`)?.addEventListener(`click`,()=>{ir=!1,gr()}),L.querySelector(`#cfg-submit`)?.addEventListener(`click`,xr),L.querySelector(`#cfg-config-file`)?.addEventListener(`change`,e=>br(e.target,`#cfg-config`)),L.querySelector(`#cfg-video-file`)?.addEventListener(`change`,e=>br(e.target,`#cfg-video`)),L.querySelectorAll(`[data-dl]`).forEach(e=>e.addEventListener(`click`,()=>{let t=nr.find(t=>String(t.id)===e.dataset.dl);t&&(e.dataset.kind===`config`?ur(`${yr(t.title)}.cfg`,t.configText):ur(`cs2_video.txt`,t.videoText))})),L.querySelectorAll(`[data-view]`).forEach(e=>e.addEventListener(`click`,()=>{let t=Number(e.dataset.view);or.has(t)?or.delete(t):or.add(t),gr()})),L.querySelectorAll(`[data-del]`).forEach(e=>e.addEventListener(`click`,()=>Cr(Number(e.dataset.del)))),L.querySelectorAll(`[data-rate]`).forEach(e=>e.addEventListener(`click`,()=>Sr(Number(e.dataset.rate),Number(e.dataset.star))))}function yr(e){return(e||`config`).toLowerCase().replace(/[^a-z0-9]+/g,`_`).replace(/^_|_$/g,``).slice(0,40)||`config`}function br(e,t){let n=e.files?.[0];if(!n)return;let r=new FileReader;r.onload=()=>{let e=L.querySelector(t);e&&(e.value=String(r.result||``))},r.readAsText(n)}async function xr(){let e=L.querySelector(`#cfg-title`)?.value||``,t=L.querySelector(`#cfg-desc`)?.value||``,n=L.querySelector(`#cfg-config`)?.value||``,r=L.querySelector(`#cfg-video`)?.value||``;try{await _.configs.create({title:e,description:t,configText:n,videoText:r}),ir=!1,rr=`new`,await dr(),cr(`Config published!`,`ok`)}catch(e){cr(e.message,`error`)}}async function Sr(e,t){try{let n=await _.configs.rate(e,t),r=nr.find(t=>t.id===e);r&&(r.avgRating=n.avgRating,r.ratingCount=n.ratingCount,r.myRating=n.myRating),gr(),cr(`Thanks for rating!`,`ok`)}catch(e){cr(e.message,`error`)}}async function Cr(e){try{await _.configs.remove(e),await dr(),cr(`Config deleted.`,`ok`)}catch(e){cr(e.message,`error`)}}async function wr(){L=document.querySelector(`#configs-tool`),L&&(tr=ke(),Ae(async e=>{tr=e,await dr()}),gr(),await dr())}var R,z=null,Tr=[],Er=[],Dr={text:``,kind:``},Or=!1,kr=null;function B(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Ar(e,t=``){Dr={text:e,kind:t};let n=R?.querySelector(`#highlights-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function jr(e){try{return new Date(e).toLocaleDateString()}catch{return``}}function Mr(e){let t=/(?:youtube\.com\/(?:watch\?v=|embed\/|shorts\/)|youtu\.be\/)([\w-]{6,})/.exec(e||``);return t?t[1]:null}function Nr(e){return/^https?:\/\//.test(e||``)?e:``}function Pr(e){let t=Nr(e);if(!t)return``;let n=Mr(e);return n?`<iframe class="hl-embed" src="https://www.youtube.com/embed/${B(n)}" title="highlight" allowfullscreen loading="lazy"></iframe>`:/\.(mp4|webm|mov)(\?|$)/i.test(e)?`<video class="hl-embed" src="${B(t)}" controls preload="none"></video>`:`<a class="btn ghost" href="${B(t)}" target="_blank" rel="noopener noreferrer">Open highlight ↗</a>`}async function Fr(){try{Tr=await _.highlights.list({}),Er=g(z)?await _.admin.highlightReports():[]}catch(e){Ar(e.message,`error`)}zr()}function Ir(){return!g(z)||!Er.length?``:`
    <section class="panel panel-review">
      <h3>Reported highlights (${Er.length})</h3>
      ${Er.map(e=>`<div class="report-item">
            <div class="report-media">${Pr(e.url)}</div>
    ...
    <article class="hl-card" data-search="${B(`${e.title} ${e.description} ${e.authorName}`.toLowerCase())}">
      ...
      ${kr===e.id?`<form class="hl-report-form" data-report-form="${e.id}">
    ...
    </article>`}function Rr(){return!z||!Or?``:`
    <section class="panel config-upload">
    ...
    </section>`}function zr(){R.innerHTML=`
    <div class="highlights-shell">
      ...
      ${Rr()}
      <div class="hl-grid">
        ${Tr.length?Tr.map(Lr).join(``):`<p class="hint">No highlights yet — share the first one!</p>`}
      </div>
      <div id="highlights-status" class="status ${Dr.kind}">${B(Dr.text)}</div>
    </div>`,Vr()}function Br(e){let t=e.trim().toLowerCase();R.querySelectorAll(`.hl-card`).forEach(e=>{e.classList.toggle(`hidden`,t&&!e.dataset.search.includes(t))})}function Vr(){R.querySelectorAll(`[data-open-auth]`).forEach(e=>e.addEventListener(`click`,()=>qe(e.dataset.openAuth))),R.querySelector(`#hl-search`)?.addEventListener(`input`,e=>Br(e.target.value)),R.querySelector(`#hl-new`)?.addEventListener(`click`,()=>{Or=!0,zr()}),R.querySelector(`#hl-cancel`)?.addEventListener(`click`,()=>{Or=!1,zr()}),R.querySelector(`#hl-submit`)?.addEventListener(`click`,Hr),R.querySelectorAll(`[data-report]`).forEach(e=>e.addEventListener(`click`,()=>{kr=Number(e.dataset.report),zr()})),R.querySelector(`[data-cancel-report]`)?.addEventListener(`click`,()=>{kr=null,zr()}),R.querySelector(`[data-report-form]`)?.addEventListener(`submit`,e=>{e.preventDefault(),Ur(Number(e.currentTarget.dataset.reportForm),e.currentTarget.querySelector(`input`).value)}),R.querySelectorAll(`[data-del]`).forEach(e=>e.addEventListener(`click`,()=>Wr(Number(e.dataset.del)))),R.querySelectorAll(`[data-keep]`).forEach(e=>e.addEventListener(`click`,()=>Gr(Number(e.dataset.keep),`keep`))),R.querySelectorAll(`[data-remove-hl]`).forEach(e=>e.addEventListener(`click`,()=>Gr(Number(e.dataset.removeHl),`delete`)))}async function Hr(){let e=R.querySelector(`#hl-title`)?.value||``,t=R.querySelector(`#hl-desc`)?.value||``,n=R.querySelector(`#hl-url`)?.value||``;try{await _.highlights.create({title:e,description:t,url:n}),Or=!1,await Fr(),Ar(`Highlight shared!`,`ok`)}catch(e){Ar(e.message,`error`)}}async function Ur(e,t){try{await _.highlights.report(e,t),kr=null,await Fr(),Ar(`Thanks — an admin will review your report.`,`ok`)}catch(e){Ar(e.message,`error`)}}async function Wr(e){try{await _.highlights.remove(e),await Fr(),Ar(`Highlight deleted.`,`ok`)}catch(e){Ar(e.message,`error`)}}async function Gr(e,t){try{await _.admin.reviewHighlight(e,t),await Fr(),Ar(t===`delete`?`Highlight removed.`:`Reports cleared — highlight kept.`,`ok`)}catch(e){Ar(e.message,`error`)}}async function Kr(){R=document.querySelector(`#highlights-tool`),R&&(z=ke(),Ae(async e=>{z=e,await Fr()}),zr(),await Fr())}var V,qr=null,H={pros:[],source:`seed`,lastSync:0},Jr=`featured`,Yr=``,Xr=null,Zr={text:``,kind:``};function U(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Qr(e,t=``){Zr={text:e,kind:t};let n=V?.querySelector(`#pros-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}async function $r(){try{H=await _.pros.list({sort:Jr,q:Yr})}catch(e){Qr(e.message,`error`)}oi()}var ei={"natus vincere":`#f4d000`,vitality:`#f5d20a`,falcons:`#0aa14f`,"team spirit":`#c8102e`,astralis:`#e4002b`,faze:`#e43b26`,g2:`#c8102e`};function ti(e){return ei[(e||``).toLowerCase()]||`#33415a`}function ni(e){let t=(e.team||e.player||`?`).trim(),n=t.split(/\s+/);return(n.length>1?n.slice(0,3).map(e=>e[0]).join(``):t.slice(0,2)).toUpperCase()}function ri(e){let t=e.photo||e.teamLogo||``,n=e.photo&&e.teamLogo?e.teamLogo:``,r=t?`<img class="pro-img" alt="${U(e.player)}" loading="lazy" src="${U(t)}"${n?` data-logo="${U(n)}"`:``} onerror="if(this.dataset.logo){this.src=this.dataset.logo;this.removeAttribute('data-logo');}else{this.remove();}" />`:``;return`<div class="pro-photo" style="--team:${ti(e.team)}"><span class="pro-monogram">${U(ni(e))}</span>${r}</div>`}function ii(e,t){return`<div class="pro-stat"><dt>${U(e)}</dt><dd>${t!=null&&t!==``?U(t):`—`}</dd></div>`}function ai(e){return`
    ...
    </article>`}function oi(){let e=g(qr)?`<div class="pros-admin-actions">
    ...
    <div class="pros-shell">
      ...
      <div class="configs-controls">
        <div class="sort-tabs">
          <button class="tool-tab ${Jr===`featured`?`active`:``}" data-sort="featured">Featured</button>
          <button class="tool-tab ${Jr===`name`?`active`:``}" data-sort="name">Name</button>
          <button class="tool-tab ${Jr===`edpi`?`active`:``}" data-sort="edpi">Lowest eDPI</button>
          <button class="tool-tab ${Jr===`edpi-desc`?`active`:``}" data-sort="edpi-desc">Highest eDPI</button>
        </div>
        <input id="pros-search" type="search" class="cfg-search" placeholder="Search player or team…" value="${U(Yr)}" />
      </div>
      ...
      <div class="pro-grid">
        ${H.pros.length?H.pros.map(ai).join(``):`<p class="hint">No pro settings yet.</p>`}
      </div>
      <div id="pros-status" class="status ${Zr.kind}">${U(Zr.text)}</div>
    </div>`,si()}function si(){V.querySelectorAll(`[data-sort]`).forEach(e=>e.addEventListener(`click`,()=>{Jr=e.dataset.sort,$r()}));let e=V.querySelector(`#pros-search`);e&&e.addEventListener(`input`,e=>{Yr=e.target.value,clearTimeout(Xr),Xr=setTimeout(async()=>{await $r();let e=V.querySelector(`#pros-search`);e&&(e.focus(),e.setSelectionRange(e.value.length,e.value.length))},300)}),V.querySelector(`#pros-sync`)?.addEventListener(`click`,ci),V.querySelector(`#pros-import`)?.addEventListener(`click`,li)}async function ci(){let e=V.querySelector(`#pros-sync`);e&&(e.disabled=!0),Qr(`Syncing from prosettings.net…`,``);try{let e=await _.admin.syncPros();await $r(),e.synced?Qr(`Synced ${e.count} players from ${e.source}.`,`ok`):Qr(`Sync failed: ${e.reason||`unknown error`}. Kept the current list.`,`error`)}catch(e){Qr(e.message,`error`)}finally{let e=V.querySelector(`#pros-sync`);e&&(e.disabled=!1)}}function li(){gn({title:`Import pro settings from HLTV`,description:`HLTV has a Cloudflare check that blocks servers. Open HLTV in your browser, complete the verification, then paste a JSON list of players here. Each item: {"player","team","dpi","sens","zoomSens","hz","resolution","aspectRatio","photo","teamLogo"}.`,sourceUrl:`https://www.hltv.org/stats/players`,sourceLabel:`Open HLTV`,placeholder:`[{"player":"s1mple","team":"Natus Vincere","dpi":400,"sens":3.09,"hz":1000,"resolution":"1280x960","aspectRatio":"4:3"}]`,onImport:async e=>{let t=await _.admin.importPros(e);return await $r(),`Imported ${t.count} players.`}})}async function ui(){V=document.querySelector(`#pros-tool`),V&&(qr=ke(),Ae(e=>{qr=e,oi()}),oi(),await $r())}var W,di=null,fi=`overview`,pi={text:``,kind:``},G={nades:0,comments:0,reports:0},K={},mi=[{id:`overview`,label:`Overview`},{id:`nades`,label:`Nades`},{id:`comments`,label:`Comments`},{id:`reports`,label:`Reports`},{id:`users`,label:`Users`},{id:`sync`,label:`Data sync`},{id:`contact`,label:`Contact`},{id:`settings`,label:`Site settings`,ownerOnly:!0}];function q(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function hi(e,t=``){pi={text:e,kind:t};let n=W?.querySelector(`#admin-status`);n&&(n.textContent=e,n.className=`status${t?` ${t}`:``}`)}function gi(e){try{return new Date(e).toLocaleString()}catch{return`—`}}async function _i(){try{let[e,t,n]=await Promise.all([_.admin.pendingCount().catch(()=>0),_.admin.pendingCommentsCount().catch(()=>0),_.admin.highlightReportsCount().catch(()=>0)]);G={nades:e,comments:t,reports:n}}catch{}}function vi(){let e=(e,t,n)=>`<button class="admin-stat" data-goto="${n}">
    ...
    <p class="hint">Use the tabs above to moderate content, manage users, sync data sources, and read contact messages.</p>`}function yi(){let e=K.nades||[];return e.length?`
    <div class="review-bulk-bar">
      <label class="review-select-all">
    ...
    ${e.map(e=>{let t=(e.media||[]).map(e=>`
        ...
        </article>`}).join(``)}`:`<p class="hint">Nothing pending. All nades are reviewed.</p>`}function bi(){let e=K.comments||[];return e.length?e.map(e=>`
      <article class="panel admin-item">
        <p>${q(e.body)}</p>
        <p class="hint">by ${q(e.username)} on <code>${q(e.commandKey)}</code> · ${gi(e.createdAt)}</p>
        <div class="actions">
      ...
      </article>`).join(``):`<p class="hint">No comments pending review.</p>`}function xi(){let e=K.reports||[];return e.length?e.map(e=>{let t=(e.reports||[]).map(e=>`<li>${q(e.reason||`No reason`)} — <span class="hint">${q(e.reporterName||`?`)}</span></li>`).join(``);return`
        <article class="panel admin-item">
          <div class="admin-item-head">
        ...
        </article>`}).join(``):`<p class="hint">No open highlight reports.</p>`}function Si(){let e=K.users||[];if(!e.length)return`<p class="hint">No users.</p>`;let t=Date.now();return`<div class="admin-users">${e.map(e=>{let n=e.bannedUntil&&new Date(e.bannedUntil).getTime()>t,r=e.role===`owner`;return`
    ...
    <div class="admin-sync">
    ...
    </div>`}function wi(){let e=K.contact||[];return e.length?e.map(e=>`
      <article class="panel admin-item">
        <div class="admin-item-head">
          <strong>${q(e.subject||`(no subject)`)}</strong>
          <span class="hint">${gi(e.created_at)}</span>
        </div>
      ...
      </article>`).join(``):`<p class="hint">No contact messages.</p>`}function Ti(){let e=K.settings||{paypalUrl:``,steamTradeUrl:``};return`
    <div class="panel admin-item">
    ...
    <div class="modal-card" role="dialog" aria-modal="true" aria-label="Contact us">
      ...
      <form id="contact-form" class="auth-form-modal">
        <label class="field"><span>Your name</span><input id="contact-name" type="text" value="${Ni(e?.username||``)}" /></label>
        <label class="field"><span>Your email</span><input id="contact-email" type="email" value="${Ni(e?.email||``)}" /></label>
...
`;var Zi=document.querySelector(`#preview-canvas`),Qi=document.querySelector(`#preview-stats`),$i=document.querySelector(`#preview-res`),ea=document.querySelector(`#preview-res-scale`),ta=`ingame`;function na(){let e=ta===`fullscreen`?1080:280;Zi.width!==e&&(Zi.width=e,Zi.height=e),Zi.style.imageRendering=ta===`fullscreen`?`auto`:`pixelated`}na();var ra=[{id:`1920x1080`,h:1080,label:`1920 × 1080 (16:9)`},{id:`2560x1440`,h:1440,label:`2560 × 1440 (16:9)`},{id:`3840x2160`,h:2160,label:`3840 × 2160 (4K)`},{id:`1600x900`,h:900,label:`1600 × 900 (16:9)`},{id:`1366x768`,h:768,label:`1366 × 768 (16:9)`},{id:`1280x960`,h:960,label:`1280 × 960 (4:3)`},{id:`1024x768`,h:768,label:`1024 × 768 (4:3)`},{id:`1280x1024`,h:1024,label:`1280 × 1024 (5:4)`}],ia=null;function aa(){return ta===`fullscreen`?Zi.height/1080:(ra.find(e=>e.id===$i?.value)||ra[0]).h/1080}var oa=zi({source:Zi,stage:document.querySelector(`.preview-stage`),toggleBtn:document.querySelector(`#magnifier-toggle`),zoomSelect:document.querySelector(`#magnifier-zoom`)});function sa(e){if(ia=e,Ri(Zi,e,aa()),ea)if(e){let t=ra.find(e=>e.id===$i?.value)||ra[0],n=t.h/1080;ea.textContent=`≈ ${Math.max(0,Math.round(e.length*n))}px arms · ${Math.max(1,Math.round(e.thickness*n))}px thick @ ${t.h}p`}else ea.textContent=``;oa.refresh()}function ca(e){ta=e===`fullscreen`?`fullscreen`:`ingame`,na(),document.querySelectorAll(`.pmode`).forEach(e=>{let t=e.dataset.pmode===ta;e.classList.toggle(`active`,t),e.setAttribute(`aria-selected`,String(t))});let t=document.querySelector(`#preview-mode-tag`);t&&(t.textContent=ta===`fullscreen`?`Relative to full screen`:`Actual in-game size`),sa(ia)}document.querySelectorAll(`.pmode`).forEach(e=>e.addEventListener(`click`,()=>ca(e.dataset.pmode)));var X=document.querySelector(`#crosshair-status`),la=document.querySelector(`#sensitivity-status`),ua=document.querySelector(`#sharecode-input`),da=document.querySelector(`#commands-output`),fa=document.querySelector(`#commands-input`),pa=document.querySelector(`#sharecode-output`),ma=document.querySelector(`#sens-from-game`),ha=document.querySelector(`#sens-to-game`),ga=document.querySelector(`#sens-source`),_a=document.querySelector(`#sens-target`),va=document.querySelector(`#sens-source-dpi`),ya=document.querySelector(`#sens-target-dpi`),ba=document.querySelector(`#sens-source-myaw`),xa=document.querySelector(`#sens-target-myaw`),Sa=document.querySelector(`#sens-source-yaw`),Ca=document.querySelector(`#sens-target-yaw`),wa=document.querySelector(`#source-yaw-field`),Ta=document.querySelector(`#target-yaw-field`),Ea=document.querySelector(`#m-yaw-fields`),Da=document.querySelector(`#sens-cm360`),Oa=document.querySelector(`#sens-stats`),ka=document.querySelector(`#sens-formula`),Aa=`CSGO-UseJt-3oTvn-47wPX-hEyER-WZfiK`,ja=`cl_crosshairstyle 4
cl_crosshairsize 3
cl_crosshairgap -2
...
cl_crosshair_recoil 0`;function Z(e,t,n=``){e&&(e.textContent=t,e.className=`status${n?` ${n}`:``}`)}function Ma(e){sa(e),Qi.innerHTML=`
  ...
  `}function Na(e){return e.trim().replace(/\s+/g,``).replace(/^csgo/i,`CSGO`)}function Pa(){let e=ua.value.trim();if(!e){Z(X,`Paste a crosshair share code first.`,`error`);return}let t=Na(e);if(!qi.test(t)){Z(X,`Invalid format. Expected CSGO-xxxxx-xxxxx-xxxxx-xxxxx-xxxxx`,`error`);return}try{let e=d(t);ua.value=t,da.value=se(ee(e)),Ma(e),Z(X,`Converted share code to console commands.`,`ok`)}catch(e){e instanceof i||e instanceof r?Z(X,`That share code is not a valid crosshair code.`,`error`):Z(X,e instanceof Error?e.message:`Failed to decode share code.`,`error`)}}function Fa(){let e=fa.value.trim();if(!e){Z(X,`Paste crosshair console commands first.`,`error`);return}try{let t=oe(e);pa.value=f(t),Ma(t),Z(X,`Converted commands to share code.`,`ok`)}catch(e){Z(X,e instanceof Error?e.message:`Failed to encode share code.`,`error`)}}async function Ia(e,t,n){if(!t){Z(e,`Nothing to copy for ${n}.`,`error`);return}try{await navigator.clipboard.writeText(t),Z(e,`Copied ${n} to clipboard.`,`ok`)}catch{Z(e,`Clipboard access failed. Select and copy manually.`,`error`)}}function La(){let e=Bi[ma.value]?.supportsMYaw||Bi[ha.value]?.supportsMYaw;Ea?.classList.toggle(`hidden`,!e),wa?.classList.toggle(`hidden`,!Bi[ma.value]?.custom),Ta?.classList.toggle(`hidden`,!Bi[ha.value]?.custom)}function Ra(){let e=Number(ga.value),t=Number(va.value),n=Number(ya.value),r=Number(ba.value)||.022,i=Number(xa.value)||.022,a=Number(Sa.value),o=Number(Ca.value);if(La(),Bi[ma.value]?.custom&&!(a>0)){Z(la,`Enter a valid source custom yaw (° per count).`,`error`);return}if(Bi[ha.value]?.custom&&!(o>0)){Z(la,`Enter a valid target custom yaw (° per count).`,`error`);return}if(!Number.isFinite(e)||e<=0){_a.value=``,Da.textContent=`—`,Oa.innerHTML=``,ka.textContent=``;return}if(!Number.isFinite(t)||t<=0||!Number.isFinite(n)||n<=0){Z(la,`Enter valid DPI values.`,`error`);return}let s=Wi({sourceGame:ma.value,targetGame:ha.value,sourceSens:e,sourceDpi:t,targetDpi:n,sourceMYaw:r,targetMYaw:i,sourceCustomYaw:a,targetCustomYaw:o}),c=Bi[ma.value].name,l=Bi[ha.value].name,u=Y(s.targetSensitivity);_a.value=u,Da.textContent=Gi(s.cm360),Oa.innerHTML=`
    <div><dt>Inches / 360°</dt><dd>${Gi(s.inches360)} in</dd></div>
    <div><dt>Source eDPI</dt><dd>${Gi(s.sourceEdpi,0)}</dd></div>
    <div><dt>Target eDPI</dt><dd>${Gi(s.targetEdpi,0)}</dd></div>
  ...
  `,Z(la,`${c} → ${l}: ${u}`,`ok`)}function za(){let e=ma.value;ma.value=ha.value,ha.value=e,_a.value&&(ga.value=_a.value),Ra()}function Ba(){ma.value=`cs2`,ha.value=`valorant`,ga.value=`1.25`,va.value=`800`,ya.value=`800`,Ra()}var Va={crosshair:`Convert a crosshair share code into console commands, build a code from commands, or design one visually with a live preview.`,sensitivity:`Keep the same cm/360 aim feel across games — with custom yaw values and DPI changes handled for you.`,psa:`Dial in your ideal sensitivity with a guided 7-round A/B test (Perfect Sensitivity Approximation).`,nades:`Browse community grenade line-ups, or sign in to submit your own with a 2D throw guide, videos and photos.`,commands:`Copy up-to-date CS2 launch options and console commands, recommend the ones that help, and share tips in the comments.`,configs:`Share your CS2 configs and video settings, download other players’ setups, and rate the best ones.`,highlights:`Share your best CS2 clips, watch the community’s highlights, and report anything that breaks the rules.`,pros:`Browse pro players’ sensitivity, DPI, resolution and crosshair settings.`,profile:`Your account, contributions, and settings.`,admin:`Moderate content, manage users, sync data sources, and read contact messages.`},Ha=document.querySelector(`#tool-desc`);function Ua(e){Ha&&(Ha.textContent=Va[e]||``)}function Wa(e){document.querySelectorAll(`.tool-nav .tool-tab`).forEach(t=>{let n=t.getAttribute(`data-tool`)===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,String(n))}),document.querySelectorAll(`.tool-view`).forEach(t=>{t.classList.toggle(`active`,t.id===`${e}-tool`)}),Ua(e),window.scrollTo({top:0,behavior:`smooth`})}document.querySelectorAll(`.tool-nav .tool-tab`).forEach(e=>{e.addEventListener(`click`,()=>Wa(e.getAttribute(`data-tool`)))}),document.addEventListener(`aimkit:navigate`,e=>Wa(e.detail)),Ua(`crosshair`),document.querySelectorAll(`.converter-panel .tab`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-tab`);document.querySelectorAll(`.converter-panel .tab`).forEach(e=>{let n=e.getAttribute(`data-tab`)===t;e.classList.toggle(`active`,n),e.setAttribute(`aria-selected`,String(n))}),document.querySelectorAll(`.converter-panel .tab-panel`).forEach(e=>{e.classList.toggle(`active`,e.getAttribute(`data-panel`)===t)})})}),document.querySelector(`#decode-btn`)?.addEventListener(`click`,Pa),document.querySelector(`#encode-btn`)?.addEventListener(`click`,Fa),ua.addEventListener(`keydown`,e=>{e.key===`Enter`&&Pa()}),fa.addEventListener(`input`,()=>{let e=fa.value.trim();if(!e){sa(null),Qi.innerHTML=``;return}try{Ma(oe(e))}catch{}}),ua.addEventListener(`input`,()=>{let e=Na(ua.value);if(qi.test(e))try{Ma(d(e))}catch{}}),document.querySelector(`#copy-commands`)?.addEventListener(`click`,()=>{Ia(X,da.value,`commands`)}),document.querySelector(`#copy-code`)?.addEventListener(`click`,()=>{Ia(X,pa.value,`share code`)}),document.querySelector(`#copy-sharecode-cmd`)?.addEventListener(`click`,()=>{let e=Na(ua.value);if(!e){Z(X,`Enter a share code first.`,`error`);return}Ia(X,`cl_crosshair_sharecode "${e}"`,`import command`)}),document.querySelector(`#load-example-code`)?.addEventListener(`click`,()=>{ua.value=Aa,Pa()}),document.querySelector(`#load-example-cmd`)?.addEventListener(`click`,()=>{fa.value=ja,Fa()});var Ga={0:[255,255,255],1:[50,250,50],2:[255,255,0],3:[50,50,250],4:[50,250,250]},Q={...ne},Ka=document.querySelector(`#ed-style`),qa=document.querySelector(`#ed-color`),Ja=document.querySelector(`#ed-custom-color`),Ya=document.querySelector(`#ed-custom-color-field`),Xa=document.querySelector(`#ed-r`),Za=document.querySelector(`#ed-g`),Qa=document.querySelector(`#ed-b`),$a=document.querySelector(`#ed-rgb-val`),eo=document.querySelector(`#ed-color-swatch`);function to(e,t){e&&document.activeElement!==e&&(e.value=String(t))}var no=document.querySelector(`#ed-length`),ro=document.querySelector(`#ed-thickness`),io=document.querySelector(`#ed-gap`),ao=document.querySelector(`#ed-outline`),oo=document.querySelector(`#ed-alpha`),so=document.querySelector(`#ed-dot`),co=document.querySelector(`#ed-tstyle`),lo=document.querySelector(`#ed-outline-on`),uo=document.querySelector(`#ed-alpha-on`),fo=document.querySelector(`#ed-sharecode`),po=document.querySelector(`#ed-commands`),mo=document.querySelector(`#ed-length-num`),ho=document.querySelector(`#ed-thickness-num`),go=document.querySelector(`#ed-gap-num`),_o=document.querySelector(`#ed-outline-num`),vo=document.querySelector(`#ed-alpha-num`),yo=document.querySelector(`#ed-r-num`),bo=document.querySelector(`#ed-g-num`),xo=document.querySelector(`#ed-b-num`),So=(e,t,n)=>Math.max(t,Math.min(n,e)),Co=[{key:`length`,slider:no,num:mo,min:0,max:15},{key:`thickness`,slider:ro,num:ho,min:0,max:6},{key:`gap`,slider:io,num:go,min:-10,max:10},{key:`outline`,slider:ao,num:_o,min:0,max:3},{key:`alpha`,slider:oo,num:vo,min:0,max:255}],wo=[{key:`red`,slider:Xa,num:yo},{key:`green`,slider:Za,num:bo},{key:`blue`,slider:Qa,num:xo}];function To(e,t,n){let r=e=>Math.max(0,Math.min(255,Math.round(e))).toString(16).padStart(2,`0`);return`#${r(e)}${r(t)}${r(n)}`}function Eo(e){let t=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(e.trim());return t?{r:parseInt(t[1],16),g:parseInt(t[2],16),b:parseInt(t[3],16)}:{r:Q.red,g:Q.green,b:Q.blue}}function Do(){let e=To(Q.red,Q.green,Q.blue);qa.value=String(Q.color),to(Ja,e);for(let e of wo)to(e.slider,Q[e.key]),to(e.num,Q[e.key]);$a&&($a.textContent=`${Q.red}, ${Q.green}, ${Q.blue}`),eo&&(eo.style.background=e),Ya?.classList.toggle(`hidden`,Q.color!==5)}function Oo(){for(let e of Co)to(e.slider,So(Q[e.key],e.min,e.max)),to(e.num,Q[e.key])}function ko(){Ka.value=String(Q.style),so.checked=Q.centerDotEnabled,co.checked=Q.tStyleEnabled,lo.checked=Q.outlineEnabled,uo.checked=Q.alphaEnabled,Oo(),Do()}function Ao(){Oo();let e=!Q.outlineEnabled;ao.disabled=e,_o.disabled=e;let t=!Q.alphaEnabled;oo.disabled=t,vo.disabled=t;try{fo.value=f(Q)}catch{fo.value=``}po.value=se(ee(Q))}function jo(){Ma(Q),Ao()}function Mo(){Q.style=Number(Ka.value),Q.centerDotEnabled=so.checked,Q.tStyleEnabled=co.checked,Q.outlineEnabled=lo.checked,Q.alphaEnabled=uo.checked,jo()}function No(e){Q[e.key]=Number(e.slider.value),jo()}function Po(e,t){let n=Number(e.num.value);if(e.num.value===``||!Number.isFinite(n)){t&&(e.num.value=String(Q[e.key]));return}Q[e.key]=So(n,e.min,e.max),t&&(e.num.value=String(Q[e.key])),jo()}function Fo(){Q.color=5,Q.red=So(Number(yo.value)||0,0,255),Q.green=So(Number(bo.value)||0,0,255),Q.blue=So(Number(xo.value)||0,0,255),Do(),jo()}function Io(){if(Q.color=Number(qa.value),Q.color!==5){let[e,t,n]=Ga[Q.color]??Ga[1];Q.red=e,Q.green=t,Q.blue=n}Do(),jo()}function Lo(){Q.color=5,Q.red=Number(Xa.value),Q.green=Number(Za.value),Q.blue=Number(Qa.value),Do(),jo()}function Ro(){Q.color=5;let{r:e,g:t,b:n}=Eo(Ja.value);Q.red=e,Q.green=t,Q.blue=n,Do(),jo()}Co.forEach(e=>{e.slider.addEventListener(`input`,()=>No(e)),e.num.addEventListener(`input`,()=>Po(e,!1)),e.num.addEventListener(`change`,()=>Po(e,!0))}),[Ka,so,co,lo,uo].forEach(e=>e.addEventListener(`change`,Mo)),qa.addEventListener(`change`,Io),Ja.addEventListener(`input`,Ro),Ja.addEventListener(`change`,Ro),wo.forEach(e=>{e.slider.addEventListener(`input`,Lo),e.num.addEventListener(`input`,Fo),e.num.addEventListener(`change`,Fo)}),document.querySelector(`#ed-copy-code`)?.addEventListener(`click`,()=>{Ia(X,fo.value,`share code`)}),document.querySelector(`#ed-copy-commands`)?.addEventListener(`click`,()=>{Ia(X,po.value,`commands`)}),document.querySelector(`#ed-reset`)?.addEventListener(`click`,()=>{Object.assign(Q,ne),ko(),jo(),Z(X,`Crosshair reset to defaults.`,`ok`)}),document.querySelector(`.converter-panel .tab[data-tab="visual"]`)?.addEventListener(`click`,jo),ko(),Ao(),ma.innerHTML=Ki(`cs2`),ha.innerHTML=Ki(`valorant`),[ma,ha,ga,va,ya,ba,xa,Sa,Ca].forEach(e=>{e.addEventListener(`input`,Ra),e.addEventListener(`change`,Ra)}),document.querySelector(`#sens-swap`)?.addEventListener(`click`,za),document.querySelector(`#copy-sens`)?.addEventListener(`click`,()=>{Ia(la,_a.value,`converted sensitivity`)}),document.querySelector(`#sens-cs2-val`)?.addEventListener(`click`,Ba);var zo=document.querySelector(`#psa-start`),Bo=document.querySelector(`#psa-begin`),Vo=document.querySelector(`#psa-round`),Ho=document.querySelector(`#psa-round-num`),Uo=document.querySelector(`#psa-bar-fill`),Wo=document.querySelector(`#psa-lower`),Go=document.querySelector(`#psa-higher`),Ko=document.querySelector(`#psa-lower-val`),qo=document.querySelector(`#psa-higher-val`),Jo=document.querySelector(`#psa-undo`),Yo=document.querySelector(`#psa-reset`),Xo=document.querySelector(`#psa-result`),Zo=document.querySelector(`#psa-result-label`),Qo=document.querySelector(`#psa-stats`),$o=document.querySelector(`#psa-history`),es=document.querySelector(`#psa-status`),$=null;function ts(){if(!$){Vo?.classList.add(`hidden`),$o?.classList.add(`hidden`),Xo.textContent=`—`,Zo.textContent=`recommended sensitivity`,Qo.innerHTML=``;return}let e=de($),t=e?ge($):fe($);if(Xo.textContent=Y(t,3),Zo.textContent=e?`final recommended sensitivity`:`current estimate`,Qo.innerHTML=`
  ...
  `,e)Vo?.classList.add(`hidden`),Z(es,`Done — set your sensitivity to ${Y(t,3)} and play a few sessions before changing again.`,`ok`);else{let{lower:e,higher:t}=ue($);Vo?.classList.remove(`hidden`),Ho.textContent=String($.round),Uo.style.width=`${($.round-1)/7*100}%`,Ko.textContent=Y(e,3),qo.textContent=Y(t,3),Z(es,`Round ${$.round} of 7: test both values, then pick the side that feels better.`,``)}$.choices.length>0?($o?.classList.remove(`hidden`),$o.innerHTML=`<strong>History:</strong><br />${$.choices.map(e=>`Round ${e.round}: chose <strong>${e.side}</strong> (${Y(e.lower,3)} vs ${Y(e.higher,3)})`).join(`<br />`)}`):($o?.classList.add(`hidden`),$o.innerHTML=``)}function ns(){let e=Number(zo.value);if(!Number.isFinite(e)||e<=0){Z(es,`Enter a valid starting sensitivity greater than 0.`,`error`);return}$=le(e),ts()}function rs(e){!$||de($)||($=me($,e),ts())}Bo?.addEventListener(`click`,ns),Wo?.addEventListener(`click`,()=>rs(`lower`)),Go?.addEventListener(`click`,()=>rs(`higher`)),Jo?.addEventListener(`click`,()=>{$&&($=he($),ts())}),Yo?.addEventListener(`click`,()=>{$=null,ts(),Z(es,`Enter a starting sensitivity and press Start PSA.`,``)}),$i.innerHTML=ra.map(e=>`<option value="${e.id}">${e.label}</option>`).join(``),$i.addEventListener(`change`,()=>sa(ia)),sa(null),Pa(),Ba();function is(e){return String(e||``).replaceAll(`&`,`&amp;`).replaceAll(`"`,`&quot;`)}function as(e){let t=document.querySelector(`#donate-section`),n=document.querySelector(`#donate-actions`);if(!t||!n)return;let r=[];e.paypalUrl&&r.push(`<a class="btn donate-btn paypal" href="${is(e.paypalUrl)}" target="_blank" rel="noopener noreferrer">${Ji}<span>Donate via PayPal</span></a>`),e.steamTradeUrl&&r.push(`<a class="btn donate-btn steam" href="${is(e.steamTradeUrl)}" target="_blank" rel="noopener noreferrer">${Yi}<span>Donate Steam skins</span></a>`),n.innerHTML=r.join(``),t.classList.toggle(`hidden`,r.length===0);let i=document.querySelector(`#donate-fab`);if(i){let t=[];e.paypalUrl&&t.push(`<a class="donate-fab-btn paypal" href="${is(e.paypalUrl)}" target="_blank" rel="noopener noreferrer" title="Donate via PayPal">${Ji}<span>PayPal</span></a>`),e.steamTradeUrl&&t.push(`<a class="donate-fab-btn steam" href="${is(e.steamTradeUrl)}" target="_blank" rel="noopener noreferrer" title="Donate Steam skins">${Yi}<span>Steam</span></a>`),i.innerHTML=t.length?`<span class="donate-fab-label">Support AimKit</span>${t.join(``)}`:``,i.classList.toggle(`hidden`,t.length===0)}}async function os(){try{as(await _.settings.get())}catch{as({paypalUrl:``,steamTradeUrl:``})}}document.addEventListener(`aimkit:settings-updated`,os),document.querySelector(`#contact-open`)?.addEventListener(`click`,Pi),Je();var ss=new URLSearchParams(window.location.search).get(`reset`);if(ss){We(ss);let e=new URL(window.location.href);e.searchParams.delete(`reset`),window.history.replaceState({},``,e)}var cs=new URLSearchParams(window.location.search);if(cs.get(`token`)){Ce(cs.get(`token`)),je();let e=new URL(window.location.href);e.searchParams.delete(`token`),window.history.replaceState({},``,e)}else if(cs.get(`steam`)===`linked`){je();let e=new URL(window.location.href);e.searchParams.delete(`steam`),window.history.replaceState({},``,e)}else if(cs.get(`steam_error`)){let e=new URL(window.location.href);e.searchParams.delete(`steam_error`),window.history.replaceState({},``,e)}mn(),Ln(),wr(),Kr(),ui(),er(),Mi(),os();