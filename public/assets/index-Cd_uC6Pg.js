...
`)}var le=.5;function ue(e){return{base:e,lo:e*(1-le),hi:e*1.5,round:1,choices:[]}}function de(e){return{lower:e.lo,higher:e.hi,mid:(e.lo+e.hi)/2}}function fe(e){return e.round>7}function pe(e){return(e.lo+e.hi)/2}function me(e){let t=pe(e);return t<=0?0:(e.hi-e.lo)/t}function he(e,t){if(fe(e))return e;let n=(e.lo+e.hi)/2,r={round:e.round,side:t,lo:e.lo,hi:e.hi,lower:e.lo,higher:e.hi},i={...e,choices:[...e.choices,r],round:e.round+1};return t===`lower`?i.hi=n:i.lo=n,i}function ge(e){if(e.choices.length===0)return e;let t=e.choices.slice(0,-1),n=e.choices[e.choices.length-1];return{...e,lo:n.lo,hi:n.hi,round:n.round,choices:t}}function _e(e){return pe(e)}var ve=`/api`,ye=`cs2utils.token`,be=/^https?:\/\//.test(ve)?new URL(ve).origin:``;function xe(){try{return localStorage.getItem(ye)}catch{return null}}function Se(e){try{e?localStorage.setItem(ye,e):localStorage.removeItem(ye)}catch{}}async function m(e,t,n,{auth:r=!1}={}){let i={};if(n!==void 0&&!(n instanceof FormData)&&(i[`Content-Type`]=`application/json`),r){let e=xe();e&&(i.Authorization=`Bearer ${e}`)}let a;try{a=await fetch(`${ve}${t}`,{method:e,headers:i,body:n instanceof FormData?n:n===void 0?void 0:JSON.stringify(n)})}catch{throw Error(`Cannot reach the server. Is the API running?`)}let o=null,s=await a.text();if(s)try{o=JSON.parse(s)}catch{o=null}if(!a.ok){let e=Error(o&&o.error||`Request failed (${a.status}).`);throw e.status=a.status,e.data=o,e}return o}var Ce=`${ve}/auth/steam`;function we(e){Se(e)}function h(e){return!!e&&(e.role===`admin`||e.role===`owner`)}function Te(e){return!!e&&e.role===`owner`}function Ee(e){return e?/^https?:\/\//.test(e)||e.startsWith(`data:`)?e:be+e:``}var g={auth:{async register(e){let t=await m(`POST`,`/auth/register`,e);return Se(t.token),t.user},async login(e){let t=await m(`POST`,`/auth/login`,e);return Se(t.token),t.user},logout(){Se(null)},async captcha(){return m(`GET`,`/auth/captcha`)},async changePassword(e){return m(`POST`,`/auth/password`,e,{auth:!0})},async forgot(e){return m(`POST`,`/auth/forgot`,{email:e})},async reset(e,t){return m(`POST`,`/auth/reset`,{token:e,password:t})},async me(){if(!xe())return null;try{return(await m(`GET`,`/auth/me`,void 0,{auth:!0})).user}catch{return Se(null),null}},async profile(){return m(`GET`,`/auth/profile`,void 0,{auth:!0})},async setAvatar(e){return(await m(`POST`,`/auth/avatar`,{url:e},{auth:!0})).user},async uploadAvatar(e){let t=new FormData;return t.append(`file`,e),(await m(`POST`,`/auth/avatar/upload`,t,{auth:!0})).user},async changePassword(e){return m(`POST`,`/auth/password`,e,{auth:!0})},async changeUsername(e){let t=await m(`POST`,`/auth/username`,{username:e},{auth:!0});return t.token&&Se(t.token),t.user},async setCredentials(e){let t=await m(`POST`,`/auth/credentials`,e,{auth:!0});return t.token&&Se(t.token),t.user},async forgot(e){return m(`POST`,`/auth/forgot`,{email:e})},async reset(e,t){return m(`POST`,`/auth/reset`,{token:e,password:t})},steamLoginUrl(){return`${ve}/auth/steam`},async steamLinkUrl(){return(await m(`GET`,`/auth/steam/link-url`,void 0,{auth:!0})).url},async steamUnlink(){return(await m(`POST`,`/auth/steam/unlink`,{},{auth:!0})).user}},settings:{async get(){return m(`GET`,`/settings`)}},contact:{async send(e){return m(`POST`,`/contact`,e)}},pros:{async list({q:e=``,sort:t=`name`}={}){let n=new URLSearchParams;e&&n.set(`q`,e),t&&n.set(`sort`,t);let r=n.toString();return m(`GET`,`/pros${r?`?${r}`:``}`)}},configs:{async list({sort:e=`top`,q:t=``}={}){let n=new URLSearchParams;e&&n.set(`sort`,e),t&&n.set(`q`,t);let r=n.toString();return(await m(`GET`,`/configs${r?`?${r}`:``}`,void 0,{auth:!0})).configs},async create(e){return(await m(`POST`,`/configs`,e,{auth:!0})).config},async rate(e,t){return m(`POST`,`/configs/${e}/rate`,{rating:t},{auth:!0})},async remove(e){return m(`DELETE`,`/configs/${e}`,void 0,{auth:!0})}},highlights:{async list({q:e=``}={}){return(await m(`GET`,`/highlights${e?`?q=${encodeURIComponent(e)}`:``}`,void 0,{auth:!0})).highlights},async create(e){return(await m(`POST`,`/highlights`,e,{auth:!0})).highlight},async report(e,t){return m(`POST`,`/highlights/${e}/report`,{reason:t},{auth:!0})},async remove(e){return m(`DELETE`,`/highlights/${e}`,void 0,{auth:!0})}},nades:{async list({map:e=``,type:t=``}={}){let n=new URLSearchParams;e&&n.set(`map`,e),t&&n.set(`type`,t);let r=n.toString();return(await m(`GET`,`/nades${r?`?${r}`:``}`)).nades},async mine(){return(await m(`GET`,`/nades/mine`,void 0,{auth:!0})).nades},async create(e){return(await m(`POST`,`/nades`,e,{auth:!0})).nade},async addMedia(e,t){return(await m(`POST`,`/nades/${e}/media`,t,{auth:!0})).media},async remove(e){return m(`DELETE`,`/nades/${e}`,void 0,{auth:!0})},async parseMapGuide(e){return m(`POST`,`/nades/map-guide/parse`,{text:e},{auth:!0})},async importMapGuide({text:e,nades:t,side:n,guideText:r,fileName:i}={}){return m(`POST`,`/nades/map-guide/import`,{text:e,nades:t,side:n,guideText:r,fileName:i},{auth:!0})},async practicePackFromText({text:e,map:t,importId:n}={}){return m(`POST`,`/nades/map-guide/practice-pack`,{text:e,map:t,importId:n},{auth:!0})},async practicePackFromImport(e){return m(`GET`,`/nades/map-guide/imports/${e}/practice-pack`,void 0,{auth:!!xe()})},async practicePackFromNades(e){return m(`POST`,`/nades/map-guide/practice-pack-from-nades`,{nadeIds:e},{auth:!!xe()})}},commands:{async catalog(){return m(`GET`,`/commands/catalog`)},async social(){return m(`GET`,`/commands/social`,void 0,{auth:!0})},async recommend(e){return m(`POST`,`/commands/${e}/recommend`,{},{auth:!0})},async addComment(e,t){return m(`POST`,`/commands/${e}/comments`,{body:t},{auth:!0})}},admin:{async pending(){return(await m(`GET`,`/admin/nades/pending`,void 0,{auth:!0})).nades},async pendingComments(){return(await m(`GET`,`/admin/comments/pending`,void 0,{auth:!0})).comments},async pendingCommentsCount(){return(await m(`GET`,`/admin/comments/pending/count`,void 0,{auth:!0})).count},async reviewComment(e,t){return m(`POST`,`/admin/comments/${e}/review`,{decision:t},{auth:!0})},async syncCommands(){return m(`POST`,`/admin/commands/sync`,{},{auth:!0})},async checkCommandsCs2(){return m(`POST`,`/admin/commands/check-cs2`,{},{auth:!0})},async saveSettings(e){return m(`POST`,`/admin/settings`,e,{auth:!0})},async highlightReports(){return(await m(`GET`,`/admin/highlights/reports`,void 0,{auth:!0})).highlights},async highlightReportsCount(){return(await m(`GET`,`/admin/highlights/reports/count`,void 0,{auth:!0})).count},async reviewHighlight(e,t){return m(`POST`,`/admin/highlights/${e}/review`,{decision:t},{auth:!0})},async syncPros(){return m(`POST`,`/admin/pros/sync`,{},{auth:!0})},async importCommands(e){return m(`POST`,`/admin/commands/import`,{content:e},{auth:!0})},async importPros(e){return m(`POST`,`/admin/pros/import`,{content:e},{auth:!0})},async banUser(e,{hours:t,permanent:n}){return(await m(`POST`,`/admin/users/${e}/ban`,{hours:t,permanent:n},{auth:!0})).user},async unbanUser(e){return(await m(`POST`,`/admin/users/${e}/unban`,{},{auth:!0})).user},async pendingCount(){return(await m(`GET`,`/admin/nades/pending/count`,void 0,{auth:!0})).count},async reviewNade(e,t,n=``){return m(`POST`,`/admin/nades/${e}/review`,{decision:t,note:n},{auth:!0})},async reviewNadesBulk(e,t,n=``){return m(`POST`,`/admin/nades/review-bulk`,{ids:e,decision:t,note:n},{auth:!0})},async reviewMedia(e,t){return m(`POST`,`/admin/media/${e}/review`,{decision:t},{auth:!0})},async reviewMediaBulk(e,t){return m(`POST`,`/admin/media/review-bulk`,{ids:e,decision:t},{auth:!0})},async users(){return(await m(`GET`,`/admin/users`,void 0,{auth:!0})).users},async setRole(e,t){return(await m(`POST`,`/admin/users/${e}/role`,{role:t},{auth:!0})).user},async contactMessages(){return(await m(`GET`,`/admin/contact`,void 0,{auth:!0})).messages}},uploads:{async image(e){let t=new FormData;return t.append(`file`,e),await m(`POST`,`/uploads`,t,{auth:!0})}}},De=null,Oe=new Set;function ke(){for(let e of Oe)e(De)}function Ae(){return De}function je(e){return Oe.add(e),()=>Oe.delete(e)}async function Me(){return De=await g.auth.me(),ke(),De}async function Ne(e){return De=await g.auth.login(e),ke(),De}async function Pe(e){return De=await g.auth.register(e),ke(),De}function Fe(){g.auth.logout(),De=null,ke()}var Ie,_,Le=`login`,Re={required:!1,token:null,svg:``};function ze(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function Be(){let e=Ae();e?(Ie.innerHTML=`
    ...
    ${e.map(e=>{let t=(e.media||[]).map(e=>`
      ...
      <article class="panel admin-item">
        ...
        </article>`}).join(``):`<p class="hint">No open highlight reports.</p>`}function ki(){let e=G.users||[];if(!e.length)return`<p class="hint">No users.</p>`;let t=Date.now();return`<div class="admin-users">${e.map(e=>{let n=e.bannedUntil&&new Date(e.bannedUntil).getTime()>t,r=e.role===`owner`;return`
        ...
        </div>`}).join(``)}</div>`}function Ai(){return`
    ...
    </div>`}var Ni={overview:Ti,nades:Ei,comments:Di,reports:Oi,users:ki,sync:Ai,contact:ji,settings:Mi};async function Pi(e){try{e===`overview`?await wi():e===`nades`?G.nades=await g.admin.pending():e===`comments`?G.comments=await g.admin.pendingComments():e===`reports`?G.reports=await g.admin.highlightReports():e===`users`?G.users=await g.admin.users():e===`contact`?G.contact=await g.admin.contactMessages():e===`settings`&&(G.settings=await g.settings.get())}catch(e){Si(e.message,`error`)}}function Fi(){if(!W)return;if(!h(_i)){W.innerHTML=`<div class="admin-shell"><div class="login-prompt">
      <p class="hint">This area is for admins only.</p>
      ${_i?``:`<div class="actions"><button class="btn primary" data-open-auth="login">Log in</button></div>`}
    </div></div>`,W.querySelector(`[data-open-auth]`)?.addEventListener(`click`,()=>Je(`login`));return}let e=xi.filter(e=>!e.ownerOnly||Te(_i)).map(e=>`<button class="tool-tab ${vi===e.id?`active`:``}" data-section="${e.id}">${K(e.label)}${e.id===`nades`&&bi.nades?` (${bi.nades})`:``}${e.id===`comments`&&bi.comments?` (${bi.comments})`:``}${e.id===`reports`&&bi.reports?` (${bi.reports})`:``}</button>`).join(``),t=(Ni[vi]||Ti)();W.innerHTML=`
...
`;var ia=document.querySelector(`#preview-canvas`),aa=document.querySelector(`#preview-stats`),oa=document.querySelector(`#preview-res`),sa=document.querySelector(`#preview-res-scale`),ca=`ingame`;function la(){let e=ca===`fullscreen`?1080:280;ia.width!==e&&(ia.width=e,ia.height=e),ia.style.imageRendering=ca===`fullscreen`?`auto`:`pixelated`}la();var ua=[{id:`1920x1080`,h:1080,label:`1920 × 1080 (16:9)`},{id:`2560x1440`,h:1440,label:`2560 × 1440 (16:9)`},{id:`3840x2160`,h:2160,label:`3840 × 2160 (4K)`},{id:`1600x900`,h:900,label:`1600 × 900 (16:9)`},{id:`1366x768`,h:768,label:`1366 × 768 (16:9)`},{id:`1280x960`,h:960,label:`1280 × 960 (4:3)`},{id:`1024x768`,h:768,label:`1024 × 768 (4:3)`},{id:`1280x1024`,h:1024,label:`1280 × 1024 (5:4)`}],da=null;function fa(){return ca===`fullscreen`?ia.height/1080:(ua.find(e=>e.id===oa?.value)||ua[0]).h/1080}var pa=Ki({source:ia,stage:document.querySelector(`.preview-stage`),toggleBtn:document.querySelector(`#magnifier-toggle`),zoomSelect:document.querySelector(`#magnifier-zoom`)});function ma(e){if(da=e,Gi(ia,e,fa()),sa)if(e){let t=ua.find(e=>e.id===oa?.value)||ua[0],n=t.h/1080;sa.textContent=`≈ ${Math.max(0,Math.round(e.length*n))}px arms · ${Math.max(1,Math.round(e.thickness*n))}px thick @ ${t.h}p`}else sa.textContent=``;pa.refresh()}function ha(e){ca=e===`fullscreen`?`fullscreen`:`ingame`,la(),document.querySelectorAll(`.pmode`).forEach(e=>{let t=e.dataset.pmode===ca;e.classList.toggle(`active`,t),e.setAttribute(`aria-selected`,String(t))});let t=document.querySelector(`#preview-mode-tag`);t&&(t.textContent=ca===`fullscreen`?`Relative to full screen`:`Actual in-game size`),ma(da)}document.querySelectorAll(`.pmode`).forEach(e=>e.addEventListener(`click`,()=>ha(e.dataset.pmode)));var Y=document.querySelector(`#crosshair-status`),ga=document.querySelector(`#sensitivity-status`),_a=document.querySelector(`#sharecode-input`),va=document.querySelector(`#commands-output`),ya=document.querySelector(`#commands-input`),ba=document.querySelector(`#sharecode-output`),X=document.querySelector(`#sens-from-game`),xa=document.querySelector(`#sens-to-game`),Sa=document.querySelector(`#sens-source`),Ca=document.querySelector(`#sens-target`),wa=document.querySelector(`#sens-source-dpi`),Ta=document.querySelector(`#sens-target-dpi`),Ea=document.querySelector(`#sens-source-myaw`),Da=document.querySelector(`#sens-target-myaw`),Oa=document.querySelector(`#sens-source-yaw`),ka=document.querySelector(`#sens-target-yaw`),Aa=document.querySelector(`#source-yaw-field`),ja=document.querySelector(`#target-yaw-field`),Ma=document.querySelector(`#m-yaw-fields`),Na=document.querySelector(`#sens-cm360`),Pa=document.querySelector(`#sens-stats`),Fa=document.querySelector(`#sens-formula`),Ia=`CSGO-UseJt-3oTvn-47wPX-hEyER-WZfiK`,La=`cl_crosshairstyle 4
cl_crosshairsize 3
cl_crosshairgap -2
...
cl_crosshair_recoil 0`;function Z(e,t,n=``){e&&(e.textContent=t,e.className=`status${n?` ${n}`:``}`)}function Ra(e){ma(e),aa.innerHTML=`
  ...
  `}function za(e){return e.trim().replace(/\s+/g,``).replace(/^csgo/i,`CSGO`)}function Ba(){let e=_a.value.trim();if(!e){Z(Y,`Paste a crosshair share code first.`,`error`);return}let t=za(e);if(!ea.test(t)){Z(Y,`Invalid format. Expected CSGO-xxxxx-xxxxx-xxxxx-xxxxx-xxxxx`,`error`);return}try{let e=d(t);_a.value=t,va.value=ce(ee(e)),Ra(e),Z(Y,`Converted share code to console commands.`,`ok`)}catch(e){e instanceof i||e instanceof r?Z(Y,`That share code is not a valid crosshair code.`,`error`):Z(Y,e instanceof Error?e.message:`Failed to decode share code.`,`error`)}}function Va(){let e=ya.value.trim();if(!e){Z(Y,`Paste crosshair console commands first.`,`error`);return}try{let t=se(e);ba.value=f(t),Ra(t),Z(Y,`Converted commands to share code.`,`ok`)}catch(e){Z(Y,e instanceof Error?e.message:`Failed to encode share code.`,`error`)}}async function Ha(e,t,n){if(!t){Z(e,`Nothing to copy for ${n}.`,`error`);return}try{await navigator.clipboard.writeText(t),Z(e,`Copied ${n} to clipboard.`,`ok`)}catch{Z(e,`Clipboard access failed. Select and copy manually.`,`error`)}}function Ua(){let e=qi[X.value]?.supportsMYaw||qi[xa.value]?.supportsMYaw;Ma?.classList.toggle(`hidden`,!e),Aa?.classList.toggle(`hidden`,!qi[X.value]?.custom),ja?.classList.toggle(`hidden`,!qi[xa.value]?.custom)}function Wa(){let e=Number(Sa.value),t=Number(wa.value),n=Number(Ta.value),r=Number(Ea.value)||.022,i=Number(Da.value)||.022,a=Number(Oa.value),o=Number(ka.value);if(Ua(),qi[X.value]?.custom&&!(a>0)){Z(ga,`Enter a valid source custom yaw (° per count).`,`error`);return}if(qi[xa.value]?.custom&&!(o>0)){Z(ga,`Enter a valid target custom yaw (° per count).`,`error`);return}if(!Number.isFinite(e)||e<=0){Ca.value=``,Na.textContent=`—`,Pa.innerHTML=``,Fa.textContent=``;return}if(!Number.isFinite(t)||t<=0||!Number.isFinite(n)||n<=0){Z(ga,`Enter valid DPI values.`,`error`);return}let s=Zi({sourceGame:X.value,targetGame:xa.value,sourceSens:e,sourceDpi:t,targetDpi:n,sourceMYaw:r,targetMYaw:i,sourceCustomYaw:a,targetCustomYaw:o}),c=qi[X.value].name,l=qi[xa.value].name,u=J(s.targetSensitivity);Ca.value=u,Na.textContent=Qi(s.cm360),Pa.innerHTML=`
  ...
  `,Z(ga,`${c} → ${l}: ${u}`,`ok`)}function Ga(){let e=X.value;X.value=xa.value,xa.value=e,Ca.value&&(Sa.value=Ca.value),Wa()}function Ka(){X.value=`cs2`,xa.value=`valorant`,Sa.value=`1.25`,wa.value=`800`,Ta.value=`800`,Wa()}var qa={crosshair:`Convert a crosshair share code into console commands, build a code from commands, or design one visually with a live preview.`,sensitivity:`Keep the same cm/360 aim feel across games — with custom yaw values and DPI changes handled for you.`,psa:`Dial in your ideal sensitivity with a guided 7-round A/B test (Perfect Sensitivity Approximation).`,nades:`Browse community grenade line-ups, or sign in to submit your own with a 2D throw guide, videos and photos.`,commands:`Copy up-to-date CS2 launch options and console commands, recommend the ones that help, and share tips in the comments.`,configs:`Share your CS2 configs and video settings, download other players’ setups, and rate the best ones.`,highlights:`Share your best CS2 clips, watch the community’s highlights, and report anything that breaks the rules.`,pros:`Browse pro players’ sensitivity, DPI, resolution and crosshair settings.`,profile:`Your account, contributions, and settings.`,admin:`Moderate content, manage users, sync data sources, and read contact messages.`},Ja=document.querySelector(`#tool-desc`);function Ya(e){Ja&&(Ja.textContent=qa[e]||``)}function Xa(e){document.querySelectorAll(`.tool-nav .tool-tab`).forEach(t=>{let n=t.getAttribute(`data-tool`)===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,String(n))}),document.querySelectorAll(`.tool-view`).forEach(t=>{t.classList.toggle(`active`,t.id===`${e}-tool`)}),Ya(e),window.scrollTo({top:0,behavior:`smooth`})}document.querySelectorAll(`.tool-nav .tool-tab`).forEach(e=>{e.addEventListener(`click`,()=>Xa(e.getAttribute(`data-tool`)))}),document.addEventListener(`aimkit:navigate`,e=>Xa(e.detail)),Ya(`crosshair`),document.querySelectorAll(`.converter-panel .tab`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-tab`);document.querySelectorAll(`.converter-panel .tab`).forEach(e=>{let n=e.getAttribute(`data-tab`)===t;e.classList.toggle(`active`,n),e.setAttribute(`aria-selected`,String(n))}),document.querySelectorAll(`.converter-panel .tab-panel`).forEach(e=>{e.classList.toggle(`active`,e.getAttribute(`data-panel`)===t)})})}),document.querySelector(`#decode-btn`)?.addEventListener(`click`,Ba),document.querySelector(`#encode-btn`)?.addEventListener(`click`,Va),_a.addEventListener(`keydown`,e=>{e.key===`Enter`&&Ba()}),ya.addEventListener(`input`,()=>{let e=ya.value.trim();if(!e){ma(null),aa.innerHTML=``;return}try{Ra(se(e))}catch{}}),_a.addEventListener(`input`,()=>{let e=za(_a.value);if(ea.test(e))try{Ra(d(e))}catch{}}),document.querySelector(`#copy-commands`)?.addEventListener(`click`,()=>{Ha(Y,va.value,`commands`)}),document.querySelector(`#copy-code`)?.addEventListener(`click`,()=>{Ha(Y,ba.value,`share code`)}),document.querySelector(`#copy-sharecode-cmd`)?.addEventListener(`click`,()=>{let e=za(_a.value);if(!e){Z(Y,`Enter a share code first.`,`error`);return}Ha(Y,`cl_crosshair_sharecode "${e}"`,`import command`)}),document.querySelector(`#load-example-code`)?.addEventListener(`click`,()=>{_a.value=Ia,Ba()}),document.querySelector(`#load-example-cmd`)?.addEventListener(`click`,()=>{ya.value=La,Va()});var Za={0:[255,255,255],1:[50,250,50],2:[255,255,0],3:[50,50,250],4:[50,250,250]},Q={...ne},Qa=document.querySelector(`#ed-style`),$a=document.querySelector(`#ed-color`),eo=document.querySelector(`#ed-custom-color`),to=document.querySelector(`#ed-custom-color-field`),no=document.querySelector(`#ed-r`),ro=document.querySelector(`#ed-g`),io=document.querySelector(`#ed-b`),ao=document.querySelector(`#ed-rgb-val`),oo=document.querySelector(`#ed-color-swatch`);function so(e,t){e&&document.activeElement!==e&&(e.value=String(t))}var co=document.querySelector(`#ed-length`),lo=document.querySelector(`#ed-thickness`),uo=document.querySelector(`#ed-gap`),fo=document.querySelector(`#ed-outline`),po=document.querySelector(`#ed-alpha`),mo=document.querySelector(`#ed-dot`),ho=document.querySelector(`#ed-tstyle`),go=document.querySelector(`#ed-outline-on`),_o=document.querySelector(`#ed-alpha-on`),vo=document.querySelector(`#ed-sharecode`),yo=document.querySelector(`#ed-commands`),bo=document.querySelector(`#ed-length-num`),xo=document.querySelector(`#ed-thickness-num`),So=document.querySelector(`#ed-gap-num`),Co=document.querySelector(`#ed-outline-num`),wo=document.querySelector(`#ed-alpha-num`),To=document.querySelector(`#ed-r-num`),Eo=document.querySelector(`#ed-g-num`),Do=document.querySelector(`#ed-b-num`),Oo=(e,t,n)=>Math.max(t,Math.min(n,e)),ko=[{key:`length`,slider:co,num:bo,min:0,max:15},{key:`thickness`,slider:lo,num:xo,min:0,max:6},{key:`gap`,slider:uo,num:So,min:-10,max:10},{key:`outline`,slider:fo,num:Co,min:0,max:3},{key:`alpha`,slider:po,num:wo,min:0,max:255}],Ao=[{key:`red`,slider:no,num:To},{key:`green`,slider:ro,num:Eo},{key:`blue`,slider:io,num:Do}];function jo(e,t,n){let r=e=>Math.max(0,Math.min(255,Math.round(e))).toString(16).padStart(2,`0`);return`#${r(e)}${r(t)}${r(n)}`}function Mo(e){let t=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(e.trim());return t?{r:parseInt(t[1],16),g:parseInt(t[2],16),b:parseInt(t[3],16)}:{r:Q.red,g:Q.green,b:Q.blue}}function No(){let e=jo(Q.red,Q.green,Q.blue);$a.value=String(Q.color),so(eo,e);for(let e of Ao)so(e.slider,Q[e.key]),so(e.num,Q[e.key]);ao&&(ao.textContent=`${Q.red}, ${Q.green}, ${Q.blue}`),oo&&(oo.style.background=e),to?.classList.toggle(`hidden`,Q.color!==5)}function Po(){for(let e of ko)so(e.slider,Oo(Q[e.key],e.min,e.max)),so(e.num,Q[e.key])}function Fo(){Qa.value=String(Q.style),mo.checked=Q.centerDotEnabled,ho.checked=Q.tStyleEnabled,go.checked=Q.outlineEnabled,_o.checked=Q.alphaEnabled,Po(),No()}function Io(){Po();let e=!Q.outlineEnabled;fo.disabled=e,Co.disabled=e;let t=!Q.alphaEnabled;po.disabled=t,wo.disabled=t;try{vo.value=f(Q)}catch{vo.value=``}yo.value=ce(ee(Q))}function Lo(){Ra(Q),Io()}function Ro(){Q.style=Number(Qa.value),Q.centerDotEnabled=mo.checked,Q.tStyleEnabled=ho.checked,Q.outlineEnabled=go.checked,Q.alphaEnabled=_o.checked,Lo()}function zo(e){Q[e.key]=Number(e.slider.value),Lo()}function Bo(e,t){let n=Number(e.num.value);if(e.num.value===``||!Number.isFinite(n)){t&&(e.num.value=String(Q[e.key]));return}Q[e.key]=Oo(n,e.min,e.max),t&&(e.num.value=String(Q[e.key])),Lo()}function Vo(){Q.color=5,Q.red=Oo(Number(To.value)||0,0,255),Q.green=Oo(Number(Eo.value)||0,0,255),Q.blue=Oo(Number(Do.value)||0,0,255),No(),Lo()}function Ho(){if(Q.color=Number($a.value),Q.color!==5){let[e,t,n]=Za[Q.color]??Za[1];Q.red=e,Q.green=t,Q.blue=n}No(),Lo()}function Uo(){Q.color=5,Q.red=Number(no.value),Q.green=Number(ro.value),Q.blue=Number(io.value),No(),Lo()}function Wo(){Q.color=5;let{r:e,g:t,b:n}=Mo(eo.value);Q.red=e,Q.green=t,Q.blue=n,No(),Lo()}ko.forEach(e=>{e.slider.addEventListener(`input`,()=>zo(e)),e.num.addEventListener(`input`,()=>Bo(e,!1)),e.num.addEventListener(`change`,()=>Bo(e,!0))}),[Qa,mo,ho,go,_o].forEach(e=>e.addEventListener(`change`,Ro)),$a.addEventListener(`change`,Ho),eo.addEventListener(`input`,Wo),eo.addEventListener(`change`,Wo),Ao.forEach(e=>{e.slider.addEventListener(`input`,Uo),e.num.addEventListener(`input`,Vo),e.num.addEventListener(`change`,Vo)}),document.querySelector(`#ed-copy-code`)?.addEventListener(`click`,()=>{Ha(Y,vo.value,`share code`)}),document.querySelector(`#ed-copy-commands`)?.addEventListener(`click`,()=>{Ha(Y,yo.value,`commands`)}),document.querySelector(`#ed-reset`)?.addEventListener(`click`,()=>{Object.assign(Q,ne),Fo(),Lo(),Z(Y,`Crosshair reset to defaults.`,`ok`)}),document.querySelector(`.converter-panel .tab[data-tab="visual"]`)?.addEventListener(`click`,Lo),Fo(),Io(),X.innerHTML=$i(`cs2`),xa.innerHTML=$i(`valorant`),[X,xa,Sa,wa,Ta,Ea,Da,Oa,ka].forEach(e=>{e.addEventListener(`input`,Wa),e.addEventListener(`change`,Wa)}),document.querySelector(`#sens-swap`)?.addEventListener(`click`,Ga),document.querySelector(`#copy-sens`)?.addEventListener(`click`,()=>{Ha(ga,Ca.value,`converted sensitivity`)}),document.querySelector(`#sens-cs2-val`)?.addEventListener(`click`,Ka);var Go=document.querySelector(`#psa-start`),Ko=document.querySelector(`#psa-begin`),qo=document.querySelector(`#psa-round`),Jo=document.querySelector(`#psa-round-num`),Yo=document.querySelector(`#psa-bar-fill`),Xo=document.querySelector(`#psa-lower`),Zo=document.querySelector(`#psa-higher`),Qo=document.querySelector(`#psa-lower-val`),$o=document.querySelector(`#psa-higher-val`),es=document.querySelector(`#psa-undo`),ts=document.querySelector(`#psa-reset`),ns=document.querySelector(`#psa-result`),rs=document.querySelector(`#psa-result-label`),is=document.querySelector(`#psa-stats`),as=document.querySelector(`#psa-history`),os=document.querySelector(`#psa-status`),$=null;function ss(){if(!$){qo?.classList.add(`hidden`),as?.classList.add(`hidden`),ns.textContent=`—`,rs.textContent=`recommended sensitivity`,is.innerHTML=``;return}let e=fe($),t=e?_e($):pe($);if(ns.textContent=J(t,3),rs.textContent=e?`final recommended sensitivity`:`current estimate`,is.innerHTML=`
  ...
  `,e)qo?.classList.add(`hidden`),Z(os,`Done — set your sensitivity to ${J(t,3)} and play a few sessions before changing again.`,`ok`);else{let{lower:e,higher:t}=de($);qo?.classList.remove(`hidden`),Jo.textContent=String($.round),Yo.style.width=`${($.round-1)/7*100}%`,Qo.textContent=J(e,3),$o.textContent=J(t,3),Z(os,`Round ${$.round} of 7: test both values, then pick the side that feels better.`,``)}$.choices.length>0?(as?.classList.remove(`hidden`),as.innerHTML=`<strong>History:</strong><br />${$.choices.map(e=>`Round ${e.round}: chose <strong>${e.side}</strong> (${J(e.lower,3)} vs ${J(e.higher,3)})`).join(`<br />`)}`):(as?.classList.add(`hidden`),as.innerHTML=``)}function cs(){let e=Number(Go.value);if(!Number.isFinite(e)||e<=0){Z(os,`Enter a valid starting sensitivity greater than 0.`,`error`);return}$=ue(e),ss()}function ls(e){!$||fe($)||($=he($,e),ss())}Ko?.addEventListener(`click`,cs),Xo?.addEventListener(`click`,()=>ls(`lower`)),Zo?.addEventListener(`click`,()=>ls(`higher`)),es?.addEventListener(`click`,()=>{$&&($=ge($),ss())}),ts?.addEventListener(`click`,()=>{$=null,ss(),Z(os,`Enter a starting sensitivity and press Start PSA.`,``)}),oa.innerHTML=ua.map(e=>`<option value="${e.id}">${e.label}</option>`).join(``),oa.addEventListener(`change`,()=>ma(da)),ma(null),Ba(),Ka();function us(e){return String(e||``).replaceAll(`&`,`&amp;`).replaceAll(`"`,`&quot;`)}function ds(e){let t=document.querySelector(`#donate-section`),n=document.querySelector(`#donate-actions`);if(!t||!n)return;let r=[];e.paypalUrl&&r.push(`<a class="btn donate-btn paypal" href="${us(e.paypalUrl)}" target="_blank" rel="noopener noreferrer">${ta}<span>Donate via PayPal</span></a>`),e.steamTradeUrl&&r.push(`<a class="btn donate-btn steam" href="${us(e.steamTradeUrl)}" target="_blank" rel="noopener noreferrer">${na}<span>Donate Steam skins</span></a>`),n.innerHTML=r.join(``),t.classList.toggle(`hidden`,r.length===0);let i=document.querySelector(`#donate-fab`);if(i){let t=[];e.paypalUrl&&t.push(`<a class="donate-fab-btn paypal" href="${us(e.paypalUrl)}" target="_blank" rel="noopener noreferrer" title="Donate via PayPal">${ta}<span>PayPal</span></a>`),e.steamTradeUrl&&t.push(`<a class="donate-fab-btn steam" href="${us(e.steamTradeUrl)}" target="_blank" rel="noopener noreferrer" title="Donate Steam skins">${na}<span>Steam</span></a>`),i.innerHTML=t.length?`<span class="donate-fab-label">Support AimKit</span>${t.join(``)}`:``,i.classList.toggle(`hidden`,t.length===0)}}async function fs(){try{ds(await g.settings.get())}catch{ds({paypalUrl:``,steamTradeUrl:``})}}document.addEventListener(`aimkit:settings-updated`,fs),document.querySelector(`#contact-open`)?.addEventListener(`click`,Vi),Ye();var ps=new URLSearchParams(window.location.search).get(`reset`);if(ps){Ge(ps);let e=new URL(window.location.href);e.searchParams.delete(`reset`),window.history.replaceState({},``,e)}var ms=new URLSearchParams(window.location.search);if(ms.get(`token`)){we(ms.get(`token`)),Me();let e=new URL(window.location.href);e.searchParams.delete(`token`),window.history.replaceState({},``,e)}else if(ms.get(`steam`)===`linked`){Me();let e=new URL(window.location.href);e.searchParams.delete(`steam`),window.history.replaceState({},``,e)}else if(ms.get(`steam_error`)){let e=new URL(window.location.href);e.searchParams.delete(`steam_error`),window.history.replaceState({},``,e)}bn(),Un(),Ar(),Qr(),gi(),or(),zi(),fs();